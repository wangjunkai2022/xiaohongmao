.class Lcom/im/freechat/data/sources/database/entities/download/DownloadDao_Impl$3;
...
.method constructor <init>(Lcom/im/freechat/data/sources/database/entities/download/DownloadDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/im/freechat/data/sources/database/entities/download/DownloadDao_Impl$3;->this$0:Lcom/im/freechat/data/sources/database/entities/download/DownloadDao_Impl;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/im/freechat/data/sources/database/entities/download/DownloadDao_Impl$3;->bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/im/freechat/data/sources/database/entities/download/DownloadEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `download` SET `chat_id` = ?,`media_id` = ?,`download_manager_id` = ?,`local_path` = ?,`remote_url` = ?,`file_size` = ?,`downloaded` = ?,`status` = ? WHERE `media_id` = ? AND `chat_id` = ?"
