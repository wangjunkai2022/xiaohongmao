...
.method private static final v(I[BI)V
    .locals 1
...
.method private static w(I[CI)V
    ...
    .line 1
    invoke-static {v0, p1, p2}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->x(I[CI)V

    add-int/lit8 p2, p2, 0x4

    .line 2
    invoke-static {p0, p1, p2}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->x(I[CI)V

    return-void
.end method

.method private static x(I[CI)V
    .locals 2
...
.method private static final y(Ljava/util/UUID;)[B
    .locals 7
    ...
    .line 3
    invoke-static {v6, v0, v5}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->v(I[BI)V
    ...
    .line 4
    invoke-static {v2, v0, v1}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->v(I[BI)V
    ...
    .line 5
    invoke-static {p0, v0, v1}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->v(I[BI)V
...
.method public acceptJsonFormatVisitor(Lcom/fasterxml/jackson/databind/jsonFormatVisitors/f;Lcom/fasterxml/jackson/databind/JavaType;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/fasterxml/jackson/databind/ser/std/StdSerializer;->u(Lcom/fasterxml/jackson/databind/jsonFormatVisitors/f;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/jsonFormatVisitors/JsonValueFormat;)V
...
.method public serialize(Ljava/util/UUID;Lcom/fasterxml/jackson/core/JsonGenerator;Lcom/fasterxml/jackson/databind/l;)V
    ...
    .line 2
    invoke-virtual {p0, p2}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->z(Lcom/fasterxml/jackson/core/JsonGenerator;)Z
    ...
    .line 3
    invoke-static {p1}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->y(Ljava/util/UUID;)[B

    move-result-object p1

    invoke-virtual {p2, p1}, Lcom/fasterxml/jackson/core/JsonGenerator;->L0([B)V
    ...
    .line 5
    invoke-static {v5, v0, v4}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->w(I[CI)V
    ...
    .line 6
    invoke-static {v1, v0, v5}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->x(I[CI)V
    ...
    .line 7
    invoke-static {v2, v0, v1}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->x(I[CI)V
    ...
    .line 9
    invoke-static {p1, v0, v5}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->x(I[CI)V
    ...
    .line 10
    invoke-static {p1, v0, v3}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->x(I[CI)V
    ...
    .line 11
    invoke-static {p1, v0, v1}, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->w(I[CI)V

    .line 12
    invoke-virtual {p2, v0, v4, p3}, Lcom/fasterxml/jackson/core/JsonGenerator;->Q1([CII)V

    return-void
.end method

.method protected z(Lcom/fasterxml/jackson/core/JsonGenerator;)Z
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/ser/std/UUIDSerializer;->d:Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lcom/fasterxml/jackson/core/JsonGenerator;->s()Z
