...
.method private a(Landroid/os/Message;Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;)Z
    ...
    .line 5
    invoke-static {v7}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->m(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)Lcom/google/android/exoplayer2/upstream/f0;

    move-result-object v7

    const/4 v8, 0x3

    invoke-interface {v7, v8}, Lcom/google/android/exoplayer2/upstream/f0;->d(I)I
    ...
    iget-object v12, v2, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;->dataSpec:Lcom/google/android/exoplayer2/upstream/o;
    ...
    invoke-direct/range {v9 .. v20}, Lcom/google/android/exoplayer2/source/o;-><init>(JLcom/google/android/exoplayer2/upstream/o;Landroid/net/Uri;Ljava/util/Map;JJJ)V

    .line 9
    new-instance v6, Lcom/google/android/exoplayer2/source/s;

    invoke-direct {v6, v8}, Lcom/google/android/exoplayer2/source/s;-><init>(I)V
    ...
    invoke-direct {v8, v4, v6, v2, v3}, Lcom/google/android/exoplayer2/upstream/f0$a;-><init>(Lcom/google/android/exoplayer2/source/o;Lcom/google/android/exoplayer2/source/s;Ljava/io/IOException;I)V

    invoke-interface {v7, v8}, Lcom/google/android/exoplayer2/upstream/f0;->a(Lcom/google/android/exoplayer2/upstream/f0$a;)J
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v2, v1, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->p:Lcom/google/android/exoplayer2/drm/k0;

    iget-object v1, v1, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->q:Ljava/util/UUID;

    iget-object v3, v0, Lcom/google/android/exoplayer2/drm/DefaultDrmSession$d;->d:Ljava/lang/Object;

    check-cast v3, Lcom/google/android/exoplayer2/drm/b0$b;

    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/drm/k0;->b(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/b0$b;)[B
    ...
    check-cast v3, Lcom/google/android/exoplayer2/drm/b0$h;

    .line 6
    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/drm/k0;->a(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/b0$h;)[B
    ...
    invoke-static {v2}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->m(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)Lcom/google/android/exoplayer2/upstream/f0;
    ...
    iget-object v2, v2, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->r:Lcom/google/android/exoplayer2/drm/DefaultDrmSession$e;
