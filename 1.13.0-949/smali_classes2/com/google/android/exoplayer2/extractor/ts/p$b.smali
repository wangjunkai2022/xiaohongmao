...
# instance fields
.field private final a:Lcom/google/android/exoplayer2/extractor/e0;
...
.field private final e:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Lcom/google/android/exoplayer2/util/b0$a;",
            ">;"
        }
    .end annotation
.end field

.field private final f:Lcom/google/android/exoplayer2/util/i0;
...
# direct methods
.method public constructor <init>(Lcom/google/android/exoplayer2/extractor/e0;ZZ)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->a:Lcom/google/android/exoplayer2/extractor/e0;
    ...
    .line 10
    new-instance p2, Lcom/google/android/exoplayer2/util/i0;

    const/4 p3, 0x0

    invoke-direct {p2, p1, p3, p3}, Lcom/google/android/exoplayer2/util/i0;-><init>([BII)V

    iput-object p2, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;
...
.method private d(I)V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->a:Lcom/google/android/exoplayer2/extractor/e0;
...
.method public a([BII)V
    ...
    .line 6
    iget-object v2, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->g:[B

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4, v1}, Lcom/google/android/exoplayer2/util/i0;->i([BII)V

    .line 7
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    const/16 v2, 0x8

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/i0;->b(I)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/i0;->k()V

    .line 9
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    invoke-virtual {v1, v7}, Lcom/google/android/exoplayer2/util/i0;->e(I)I
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/i0;->l(I)V

    .line 11
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/i0;->c()Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/i0;->h()I
    ...
    check-cast v1, Lcom/google/android/exoplayer2/util/b0$a;

    .line 23
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->d:Landroid/util/SparseArray;

    iget v5, v1, Lcom/google/android/exoplayer2/util/b0$a;->b:I
    ...
    check-cast v9, Lcom/google/android/exoplayer2/util/b0$b;

    .line 24
    iget-boolean v3, v9, Lcom/google/android/exoplayer2/util/b0$b;->h:Z

    if-eqz v3, :cond_9

    .line 25
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/i0;->b(I)Z
    ...
    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/i0;->l(I)V

    .line 27
    :cond_9
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    iget v5, v9, Lcom/google/android/exoplayer2/util/b0$b;->j:I

    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/i0;->b(I)Z
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/i0;->e(I)I

    move-result v12

    .line 29
    iget-boolean v3, v9, Lcom/google/android/exoplayer2/util/b0$b;->i:Z
    ...
    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/i0;->d()Z
    ...
    .line 32
    iget-object v6, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/i0;

    invoke-virtual {v6, v5}, Lcom/google/android/exoplayer2/util/i0;->b(I)Z
    ...
    invoke-virtual {v6}, Lcom/google/android/exoplayer2/util/i0;->d()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/i0;->c()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/i0;->h()I
    ...
    .line 37
    :goto_3
    iget v2, v9, Lcom/google/android/exoplayer2/util/b0$b;->k:I
    ...
    iget v3, v9, Lcom/google/android/exoplayer2/util/b0$b;->l:I

    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/i0;->b(I)Z
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/i0;->e(I)I

    move-result v2

    .line 40
    iget-boolean v1, v1, Lcom/google/android/exoplayer2/util/b0$a;->c:Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/i0;->g()I
    ...
    .line 43
    iget-boolean v2, v9, Lcom/google/android/exoplayer2/util/b0$b;->m:Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/i0;->g()I
    ...
    invoke-virtual/range {v8 .. v22}, Lcom/google/android/exoplayer2/extractor/ts/p$b$a;->e(Lcom/google/android/exoplayer2/util/b0$b;IIIIZZZZIIIII)V
...
.method public e(Lcom/google/android/exoplayer2/util/b0$a;)V
    .locals 2

    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->e:Landroid/util/SparseArray;

    iget v1, p1, Lcom/google/android/exoplayer2/util/b0$a;->a:I
...
.method public f(Lcom/google/android/exoplayer2/util/b0$b;)V
    .locals 2

    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->d:Landroid/util/SparseArray;

    iget v1, p1, Lcom/google/android/exoplayer2/util/b0$b;->d:I
