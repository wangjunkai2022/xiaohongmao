...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->c:Lcom/google/android/exoplayer2/util/g0;

    return-void
.end method

.method private static a(Lcom/google/android/exoplayer2/util/g0;)J
    .locals 2
...
.method private g(Lcom/google/android/exoplayer2/util/g0;)V
    .locals 2
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/s;->l(Lcom/google/android/exoplayer2/util/g0;)V
    ...
    .line 7
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/s;->j(Lcom/google/android/exoplayer2/util/g0;)I

    move-result v0

    .line 8
    invoke-direct {p0, p1, v0}, Lcom/google/android/exoplayer2/extractor/ts/s;->k(Lcom/google/android/exoplayer2/util/g0;I)V
...
.method private h(Lcom/google/android/exoplayer2/util/g0;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    .line 1
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/g0;->b()I
    ...
    .line 2
    invoke-static {p1, v1}, Lcom/google/android/exoplayer2/audio/a;->f(Lcom/google/android/exoplayer2/util/g0;Z)Lcom/google/android/exoplayer2/audio/a$c;

    move-result-object v1

    .line 3
    iget-object v2, v1, Lcom/google/android/exoplayer2/audio/a$c;->c:Ljava/lang/String;

    iput-object v2, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->u:Ljava/lang/String;

    .line 4
    iget v2, v1, Lcom/google/android/exoplayer2/audio/a$c;->a:I

    iput v2, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->r:I

    .line 5
    iget v1, v1, Lcom/google/android/exoplayer2/audio/a$c;->b:I
...
.method private i(Lcom/google/android/exoplayer2/util/g0;)V
    .locals 4
    ...
    .line 4
    :cond_2
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/util/g0;->s(I)V
...
.method private j(Lcom/google/android/exoplayer2/util/g0;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    .line 2
    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/util/g0;->h(I)I
...
.method private k(Lcom/google/android/exoplayer2/util/g0;I)V
    .locals 8
    .annotation runtime Lorg/checkerframework/checker/nullness/qual/RequiresNonNull;
        value = {
            "output"
    ...
    .line 1
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/g0;->e()I
    ...
    invoke-virtual {p1, v0, v2, v1}, Lcom/google/android/exoplayer2/util/g0;->i([BII)V
    ...
    .line 5
    :goto_0
    iget-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->d:Lcom/google/android/exoplayer2/extractor/e0;

    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->b:Lcom/google/android/exoplayer2/util/h0;

    invoke-interface {p1, v0, p2}, Lcom/google/android/exoplayer2/extractor/e0;->c(Lcom/google/android/exoplayer2/util/h0;I)V

    .line 6
    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->d:Lcom/google/android/exoplayer2/extractor/e0;
...
.method private l(Lcom/google/android/exoplayer2/util/g0;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    .line 3
    invoke-static {p1}, Lcom/google/android/exoplayer2/extractor/ts/s;->a(Lcom/google/android/exoplayer2/util/g0;)J
    ...
    .line 5
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/util/g0;->h(I)I
    ...
    .line 7
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/util/g0;->h(I)I
    ...
    .line 9
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/s;->h(Lcom/google/android/exoplayer2/util/g0;)I

    move-result v5

    .line 10
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/util/g0;->q(I)V
    ...
    .line 12
    invoke-virtual {p1, v4, v2, v5}, Lcom/google/android/exoplayer2/util/g0;->i([BII)V
    ...
    .line 25
    iget-object v4, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->d:Lcom/google/android/exoplayer2/extractor/e0;

    invoke-interface {v4, v2}, Lcom/google/android/exoplayer2/extractor/e0;->d(Lcom/google/android/exoplayer2/Format;)V
    ...
    :cond_3
    :goto_1
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/s;->i(Lcom/google/android/exoplayer2/util/g0;)V
...
.method private m(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/util/h0;->O(I)V

    .line 2
    iget-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->c:Lcom/google/android/exoplayer2/util/g0;
    ...
    invoke-virtual {p1, v0}, Lcom/google/android/exoplayer2/util/g0;->o([B)V
...
.method public b(Lcom/google/android/exoplayer2/util/h0;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->d:Lcom/google/android/exoplayer2/extractor/e0;
    ...
    .line 5
    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->c:Lcom/google/android/exoplayer2/util/g0;

    iget-object v1, v1, Lcom/google/android/exoplayer2/util/g0;->a:[B

    iget v2, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->h:I

    invoke-virtual {p1, v1, v2, v0}, Lcom/google/android/exoplayer2/util/h0;->k([BII)V
    ...
    .line 8
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->c:Lcom/google/android/exoplayer2/util/g0;

    invoke-virtual {v0, v4}, Lcom/google/android/exoplayer2/util/g0;->q(I)V

    .line 9
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->c:Lcom/google/android/exoplayer2/util/g0;

    invoke-direct {p0, v0}, Lcom/google/android/exoplayer2/extractor/ts/s;->g(Lcom/google/android/exoplayer2/util/g0;)V
    ...
    .line 13
    iget-object v2, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->b:Lcom/google/android/exoplayer2/util/h0;
...
.method public d(Lcom/google/android/exoplayer2/extractor/m;Lcom/google/android/exoplayer2/extractor/ts/i0$e;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/s;->d:Lcom/google/android/exoplayer2/extractor/e0;
