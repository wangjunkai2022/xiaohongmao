.class final Lcom/google/common/util/concurrent/i$k;
...
.method constructor <init>(Lcom/google/common/util/concurrent/Service$State;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v1}, Lcom/google/common/util/concurrent/i$k;-><init>(Lcom/google/common/util/concurrent/Service$State;ZLjava/lang/Throwable;)V
...
.method constructor <init>(Lcom/google/common/util/concurrent/Service$State;ZLjava/lang/Throwable;)V
    ...
    .line 5
    iput-object p1, p0, Lcom/google/common/util/concurrent/i$k;->a:Lcom/google/common/util/concurrent/Service$State;

    .line 6
    iput-boolean p2, p0, Lcom/google/common/util/concurrent/i$k;->b:Z

    .line 7
    iput-object p3, p0, Lcom/google/common/util/concurrent/i$k;->c:Ljava/lang/Throwable;
...
.method a()Lcom/google/common/util/concurrent/Service$State;
    ...
    .line 1
    iget-boolean v0, p0, Lcom/google/common/util/concurrent/i$k;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/common/util/concurrent/i$k;->a:Lcom/google/common/util/concurrent/Service$State;
...
.method b()Ljava/lang/Throwable;
    ...
    .line 2
    iget-object v0, p0, Lcom/google/common/util/concurrent/i$k;->c:Ljava/lang/Throwable;
