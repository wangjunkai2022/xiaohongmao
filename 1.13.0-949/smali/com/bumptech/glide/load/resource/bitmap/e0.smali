...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/bumptech/glide/load/resource/bitmap/e0$d;,
        Lcom/bumptech/glide/load/resource/bitmap/e0$c;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e0;->e:Landroid/graphics/Paint;
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e0;->g:Ljava/util/Set;
    ...
    :cond_0
    new-instance v0, Lcom/bumptech/glide/load/resource/bitmap/e0$d;

    invoke-direct {v0}, Lcom/bumptech/glide/load/resource/bitmap/e0$d;-><init>()V

    :goto_0
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e0;->h:Ljava/util/concurrent/locks/Lock;
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e0;->f:Landroid/graphics/Paint;
...
.method private static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    .line 1
    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/e0;->h:Ljava/util/concurrent/locks/Lock;
    ...
    .line 3
    sget-object p1, Lcom/bumptech/glide/load/resource/bitmap/e0;->c:Landroid/graphics/Paint;

    invoke-virtual {v1, p0, p2, p1}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;Landroid/graphics/Paint;)V

    .line 4
    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/e0;->e(Landroid/graphics/Canvas;)V
    :try_end_0
    ...
    sget-object p1, Lcom/bumptech/glide/load/resource/bitmap/e0;->h:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 10
    invoke-static {p1}, Lcom/bumptech/glide/load/resource/bitmap/e0;->k(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    .line 11
    invoke-static {p1, p0}, Lcom/bumptech/glide/load/resource/bitmap/e0;->t(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static c(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 6
    :cond_2
    invoke-static {p0, p1, p2, p3}, Lcom/bumptech/glide/load/resource/bitmap/e0;->f(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static d(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 6
    invoke-static {p0, p1}, Lcom/bumptech/glide/load/resource/bitmap/e0;->g(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 10
    sget-object v2, Lcom/bumptech/glide/load/resource/bitmap/e0;->h:Ljava/util/concurrent/locks/Lock;
    ...
    .line 12
    sget-object v4, Lcom/bumptech/glide/load/resource/bitmap/e0;->e:Landroid/graphics/Paint;
    ...
    .line 13
    sget-object v4, Lcom/bumptech/glide/load/resource/bitmap/e0;->f:Landroid/graphics/Paint;
    ...
    .line 14
    invoke-static {v3}, Lcom/bumptech/glide/load/resource/bitmap/e0;->e(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static o(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p2}, Lcom/bumptech/glide/load/resource/bitmap/e0;->m(I)Z
    ...
    .line 3
    invoke-static {p2, v0}, Lcom/bumptech/glide/load/resource/bitmap/e0;->l(ILandroid/graphics/Matrix;)V
...
.method public static p(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;FFFF)Landroid/graphics/Bitmap;
    ...
    new-instance v0, Lcom/bumptech/glide/load/resource/bitmap/e0$b;

    invoke-direct {v0, p2, p3, p4, p5}, Lcom/bumptech/glide/load/resource/bitmap/e0$b;-><init>(FFFF)V

    invoke-static {p0, p1, v0}, Lcom/bumptech/glide/load/resource/bitmap/e0;->s(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;Lcom/bumptech/glide/load/resource/bitmap/e0$c;)Landroid/graphics/Bitmap;
...
.method public static q(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p2}, Lcom/bumptech/glide/load/resource/bitmap/e0$a;-><init>(I)V
...
.method public static r(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p4}, Lcom/bumptech/glide/load/resource/bitmap/e0;->q(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method private static s(Lcom/bumptech/glide/load/engine/bitmap_recycle/e;Landroid/graphics/Bitmap;Lcom/bumptech/glide/load/resource/bitmap/e0$c;)Landroid/graphics/Bitmap;
    .locals 8
    .param p0    # Lcom/bumptech/glide/load/engine/bitmap_recycle/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 10
    sget-object v3, Lcom/bumptech/glide/load/resource/bitmap/e0;->h:Ljava/util/concurrent/locks/Lock;
    ...
    .line 13
    invoke-interface {p2, v5, v4, v2}, Lcom/bumptech/glide/load/resource/bitmap/e0$c;->a(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/RectF;)V

    .line 14
    invoke-static {v5}, Lcom/bumptech/glide/load/resource/bitmap/e0;->e(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
