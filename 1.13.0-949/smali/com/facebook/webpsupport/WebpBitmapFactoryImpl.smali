...
.field private static d:Lt0/b$a;

.field private static e:Lt0/a;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->c:Z
...
.method private static createBitmap(IILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 1
    sget-boolean v0, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->c:Z
    ...
    .line 4
    :cond_0
    sget-object p2, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->e:Lt0/a;

    sget-object v0, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-interface {p2, p0, p1, v0}, Lt0/a;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method private static g(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)[B
    .locals 2
...
.method private static h(Ljava/lang/String;)V
    ...
    .line 1
    sget-object v0, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->d:Lt0/b$a;
    ...
    .line 2
    invoke-interface {v0, p0, v1}, Lt0/b$a;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static hookDecodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 2
    sget-boolean v0, Lt0/c;->a:Z

    if-eqz v0, :cond_1

    invoke-static {p0, p1, p2}, Lt0/c;->h([BII)Z
    ...
    .line 6
    invoke-static {p1}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->h(Ljava/lang/String;)V

    .line 7
    :cond_0
    invoke-static {p0, p3}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->j(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
...
.method public static hookDecodeFile(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 2
    :try_start_1
    invoke-static {p0, v0, p1}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static hookDecodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, p0}, Lio/sentry/instrumentation/file/h$b;->c(Ljava/io/FileInputStream;Ljava/io/FileDescriptor;)Ljava/io/FileInputStream;

    move-result-object v3

    invoke-static {v3}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->k(Ljava/io/InputStream;)Ljava/io/InputStream;

    move-result-object v3

    .line 4
    :try_start_0
    invoke-static {v3, p2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->g(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)[B

    move-result-object v4

    .line 5
    sget-boolean v5, Lt0/c;->a:Z
    ...
    .line 6
    invoke-static {v4, v2, v5}, Lt0/c;->h([BII)Z
    ...
    .line 9
    invoke-static {v0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->h(Ljava/lang/String;)V
    ...
    .line 11
    invoke-static {p0, p2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->j(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
    ...
    invoke-static {v0, p0}, Lio/sentry/instrumentation/file/h$b;->c(Ljava/io/FileInputStream;Ljava/io/FileDescriptor;)Ljava/io/FileInputStream;

    move-result-object p0

    invoke-static {p0, p1, p2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static hookDecodeResource(Landroid/content/res/Resources;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_1
    :goto_1
    sget-boolean p0, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->c:Z
...
.method public static hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 2
    invoke-static {p0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->k(Ljava/io/InputStream;)Ljava/io/InputStream;

    move-result-object p0

    .line 3
    invoke-static {p0, p2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->g(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)[B

    move-result-object v0

    .line 4
    sget-boolean v1, Lt0/c;->a:Z
    ...
    .line 5
    invoke-static {v0, v1, v2}, Lt0/c;->h([BII)Z
...
.method private static i(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
    .locals 3
...
.method private static j(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
    .locals 0
    .param p0    # Landroid/graphics/Bitmap;
        .annotation runtime Lr7/h;
        .end annotation
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->i(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
...
# virtual methods
.method public a(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public b(Lt0/b$a;)V
    ...
    sput-object p1, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->d:Lt0/b$a;
...
.method public d(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 0
    .param p2    # Landroid/graphics/Rect;
        .annotation runtime Lr7/h;
        .end annotation
...
.method public e(Lt0/a;)V
    ...
    sput-object p1, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->e:Lt0/a;

    return-void
.end method

.method public f([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 0
    .param p4    # Landroid/graphics/BitmapFactory$Options;
        .annotation runtime Lr7/h;
        .end annotation
