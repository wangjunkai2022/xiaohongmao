...
# instance fields
.field protected transient p:Ljava/util/LinkedHashMap;
...
.method public checkUnresolvedObjectId()V
    ...
    .line 1
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->p:Ljava/util/LinkedHashMap;
    ...
    .line 3
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->p:Ljava/util/LinkedHashMap;
    ...
    check-cast v2, Lcom/fasterxml/jackson/databind/deser/impl/j;

    .line 5
    invoke-virtual {v2}, Lcom/fasterxml/jackson/databind/deser/impl/j;->e()Z
    ...
    .line 6
    :cond_3
    invoke-virtual {p0, v2}, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->s(Lcom/fasterxml/jackson/databind/deser/impl/j;)Z
    ...
    .line 9
    :cond_5
    invoke-virtual {v2}, Lcom/fasterxml/jackson/databind/deser/impl/j;->c()Lcom/fasterxml/jackson/annotation/ObjectIdGenerator$IdKey;
    ...
    .line 10
    invoke-virtual {v2}, Lcom/fasterxml/jackson/databind/deser/impl/j;->f()Ljava/util/Iterator;
    ...
    check-cast v4, Lcom/fasterxml/jackson/databind/deser/impl/j$a;

    .line 12
    invoke-virtual {v4}, Lcom/fasterxml/jackson/databind/deser/impl/j$a;->a()Ljava/lang/Class;

    move-result-object v5

    invoke-virtual {v4}, Lcom/fasterxml/jackson/databind/deser/impl/j$a;->b()Lcom/fasterxml/jackson/core/JsonLocation;
...
.method public deserializerInstance(Lcom/fasterxml/jackson/databind/introspect/a;Ljava/lang/Object;)Lcom/fasterxml/jackson/databind/d;
    ...
    .line 7
    iget-object v1, p0, Lcom/fasterxml/jackson/databind/DeserializationContext;->d:Lcom/fasterxml/jackson/databind/DeserializationConfig;
    ...
    .line 8
    :cond_3
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/DeserializationContext;->d:Lcom/fasterxml/jackson/databind/DeserializationConfig;

    invoke-virtual {v1, v0, p1, p2}, Lcom/fasterxml/jackson/databind/cfg/c;->b(Lcom/fasterxml/jackson/databind/DeserializationConfig;Lcom/fasterxml/jackson/databind/introspect/a;Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/d;
    ...
    .line 9
    iget-object p1, p0, Lcom/fasterxml/jackson/databind/DeserializationContext;->d:Lcom/fasterxml/jackson/databind/DeserializationConfig;
    ...
    .line 12
    :goto_1
    instance-of p1, p2, Lcom/fasterxml/jackson/databind/deser/m;
    ...
    invoke-interface {p1, p0}, Lcom/fasterxml/jackson/databind/deser/m;->resolve(Lcom/fasterxml/jackson/databind/DeserializationContext;)V
...
.method public findObjectId(Ljava/lang/Object;Lcom/fasterxml/jackson/annotation/ObjectIdGenerator;Lcom/fasterxml/jackson/annotation/c0;)Lcom/fasterxml/jackson/databind/deser/impl/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p2, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->p:Ljava/util/LinkedHashMap;
    ...
    iput-object p2, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->p:Ljava/util/LinkedHashMap;
    ...
    check-cast p2, Lcom/fasterxml/jackson/databind/deser/impl/j;
    ...
    :cond_2
    :goto_0
    iget-object p2, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->q:Ljava/util/List;
    ...
    iput-object p2, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->q:Ljava/util/List;
    ...
    .line 8
    invoke-interface {v1, p3}, Lcom/fasterxml/jackson/annotation/c0;->b(Lcom/fasterxml/jackson/annotation/c0;)Z
    ...
    .line 9
    invoke-interface {p3, p0}, Lcom/fasterxml/jackson/annotation/c0;->d(Ljava/lang/Object;)Lcom/fasterxml/jackson/annotation/c0;
    ...
    .line 11
    :cond_6
    invoke-virtual {p0, p1}, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->r(Lcom/fasterxml/jackson/annotation/ObjectIdGenerator$IdKey;)Lcom/fasterxml/jackson/databind/deser/impl/j;

    move-result-object p2

    .line 12
    invoke-virtual {p2, v0}, Lcom/fasterxml/jackson/databind/deser/impl/j;->h(Lcom/fasterxml/jackson/annotation/c0;)V

    .line 13
    iget-object p3, p0, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->p:Ljava/util/LinkedHashMap;
...
.method public final keyDeserializerInstance(Lcom/fasterxml/jackson/databind/introspect/a;Ljava/lang/Object;)Lcom/fasterxml/jackson/databind/h;
    ...
    invoke-virtual {v1, v0, p1, p2}, Lcom/fasterxml/jackson/databind/cfg/c;->d(Lcom/fasterxml/jackson/databind/DeserializationConfig;Lcom/fasterxml/jackson/databind/introspect/a;Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/h;
...
.method protected q(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/d;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    invoke-static {v1}, Lcom/fasterxml/jackson/databind/util/g;->h0(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 14
    invoke-virtual {p3, p1, p0}, Lcom/fasterxml/jackson/databind/d;->deserialize(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;)Ljava/lang/Object;
    ...
    .line 15
    :cond_3
    invoke-virtual {p3, p1, p0, p4}, Lcom/fasterxml/jackson/databind/d;->deserialize(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected r(Lcom/fasterxml/jackson/annotation/ObjectIdGenerator$IdKey;)Lcom/fasterxml/jackson/databind/deser/impl/j;
    .locals 1

    new-instance v0, Lcom/fasterxml/jackson/databind/deser/impl/j;

    invoke-direct {v0, p1}, Lcom/fasterxml/jackson/databind/deser/impl/j;-><init>(Lcom/fasterxml/jackson/annotation/ObjectIdGenerator$IdKey;)V

    return-object v0
.end method

.method public readRootValue(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/d;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/fasterxml/jackson/databind/deser/DefaultDeserializationContext;->q(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/d;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected s(Lcom/fasterxml/jackson/databind/deser/impl/j;)Z
    .locals 0

    invoke-virtual {p1, p0}, Lcom/fasterxml/jackson/databind/deser/impl/j;->i(Lcom/fasterxml/jackson/databind/DeserializationContext;)Z
