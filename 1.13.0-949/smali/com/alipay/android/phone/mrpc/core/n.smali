...
.method public final a()Ljava/lang/Object;
    ...
    invoke-interface {v2}, Lcom/alipay/android/phone/mrpc/core/k;->a()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/alipay/android/phone/mrpc/core/s;-><init>(Ljava/lang/String;)V

    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/a;->b:[B

    invoke-virtual {v1, v2}, Lcom/alipay/android/phone/mrpc/core/s;->i([B)V

    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/a;->e:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/alipay/android/phone/mrpc/core/s;->e(Ljava/lang/String;)V

    iget-boolean v2, p0, Lcom/alipay/android/phone/mrpc/core/a;->f:Z

    invoke-virtual {v1, v2}, Lcom/alipay/android/phone/mrpc/core/s;->h(Z)V
    ...
    invoke-virtual {v1, v3, v2}, Lcom/alipay/android/phone/mrpc/core/s;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Lcom/alipay/android/phone/mrpc/core/s;->g(Lorg/apache/http/Header;)V

    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/n;->g:Lcom/alipay/android/phone/mrpc/core/k;

    invoke-interface {v2}, Lcom/alipay/android/phone/mrpc/core/k;->c()Lcom/alipay/android/phone/mrpc/core/b;

    move-result-object v2

    invoke-virtual {v2}, Lcom/alipay/android/phone/mrpc/core/b;->c()Ljava/util/List;
    ...
    invoke-virtual {v1, v3}, Lcom/alipay/android/phone/mrpc/core/s;->g(Lorg/apache/http/Header;)V
    ...
    :try_start_0
    iget-object v4, p0, Lcom/alipay/android/phone/mrpc/core/n;->g:Lcom/alipay/android/phone/mrpc/core/k;

    invoke-interface {v4}, Lcom/alipay/android/phone/mrpc/core/k;->b()Lcom/alipay/android/phone/mrpc/core/c;

    move-result-object v4

    invoke-interface {v4, v1}, Lcom/alipay/android/phone/mrpc/core/c;->a(Lcom/alipay/android/phone/mrpc/core/x;)Ljava/util/concurrent/Future;
    ...
    check-cast v1, Lcom/alipay/android/phone/mrpc/core/y;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/y;->b()[B
