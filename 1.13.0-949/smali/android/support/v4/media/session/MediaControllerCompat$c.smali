...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/b$b;->s(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
...
.method public G()Ljava/util/List;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->G()Ljava/util/List;
...
.method public a()Landroid/support/v4/media/session/MediaControllerCompat$d;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->A1()Landroid/support/v4/media/session/ParcelableVolumeInfo;
...
.method public b(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/media/session/b;->e1(Landroid/support/v4/media/session/a;)V
...
.method public d(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/b;->i0(Landroid/support/v4/media/MediaDescriptionCompat;I)V
...
.method public e(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 3
    :goto_0
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/media/session/b;->y0(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public f()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->K()Landroid/app/PendingIntent;
...
.method public h(II)V
    ...
    invoke-interface {v0, p1, p2, v1}, Landroid/support/v4/media/session/b;->q1(IILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public i(Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/b;->f0(Landroid/view/KeyEvent;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public j(II)V
    ...
    invoke-interface {v0, p1, p2, v1}, Landroid/support/v4/media/session/b;->S0(IILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public m()Landroid/os/Bundle;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->m()Landroid/os/Bundle;
...
.method public q()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->q()Z
...
.method public r(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    .locals 3
...
.method public t(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/b;->t(Landroid/support/v4/media/MediaDescriptionCompat;)V
...
.method public u(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/b;->u(Landroid/support/v4/media/MediaDescriptionCompat;)V
