...
.method public J(Landroid/content/Intent;)Z
    ...
    .line 8
    :cond_2
    invoke-interface {v2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->w()Landroidx/media/MediaSessionManager$RemoteUserInfo;
    ...
    .line 10
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$b;->d(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    .line 15
    invoke-interface {v2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->c()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 17
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->i0()V
...
.method d(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    .line 4
    invoke-interface {p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->c()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method m0(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    .locals 3
