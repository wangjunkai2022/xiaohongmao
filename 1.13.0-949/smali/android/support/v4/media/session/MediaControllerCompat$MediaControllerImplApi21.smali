...
.method private w()V
    ...
    invoke-virtual {p0, v1, v2, v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->e(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public final b(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {p1, v1}, Landroid/support/v4/media/session/b;->e1(Landroid/support/v4/media/session/a;)V
    :try_end_1
...
.method public d(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    .line 5
    invoke-virtual {p0, p2, v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->e(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public final r(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    .locals 3
    ...
    invoke-interface {v2, v0}, Landroid/support/v4/media/session/b;->Q0(Landroid/support/v4/media/session/a;)V
...
.method s()V
    ...
    invoke-interface {v3, v2}, Landroid/support/v4/media/session/b;->Q0(Landroid/support/v4/media/session/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public t(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 4
    invoke-virtual {p0, v1, v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->e(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
