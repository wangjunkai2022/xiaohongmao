...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Landroidx/versionedparcelable/VersionedParcelable;)V
    ...
    invoke-direct {p3, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$h;-><init>(Landroid/media/session/MediaSession;Landroidx/versionedparcelable/VersionedParcelable;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p3, p2}, Landroid/support/v4/media/session/MediaSessionCompat;->r(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    invoke-interface {p2, p4}, Landroid/support/v4/media/session/MediaSessionCompat$c;->p(Landroid/app/PendingIntent;)V
    ...
    .line 22
    sget p2, Landroid/support/v4/media/session/MediaSessionCompat;->R:I
    ...
    sput p1, Landroid/support/v4/media/session/MediaSessionCompat;->R:I
...
.method public static d(Landroid/content/Context;Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat;
    .locals 2
...
.method static k(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 14
...
.method public A(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->i(Ljava/util/List;)V
...
.method public B(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->f(Ljava/lang/CharSequence;)V
...
.method public C(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->h(I)V
...
.method public e()Ljava/lang/String;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$c;->l()Ljava/lang/String;
...
.method public f()Landroid/support/v4/media/session/MediaControllerCompat;
    .locals 1
...
.method public final g()Landroidx/media/MediaSessionManager$RemoteUserInfo;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$c;->w()Landroidx/media/MediaSessionManager$RemoteUserInfo;
...
.method public h()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$c;->u()Ljava/lang/Object;
...
.method public n(Landroid/support/v4/media/session/MediaSessionCompat$j;)V
    .locals 1
...
.method public o(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->d(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public p(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->s(Z)V
...
.method public q(Landroid/support/v4/media/session/MediaSessionCompat$b;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat;->r(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V

    return-void
.end method

.method public r(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    .locals 1
...
.method public w(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->g(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public z(Landroidx/media/VolumeProviderCompat;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->v(Landroidx/media/VolumeProviderCompat;)V
