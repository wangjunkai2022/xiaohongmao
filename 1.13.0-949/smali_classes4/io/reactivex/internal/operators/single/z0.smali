...
.method public constructor <init>(Ljava/lang/Iterable;Ln7/o;)V
    ...
    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/single/z0;->b:Ln7/o;
...
.method protected b1(Lio/reactivex/l0;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/single/z0;->b:Ln7/o;

    invoke-direct {v1, p1, v3, v4}, Lio/reactivex/internal/operators/single/y0$b;-><init>(Lio/reactivex/l0;ILn7/o;)V

    .line 9
    invoke-interface {p1, v1}, Lio/reactivex/l0;->onSubscribe(Lio/reactivex/disposables/c;)V

    :goto_1
    if-ge v2, v3, :cond_6

    .line 10
    invoke-virtual {v1}, Lio/reactivex/internal/operators/single/y0$b;->isDisposed()Z
