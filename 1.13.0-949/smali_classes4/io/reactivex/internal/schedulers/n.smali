...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/n;->h:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/internal/schedulers/n;->g:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/schedulers/n;->g:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/n;->d:Ljava/util/concurrent/atomic/AtomicReference;

    .line 4
    iput-object p1, p0, Lio/reactivex/internal/schedulers/n;->c:Ljava/util/concurrent/ThreadFactory;

    .line 5
    invoke-static {p1}, Lio/reactivex/internal/schedulers/n;->l(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public g(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/c;
    ...
    .line 2
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/schedulers/n;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/c;
    ...
    .line 2
    iget-object p4, p0, Lio/reactivex/internal/schedulers/n;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public i()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/schedulers/n;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 2
    sget-object v1, Lio/reactivex/internal/schedulers/n;->h:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public j()V
    ...
    .line 2
    sget-object v2, Lio/reactivex/internal/schedulers/n;->h:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/schedulers/n;->c:Ljava/util/concurrent/ThreadFactory;

    invoke-static {v0}, Lio/reactivex/internal/schedulers/n;->l(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v0

    .line 5
    :cond_3
    iget-object v2, p0, Lio/reactivex/internal/schedulers/n;->d:Ljava/util/concurrent/atomic/AtomicReference;
