...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    .line 2
    invoke-static {p1}, Lio/reactivex/rxjava3/internal/schedulers/l;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public b(Ljava/lang/Runnable;)Lio/reactivex/rxjava3/disposables/f;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/rxjava3/internal/schedulers/i;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/f;
...
.method public e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/disposables/g;)Lio/reactivex/rxjava3/internal/schedulers/ScheduledRunnable;
    .locals 3
    .param p4    # Ljava/util/concurrent/TimeUnit;
        .annotation build Lp7/e;
        .end annotation
    .end param
    .param p5    # Lio/reactivex/rxjava3/disposables/g;
    ...
    invoke-direct {v0, p1, p5}, Lio/reactivex/rxjava3/internal/schedulers/ScheduledRunnable;-><init>(Ljava/lang/Runnable;Lio/reactivex/rxjava3/disposables/g;)V

    if-eqz p5, :cond_0

    .line 3
    invoke-interface {p5, v0}, Lio/reactivex/rxjava3/disposables/g;->b(Lio/reactivex/rxjava3/disposables/f;)Z
    ...
    .line 7
    invoke-interface {p5, v0}, Lio/reactivex/rxjava3/disposables/g;->a(Lio/reactivex/rxjava3/disposables/f;)Z
...
.method public f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/f;
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
...
.method public g(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/f;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
