.class public final Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;
.super Lcom/qennnsad/aknkaksd/domain/base/h;
.source "UpdateSubscribeNotificationsUseCase.kt"
...
.method public constructor <init>(Lg5/a;Lcom/qennnsad/aknkaksd/data/repository/m;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->a:Lg5/a;

    .line 3
    iput-object p2, p0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->b:Lcom/qennnsad/aknkaksd/data/repository/m;
    ...
    iput-object p2, p0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->c:Lcom/qennnsad/aknkaksd/domain/base/d;
...
.method public static synthetic c(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->g(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Ljava/lang/String;
...
.method public static synthetic d(Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;ILjava/lang/String;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->f(Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;ILjava/lang/String;)V

    return-void
.end method

.method private static final f(Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;ILjava/lang/String;)V
    .locals 67
    ...
    .line 1
    iget-object v1, v0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->a:Lg5/a;
    ...
    .line 2
    :cond_0
    iget-object v0, v0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->a:Lg5/a;
    ...
    const v65, 0x1fffffdf    # 1.08420004E-19f
...
.method public bridge synthetic a(Ljava/lang/Object;)Lio/reactivex/z;
    ...
    invoke-virtual {p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->e(I)Lio/reactivex/z;
...
.method protected e(I)Lio/reactivex/z;
    ...
    iget-object v0, p0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->b:Lcom/qennnsad/aknkaksd/data/repository/m;
    ...
    invoke-interface {v0, p1}, Lcom/qennnsad/aknkaksd/data/repository/b;->updateSubscribeNotify(I)Lio/reactivex/z;

    move-result-object v0

    iget-object v1, p0, Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;->c:Lcom/qennnsad/aknkaksd/domain/base/d;

    new-instance v2, Lcom/qennnsad/aknkaksd/domain/usecase/user/n1;

    invoke-direct {v2, v1}, Lcom/qennnsad/aknkaksd/domain/usecase/user/n1;-><init>(Lcom/qennnsad/aknkaksd/domain/base/d;)V

    invoke-virtual {v0, v2}, Lio/reactivex/z;->map(Ln7/o;)Lio/reactivex/z;

    move-result-object v0

    new-instance v1, Lcom/qennnsad/aknkaksd/domain/usecase/user/m1;

    invoke-direct {v1, p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/user/m1;-><init>(Lcom/qennnsad/aknkaksd/domain/usecase/user/o1;I)V

    invoke-virtual {v0, v1}, Lio/reactivex/z;->doOnNext(Ln7/g;)Lio/reactivex/z;

    move-result-object p1

    const-string v0, "sourceFactory.create().u\u2026tify = params))\n        }"
