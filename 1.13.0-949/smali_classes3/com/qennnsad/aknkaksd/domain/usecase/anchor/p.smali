.class public final Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;
...
.method public constructor <init>(Lcom/qennnsad/aknkaksd/data/repository/m;Lg5/a;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;->a:Lcom/qennnsad/aknkaksd/data/repository/m;
    ...
    .line 4
    const-class v3, Lcom/qennnsad/aknkaksd/data/bean/AnchorSummary;
    ...
    iput-object p1, p0, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;->b:Lcom/qennnsad/aknkaksd/domain/base/d;
...
.method public static synthetic c(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Lcom/qennnsad/aknkaksd/data/bean/PageBean;
    ...
    invoke-static {p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;->e(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Lcom/qennnsad/aknkaksd/data/bean/PageBean;
...
.method public bridge synthetic a(Ljava/lang/Object;)Lio/reactivex/z;
    ...
    invoke-virtual {p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;->d(Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p$a;)Lio/reactivex/z;
...
.method protected d(Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p$a;)Lio/reactivex/z;
    .locals 4
    .param p1    # Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p$a;
        .annotation build Lm8/g;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    iget-object v0, p0, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;->a:Lcom/qennnsad/aknkaksd/data/repository/m;
    ...
    invoke-virtual {p1}, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p$a;->f()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p$a;->e()I

    move-result p1

    invoke-interface {v0, v1, p1}, Lcom/qennnsad/aknkaksd/data/repository/b;->queryAnchors(Ljava/lang/String;I)Lio/reactivex/z;

    move-result-object p1

    iget-object v0, p0, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/p;->b:Lcom/qennnsad/aknkaksd/domain/base/d;

    new-instance v1, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/o;

    invoke-direct {v1, v0}, Lcom/qennnsad/aknkaksd/domain/usecase/anchor/o;-><init>(Lcom/qennnsad/aknkaksd/domain/base/d;)V

    invoke-virtual {p1, v1}, Lio/reactivex/z;->map(Ln7/o;)Lio/reactivex/z;

    move-result-object p1

    const-string v0, "sourceFactory.create().q\u2026.map(responseMapper::map)"
