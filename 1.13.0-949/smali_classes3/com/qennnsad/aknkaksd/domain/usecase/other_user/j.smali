.class public final Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;
...
.method public constructor <init>(Lg5/a;Lcom/qennnsad/aknkaksd/data/repository/m;)V
    ...
    .line 2
    iput-object p2, p0, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;->a:Lcom/qennnsad/aknkaksd/data/repository/m;

    .line 3
    new-instance p2, Lcom/qennnsad/aknkaksd/domain/base/d;

    const-class v0, Lcom/qennnsad/aknkaksd/data/bean/me/UserInfo;

    invoke-direct {p2, v0, p1}, Lcom/qennnsad/aknkaksd/domain/base/d;-><init>(Ljava/lang/reflect/Type;Lg5/a;)V

    iput-object p2, p0, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;->b:Lcom/qennnsad/aknkaksd/domain/base/d;

    return-void
.end method

.method public static synthetic c(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Lcom/qennnsad/aknkaksd/data/bean/me/UserInfo;
    .locals 0

    invoke-static {p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;->e(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Lcom/qennnsad/aknkaksd/data/bean/me/UserInfo;
...
.method private static final synthetic e(Lcom/qennnsad/aknkaksd/domain/base/d;Lretrofit2/Response;)Lcom/qennnsad/aknkaksd/data/bean/me/UserInfo;
    .locals 2
...
.method public bridge synthetic a(Ljava/lang/Object;)Lio/reactivex/z;
    ...
    invoke-virtual {p0, p1}, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;->d(Ljava/lang/String;)Lio/reactivex/z;
...
.method protected d(Ljava/lang/String;)Lio/reactivex/z;
    ...
    iget-object v0, p0, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;->a:Lcom/qennnsad/aknkaksd/data/repository/m;
    ...
    iget-object v0, p0, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/j;->b:Lcom/qennnsad/aknkaksd/domain/base/d;

    new-instance v1, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/i;

    invoke-direct {v1, v0}, Lcom/qennnsad/aknkaksd/domain/usecase/other_user/i;-><init>(Lcom/qennnsad/aknkaksd/domain/base/d;)V

    invoke-virtual {p1, v1}, Lio/reactivex/z;->map(Ln7/o;)Lio/reactivex/z;

    move-result-object p1

    const-string v0, "sourceFactory.create().g\u2026(params).map(mapper::map)"
