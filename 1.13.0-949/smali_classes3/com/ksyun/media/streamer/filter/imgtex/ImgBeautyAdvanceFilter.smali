.class public Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;
.super Lcom/ksyun/media/streamer/filter/imgtex/ImgFilterBase;
.source "ImgBeautyAdvanceFilter.java"


# static fields
.field private static final a:Ljava/lang/String; = "ImgBeautyAdvanceFilter"


# instance fields
.field private b:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;
...
.method public constructor <init>(Lcom/ksyun/media/streamer/util/gles/GLRender;Landroid/content/Context;)V
    ...
    const-string v1, "ImgBeautyAdvanceFilter"

    .line 1
    invoke-direct {p0}, Lcom/ksyun/media/streamer/filter/imgtex/ImgFilterBase;-><init>()V

    .line 2
    new-instance v2, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;

    invoke-direct {v2, p1}, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;-><init>(Lcom/ksyun/media/streamer/util/gles/GLRender;)V

    iput-object v2, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->b:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;
    ...
    iput-object v2, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->c:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautySpecialEffectsFilter;
    :try_end_0
    ...
    .line 5
    :goto_0
    iget-object v2, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->c:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautySpecialEffectsFilter;

    if-eqz v2, :cond_0

    .line 6
    iget-object v2, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->b:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;
    ...
    iget-object v3, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->c:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautySpecialEffectsFilter;
    ...
    iput-object v4, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->d:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdjustSkinColorFilter;
    :try_end_1
    ...
    .line 9
    :goto_1
    iget-object p1, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->d:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdjustSkinColorFilter;

    if-eqz p1, :cond_2

    .line 10
    iget-object p1, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->c:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautySpecialEffectsFilter;
    ...
    iget-object p2, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->d:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdjustSkinColorFilter;
    ...
    .line 12
    :cond_1
    iget-object p1, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->b:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;
    ...
    .line 13
    invoke-virtual {p0, p1}, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->setGrindRatio(F)V

    const/4 p1, 0x0

    .line 14
    invoke-virtual {p0, p1}, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->setRuddyRatio(F)V
...
.method public getSrcPin()Lcom/ksyun/media/streamer/framework/SrcPin;
    ...
    .line 1
    iget-object v0, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->d:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdjustSkinColorFilter;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->c:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautySpecialEffectsFilter;
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyAdvanceFilter;->b:Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;
...
.method public setGrindRatio(F)V
    ...
    invoke-virtual {v0, p1}, Lcom/ksyun/media/streamer/filter/imgtex/ImgBeautyGrindAdvanceFilter;->setGrindRatio(F)V
