...
# instance fields
.field i:Lcom/koushikdutta/async/http/AsyncHttpClient;
...
.method public constructor <init>(Lcom/koushikdutta/async/AsyncServer;)V
    ...
    iput-object v0, p0, Lcom/koushikdutta/async/http/server/AsyncProxyServer;->i:Lcom/koushikdutta/async/http/AsyncHttpClient;
...
.method protected K(Lcom/koushikdutta/async/http/server/HttpServerRequestCallback;Lcom/koushikdutta/async/http/server/AsyncHttpServerRequest;Lcom/koushikdutta/async/http/server/AsyncHttpServerResponse;)V
    ...
    .line 1
    invoke-super {p0, p1, p2, p3}, Lcom/koushikdutta/async/http/server/AsyncHttpServer;->K(Lcom/koushikdutta/async/http/server/HttpServerRequestCallback;Lcom/koushikdutta/async/http/server/AsyncHttpServerRequest;Lcom/koushikdutta/async/http/server/AsyncHttpServerResponse;)V
    ...
    :catch_0
    :try_start_1
    invoke-interface {p2}, Lcom/koushikdutta/async/http/server/AsyncHttpServerRequest;->d()Lcom/koushikdutta/async/http/Headers;
    ...
    .line 11
    :goto_0
    iget-object v0, p0, Lcom/koushikdutta/async/http/server/AsyncProxyServer;->i:Lcom/koushikdutta/async/http/AsyncHttpClient;
    ...
    invoke-virtual {v0, v1, p1}, Lcom/koushikdutta/async/http/AsyncHttpClient;->p(Lcom/koushikdutta/async/http/AsyncHttpRequest;Lcom/koushikdutta/async/http/callback/HttpConnectCallback;)Lcom/koushikdutta/async/future/Future;
    :try_end_2
    ...
    .line 12
    invoke-interface {p3, p2}, Lcom/koushikdutta/async/http/server/AsyncHttpServerResponse;->h(I)Lcom/koushikdutta/async/http/server/AsyncHttpServerResponse;
