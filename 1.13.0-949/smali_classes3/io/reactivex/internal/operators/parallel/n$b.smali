...
# instance fields
.field final m:[Lio/reactivex/internal/operators/parallel/n$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
# direct methods
.method constructor <init>(Lorg/reactivestreams/d;ILn7/c;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/n$b;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/n$b;->p:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v1, p0, p3}, Lio/reactivex/internal/operators/parallel/n$a;-><init>(Lio/reactivex/internal/operators/parallel/n$b;Ln7/c;)V
    ...
    .line 7
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/n$b;->m:[Lio/reactivex/internal/operators/parallel/n$a;

    .line 8
    iput-object p3, p0, Lio/reactivex/internal/operators/parallel/n$b;->n:Ln7/c;

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/n$b;->p:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public cancel()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/n$b;->m:[Lio/reactivex/internal/operators/parallel/n$a;
...
.method j(Ljava/lang/Object;)Lio/reactivex/internal/operators/parallel/n$c;
    ...
    .line 1
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/n$b;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/parallel/n$b;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 6
    iput-object p1, v0, Lio/reactivex/internal/operators/parallel/n$c;->a:Ljava/lang/Object;
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/n$b;->o:Ljava/util/concurrent/atomic/AtomicReference;
...
.method k(Ljava/lang/Object;)V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/n$b;->n:Ln7/c;

    iget-object v1, p1, Lio/reactivex/internal/operators/parallel/n$c;->a:Ljava/lang/Object;
    ...
    .line 8
    iget-object p1, p1, Lio/reactivex/internal/operators/parallel/n$c;->a:Ljava/lang/Object;
    ...
    .line 9
    :cond_1
    iget-object p1, p0, Lio/reactivex/internal/subscriptions/DeferredScalarSubscription;->b:Lorg/reactivestreams/d;
