...
.field final f:[Lio/reactivex/internal/operators/observable/b3$b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
# direct methods
.method constructor <init>(Lio/reactivex/l0;ILio/reactivex/e0;Lio/reactivex/e0;Ln7/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/b3$a;->a:Lio/reactivex/l0;

    .line 3
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/b3$a;->d:Lio/reactivex/e0;

    .line 4
    iput-object p4, p0, Lio/reactivex/internal/operators/observable/b3$a;->e:Lio/reactivex/e0;

    .line 5
    iput-object p5, p0, Lio/reactivex/internal/operators/observable/b3$a;->b:Ln7/d;
    ...
    .line 6
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/b3$a;->f:[Lio/reactivex/internal/operators/observable/b3$b;
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/b3$a;->c:Lio/reactivex/internal/disposables/ArrayCompositeDisposable;
...
.method b()V
    ...
    .line 4
    iget-object v3, v2, Lio/reactivex/internal/operators/observable/b3$b;->b:Lio/reactivex/internal/queue/b;
    ...
    .line 6
    iget-object v5, v0, Lio/reactivex/internal/operators/observable/b3$b;->b:Lio/reactivex/internal/queue/b;
    ...
    .line 12
    invoke-virtual {p0, v3, v5}, Lio/reactivex/internal/operators/observable/b3$a;->a(Lio/reactivex/internal/queue/b;Lio/reactivex/internal/queue/b;)V

    .line 13
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/b3$a;->a:Lio/reactivex/l0;
    ...
    .line 27
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/b3$a;->b:Ln7/d;

    iget-object v8, p0, Lio/reactivex/internal/operators/observable/b3$a;->h:Ljava/lang/Object;

    invoke-interface {v7, v8, v10}, Ln7/d;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 34
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/b3$a;->a:Lio/reactivex/l0;
...
.method c(Lio/reactivex/disposables/c;I)Z
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/b3$a;->c:Lio/reactivex/internal/disposables/ArrayCompositeDisposable;

    invoke-virtual {v0, p2, p1}, Lio/reactivex/internal/disposables/ArrayCompositeDisposable;->setResource(ILio/reactivex/disposables/c;)Z
...
.method d()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/b3$a;->d:Lio/reactivex/e0;
    ...
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/b3$a;->e:Lio/reactivex/e0;
...
.method public dispose()V
    ...
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/b3$a;->c:Lio/reactivex/internal/disposables/ArrayCompositeDisposable;
    ...
    iget-object v2, v2, Lio/reactivex/internal/operators/observable/b3$b;->b:Lio/reactivex/internal/queue/b;
    ...
    iget-object v0, v0, Lio/reactivex/internal/operators/observable/b3$b;->b:Lio/reactivex/internal/queue/b;
