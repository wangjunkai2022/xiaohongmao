...
# direct methods
.method constructor <init>(Lio/reactivex/g0;Ln7/o;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/u$b;->i:Lio/reactivex/internal/util/AtomicThrowable;

    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/u$b;->a:Lio/reactivex/g0;

    .line 4
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/u$b;->b:Ln7/o;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/u$b;->e:Lio/reactivex/internal/queue/b;
...
.method c()V
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/u$b;->e:Lio/reactivex/internal/queue/b;

    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/u$b;->a:Lio/reactivex/g0;
    ...
    .line 6
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/observable/u$b;->b(Lio/reactivex/internal/queue/b;)V
    ...
    .line 7
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/u$b;->i:Lio/reactivex/internal/util/AtomicThrowable;
    ...
    .line 10
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/u$b;->i:Lio/reactivex/internal/util/AtomicThrowable;
    ...
    :cond_7
    :try_start_0
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/u$b;->b:Ln7/o;

    invoke-interface {v5, v6}, Ln7/o;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 21
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/u$b;->i:Lio/reactivex/internal/util/AtomicThrowable;
...
.method d(I)V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/u$b;->d:[Ljava/lang/Object;
    ...
    .line 6
    :cond_2
    iput-boolean v1, p0, Lio/reactivex/internal/operators/observable/u$b;->h:Z
...
.method e(ILjava/lang/Throwable;)V
    ...
    .line 2
    iget-boolean p2, p0, Lio/reactivex/internal/operators/observable/u$b;->f:Z
    ...
    .line 4
    :try_start_0
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/u$b;->d:[Ljava/lang/Object;
    ...
    .line 7
    iget v1, p0, Lio/reactivex/internal/operators/observable/u$b;->k:I

    add-int/2addr v1, v0

    iput v1, p0, Lio/reactivex/internal/operators/observable/u$b;->k:I
...
.method h(ILjava/lang/Object;)V
    ...
    .line 5
    iget v2, p0, Lio/reactivex/internal/operators/observable/u$b;->j:I
    ...
    .line 6
    iput v2, p0, Lio/reactivex/internal/operators/observable/u$b;->j:I
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/u$b;->e:Lio/reactivex/internal/queue/b;
...
.method public i([Lio/reactivex/e0;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/u$b;->a:Lio/reactivex/g0;

    invoke-interface {v2, p0}, Lio/reactivex/g0;->onSubscribe(Lio/reactivex/disposables/c;)V
