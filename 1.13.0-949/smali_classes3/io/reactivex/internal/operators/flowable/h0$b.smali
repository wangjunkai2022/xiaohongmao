...
.method constructor <init>(Lorg/reactivestreams/d;JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0$c;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/h0$b;->a:Lorg/reactivestreams/d;
    ...
    .line 5
    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/h0$b;->d:Lio/reactivex/h0$c;
...
.method a(JLjava/lang/Object;Lio/reactivex/internal/operators/flowable/h0$a;)V
    ...
    .line 1
    iget-wide v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->g:J
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/h0$b;->a:Lorg/reactivestreams/d;
...
.method public cancel()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->e:Lorg/reactivestreams/e;

    invoke-interface {v0}, Lorg/reactivestreams/e;->cancel()V

    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->d:Lio/reactivex/h0$c;
...
.method public onComplete()V
    ...
    .line 1
    iget-boolean v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->h:Z
    ...
    .line 2
    iput-boolean v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->h:Z

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->f:Lio/reactivex/disposables/c;
    ...
    .line 7
    :cond_2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->a:Lorg/reactivestreams/d;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 7
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/h0$b;->d:Lio/reactivex/h0$c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 3
    iput-wide v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->g:J

    .line 4
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/h0$b;->f:Lio/reactivex/disposables/c;
    ...
    .line 7
    iput-object v2, p0, Lio/reactivex/internal/operators/flowable/h0$b;->f:Lio/reactivex/disposables/c;

    .line 8
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/h0$b;->d:Lio/reactivex/h0$c;

    iget-wide v0, p0, Lio/reactivex/internal/operators/flowable/h0$b;->b:J

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/h0$b;->c:Ljava/util/concurrent/TimeUnit;
...
.method public onSubscribe(Lorg/reactivestreams/e;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/h0$b;->e:Lorg/reactivestreams/e;
