...
public final class Retrofit {
    ...
    Retrofit(Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, List<CallAdapter.Factory> list2, @h Executor executor, boolean z9) {
    ...
    public CallAdapter<?, ?> nextCallAdapter(@h CallAdapter.Factory factory, Type type, Annotation[] annotationArr) {
    ...
    public <T> Converter<T, RequestBody> nextRequestBodyConverter(@h Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
    ...
    public <T> Converter<ResponseBody, T> nextResponseBodyConverter(@h Converter.Factory factory, Type type, Annotation[] annotationArr) {
        Objects.requireNonNull(type, "type == null");
        Objects.requireNonNull(annotationArr, "annotations == null");
        int indexOf = this.converterFactories.indexOf(factory) + 1;
        int size = this.converterFactories.size();
