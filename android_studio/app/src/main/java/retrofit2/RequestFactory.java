    ...
    public static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                parseHttpMethodAndPath(AsyncHttpDelete.f44553o, ((DELETE) annotation).value(), false);
            } else if (annotation instanceof GET) {
                parseHttpMethodAndPath(AsyncHttpGet.f44554o, ((GET) annotation).value(), false);
            } else if (annotation instanceof HEAD) {
                parseHttpMethodAndPath(AsyncHttpHead.f44555o, ((HEAD) annotation).value(), false);
            } else if (annotation instanceof PATCH) {
                parseHttpMethodAndPath("PATCH", ((PATCH) annotation).value(), true);
            } else if (annotation instanceof POST) {
                parseHttpMethodAndPath(AsyncHttpPost.f44556o, ((POST) annotation).value(), true);
            } else if (annotation instanceof PUT) {
                parseHttpMethodAndPath(AsyncHttpPut.f44557o, ((PUT) annotation).value(), true);
        ...
        @h
        private ParameterHandler<?> parseParameter(int i4, Type type, @h Annotation[] annotationArr, boolean z9) {
            ...
            if (annotation instanceof Url) {
                ...
                for (int i10 = i4 - 1; i10 >= 0; i10--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        throw Utils.parameterError(this.method, i4, "@Tag type " + rawType10.getName() + " is duplicate of parameter #" + (i10 + 1) + " and would always overwrite its value.", new Object[0]);
                    }
                }
        ...
        RequestFactory build() {
            ...
            if (this.httpMethod != null) {
                ...
                while (true) {
                    ...
                    parameterHandlerArr[i10] = parseParameter(i10, type, annotationArr, z9);
                    i10++;
                }
