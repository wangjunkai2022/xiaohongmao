...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @g
        public final synchronized CipherSuite forJavaName(@g String javaName) {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@g String a10, @g String b10) {
        ...
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", h0.J);
        TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", 136);
        TLS_PSK_WITH_RC4_128_SHA = companion.init("TLS_PSK_WITH_RC4_128_SHA", h0.H);
    ...
    @JvmStatic
    @g
    public static final synchronized CipherSuite forJavaName(@g String str) {
    ...
    public final String m1592deprecated_javaName() {
