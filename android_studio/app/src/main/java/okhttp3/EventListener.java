...
public abstract class EventListener {
    ...
    public interface Factory {
        @g
        EventListener create(@g Call call);
    }
    ...
    public void dnsEnd(@g Call call, @g String domainName, @g List<InetAddress> inetAddressList) {
        Intrinsics.checkNotNullParameter(call, "call");
    ...
    public void proxySelectEnd(@g Call call, @g HttpUrl url, @g List<Proxy> proxies) {
        Intrinsics.checkNotNullParameter(call, "call");
