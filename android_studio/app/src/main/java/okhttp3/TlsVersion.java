...
public enum TlsVersion {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @g
        public final TlsVersion forJavaName(@g String javaName) {
    ...
    @JvmStatic
    @g
    public static final TlsVersion forJavaName(@g String str) {
    ...
    public final String m1699deprecated_javaName() {
