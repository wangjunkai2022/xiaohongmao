...
public final class WebSocketWriter implements Closeable {
    ...
    public WebSocketWriter(boolean z9, @g BufferedSink sink, @g Random random, boolean z10, boolean z11, long j4) {
    ...
    public final void writeClose(int i4, @h ByteString byteString) throws IOException {
    ...
    public final void writeMessageFrame(int i4, @g ByteString data) throws IOException {
    ...
    public final void writePing(@g ByteString payload) throws IOException {
        Intrinsics.checkNotNullParameter(payload, "payload");
        writeControlFrame(9, payload);
    }

    public final void writePong(@g ByteString payload) throws IOException {
        Intrinsics.checkNotNullParameter(payload, "payload");
