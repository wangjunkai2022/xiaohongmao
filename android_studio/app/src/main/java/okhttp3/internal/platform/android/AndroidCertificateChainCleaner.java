...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        public final AndroidCertificateChainCleaner buildIfSupported(@g X509TrustManager trustManager) {
    ...
    public AndroidCertificateChainCleaner(@g X509TrustManager trustManager, @g X509TrustManagerExtensions x509TrustManagerExtensions) {
        Intrinsics.checkNotNullParameter(trustManager, "trustManager");
    ...
    @SuppressSignatureCheck
    @g
    public List<Certificate> clean(@g List<? extends Certificate> chain, @g String hostname) throws SSLPeerUnverifiedException {
