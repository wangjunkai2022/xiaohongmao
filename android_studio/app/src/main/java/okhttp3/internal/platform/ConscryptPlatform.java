...
public final class ConscryptPlatform extends Platform {
    ...
    public static final class DisabledHostnameVerifier implements ConscryptHostnameVerifier {
        ...
        public final boolean verify(@h String str, @h SSLSession sSLSession) {
            return true;
        }

        public boolean verify(@h X509Certificate[] x509CertificateArr, @h String str, @h SSLSession sSLSession) {
            return true;
        }
    }
