...
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    public static final class Companion {
        ...
        @h
        public final SocketAdapter buildIfSupported(@g String packageName) {
    ...
    public StandardAndroidSocketAdapter(@g Class<? super SSLSocket> sslSocketClass, @g Class<? super SSLSocketFactory> sslSocketFactoryClass, @g Class<?> paramClass) {
