...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    private static final class AlpnProvider implements InvocationHandler {
        ...
        public AlpnProvider(@g List<String> protocols) {
        ...
        @h
        public Object invoke(@g Object proxy, @g Method method, @h Object[] objArr) throws Throwable {
        ...
        public final void setSelected(@h String str) {
            this.selected = str;
        }
    ...
    public Jdk8WithJettyBootPlatform(@g Method putMethod, @g Method getMethod, @g Method removeMethod, @g Class<?> clientProviderClass, @g Class<?> serverProviderClass) {
