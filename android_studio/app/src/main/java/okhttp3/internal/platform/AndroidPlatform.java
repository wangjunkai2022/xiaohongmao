...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(@g X509TrustManager trustManager, @g Method findByIssuerAndSignatureMethod) {
        ...
        @g
        public final CustomTrustRootIndex copy(@g X509TrustManager trustManager, @g Method findByIssuerAndSignatureMethod) {
            Intrinsics.checkNotNullParameter(trustManager, "trustManager");
            Intrinsics.checkNotNullParameter(findByIssuerAndSignatureMethod, "findByIssuerAndSignatureMethod");
        ...
        @h
        public X509Certificate findByIssuerAndSignature(@g X509Certificate cert) {
