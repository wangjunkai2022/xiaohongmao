...
public abstract class CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        @g
        public final CertificateChainCleaner get(@g X509TrustManager trustManager) {
        ...
        @g
        public final CertificateChainCleaner get(@g X509Certificate... caCerts) {
    ...
    @g
    public abstract List<Certificate> clean(@g List<? extends Certificate> list, @g String str) throws SSLPeerUnverifiedException;
}
