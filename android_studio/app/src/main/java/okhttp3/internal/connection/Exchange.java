...
public final class Exchange {
    ...
    /* compiled from: Exchange.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\u000b\u001a\u00020\fH\u0016J!\u0010\r\u001a\u0002H\u000e\"\n\b\u0000\u0010\u000e*\u0004\u0018\u00010\u000f2\u0006\u0010\u0010\u001a\u0002H\u000eH\u0002¢\u0006\u0002\u0010\u0011J\b\u0010\u0012\u001a\u00020\fH\u0016J\u0018\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u0005H\u0016R\u000e\u0010\u0007\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\tX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lokhttp3/internal/connection/Exchange$RequestBodySink;", "Lokio/ForwardingSink;", "delegate", "Lokio/Sink;", "contentLength", "", "(Lokhttp3/internal/connection/Exchange;Lokio/Sink;J)V", "bytesReceived", "closed", "", "completed", "close", "", "complete", ExifInterface.LONGITUDE_EAST, "Ljava/io/IOException;", "e", "(Ljava/io/IOException;)Ljava/io/IOException;", "flush", "write", v.b.f83881a, "Lokio/Buffer;", n.f13105s, "okhttp"}, k = 1, mv = {1, 4, 0})
    /* loaded from: classes4.dex */
    private final class RequestBodySink extends ForwardingSink {
        ...
        public RequestBodySink(@g Exchange exchange, Sink delegate, long j4) {
            super(delegate);
        ...
        public void write(@g Buffer source, long j4) throws IOException {
            ...
            if (!this.closed) {
                ...
                if (j10 != -1 && this.bytesReceived + j4 > j10) {
    ...
    public final class ResponseBodySource extends ForwardingSource {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ResponseBodySource(@g Exchange exchange, Source delegate, long j4) {
            super(delegate);
            Intrinsics.checkNotNullParameter(delegate, "delegate");
            this.this$0 = exchange;
            this.contentLength = j4;
    ...
    public Exchange(@g RealCall call, @g EventListener eventListener, @g ExchangeFinder finder, @g ExchangeCodec codec) {
    ...
    public final <E extends IOException> E bodyComplete(long j4, boolean z9, boolean z10, E e4) {
        if (e4 != null) {
            trackFailure(e4);
        }
        if (z10) {
        ...
        return (E) this.call.messageDone$okhttp(this, z10, z9, e4);
    }
    ...
    @g
    public final Sink createRequestBody(@g Request request, boolean z9) throws IOException {
    ...
    @g
    public final ResponseBody openResponseBody(@g Response response) throws IOException {
    ...
    public final Response.Builder readResponseHeaders(boolean z9) throws IOException {
        try {
            Response.Builder readResponseHeaders = this.codec.readResponseHeaders(z9);
    ...
    public final void responseHeadersEnd(@g Response response) {
        Intrinsics.checkNotNullParameter(response, "response");
    ...
    public final void writeRequestHeaders(@g Request request) throws IOException {
        Intrinsics.checkNotNullParameter(request, "request");
        try {
