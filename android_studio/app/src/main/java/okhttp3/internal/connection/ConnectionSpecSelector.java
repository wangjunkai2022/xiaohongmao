...
public final class ConnectionSpecSelector {
    ...
    public ConnectionSpecSelector(@g List<ConnectionSpec> connectionSpecs) {
    ...
    @g
    public final ConnectionSpec configureSecureSocket(@g SSLSocket sslSocket) throws IOException {
    ...
    public final boolean connectionFailed(@g IOException e4) {
