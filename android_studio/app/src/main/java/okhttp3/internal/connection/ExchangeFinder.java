...
public final class ExchangeFinder {
    ...
    public ExchangeFinder(@g RealConnectionPool connectionPool, @g Address address, @g RealCall call, @g EventListener eventListener) {
    ...
    */
    ...
    private final RealConnection findHealthyConnection(int i4, int i10, int i11, int i12, boolean z9, boolean z10) throws IOException {
        while (true) {
            RealConnection findConnection = findConnection(i4, i10, i11, i12, z9);
            if (findConnection.isHealthy(z10)) {
    ...
    @g
    public final ExchangeCodec find(@g OkHttpClient client, @g RealInterceptorChain chain) {
        Intrinsics.checkNotNullParameter(client, "client");
        Intrinsics.checkNotNullParameter(chain, "chain");
        try {
            return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis$okhttp(), chain.getWriteTimeoutMillis$okhttp(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !Intrinsics.areEqual(chain.getRequest$okhttp().method(), AsyncHttpGet.f44554o)).newCodec$okhttp(client, chain);
