...
public final class TaskQueue {
    ...
    public TaskQueue(@g TaskRunner taskRunner, @g String name) {
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String name, long j4, boolean z9, Function0 block, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            j4 = 0;
        }
        boolean z10 = (i4 & 4) != 0 ? true : z9;
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(block, "block");
        taskQueue.schedule(new TaskQueue$execute$1(block, name, z10, name, z10), j4);
    }
    ...
    public final void execute(@g String name, long j4, boolean z9, @g Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(block, "block");
        schedule(new TaskQueue$execute$1(block, name, z9, name, z9), j4);
    }
    ...
    public final void schedule(@g Task task, long j4) {
    ...
    public final boolean scheduleAndDecide$okhttp(@g Task task, long j4, boolean z9) {
        String str;
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public final void setActiveTask$okhttp(@h Task task) {
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String name, long j4, Function0 block, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            j4 = 0;
        }
        Intrinsics.checkNotNullParameter(name, "name");
    ...
    public final void schedule(@g String name, long j4, @g Function0<Long> block) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(block, "block");
