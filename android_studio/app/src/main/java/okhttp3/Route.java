...
public final class Route {
    ...
    public Route(@g Address address, @g Proxy proxy, @g InetSocketAddress socketAddress) {
    ...
    public final Address m1696deprecated_address() {
        return this.address;
    }
    ...
    public final Proxy m1697deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m1698deprecated_socketAddress() {
