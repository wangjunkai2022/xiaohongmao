...
public final class ZipFileSystem extends FileSystem {
    ...
    public ZipFileSystem(@g Path zipPath, @g FileSystem fileSystem, @g Map<Path, ZipEntry> entries, @h String str) {
    ...
    @Override // okio.FileSystem
    @g
    public Source source(@g Path path) throws IOException {
        BufferedSource bufferedSource;
        Intrinsics.checkNotNullParameter(path, "path");
        ZipEntry zipEntry = this.entries.get(canonicalizeInternal(path));
        if (zipEntry != null) {
