...
public final class _FileSystemKt$commonListRecursively$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
    ...
    public _FileSystemKt$commonListRecursively$1(Path path, FileSystem fileSystem, boolean z9, Continuation<? super _FileSystemKt$commonListRecursively$1> continuation) {
    ...
    public final Object invokeSuspend(@g Object obj) {
        ...
        while (it.hasNext()) {
            ...
            boolean z9 = _filesystemkt_commonlistrecursively_1.$followSymlinks;
            ...
            if (_FileSystemKt.collectRecursively(sequenceScope, fileSystem, arrayDeque, next, z9, false, _filesystemkt_commonlistrecursively_1) == coroutine_suspended) {
