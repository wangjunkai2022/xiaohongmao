...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0 || !this.mIgnoreTap) {
            ...
            if (action == 0) {
                ...
                if (action == 2 && (Math.abs(x9 - this.mInitialMotionX) > this.mTouchSlop || Math.abs(y9 - this.mInitialMotionY) > this.mTouchSlop)) {
                    this.mIgnoreTap = true;
                }
            } else if (x9 < this.mCurrText.getLeft() - this.mTabPadding) {
                ViewPager viewPager = this.mPager;
                viewPager.setCurrentItem(viewPager.getCurrentItem() - 1);
            } else if (x9 > this.mCurrText.getRight() + this.mTabPadding) {
    ...
    public void updateTextPositions(int i4, float f10, boolean z9) {
        ...
        super.updateTextPositions(i4, f10, z9);
