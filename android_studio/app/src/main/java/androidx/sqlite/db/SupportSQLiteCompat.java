...
public final class SupportSQLiteCompat {
    ...
    public static final class Api16Impl {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public static void setForeignKeyConstraintsEnabled(@NonNull SQLiteDatabase sQLiteDatabase, boolean z9) {
            sQLiteDatabase.setForeignKeyConstraintsEnabled(z9);
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public static void setWriteAheadLoggingEnabled(@NonNull SQLiteOpenHelper sQLiteOpenHelper, boolean z9) {
