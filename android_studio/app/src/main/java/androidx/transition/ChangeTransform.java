...
public class ChangeTransform extends Transition {
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, final boolean z9) {
        ...
        AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeTransform.3
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (z9 && ChangeTransform.this.mUseOverlay) {
    ...
    */
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        ObjectAnimator createTransformAnimator = createTransformAnimator(transitionValues, transitionValues2, z9);
        if (z9 && createTransformAnimator != null && this.mUseOverlay) {
