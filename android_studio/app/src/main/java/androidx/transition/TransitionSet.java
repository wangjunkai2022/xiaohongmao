...
public class TransitionSet extends Transition {
    ...
    public Transition excludeTarget(@NonNull View view, boolean z9) {
        for (int i4 = 0; i4 < this.mTransitions.size(); i4++) {
            this.mTransitions.get(i4).excludeTarget(view, z9);
        }
    ...
    public void setCanRemoveViews(boolean z9) {
        ...
        int size = this.mTransitions.size();
        for (int i4 = 0; i4 < size; i4++) {
            this.mTransitions.get(i4).setCanRemoveViews(z9);
        }
    }
    ...
    public Transition clone() {
        ...
        int size = this.mTransitions.size();
        for (int i4 = 0; i4 < size; i4++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i4).m53clone());
        }
    ...
    public Transition excludeTarget(@NonNull String str, boolean z9) {
        for (int i4 = 0; i4 < this.mTransitions.size(); i4++) {
            this.mTransitions.get(i4).excludeTarget(str, z9);
        }
    ...
    public TransitionSet removeTarget(@IdRes int i4) {
        for (int i10 = 0; i10 < this.mTransitions.size(); i10++) {
            this.mTransitions.get(i10).removeTarget(i4);
        }
    ...
    @Override // androidx.transition.Transition
    @NonNull
    public Transition excludeTarget(int i4, boolean z9) {
        for (int i10 = 0; i10 < this.mTransitions.size(); i10++) {
            this.mTransitions.get(i10).excludeTarget(i4, z9);
        }
        return super.excludeTarget(i4, z9);
    }
    ...
    public TransitionSet addTarget(@IdRes int i4) {
        for (int i10 = 0; i10 < this.mTransitions.size(); i10++) {
            this.mTransitions.get(i10).addTarget(i4);
        }
    ...
    public Transition excludeTarget(@NonNull Class<?> cls, boolean z9) {
        for (int i4 = 0; i4 < this.mTransitions.size(); i4++) {
            this.mTransitions.get(i4).excludeTarget(cls, z9);
        }
