...
public abstract class Transition implements Cloneable {
    ...
    public static class ArrayListManager {
        ...
        static <T> ArrayList<T> add(ArrayList<T> arrayList, T t9) {
            if (arrayList == null) {
        ...
        static <T> ArrayList<T> remove(ArrayList<T> arrayList, T t9) {
            if (arrayList != null) {
                arrayList.remove(t9);
                    ...
                    if (arrayList4 == null || !arrayList4.contains(Integer.valueOf(id))) {
                        ...
                        if (arrayList5 == null || !arrayList5.contains(view)) {
                            ...
                            for (int i11 = 0; i11 < viewGroup.getChildCount(); i11++) {
                                captureHierarchy(viewGroup.getChildAt(i11), z9);
                            }
                        }
                    }
                }
    ...
    private ArrayList<Integer> excludeId(ArrayList<Integer> arrayList, int i4, boolean z9) {
        if (i4 > 0) {
            if (z9) {
    ...
    private static <T> ArrayList<T> excludeObject(ArrayList<T> arrayList, T t9, boolean z9) {
        if (t9 != null) {
            if (z9) {
                return ArrayListManager.add(arrayList, t9);
            }
            return ArrayListManager.remove(arrayList, t9);
        }
        return arrayList;
    }
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i14 = 0; i14 < sparseIntArray.size(); i14++) {
                ...
                animator3.setStartDelay((sparseIntArray.valueAt(i14) - j4) + animator3.getStartDelay());
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public TransitionValues getMatchedTransitionValues(View view, boolean z9) {
        TransitionSet transitionSet = this.mParent;
        if (transitionSet != null) {
            return transitionSet.getMatchedTransitionValues(view, z9);
        }
        ArrayList<TransitionValues> arrayList = z9 ? this.mStartValuesList : this.mEndValuesList;
        if (arrayList == null) {
            return null;
        }
        int size = arrayList.size();
        ...
        if (i4 >= 0) {
            return (z9 ? this.mEndValuesList : this.mStartValuesList).get(i4);
        }
        return null;
    }
    ...
    @NonNull
    public Transition excludeChildren(@IdRes int i4, boolean z9) {
        this.mTargetIdChildExcludes = excludeId(this.mTargetIdChildExcludes, i4, z9);
        return this;
    }

    @NonNull
    public Transition excludeTarget(@IdRes int i4, boolean z9) {
        this.mTargetIdExcludes = excludeId(this.mTargetIdExcludes, i4, z9);
        return this;
    }
