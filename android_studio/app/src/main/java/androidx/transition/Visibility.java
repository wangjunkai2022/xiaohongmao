...
public abstract class Visibility extends Transition {
    ...
    public static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        DisappearListener(View view, int i4, boolean z9) {
            this.mView = view;
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (i4 == i10 && visibilityInfo.mStartParent == visibilityInfo.mEndParent) {
    ...
    @Nullable
    public Animator onAppear(ViewGroup viewGroup, TransitionValues transitionValues, int i4, TransitionValues transitionValues2, int i10) {
