...
public final class SavedStateRegistryController {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @g
        public final SavedStateRegistryController create(@g SavedStateRegistryOwner owner) {
    ...
    @JvmStatic
    @g
    public static final SavedStateRegistryController create(@g SavedStateRegistryOwner savedStateRegistryOwner) {
    ...
    @MainThread
    public final void performRestore(@h Bundle bundle) {
        if (!this.attached) {
            performAttach();
        }
        Lifecycle lifecycle = this.owner.getLifecycle();
