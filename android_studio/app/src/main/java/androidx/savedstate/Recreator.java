...
public final class Recreator implements LifecycleEventObserver {
    ...
    public static final class SavedStateProvider implements SavedStateRegistry.SavedStateProvider {
        ...
        public SavedStateProvider(@g SavedStateRegistry registry) {
            Intrinsics.checkNotNullParameter(registry, "registry");
            this.classes = new LinkedHashSet();
            registry.registerSavedStateProvider(Recreator.COMPONENT_KEY, this);
        }

        public final void add(@g String className) {
    ...
    public Recreator(@g SavedStateRegistryOwner owner) {
    ...
    public void onStateChanged(@g LifecycleOwner source, @g Lifecycle.Event event) {
