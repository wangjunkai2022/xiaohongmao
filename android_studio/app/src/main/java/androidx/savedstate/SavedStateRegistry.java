...
public final class SavedStateRegistry {
    ...
    public interface AutoRecreated {
        void onRecreated(@g SavedStateRegistryOwner savedStateRegistryOwner);
    }
    ...
    @h
    @MainThread
    public final Bundle consumeRestoredStateForKey(@g String key) {
    ...
    @h
    public final SavedStateProvider getSavedStateProvider(@g String key) {
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    @MainThread
    public final void performAttach$savedstate_release(@g Lifecycle lifecycle) {
    ...
    @MainThread
    public final void performRestore$savedstate_release(@h Bundle bundle) {
        if (this.attached) {
            if (!this.isRestored) {
    ...
    @MainThread
    public final void performSave(@g Bundle outBundle) {
    ...
    @MainThread
    public final void registerSavedStateProvider(@g String key, @g SavedStateProvider provider) {
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    @MainThread
    public final void runOnNextRecreation(@g Class<? extends AutoRecreated> clazz) {
    ...
    @MainThread
    public final void unregisterSavedStateProvider(@g String key) {
        Intrinsics.checkNotNullParameter(key, "key");
