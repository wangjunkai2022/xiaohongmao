...
public final class ExtensionsWindowLayoutInfoAdapter {
    ...
    @h
    public final FoldingFeature translate$window_release(@g Activity activity, @g androidx.window.extensions.layout.FoldingFeature oemFeature) {
    ...
    @g
    public final WindowLayoutInfo translate$window_release(@g Activity activity, @g androidx.window.extensions.layout.WindowLayoutInfo info) {
