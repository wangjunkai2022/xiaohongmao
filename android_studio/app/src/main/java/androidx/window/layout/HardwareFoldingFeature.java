...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    public static final class Companion {
        ...
        public final void validateFeatureBounds$window_release(@g Bounds bounds) {
    ...
    public HardwareFoldingFeature(@g Bounds featureBounds, @g Type type, @g FoldingFeature.State state) {
