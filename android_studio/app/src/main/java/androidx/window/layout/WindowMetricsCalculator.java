...
public interface WindowMetricsCalculator {
    ...
    public static final class Companion {
        ...
        public final void overrideDecorator(@g WindowMetricsCalculatorDecorator overridingDecorator) {
    ...
    @g
    WindowMetrics computeCurrentWindowMetrics(@g Activity activity);

    @g
    WindowMetrics computeMaximumWindowMetrics(@g Activity activity);
}
