...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        ...
        if (charSequence != null) {
            if (!(charSequence.length() == 0)) {
                ...
                indexOf$default = StringsKt__StringsKt.indexOf$default((CharSequence) obj, (char) com.fasterxml.jackson.core.e.f13819f, 0, false, 6, (Object) null);
    ...
    private final ActivityRule parseSplitActivityRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        return new ActivityRule(emptySet, z9);
    }
    ...
    private final SplitPairRule parseSplitPairRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        emptySet = SetsKt__SetsKt.emptySet();
        return new SplitPairRule(emptySet, z9, z10, z11, dimension, dimension2, f10, i4);
    }
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        return new SplitPlaceholderRule(emptySet, component, dimension, dimension2, f10, i4);
    }

    private final Set<EmbeddingRule> parseSplitXml(Context context, int i4) {
    ...
    @h
    public final Set<EmbeddingRule> parseSplitRules$window_release(@g Context context, int i4) {
