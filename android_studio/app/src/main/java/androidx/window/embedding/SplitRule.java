...
public class SplitRule extends EmbeddingRule {
    ...
    public static final class Api30Impl {
        ...
        @DoNotInline
        @g
        public final Rect getBounds(@g WindowMetrics windowMetrics) {
    ...
    public /* synthetic */ SplitRule(int i4, int i10, float f10, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? 0 : i4, (i12 & 2) != 0 ? 0 : i10, (i12 & 4) != 0 ? 0.5f : f10, (i12 & 8) != 0 ? 3 : i11);
    }

    public final boolean checkParentMetrics(@g WindowMetrics parentMetrics) {
    ...
    public SplitRule(int i4, int i10, float f10, int i11) {
        this.minWidth = i4;
        this.minSmallestWidth = i10;
        this.splitRatio = f10;
