...
public final class ActivityStack {
    ...
    public ActivityStack(@g List<? extends Activity> activities, boolean z9) {
        Intrinsics.checkNotNullParameter(activities, "activities");
        this.activities = activities;
        this.isEmpty = z9;
    }

    public final boolean contains(@g Activity activity) {
    ...
    public /* synthetic */ ActivityStack(List list, boolean z9, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i4 & 2) != 0 ? false : z9);
    }
}
