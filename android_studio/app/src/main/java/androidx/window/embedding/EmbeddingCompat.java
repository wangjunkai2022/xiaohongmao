...
public final class EmbeddingCompat implements EmbeddingInterfaceCompat {
    ...
    public EmbeddingCompat(@g ActivityEmbeddingComponent embeddingExtension, @g EmbeddingAdapter adapter) {
    ...
    public void setEmbeddingCallback(@g EmbeddingInterfaceCompat.EmbeddingCallbackInterface embeddingCallback) {
    ...
    @Override // androidx.window.embedding.EmbeddingInterfaceCompat
    public void setSplitRules(@g Set<? extends EmbeddingRule> rules) {
