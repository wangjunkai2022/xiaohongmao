...
public final class SplitController {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final void initialize(@g Context context, int i4) {
    ...
    @JvmStatic
    public static final void initialize(@g Context context, int i4) {
    ...
    public final void addSplitListener(@g Activity activity, @g Executor executor, @g Consumer<List<SplitInfo>> consumer) {
    ...
    public final void registerRule(@g EmbeddingRule rule) {
        Intrinsics.checkNotNullParameter(rule, "rule");
        this.embeddingBackend.registerRule(rule);
    }

    public final void removeSplitListener(@g Consumer<List<SplitInfo>> consumer) {
        Intrinsics.checkNotNullParameter(consumer, "consumer");
        this.embeddingBackend.unregisterSplitListenerForActivity(consumer);
    }

    public final void unregisterRule(@g EmbeddingRule rule) {
        Intrinsics.checkNotNullParameter(rule, "rule");
