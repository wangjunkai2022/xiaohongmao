...
public final class EmbeddingAdapter {
    ...
    public static final boolean m54translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
    ...
    public static final boolean m55translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue(pair, "(first, second)");
        Activity activity = (Activity) this$0.component1(pair);
    ...
    public static final boolean m56translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
    ...
    public static final boolean m57translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        if ((activityFilters instanceof Collection) && activityFilters.isEmpty()) {
            return false;
        }
    ...
    public static final boolean m58translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(@g final Set<SplitPairFilter> splitPairFilters) {
        Intrinsics.checkNotNullParameter(splitPairFilters, "splitPairFilters");
        return new Predicate() { // from class: androidx.window.embedding.a
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m54translateActivityIntentPredicates$lambda3;
                m54translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m54translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m54translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    @g
    @SuppressLint({"ClassVerificationFailure", "NewApi"})
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(@g final Set<SplitPairFilter> splitPairFilters) {
        Intrinsics.checkNotNullParameter(splitPairFilters, "splitPairFilters");
        return new Predicate() { // from class: androidx.window.embedding.b
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m55translateActivityPairPredicates$lambda1;
                m55translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m55translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m55translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    @g
    @SuppressLint({"ClassVerificationFailure", "NewApi"})
    public final Predicate<Activity> translateActivityPredicates(@g final Set<ActivityFilter> activityFilters) {
        Intrinsics.checkNotNullParameter(activityFilters, "activityFilters");
        return new Predicate() { // from class: androidx.window.embedding.d
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m56translateActivityPredicates$lambda6;
                m56translateActivityPredicates$lambda6 = EmbeddingAdapter.m56translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m56translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    @g
    @SuppressLint({"ClassVerificationFailure", "NewApi"})
    public final Predicate<Intent> translateIntentPredicates(@g final Set<ActivityFilter> activityFilters) {
        Intrinsics.checkNotNullParameter(activityFilters, "activityFilters");
        return new Predicate() { // from class: androidx.window.embedding.e
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m57translateIntentPredicates$lambda8;
                m57translateIntentPredicates$lambda8 = EmbeddingAdapter.m57translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m57translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    @g
    @SuppressLint({"ClassVerificationFailure", "NewApi"})
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(@g final SplitRule splitRule) {
        Intrinsics.checkNotNullParameter(splitRule, "splitRule");
        return new Predicate() { // from class: androidx.window.embedding.c
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m58translateParentMetricsPredicate$lambda4;
                m58translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m58translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m58translateParentMetricsPredicate$lambda4;
            }
        };
    }

    @g
    public final List<SplitInfo> translate(@g List<? extends androidx.window.extensions.embedding.SplitInfo> splitInfoList) {
    ...
    @g
    public final Set<androidx.window.extensions.embedding.EmbeddingRule> translate(@g Set<? extends EmbeddingRule> rules) {
        int collectionSizeOrDefault;
