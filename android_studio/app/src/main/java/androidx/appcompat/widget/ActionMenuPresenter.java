...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z9 || i17 + i16 > i14)) {
            i14--;
        }
        int i19 = i14 - i16;
        ...
        while (i21 < i4) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z11 = (i19 > 0 || z10) && i15 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i11 > 0);
                boolean z12 = z11;
                i12 = i4;
                if (z11) {
                    ...
                    z11 = z13 & (!actionMenuPresenter.mStrictWidthLimit ? i15 + i22 <= 0 : i15 < 0);
                }
                if (z11 && groupId2 != 0) {
    ...
    public void setWidthLimit(int i4, boolean z9) {
        this.mWidthLimit = i4;
