...
public class DropDownListView extends ListView {
    ...
    private void positionSelectorCompat(int i4, View view) {
        ...
        try {
            boolean z9 = this.mIsChildViewEnabled.getBoolean(this);
            if (view.isEnabled() != z9) {
                this.mIsChildViewEnabled.set(this, Boolean.valueOf(!z9));
                if (i4 != -1) {
    ...
    private void positionSelectorLikeFocusCompat(int i4, View view) {
        ...
        boolean z9 = (selector == null || i4 == -1) ? false : true;
        if (z9) {
    ...
    private void positionSelectorLikeTouchCompat(int i4, View view, float f10, float f11) {
    ...
    private void setPressedItem(View view, int i4, float f10, float f11) {
        View childAt;
        ...
        positionSelectorLikeTouchCompat(i4, view, f10, f11);
    ...
    public int lookForSelectablePosition(int i4, boolean z9) {
        int min;
    ...
    public int measureHeightOfChildrenCompat(int i4, int i10, int i11, int i12, int i13) {
        int makeMeasureSpec;
