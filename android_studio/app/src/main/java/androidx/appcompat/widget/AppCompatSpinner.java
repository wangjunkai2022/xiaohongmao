...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i10) {
        this(context, attributeSet, i4, i10, null);
    }
