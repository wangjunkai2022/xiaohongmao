...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i11 < size) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int i13 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin - i4;
    ...
    private int layoutChildLeft(View view, int i4, int[] iArr, int i10) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    private int layoutChildRight(View view, int i4, int[] iArr, int i10) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    private int measureChildCollapseMargins(View view, int i4, int i10, int i11, int i12, int[] iArr) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        ...
        view.measure(ViewGroup.getChildMeasureSpec(i4, getPaddingLeft() + getPaddingRight() + max + i10, marginLayoutParams.width), ViewGroup.getChildMeasureSpec(i11, getPaddingTop() + getPaddingBottom() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i12, marginLayoutParams.height));
        return view.getMeasuredWidth() + max;
    }

    private void measureChildConstrained(View view, int i4, int i10, int i11, int i12, int i13) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        int childMeasureSpec = ViewGroup.getChildMeasureSpec(i4, getPaddingLeft() + getPaddingRight() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + i10, marginLayoutParams.width);
    ...
    */
    ...
    protected void onMeasure(int i4, int i10) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            measureChildConstrained(this.mNavButtonView, i4, 0, i10, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            measureChildConstrained(this.mCollapseButtonView, i4, 0, i10, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mMenuView)) {
            measureChildConstrained(this.mMenuView, i4, max, i10, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            max2 += measureChildCollapseMargins(this.mExpandedActionView, i4, max2, i10, 0, iArr);
        ...
        if (shouldLayout(this.mLogoView)) {
            max2 += measureChildCollapseMargins(this.mLogoView, i4, max2, i10, 0, iArr);
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                max2 += measureChildCollapseMargins(childAt, i4, max2, i10, 0, iArr);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i4, max2 + i21, i10, i20, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i16 = Math.max(i16, measureChildCollapseMargins(this.mSubtitleTextView, i4, max2 + i21, i10, i17 + i20, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max2 + i16 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i4, (-16777216) & i15), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(max3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i10, i15 << 16));
    }
    ...
    public void setContentInsetsAbsolute(int i4, int i10) {
        ensureContentInsets();
        this.mContentInsets.setAbsolute(i4, i10);
    }

    public void setContentInsetsRelative(int i4, int i10) {
        ensureContentInsets();
        this.mContentInsets.setRelative(i4, i10);
    }
    ...
    public void setTitleMargin(int i4, int i10, int i11, int i12) {
