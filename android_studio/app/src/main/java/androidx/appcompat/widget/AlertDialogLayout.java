...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i4, int i10) {
        int i11;
        int i12;
        int i13;
        int i14;
        ...
        if (view2 != null) {
            ...
            view2.measure(i4, View.MeasureSpec.makeMeasureSpec(i12, 1073741824));
            paddingTop = i17 + view2.getMeasuredHeight();
            i11 = View.combineMeasuredStates(i11, view2.getMeasuredState());
        }
        if (view3 != null && i16 > 0) {
            view3.measure(i4, View.MeasureSpec.makeMeasureSpec(i14 + i16, mode));
        ...
        setMeasuredDimension(View.resolveSizeAndState(i18 + getPaddingLeft() + getPaddingRight(), i4, i11), View.resolveSizeAndState(paddingTop, i10, 0));
        if (mode2 != 1073741824) {
