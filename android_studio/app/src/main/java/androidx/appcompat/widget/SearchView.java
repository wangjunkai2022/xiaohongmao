...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + i.f6967d;
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z10 && !this.mSlopBounds.contains(x9, y9)) {
                        z11 = z10;
                        z9 = false;
                    }
                } else {
                ...
                if (this.mTargetBounds.contains(x9, y9)) {
            ...
            if (z11) {
                if (z9 && !this.mActualBounds.contains(x9, y9)) {
    ...
    private Intent createIntent(String str, Uri uri, String str2, String str3, int i4, String str4) {
        ...
        if (str3 != null) {
            intent.putExtra(d.f93273b, str3);
        }
        if (str2 != null) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i4, String str) {
        ...
        try {
            ...
            Log.w(LOG_TAG, "Search suggestions cursor at row " + i10 + " returned exception.", e4);
            return null;
        }
    }
    ...
    private boolean launchSuggestion(int i4, int i10, String str) {
    ...
    private void updateCloseButton() {
        ...
        this.mCloseButton.setVisibility(z9 ? 0 : 8);
    ...
    boolean onItemClicked(int i4, int i10, String str) {
