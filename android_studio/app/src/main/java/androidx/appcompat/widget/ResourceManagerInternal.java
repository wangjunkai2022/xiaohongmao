...
public final class ResourceManagerInternal {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i4, boolean z9, @NonNull Drawable drawable) {
        ...
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i4, drawable)) && !tintDrawableUsingColorFilter(context, i4, drawable) && z9) {
            return null;
        }
        return drawable;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i4, boolean z9) {
        ...
        if (loadDrawableFromDelegates != null) {
            loadDrawableFromDelegates = tintDrawable(context, i4, z9, loadDrawableFromDelegates);
        }
        if (loadDrawableFromDelegates != null) {
