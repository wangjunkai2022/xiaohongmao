...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    protected void onMeasure(int i4, int i10) {
        int measuredHeight;
        pullChildren();
        measureChildWithMargins(this.mActionBarTop, i4, 0, i10, 0);
        ...
        measureChildWithMargins(this.mContent, i4, 0, i10, 0);
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max3 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i4, combineMeasuredStates2), View.resolveSizeAndState(Math.max(max4 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i10, combineMeasuredStates2 << 16));
    }
    ...
    public void onWindowSystemUiVisibilityChanged(int i4) {
        ...
        pullChildren();
        int i10 = this.mLastSystemUiVisibility ^ i4;
    ...
    public void setOverlayMode(boolean z9) {
        ...
        this.mIgnoreWindowContentOverlay = z9 && getContext().getApplicationInfo().targetSdkVersion < 19;
    }
