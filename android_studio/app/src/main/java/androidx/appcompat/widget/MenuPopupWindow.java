...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int i4, boolean z9) {
            return super.lookForSelectablePosition(i4, z9);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i4, int i10, int i11, int i12, int i13) {
            return super.measureHeightOfChildrenCompat(i4, i10, i11, i12, i13);
        }
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                if (motionEvent.getAction() != 10 && (pointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) != -1 && (i10 = pointToPosition - i4) >= 0 && i10 < menuAdapter.getCount()) {
    ...
    public MenuPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i10) {
