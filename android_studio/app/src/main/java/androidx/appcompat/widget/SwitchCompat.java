...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private void animateThumbToCheckedState(boolean z9) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, THUMB_POS, z9 ? 1.0f : 0.0f);
    ...
    private void setSwitchTypefaceByIndex(int i4, int i10) {
        Typeface typeface;
        if (i4 == 1) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (rect != null) {
                ...
                if (i21 > i22) {
                    i10 = i14 - (i21 - i22);
                    this.mTrackDrawable.setBounds(i11, i4, i13, i10);
                }
            } else {
                i4 = i12;
            }
    ...
    */
    ...
    public void setSwitchTypeface(Typeface typeface, int i4) {
        ...
        if (i4 > 0) {
            ...
            int i10 = (~(create != null ? create.getStyle() : 0)) & i4;
