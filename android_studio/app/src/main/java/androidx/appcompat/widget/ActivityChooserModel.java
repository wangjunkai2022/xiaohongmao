...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class HistoricalRecord {
        ...
        public HistoricalRecord(String str, long j4, float f10) {
            this(ComponentName.unflattenFromString(str), j4, f10);
        }
        ...
        public HistoricalRecord(ComponentName componentName, long j4, float f10) {
        ...
        try {
            ...
            try {
                try {
                    ...
                    String str2 = LOG_TAG;
                    Log.e(str2, "Error reading historical recrod file: " + this.mHistoryFileName, e10);
                    if (openFileInput == null) {
                        return;
                    }
                }
