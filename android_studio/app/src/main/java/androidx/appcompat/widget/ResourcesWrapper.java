...
public class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    @RequiresApi(15)
    public Drawable getDrawableForDensity(int i4, int i10) throws Resources.NotFoundException {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i4, i10, null);
    }

    @Override // android.content.res.Resources
    public float getFraction(int i4, int i10, int i11) {
        return this.mResources.getFraction(i4, i10, i11);
    }
    ...
    @Override // android.content.res.Resources
    public String getQuantityString(int i4, int i10, Object... objArr) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i4, i10, objArr);
    }

    @Override // android.content.res.Resources
    public CharSequence getQuantityText(int i4, int i10) throws Resources.NotFoundException {
        return this.mResources.getQuantityText(i4, i10);
    }
    ...
    @Override // android.content.res.Resources
    public void getValue(int i4, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        this.mResources.getValue(i4, typedValue, z9);
    }

    @Override // android.content.res.Resources
    @RequiresApi(15)
    public void getValueForDensity(int i4, int i10, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        Compatibility.Api15Impl.getValueForDensity(this.mResources, i4, i10, typedValue, z9);
    }
    ...
    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawableForDensity(int i4, int i10, Resources.Theme theme) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i4, i10, theme);
    }

    @Override // android.content.res.Resources
    public String getQuantityString(int i4, int i10) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i4, i10);
    }
