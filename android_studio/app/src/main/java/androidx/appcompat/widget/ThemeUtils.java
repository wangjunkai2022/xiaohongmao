...
public class ThemeUtils {
    ...
    @NonNull
    public static ColorStateList createDisabledStateList(int i4, int i10) {
        return new ColorStateList(new int[][]{DISABLED_STATE_SET, EMPTY_STATE_SET}, new int[]{i10, i4});
    }
    ...
    static int getThemeAttrColor(@NonNull Context context, int i4, float f10) {
