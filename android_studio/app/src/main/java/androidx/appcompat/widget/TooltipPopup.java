...
class TooltipPopup {
    ...
    private void computePosition(View view, int i4, int i10, boolean z9, WindowManager.LayoutParams layoutParams) {
        int height;
        int i11;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void show(View view, int i4, int i10, boolean z9, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i4, i10, z9, this.mLayoutParams);
