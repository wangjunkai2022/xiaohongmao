...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        private static long generateTransitionKey(int i4, int i10) {
            return i10 | (i4 << 32);
        }
        ...
        int addTransition(int i4, int i10, @NonNull Drawable drawable, boolean z9) {
            int addChild = super.addChild(drawable);
            long generateTransitionKey = generateTransitionKey(i4, i10);
            long j4 = z9 ? 8589934592L : 0L;
            long j10 = addChild;
            this.mTransitions.append(generateTransitionKey, Long.valueOf(j10 | j4));
            if (z9) {
                this.mTransitions.append(generateTransitionKey(i10, i4), Long.valueOf(4294967296L | j10 | j4));
            }
            return addChild;
        }
        ...
        int indexOfTransition(int i4, int i10) {
            return (int) this.mTransitions.get(generateTransitionKey(i4, i10), -1L).longValue();
        }

        boolean isTransitionReversed(int i4, int i10) {
            return (this.mTransitions.get(generateTransitionKey(i4, i10), -1L).longValue() & 4294967296L) != 0;
        }
        ...
        boolean transitionHasReversibleFlag(int i4, int i10) {
            return (this.mTransitions.get(generateTransitionKey(i4, i10), -1L).longValue() & 8589934592L) != 0;
        }
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z9, boolean z10) {
            super();
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        FrameInterpolator(AnimationDrawable animationDrawable, boolean z9) {
            updateFrames(animationDrawable, z9);
        }

        @Override // android.animation.TimeInterpolator
        public float getInterpolation(float f10) {
            int i4 = (int) ((f10 * this.mTotalDuration) + 0.5f);
            ...
            return (i11 / i10) + (i11 < i10 ? i4 / this.mTotalDuration : 0.0f);
        }
        ...
        int updateFrames(AnimationDrawable animationDrawable, boolean z9) {
            int numberOfFrames = animationDrawable.getNumberOfFrames();
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        boolean z9 = obtainAttributes.getBoolean(R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        obtainAttributes.recycle();
        if (drawable == null) {
            do {
                next = xmlPullParser.next();
    ...
    public <T extends Drawable & Animatable> void addTransition(int i4, int i10, @NonNull T t9, boolean z9) {
        if (t9 != null) {
            this.mState.addTransition(i4, i10, t9, z9);
            return;
        }
    ...
    protected boolean onStateChange(int[] iArr) {
        ...
        boolean z9 = indexOfKeyframe != getCurrentIndex() && (selectTransition(indexOfKeyframe) || selectDrawable(indexOfKeyframe));
        Drawable current = getCurrent();
