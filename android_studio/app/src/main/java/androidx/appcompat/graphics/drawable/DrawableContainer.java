...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        final boolean setLayoutDirection(int i4, int i10) {
            int i11 = this.mNumChildren;
            Drawable[] drawableArr = this.mDrawables;
            boolean z9 = false;
            for (int i12 = 0; i12 < i11; i12++) {
                if (drawableArr[i12] != null) {
                    boolean layoutDirection = Build.VERSION.SDK_INT >= 23 ? DrawableCompat.setLayoutDirection(drawableArr[i12], i4) : false;
                    if (i12 == i10) {
                        z9 = layoutDirection;
                    }
                }
    ...
    */
    ...
    public void setHotspotBounds(int i4, int i10, int i11, int i12) {
        Rect rect = this.mHotspotBounds;
        if (rect == null) {
            this.mHotspotBounds = new Rect(i4, i10, i11, i12);
        } else {
