...
public final class Compatibility {
    ...
    public static class Api15Impl {
        ...
        @DoNotInline
        public static void getValueForDensity(@NonNull Resources resources, int i4, int i10, @NonNull TypedValue typedValue, boolean z9) {
            resources.getValueForDensity(i4, i10, typedValue, z9);
        }
    }
