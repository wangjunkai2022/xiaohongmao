...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        if (j11 == -1 || j12 == -1) {
            ...
            j4 = (currentTimeMillis > j12 ? 0 + j13 : currentTimeMillis > j11 ? 0 + j12 : 0 + j11) + w.f27407d;
        }
        twilightState.isNight = z10;
        twilightState.yesterdaySunset = j10;
        twilightState.todaySunrise = j11;
        twilightState.todaySunset = j12;
        twilightState.tomorrowSunrise = j13;
