...
public class AlertController {
    ...
    public static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        public CheckedItemAdapter(Context context, int i4, int i10, CharSequence[] charSequenceArr) {
            super(context, i4, i10, charSequenceArr);
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i4, int i10) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ViewCompat.setScrollIndicators(view, i4, i10);
    ...
    private void setupView() {
        ...
        boolean z10 = (resolvePanel == null || resolvePanel.getVisibility() == 8) ? 0 : 1;
        boolean z11 = (resolvePanel3 == null || resolvePanel3.getVisibility() == 8) ? false : true;
        if (!z11 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(R.id.textSpacerNoButtons)) != null) {
        ...
        if (!z9) {
            ...
            if (view2 != null) {
                setScrollIndicators(resolvePanel2, view2, z10 | (z11 ? 2 : 0), 3);
            }
        }
