...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z9, boolean z10) {
        ...
        int resourceId = z9 ? obtainStyledAttributes.getResourceId(R.styleable.View_android_theme, 0) : 0;
        if (z10 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(R.styleable.View_theme, 0)) != 0) {
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z9, boolean z10, boolean z11, boolean z12) {
