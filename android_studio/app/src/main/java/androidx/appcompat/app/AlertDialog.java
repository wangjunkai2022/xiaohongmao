...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setSingleChoiceItems(@ArrayRes int i4, int i10, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i4);
            AlertController.AlertParams alertParams2 = this.P;
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public Builder setView(View view, int i4, int i10, int i11, int i12) {
            AlertController.AlertParams alertParams = this.P;
            alertParams.mView = view;
            alertParams.mViewLayoutResId = 0;
    ...
    public void setView(View view, int i4, int i10, int i11, int i12) {
        this.mAlert.setView(view, i4, i10, i11, i12);
    }
    ...
    protected AlertDialog(@NonNull Context context, boolean z9, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        this(context, 0);
        setCancelable(z9);
