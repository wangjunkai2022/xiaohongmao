...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class ListMenuDecorView extends ContentFrameLayout {
        ...
        private boolean isOutOfBounds(int i4, int i10) {
            return i4 < -5 || i10 < -5 || i4 > getWidth() + 5 || i10 > getHeight() + 5;
        }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z9) {
            ...
            if (findMenuPanel != null) {
                ...
                AppCompatDelegateImpl.this.closePanel(findMenuPanel, z9);
            }
        }
    ...
    private Configuration createOverrideConfigurationForDayNight(@NonNull Context context, int i4, @Nullable Configuration configuration) {
        int i10;
        if (i4 != 1) {
            i10 = i4 != 2 ? context.getApplicationContext().getResources().getConfiguration().uiMode & 48 : 32;
        } else {
            i10 = 16;
        }
    ...
    private boolean onKeyUpPanel(int i4, KeyEvent keyEvent) {
        ...
        if (i4 == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.canShowOverflowMenu() && !ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
            ...
            boolean z11 = panelState.isOpen;
            if (!z11 && !panelState.isHandled) {
                if (panelState.isPrepared) {
                    if (panelState.refreshMenuContent) {
                        panelState.isPrepared = false;
                        z9 = preparePanel(panelState, keyEvent);
                    } else {
                        z9 = true;
                    }
                    if (z9) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                if (view != null && (layoutParams = view.getLayoutParams()) != null && layoutParams.width == -1) {
                    ...
                    WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i4, -2, panelFeatureState.f408x, panelFeatureState.f409y, 1002, 8519680, -3);
            ...
            i4 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(i4, -2, panelFeatureState.f408x, panelFeatureState.f409y, 1002, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i4, KeyEvent keyEvent, int i10) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            z9 = menuBuilder.performShortcut(i4, keyEvent, i10);
        }
        if (z9 && (i10 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
        return z9;
    }
    ...
    */
    ...
    private void updateResourcesConfigurationForNightMode(int i4, boolean z9, @Nullable Configuration configuration) {
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z9, z11, true, VectorEnabledTintResources.shouldBeUsed());
    }
    ...
    protected PanelFeatureState getPanelState(int i4, boolean z9) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i4) {
        ...
        if (sanitizeWindowFeatureId == 1) {
            z9 = this.mWindowNoTitle;
        } else if (sanitizeWindowFeatureId == 2) {
            z9 = this.mFeatureProgress;
        } else if (sanitizeWindowFeatureId == 5) {
            z9 = this.mFeatureIndeterminateProgress;
        } else if (sanitizeWindowFeatureId == 10) {
            z9 = this.mOverlayActionMode;
        } else if (sanitizeWindowFeatureId != 108) {
            z9 = sanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar;
        } else {
            z9 = this.mHasActionBar;
        }
        return z9 || this.mWindow.hasFeature(i4);
    }
    ...
    */
    ...
    private boolean applyDayNight(boolean z9) {
        if (this.mDestroyed) {
            return false;
        }
        int calculateNightMode = calculateNightMode();
        boolean updateForNightMode = updateForNightMode(mapNightMode(this.mContext, calculateNightMode), z9);
    ...
    void closePanel(PanelFeatureState panelFeatureState, boolean z9) {
        ViewGroup viewGroup;
        DecorContentParent decorContentParent;
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onPreparePanel(int i4, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            z9 = (actionBarMenuCallback == null || !actionBarMenuCallback.onPreparePanel(i4)) ? false : false;
            if (!z9) {
                z9 = super.onPreparePanel(i4, view, menu);
            }
            if (menuBuilder != null) {
