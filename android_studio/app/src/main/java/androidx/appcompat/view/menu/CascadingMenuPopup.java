...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i4, @StyleRes int i10, boolean z9) {
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        if (i10 != -1 && (firstVisiblePosition = (i10 + i4) - listView.getFirstVisiblePosition()) >= 0 && firstVisiblePosition < listView.getChildCount()) {
        ...
        if (view != null) {
            ...
            if ((this.mDropDownGravity & 5) == 5) {
                if (!z9) {
                    ...
                    i11 = i4 - measureIndividualMenuWidth;
                }
                i11 = i4 + measureIndividualMenuWidth;
            } else {
                if (z9) {
