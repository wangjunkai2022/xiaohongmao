...
public class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeChanged(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10) {
        this.mConcatAdapter.notifyItemRangeChanged(i4 + countItemsBefore(nestedAdapterWrapper), i10);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeInserted(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10) {
        this.mConcatAdapter.notifyItemRangeInserted(i4 + countItemsBefore(nestedAdapterWrapper), i10);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeMoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10) {
        int countItemsBefore = countItemsBefore(nestedAdapterWrapper);
        this.mConcatAdapter.notifyItemMoved(i4 + countItemsBefore, i10 + countItemsBefore);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeRemoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10) {
        this.mConcatAdapter.notifyItemRangeRemoved(i4 + countItemsBefore(nestedAdapterWrapper), i10);
    }
    ...
    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeChanged(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10, @Nullable Object obj) {
        this.mConcatAdapter.notifyItemRangeChanged(i4 + countItemsBefore(nestedAdapterWrapper), i10, obj);
    }
}
