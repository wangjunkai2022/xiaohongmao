...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class AnonymousClass1 implements ThreadUtil.MainThreadCallback<T> {
        ...
        public void removeTile(int i4, int i10) {
            sendMessage(SyncQueueItem.obtainMessage(3, i4, i10));
        }

        @Override // androidx.recyclerview.widget.ThreadUtil.MainThreadCallback
        public void updateItemCount(int i4, int i10) {
            sendMessage(SyncQueueItem.obtainMessage(1, i4, i10));
        }
    }
    ...
    class AnonymousClass2 implements ThreadUtil.BackgroundCallback<T> {
        ...
        public void updateRange(int i4, int i10, int i11, int i12, int i13) {
            sendMessageAtFrontOfQueue(SyncQueueItem.obtainMessage(2, i4, i10, i11, i12, i13, null));
        }
    }
    ...
    public static class SyncQueueItem {
        ...
        static SyncQueueItem obtainMessage(int i4, int i10, int i11, int i12, int i13, int i14, Object obj) {
            SyncQueueItem syncQueueItem;
        ...
        static SyncQueueItem obtainMessage(int i4, int i10, int i11) {
            return obtainMessage(i4, i10, i11, 0, 0, 0, null);
        }

        static SyncQueueItem obtainMessage(int i4, int i10, Object obj) {
            return obtainMessage(i4, i10, 0, 0, 0, 0, obj);
        }
    }
}
