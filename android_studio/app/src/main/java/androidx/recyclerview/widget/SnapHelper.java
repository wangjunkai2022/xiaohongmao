...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private boolean snapFromFling(@NonNull RecyclerView.LayoutManager layoutManager, int i4, int i10) {
        RecyclerView.SmoothScroller createScroller;
        int findTargetSnapPosition;
        if (!(layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) || (createScroller = createScroller(layoutManager)) == null || (findTargetSnapPosition = findTargetSnapPosition(layoutManager, i4, i10)) == -1) {
            return false;
        }
    ...
    public abstract int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i4, int i10);
    ...
    public boolean onFling(int i4, int i10) {
        ...
        return (Math.abs(i10) > minFlingVelocity || Math.abs(i4) > minFlingVelocity) && snapFromFling(layoutManager, i4, i10);
    }
