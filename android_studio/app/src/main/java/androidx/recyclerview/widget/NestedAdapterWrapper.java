...
public class NestedAdapterWrapper {
    ...
    private RecyclerView.AdapterDataObserver mAdapterObserver = new RecyclerView.AdapterDataObserver() { // from class: androidx.recyclerview.widget.NestedAdapterWrapper.1
        ...
        public void onItemRangeChanged(int i4, int i10) {
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCallback.onItemRangeChanged(nestedAdapterWrapper, i4, i10, null);
        }
        ...
        public void onItemRangeInserted(int i4, int i10) {
            ...
            nestedAdapterWrapper.mCallback.onItemRangeInserted(nestedAdapterWrapper, i4, i10);
            NestedAdapterWrapper nestedAdapterWrapper2 = NestedAdapterWrapper.this;
        ...
        public void onItemRangeMoved(int i4, int i10, int i11) {
            ...
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCallback.onItemRangeMoved(nestedAdapterWrapper, i4, i10);
        }
        ...
        public void onItemRangeRemoved(int i4, int i10) {
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCachedItemCount -= i10;
            nestedAdapterWrapper.mCallback.onItemRangeRemoved(nestedAdapterWrapper, i4, i10);
            NestedAdapterWrapper nestedAdapterWrapper2 = NestedAdapterWrapper.this;
        ...
        public void onItemRangeChanged(int i4, int i10, @Nullable Object obj) {
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCallback.onItemRangeChanged(nestedAdapterWrapper, i4, i10, obj);
        }
    };
    ...
    interface Callback {
        ...
        void onItemRangeChanged(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10);

        void onItemRangeChanged(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10, @Nullable Object obj);

        void onItemRangeInserted(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10);

        void onItemRangeMoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10);

        void onItemRangeRemoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i10);
