...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    private int clampApplyScroll(int i4, int i10) {
        int i11 = i4 - i10;
        if (i4 * i11 <= 0) {
            return 0;
        }
    ...
    protected void onSeekTargetStep(int i4, int i10, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
