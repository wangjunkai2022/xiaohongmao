...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static final class DefaultSpanSizeLookup extends SpanSizeLookup {
        ...
        public int getSpanIndex(int i4, int i10) {
            return i4 % i10;
        }
    ...
    public static abstract class SpanSizeLookup {
        ...
        int getCachedSpanGroupIndex(int i4, int i10) {
            if (!this.mCacheSpanGroupIndices) {
                return getSpanGroupIndex(i4, i10);
            }
            int i11 = this.mSpanGroupIndexCache.get(i4, -1);
            if (i11 != -1) {
                return i11;
            }
            int spanGroupIndex = getSpanGroupIndex(i4, i10);
            this.mSpanGroupIndexCache.put(i4, spanGroupIndex);
            return spanGroupIndex;
        }

        int getCachedSpanIndex(int i4, int i10) {
            if (!this.mCacheSpanIndices) {
                return getSpanIndex(i4, i10);
            }
            int i11 = this.mSpanIndexCache.get(i4, -1);
            if (i11 != -1) {
                return i11;
            }
            int spanIndex = getSpanIndex(i4, i10);
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i4, int i10) {
        ...
        setSpanCount(RecyclerView.LayoutManager.getProperties(context, attributeSet, i4, i10).spanCount);
    }

    private void assignSpans(RecyclerView.Recycler recycler, RecyclerView.State state, int i4, boolean z9) {
        int i10;
        int i11;
        int i12 = 0;
        int i13 = -1;
    ...
    private void measureChild(View view, int i4, boolean z9) {
        int i10;
        int i11;
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        ...
        if (this.mOrientation == 1) {
            i11 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, i4, i13, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
            ...
            int childMeasureSpec = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, i4, i12, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
        ...
        measureChildWithDecorationsAndMargin(view, i11, i10, z9);
    }
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i4, int i10, boolean z9) {
        ...
        if (z9) {
            shouldMeasureChild = shouldReMeasureChild(view, i4, i10, layoutParams);
        } else {
            shouldMeasureChild = shouldMeasureChild(view, i4, i10, layoutParams);
        }
    ...
    int getSpaceForSpanRange(int i4, int i10) {
        if (this.mOrientation == 1 && isLayoutRTL()) {
            int[] iArr = this.mCachedBorders;
            int i11 = this.mSpanCount;
            return iArr[i11 - i4] - iArr[(i11 - i4) - i10];
        }
        int[] iArr2 = this.mCachedBorders;
        return iArr2[i10 + i4] - iArr2[i4];
    }
    ...
    */
    ...
    static int[] calculateItemBorders(int[] iArr, int i4, int i10) {
        int i11;
    ...
    public GridLayoutManager(Context context, int i4, int i10, boolean z9) {
