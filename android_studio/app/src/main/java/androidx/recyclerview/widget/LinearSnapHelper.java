...
public class LinearSnapHelper extends SnapHelper {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper, int i4, int i10) {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i4, int i10) {
        ...
        if (layoutManager.canScrollHorizontally()) {
            i12 = estimateNextPositionDiffForFling(layoutManager, getHorizontalHelper(layoutManager), i4, 0);
