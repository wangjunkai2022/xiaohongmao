...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromEnd(int i4) {
        ...
        for (int i10 = 0; i10 < this.mSpanCount; i10++) {
            fullSpanItem.mGapPerSpan[i10] = i4 - this.mSpans[i10].getEndLine(i4);
        }
        return fullSpanItem;
    }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromStart(int i4) {
        ...
        fullSpanItem.mGapPerSpan = new int[this.mSpanCount];
        for (int i10 = 0; i10 < this.mSpanCount; i10++) {
            fullSpanItem.mGapPerSpan[i10] = this.mSpans[i10].getStartLine(i4) - i4;
        }
        return fullSpanItem;
    }
    ...
    private int getMaxEnd(int i4) {
        ...
        for (int i10 = 1; i10 < this.mSpanCount; i10++) {
            int endLine2 = this.mSpans[i10].getEndLine(i4);
            if (endLine2 > endLine) {
                endLine = endLine2;
            }
        }
    ...
    private int getMaxStart(int i4) {
        ...
        for (int i10 = 1; i10 < this.mSpanCount; i10++) {
            int startLine2 = this.mSpans[i10].getStartLine(i4);
    ...
    */
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z9) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view, this.mFullSizeSpec, RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), ((ViewGroup.MarginLayoutParams) layoutParams).height, true), z9);
            } else {
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), ((ViewGroup.MarginLayoutParams) layoutParams).width, true), this.mFullSizeSpec, z9);
            }
    ...
    */
    ...
    private void updateRemainingSpans(Span span, int i4, int i10) {
    ...
    boolean checkForGaps() {
        ...
        if (firstChildPosition == 0 && hasGapsToFix() != null) {
            ...
            LazySpanLookup.FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, i10, i4, true);
    ...
    View findFirstVisibleItemClosestToEnd(boolean z9) {
        int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        View view = null;
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
    ...
    View findFirstVisibleItemClosestToStart(boolean z9) {
        int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        int childCount = getChildCount();
        View view = null;
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i4, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (z9 || (focusableViewAfter = span.getFocusableViewAfter(firstChildPosition, convertFocusDirectionToLayoutDirection)) == null || focusableViewAfter == findContainingItemView) {
    ...
    */
    ...
    public class Span {
        ...
        void cacheReferenceLineAndClear(boolean z9, int i4) {
            int startLine;
            if (z9) {
            ...
            if (!z9 || startLine >= StaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding()) {
                if (z9 || startLine <= StaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding()) {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i4, int i10, boolean z9, boolean z10, boolean z11) {
        ...
        int findOnePartiallyVisibleChild(int i4, int i10, boolean z9) {
            return findOnePartiallyOrCompletelyVisibleChild(i4, i10, false, false, z9);
        }

        int findOneVisibleChild(int i4, int i10, boolean z9) {
            return findOnePartiallyOrCompletelyVisibleChild(i4, i10, z9, true, false);
        }
        ...
        public View getFocusableViewAfter(int i4, int i10) {
            View view = null;
            if (i10 == -1) {
        ...
        void onOffset(int i4) {
            int i10 = this.mCachedStart;
            if (i10 != Integer.MIN_VALUE) {
                this.mCachedStart = i10 + i4;
            }
            int i11 = this.mCachedEnd;
            if (i11 != Integer.MIN_VALUE) {
                this.mCachedEnd = i11 + i4;
            }
        }
    ...
    public static class LazySpanLookup {
        ...
        private int invalidateFullSpansAfter(int i4) {
            ...
            while (true) {
                if (i10 >= size) {
                    i10 = -1;
                    break;
                } else if (this.mFullSpanItems.get(i10).mPosition >= i4) {
                    break;
                } else {
                    i10++;
                }
        ...
        private void offsetFullSpansForAddition(int i4, int i10) {
        ...
        private void offsetFullSpansForRemoval(int i4, int i10) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return;
            }
        ...
        public FullSpanItem getFirstFullSpanItemInRange(int i4, int i10, int i11, boolean z9) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return null;
            }
            ...
            for (int i12 = 0; i12 < size; i12++) {
                ...
                if (i13 >= i4 && (i11 == 0 || fullSpanItem.mGapDir == i11 || (z9 && fullSpanItem.mHasUnwantedGapAfter))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        void offsetForAddition(int i4, int i10) {
            int[] iArr = this.mData;
            if (iArr == null || i4 >= iArr.length) {
                return;
            }
            ...
            Arrays.fill(this.mData, i4, i11, -1);
            offsetFullSpansForAddition(i4, i10);
        }

        void offsetForRemoval(int i4, int i10) {
            int[] iArr = this.mData;
            if (iArr == null || i4 >= iArr.length) {
                return;
            }
            ...
            offsetFullSpansForRemoval(i4, i10);
        }
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i4, int i10, boolean z9) {
        boolean shouldMeasureChild;
        calculateItemDecorationsForChild(view, this.mTmpRect);
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i11 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
        Rect rect = this.mTmpRect;
        int updateSpecWithExtra = updateSpecWithExtra(i4, i11 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
