...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void notifyItemMoved(int i4, int i10) {
            this.mObservable.notifyItemMoved(i4, i10);
        }

        public final void notifyItemRangeChanged(int i4, int i10) {
            this.mObservable.notifyItemRangeChanged(i4, i10);
        }

        public final void notifyItemRangeInserted(int i4, int i10) {
            this.mObservable.notifyItemRangeInserted(i4, i10);
        }

        public final void notifyItemRangeRemoved(int i4, int i10) {
            this.mObservable.notifyItemRangeRemoved(i4, i10);
        }
        ...
        public final void notifyItemRangeChanged(int i4, int i10, @Nullable Object obj) {
            this.mObservable.notifyItemRangeChanged(i4, i10, obj);
        }
    }
    ...
    public static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemMoved(int i4, int i10) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeMoved(i4, i10, 1);
            }
        }

        public void notifyItemRangeChanged(int i4, int i10) {
            notifyItemRangeChanged(i4, i10, null);
        }

        public void notifyItemRangeInserted(int i4, int i10) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeInserted(i4, i10);
            }
        }

        public void notifyItemRangeRemoved(int i4, int i10) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeRemoved(i4, i10);
            }
        }
        ...
        public void notifyItemRangeChanged(int i4, int i10, @Nullable Object obj) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeChanged(i4, i10, obj);
            }
        }
    }
    ...
    public interface ChildDrawingOrderCallback {
        int onGetChildDrawingOrder(int i4, int i10);
    }
    ...
    public static abstract class LayoutManager {
        ...
        public interface LayoutPrefetchRegistry {
            void addPosition(int i4, int i10);
        }
        ...
        private void addViewInt(View view, int i4, boolean z9) {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i10) {
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int i4, int i10) {
            ...
            return rect.left - i4 < width && rect.right - i4 > paddingLeft && rect.top - i10 < height && rect.bottom - i10 > paddingTop;
        }

        private static boolean isMeasurementUpToDate(int i4, int i10, int i11) {
        ...
        public void collectAdjacentPrefetchPositions(int i4, int i10, State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }
        ...
        public void layoutDecorated(@NonNull View view, int i4, int i10, int i11, int i12) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).mDecorInsets;
            view.layout(i4 + rect.left, i10 + rect.top, i11 - rect.right, i12 - rect.bottom);
        }

        public void layoutDecoratedWithMargins(@NonNull View view, int i4, int i10, int i11, int i12) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        ...
        public void measureChild(@NonNull View view, int i4, int i10) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect itemDecorInsetsForChild = this.mRecyclerView.getItemDecorInsetsForChild(view);
            int i11 = i4 + itemDecorInsetsForChild.left + itemDecorInsetsForChild.right;
        ...
        public void measureChildWithMargins(@NonNull View view, int i4, int i10) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect itemDecorInsetsForChild = this.mRecyclerView.getItemDecorInsetsForChild(view);
            int i11 = i4 + itemDecorInsetsForChild.left + itemDecorInsetsForChild.right;
            int i12 = i10 + itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom;
        ...
        public boolean onAddFocusables(@NonNull RecyclerView recyclerView, @NonNull ArrayList<View> arrayList, int i4, int i10) {
            return false;
        }
        ...
        public void onItemsAdded(@NonNull RecyclerView recyclerView, int i4, int i10) {
        }

        public void onItemsChanged(@NonNull RecyclerView recyclerView) {
        }

        public void onItemsMoved(@NonNull RecyclerView recyclerView, int i4, int i10, int i11) {
        }

        public void onItemsRemoved(@NonNull RecyclerView recyclerView, int i4, int i10) {
        }

        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i4, int i10) {
        }

        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i4, int i10, @Nullable Object obj) {
        ...
        public void onMeasure(@NonNull Recycler recycler, @NonNull State state, int i4, int i10) {
            this.mRecyclerView.defaultOnMeasure(i4, i10);
        }
        ...
        public void setMeasuredDimension(Rect rect, int i4, int i10) {
            setMeasuredDimension(chooseSize(i4, rect.width() + getPaddingLeft() + getPaddingRight(), getMinimumWidth()), chooseSize(i10, rect.height() + getPaddingTop() + getPaddingBottom(), getMinimumHeight()));
        }

        void setMeasuredDimensionFromChildren(int i4, int i10) {
            int childCount = getChildCount();
            if (childCount == 0) {
                this.mRecyclerView.defaultOnMeasure(i4, i10);
                return;
            ...
            setMeasuredDimension(this.mRecyclerView.mTempRect, i4, i10);
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public boolean shouldMeasureChild(View view, int i4, int i10, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), i4, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getHeight(), i10, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public boolean shouldReMeasureChild(View view, int i4, int i10, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), i4, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getMeasuredHeight(), i10, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public boolean requestChildRectangleOnScreen(@NonNull RecyclerView recyclerView, @NonNull View view, @NonNull Rect rect, boolean z9, boolean z10) {
            ...
            if ((!z10 || isFocusedChildVisibleAfterScrolling(recyclerView, i4, i10)) && !(i4 == 0 && i10 == 0)) {
                if (z9) {
                    recyclerView.scrollBy(i4, i10);
                } else {
                    recyclerView.smoothScrollBy(i4, i10);
                }
                return true;
            }
            return false;
    ...
    public static abstract class OnFlingListener {
        public abstract boolean onFling(int i4, int i10);
    }
    ...
    public static class RecycledViewPool {
        ...
        void onAdapterChanged(Adapter adapter, Adapter adapter2, boolean z9) {
            if (adapter != null) {
                detach();
            }
            if (!z9 && this.mAttachCount == 0) {
                clear();
            }
            if (adapter2 != null) {
                attach();
        ...
        long runningAverage(long j4, long j10) {
            return j4 == 0 ? j10 : ((j4 / 4) * 3) + (j10 / 4);
        }

        public void setMaxRecycledViews(int i4, int i10) {
            ScrapData scrapDataForType = getScrapDataForType(i4);
        ...
        boolean willBindInTime(int i4, long j4, long j10) {
            long j11 = getScrapDataForType(i4).mBindRunningAverageNs;
            return j11 == 0 || j4 + j11 < j10;
        }

        boolean willCreateInTime(int i4, long j4, long j10) {
            long j11 = getScrapDataForType(i4).mCreateRunningAverageNs;
            return j11 == 0 || j4 + j11 < j10;
        }
    }
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull ViewHolder viewHolder, int i4, int i10, long j4) {
        ...
        ViewHolder getScrapOrCachedViewForId(long j4, int i4, boolean z9) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i4, boolean z9) {
            ...
            if (!z9 && (findHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i4)) != null) {
        ...
        void offsetPositionRecordsForInsert(int i4, int i10) {
            int size = this.mCachedViews.size();
            for (int i11 = 0; i11 < size; i11++) {
        ...
        void offsetPositionRecordsForMove(int i4, int i10) {
            int i11;
            int i12;
            int i13;
            int i14;
            ...
            for (int i15 = 0; i15 < size; i15++) {
                ...
                if (viewHolder != null && (i14 = viewHolder.mPosition) >= i13 && i14 <= i12) {
                    if (i14 == i4) {
                        viewHolder.offsetPosition(i10 - i4, false);
                    } else {
        ...
        void offsetPositionRecordsForRemove(int i4, int i10, boolean z9) {
            int i11 = i4 + i10;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ...
                if (viewHolder != null) {
                    ...
                    if (i12 >= i11) {
                        viewHolder.offsetPosition(-i10, z9);
                    } else if (i12 >= i4) {
        ...
        */
        ...
        void viewRangeUpdate(int i4, int i10) {
            int i11;
            int i12 = i10 + i4;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null && (i11 = viewHolder.mPosition) >= i4 && i11 < i12) {
        ...
        View getViewForPosition(int i4, boolean z9) {
            return tryGetViewHolderForPositionByDeadline(i4, z9, Long.MAX_VALUE).itemView;
        }
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onItemRangeChanged(int i4, int i10, Object obj) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(i4, i10, obj)) {
        ...
        public void onItemRangeInserted(int i4, int i10) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeInserted(i4, i10)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int i4, int i10, int i11) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeMoved(i4, i10, i11)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int i4, int i10) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeRemoved(i4, i10)) {
                triggerUpdateProcessor();
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@Px int i4, @Px int i10) {
                this(i4, i10, Integer.MIN_VALUE, null);
            }
            ...
            public void update(@Px int i4, @Px int i10, int i11, @Nullable Interpolator interpolator) {
                this.mDx = i4;
                this.mDy = i10;
                this.mDuration = i11;
                this.mInterpolator = interpolator;
            ...
            public Action(@Px int i4, @Px int i10, int i11) {
                this(i4, i10, i11, null);
            }

            public Action(@Px int i4, @Px int i10, int i11, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i4;
        ...
        void onAnimation(int i4, int i10) {
            ...
            if (this.mRunning) {
                onSeekTargetStep(i4, i10, recyclerView.mState, this.mRecyclingAction);
        ...
        protected abstract void onSeekTargetStep(@Px int i4, @Px int i10, @NonNull State state, @NonNull Action action);
    ...
    public static abstract class ViewCacheExtension {
        @Nullable
        public abstract View getViewForPositionAndType(@NonNull Recycler recycler, int i4, int i10);
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i4, int i10) {
            int abs = Math.abs(i4);
        ...
        public void fling(int i4, int i10) {
            ...
            this.mOverScroller.fling(0, 0, i4, i10, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (recyclerView3.mAdapter != null) {
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i10, i4);
                        } else {
                            smoothScroller.onAnimation(i10, i4);
                        }
                    }
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i10, i4, i11, i12, null, 1, iArr5);
                RecyclerView recyclerView6 = RecyclerView.this;
                int[] iArr6 = recyclerView6.mReusableIntPair;
                int i13 = i11 - iArr6[0];
                int i14 = i12 - iArr6[1];
                if (i10 != 0 || i4 != 0) {
                    recyclerView6.dispatchOnScrolled(i10, i4);
                }
                ...
                if (!(smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) && z9) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i10, i4);
                    }
                }
            }
        ...
        public void smoothScrollBy(int i4, int i10, int i11, @Nullable Interpolator interpolator) {
            if (i11 == Integer.MIN_VALUE) {
                i11 = computeScrollDuration(i4, i10);
            }
            int i12 = i11;
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, i4, i10, i12);
    ...
    public static abstract class ViewHolder {
        ...
        void flagRemovedAndOffsetPosition(int i4, int i10, boolean z9) {
            addFlags(8);
        ...
        void offsetPosition(int i4, boolean z9) {
        ...
        void setScrapContainer(Recycler recycler, boolean z9) {
    ...
    private View findNextViewToFocus() {
        ...
        for (int i10 = i4; i10 < itemCount; i10++) {
    ...
    private void nestedScrollByInternal(int i4, int i10, @Nullable MotionEvent motionEvent, int i11) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            ...
            if (dispatchNestedPreScroll(canScrollHorizontally != 0 ? i4 : 0, canScrollVertically ? i10 : 0, this.mReusableIntPair, this.mScrollOffset, i11)) {
                int[] iArr2 = this.mReusableIntPair;
                i4 -= iArr2[0];
                i10 -= iArr2[1];
            }
            scrollByInternal(canScrollHorizontally != 0 ? i4 : 0, canScrollVertically ? i10 : 0, motionEvent, i11);
            GapWorker gapWorker = this.mGapWorker;
            if (gapWorker != null && (i4 != 0 || i10 != 0)) {
                gapWorker.postFromTraversal(this, i4, i10);
            }
    ...
    private void onPointerUp(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.mScrollPointerId) {
            ...
            int y9 = (int) (motionEvent.getY(i4) + 0.5f);
            this.mLastTouchY = y9;
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z9 = this.mDataSetHasChangedAfterLayout) || z11 || this.mLayout.mRequestedSimpleAnimations) && (!z9 || this.mAdapter.hasStableIds());
        State state = this.mState;
        if (state.mRunSimpleAnimations && z11 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled()) {
            z10 = true;
        }
        state.mRunPredictiveAnimations = z10;
    }
    ...
    */
    ...
    void absorbGlows(int i4, int i10) {
        if (i4 < 0) {
            ensureLeftGlow();
    ...
    public void addFocusables(ArrayList<View> arrayList, int i4, int i10) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null || !layoutManager.onAddFocusables(this, arrayList, i4, i10)) {
    ...
    void considerReleasingGlowsOnScroll(int i4, int i10) {
        boolean z9;
        EdgeEffect edgeEffect = this.mLeftGlow;
    ...
    void defaultOnMeasure(int i4, int i10) {
        setMeasuredDimension(LayoutManager.chooseSize(i4, getPaddingLeft() + getPaddingRight(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(i10, getPaddingTop() + getPaddingBottom(), ViewCompat.getMinimumHeight(this)));
    }
    ...
    public boolean dispatchNestedPreScroll(int i4, int i10, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i4, i10, iArr, iArr2);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedScroll(int i4, int i10, int i11, int i12, int[] iArr) {
        return getScrollingChildHelper().dispatchNestedScroll(i4, i10, i11, i12, iArr);
    }
    ...
    void dispatchOnScrolled(int i4, int i10) {
        ...
        OnScrollListener onScrollListener = this.mScrollListener;
        if (onScrollListener != null) {
            onScrollListener.onScrolled(this, i4, i10);
        }
        List<OnScrollListener> list = this.mScrollListeners;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.mScrollListeners.get(size).onScrolled(this, i4, i10);
            }
        }
        this.mDispatchScrollCounter--;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (z9 || this.mItemAnimator == null || this.mItemDecorations.size() <= 0 || !this.mItemAnimator.isRunning()) {
            z11 = z9;
        }
        if (z11) {
            ViewCompat.postInvalidateOnAnimation(this);
    ...
    */
    ...
    public boolean fling(int i4, int i10) {
        ...
        if (layoutManager == null) {
            ...
            if (!dispatchNestedPreFling(f10, f11)) {
                ...
                if (onFlingListener != null && onFlingListener.onFling(i4, i10)) {
                    return true;
                }
                if (z9) {
    ...
    public View focusSearch(View view, int i4) {
        ...
        if (z10 && (i4 == 2 || i4 == 1)) {
            ...
            if (!z9 && this.mLayout.canScrollHorizontally()) {
                int i11 = (this.mLayout.getLayoutDirection() == 1) ^ (i4 == 2) ? 66 : 17;
    ...
    protected int getChildDrawingOrder(int i4, int i10) {
        ...
        return childDrawingOrderCallback.onGetChildDrawingOrder(i4, i10);
    }
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.6
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void markViewHoldersUpdated(int i4, int i10, Object obj) {
                RecyclerView.this.viewRangeUpdate(i4, i10, obj);
                RecyclerView.this.mItemsChanged = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForAdd(int i4, int i10) {
                RecyclerView.this.offsetPositionRecordsForInsert(i4, i10);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForMove(int i4, int i10) {
                RecyclerView.this.offsetPositionRecordsForMove(i4, i10);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingInvisible(int i4, int i10) {
                RecyclerView.this.offsetPositionRecordsForRemove(i4, i10, true);
                RecyclerView recyclerView = RecyclerView.this;
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingLaidOutOrNewView(int i4, int i10) {
                RecyclerView.this.offsetPositionRecordsForRemove(i4, i10, false);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
    ...
    public void offsetChildrenHorizontal(@Px int i4) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            this.mChildHelper.getChildAt(i10).offsetLeftAndRight(i4);
        }
    }
    ...
    public void offsetChildrenVertical(@Px int i4) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            this.mChildHelper.getChildAt(i10).offsetTopAndBottom(i4);
        }
    }
    ...
    void offsetPositionRecordsForInsert(int i4, int i10) {
        ...
        this.mRecycler.offsetPositionRecordsForInsert(i4, i10);
        requestLayout();
    }
    ...
    void offsetPositionRecordsForMove(int i4, int i10) {
        ...
        this.mRecycler.offsetPositionRecordsForMove(i4, i10);
        requestLayout();
    }
        ...
        for (int i12 = 0; i12 < unfilteredChildCount; i12++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore()) {
                ...
                if (i13 >= i11) {
                    ...
                    childViewHolderInt.flagRemovedAndOffsetPosition(i4 - 1, -i10, z9);
                    this.mState.mStructureChanged = true;
                }
            }
        }
        this.mRecycler.offsetPositionRecordsForRemove(i4, i10, z9);
        requestLayout();
    }
    ...
    */
    ...
    protected void onMeasure(int i4, int i10) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            int mode = View.MeasureSpec.getMode(i4);
            int mode2 = View.MeasureSpec.getMode(i10);
            this.mLayout.onMeasure(this.mRecycler, this.mState, i4, i10);
            ...
            this.mLayout.setMeasureSpecs(i4, i10);
            this.mState.mIsMeasuring = true;
            dispatchLayoutStep2();
            this.mLayout.setMeasuredDimensionFromChildren(i4, i10);
    ...
    public void onScrolled(@Px int i4, @Px int i10) {
    }
    ...
    */
    ...
    public void requestDisallowInterceptTouchEvent(boolean z9) {
        int size = this.mOnItemTouchListeners.size();
        for (int i4 = 0; i4 < size; i4++) {
            this.mOnItemTouchListeners.get(i4).onRequestDisallowInterceptTouchEvent(z9);
        }
    ...
    boolean scrollByInternal(int i4, int i10, MotionEvent motionEvent, int i11) {
        int i12;
        int i13;
        int i14;
        int i15;
    ...
    void scrollStep(int i4, int i10, @Nullable int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
    ...
    public void smoothScrollBy(@Px int i4, @Px int i10) {
    ...
    void viewRangeUpdate(int i4, int i10, Object obj) {
        int i11;
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        int i12 = i4 + i10;
        ...
        this.mRecycler.viewRangeUpdate(i4, i10);
    }
    ...
    public boolean dispatchNestedPreScroll(int i4, int i10, int[] iArr, int[] iArr2, int i11) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i4, i10, iArr, iArr2, i11);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int i4, int i10, int i11, int i12, int[] iArr, int i13) {
        return getScrollingChildHelper().dispatchNestedScroll(i4, i10, i11, i12, iArr, i13);
    }
    ...
    */
    ...
    public void smoothScrollBy(@Px int i4, @Px int i10, @Nullable Interpolator interpolator) {
        smoothScrollBy(i4, i10, interpolator, Integer.MIN_VALUE);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean startNestedScroll(int i4, int i10) {
        return getScrollingChildHelper().startNestedScroll(i4, i10);
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        boolean z9 = obtainStyledAttributes.getBoolean(R.styleable.RecyclerView_fastScrollEnabled, false);
    ...
    public final void dispatchNestedScroll(int i4, int i10, int i11, int i12, int[] iArr, int i13, @NonNull int[] iArr2) {
        getScrollingChildHelper().dispatchNestedScroll(i4, i10, i11, i12, iArr, i13, iArr2);
    }

    public void smoothScrollBy(@Px int i4, @Px int i10, @Nullable Interpolator interpolator, int i11) {
    ...
    void smoothScrollBy(@Px int i4, @Px int i10, @Nullable Interpolator interpolator, int i11, boolean z9) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (this.mLayoutSuppressed) {
            ...
            if (i11 == Integer.MIN_VALUE || i11 > 0) {
                ...
                this.mViewFlinger.smoothScrollBy(i4, i10, i11, interpolator);
                return;
            }
            scrollBy(i4, i10);
        }
