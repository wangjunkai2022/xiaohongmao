...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        MoveInfo(RecyclerView.ViewHolder viewHolder, int i4, int i10, int i11, int i12) {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i4, int i10, int i11, int i12) {
        if (viewHolder == viewHolder2) {
            return animateMove(viewHolder, i4, i10, i11, i12);
        }
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i4, i10, i11, i12));
        return true;
    }
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i4, int i10, int i11, int i12) {
        final View view = viewHolder.itemView;
        final int i13 = i11 - i4;
        ...
        if (z9 || z10 || z12 || z11) {
            ...
            if (z12) {
                ...
                if (!z9 && !z10 && !z11) {
                    ...
                    ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, (z9 ? getRemoveDuration() : 0L) + Math.max(z10 ? getMoveDuration() : 0L, z11 ? getChangeDuration() : 0L));
                }
            }
        }
    }
    ...
    public static class ChangeInfo {
        ...
        ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i4, int i10, int i11, int i12) {
