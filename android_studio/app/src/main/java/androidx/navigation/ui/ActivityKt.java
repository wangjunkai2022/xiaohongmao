...
public final class ActivityKt {
    public static final void setupActionBarWithNavController(@g AppCompatActivity appCompatActivity, @g NavController navController, @h DrawerLayout drawerLayout) {
    ...
    public static final void setupActionBarWithNavController(@g AppCompatActivity appCompatActivity, @g NavController navController, @g AppBarConfiguration configuration) {
        Intrinsics.checkNotNullParameter(appCompatActivity, "<this>");
        Intrinsics.checkNotNullParameter(navController, "navController");
