...
public final class AppBarConfigurationKt {
    @g
    public static final AppBarConfiguration AppBarConfiguration(@g NavGraph navGraph, @h Openable openable, @g Function0<Boolean> fallbackOnNavigateUpListener) {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(NavGraph navGraph, Openable openable, Function0 fallbackOnNavigateUpListener, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            openable = null;
        }
        if ((i4 & 4) != 0) {
    ...
    @g
    public static final AppBarConfiguration AppBarConfiguration(@g Menu topLevelMenu, @h Openable openable, @g Function0<Boolean> fallbackOnNavigateUpListener) {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(Menu topLevelMenu, Openable openable, Function0 fallbackOnNavigateUpListener, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            openable = null;
        }
        if ((i4 & 4) != 0) {
    ...
    @g
    public static final AppBarConfiguration AppBarConfiguration(@g Set<Integer> topLevelDestinationIds, @h Openable openable, @g Function0<Boolean> fallbackOnNavigateUpListener) {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(Set topLevelDestinationIds, Openable openable, Function0 fallbackOnNavigateUpListener, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            openable = null;
        }
        if ((i4 & 4) != 0) {
