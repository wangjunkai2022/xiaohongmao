...
public final class ToolbarKt {
    public static final void setupWithNavController(@g Toolbar toolbar, @g NavController navController, @h DrawerLayout drawerLayout) {
    ...
    public static final void setupWithNavController(@g Toolbar toolbar, @g NavController navController, @g AppBarConfiguration configuration) {
        Intrinsics.checkNotNullParameter(toolbar, "<this>");
        Intrinsics.checkNotNullParameter(navController, "navController");
