...
public final class CollapsingToolbarLayoutKt {
    public static final void setupWithNavController(@g CollapsingToolbarLayout collapsingToolbarLayout, @g Toolbar toolbar, @g NavController navController, @h DrawerLayout drawerLayout) {
    ...
    public static final void setupWithNavController(@g CollapsingToolbarLayout collapsingToolbarLayout, @g Toolbar toolbar, @g NavController navController, @g AppBarConfiguration configuration) {
        Intrinsics.checkNotNullParameter(collapsingToolbarLayout, "<this>");
        Intrinsics.checkNotNullParameter(toolbar, "toolbar");
        Intrinsics.checkNotNullParameter(navController, "navController");
