...
public class NavGraphBuilder extends NavDestinationBuilder<NavGraph> {
    ...
    public NavGraphBuilder(@g NavigatorProvider provider, @IdRes int i4, @IdRes int i10) {
    ...
    public final void addDestination(@g NavDestination destination) {
        Intrinsics.checkNotNullParameter(destination, "destination");
        this.destinations.add(destination);
    }

    public final <D extends NavDestination> void destination(@g NavDestinationBuilder<? extends D> navDestination) {
    ...
    public final void unaryPlus(@g NavDestination navDestination) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavGraphBuilder(@g NavigatorProvider provider, @g String startDestination, @h String str) {
