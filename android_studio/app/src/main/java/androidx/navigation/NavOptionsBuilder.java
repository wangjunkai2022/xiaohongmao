...
public final class NavOptionsBuilder {
    ...
    public static /* synthetic */ void popUpTo$default(NavOptionsBuilder navOptionsBuilder, int i4, Function1 function1, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            function1 = NavOptionsBuilder$popUpTo$1.INSTANCE;
        }
        navOptionsBuilder.popUpTo(i4, function1);
    }
    ...
    public final void anim(@g Function1<? super AnimBuilder, Unit> animBuilder) {
    ...
    public final void popUpTo(@IdRes int i4, @g Function1<? super PopUpToBuilder, Unit> popUpToBuilder) {
    ...
    public final void setPopUpTo(int i4) {
        popUpTo$default(this, i4, (Function1) null, 2, (Object) null);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ void popUpTo$default(NavOptionsBuilder navOptionsBuilder, String str, Function1 function1, int i4, Object obj) {
        if ((i4 & 2) != 0) {
    ...
    public final void popUpTo(@g String route, @g Function1<? super PopUpToBuilder, Unit> popUpToBuilder) {
