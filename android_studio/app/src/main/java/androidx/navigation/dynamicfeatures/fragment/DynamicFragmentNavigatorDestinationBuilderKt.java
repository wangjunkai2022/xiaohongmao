...
public final class DynamicFragmentNavigatorDestinationBuilderKt {
    ...
    public static final /* synthetic */ <F extends Fragment> void fragment(DynamicNavGraphBuilder dynamicNavGraphBuilder, @IdRes int i4, Function1<? super DynamicFragmentNavigatorDestinationBuilder, Unit> builder) {
        ...
        DynamicFragmentNavigatorDestinationBuilder dynamicFragmentNavigatorDestinationBuilder = new DynamicFragmentNavigatorDestinationBuilder((DynamicFragmentNavigator) dynamicNavGraphBuilder.getProvider().getNavigator(DynamicFragmentNavigator.class), i4, name);
    ...
    public static final void fragment(@g DynamicNavGraphBuilder dynamicNavGraphBuilder, @IdRes int i4, @g String fragmentClassName, @g Function1<? super DynamicFragmentNavigatorDestinationBuilder, Unit> builder) {
        Intrinsics.checkNotNullParameter(dynamicNavGraphBuilder, "<this>");
        Intrinsics.checkNotNullParameter(fragmentClassName, "fragmentClassName");
        Intrinsics.checkNotNullParameter(builder, "builder");
        DynamicFragmentNavigatorDestinationBuilder dynamicFragmentNavigatorDestinationBuilder = new DynamicFragmentNavigatorDestinationBuilder((DynamicFragmentNavigator) dynamicNavGraphBuilder.getProvider().getNavigator(DynamicFragmentNavigator.class), i4, fragmentClassName);
        builder.invoke(dynamicFragmentNavigatorDestinationBuilder);
        dynamicNavGraphBuilder.destination(dynamicFragmentNavigatorDestinationBuilder);
    }
    ...
    public static final void fragment(@g DynamicNavGraphBuilder dynamicNavGraphBuilder, @g String route, @g String fragmentClassName, @g Function1<? super DynamicFragmentNavigatorDestinationBuilder, Unit> builder) {
        Intrinsics.checkNotNullParameter(dynamicNavGraphBuilder, "<this>");
        Intrinsics.checkNotNullParameter(route, "route");
        Intrinsics.checkNotNullParameter(fragmentClassName, "fragmentClassName");
        Intrinsics.checkNotNullParameter(builder, "builder");
    ...
    public static final /* synthetic */ <F extends Fragment> void fragment(DynamicNavGraphBuilder dynamicNavGraphBuilder, @IdRes int i4) {
        Intrinsics.checkNotNullParameter(dynamicNavGraphBuilder, "<this>");
        Intrinsics.reifiedOperationMarker(4, "F");
        dynamicNavGraphBuilder.destination(new FragmentNavigatorDestinationBuilder((FragmentNavigator) dynamicNavGraphBuilder.getProvider().getNavigator(FragmentNavigator.class), i4, Reflection.getOrCreateKotlinClass(Fragment.class)));
    }
    ...
    public static final /* synthetic */ <F extends Fragment> void fragment(DynamicNavGraphBuilder dynamicNavGraphBuilder, String route) {
        ...
        Intrinsics.checkNotNullParameter(route, "route");
        Intrinsics.reifiedOperationMarker(4, "F");
        dynamicNavGraphBuilder.destination(new FragmentNavigatorDestinationBuilder((FragmentNavigator) dynamicNavGraphBuilder.getProvider().getNavigator(FragmentNavigator.class), route, Reflection.getOrCreateKotlinClass(Fragment.class)));
    }
}
