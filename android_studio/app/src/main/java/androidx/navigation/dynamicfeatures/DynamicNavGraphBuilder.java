...
public final class DynamicNavGraphBuilder extends NavGraphBuilder {
    ...
    public DynamicNavGraphBuilder(@g NavigatorProvider provider, @IdRes int i4, @IdRes int i10) {
        super(provider, i4, i10);
    ...
    public final void setProgressDestination(int i4) {
        ...
        this._progressDestination = i4;
    }

    public final void setProgressDestinationRoute(@h String str) {
        boolean isBlank;
        int hashCode;
        if (str == null) {
            hashCode = 0;
    ...
    public /* synthetic */ DynamicNavGraphBuilder(NavigatorProvider navigatorProvider, String str, String str2, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(navigatorProvider, str, (i4 & 4) != 0 ? null : str2);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DynamicNavGraphBuilder(@g NavigatorProvider provider, @g String startDestination, @h String str) {
