...
public final class ActivityNavigatorDestinationBuilder extends NavDestinationBuilder<ActivityNavigator.Destination> {
    ...
    public ActivityNavigatorDestinationBuilder(@g ActivityNavigator navigator, @IdRes int i4) {
        super(navigator, i4);
    ...
    public final void setActivityClass(@h KClass<? extends Activity> kClass) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ActivityNavigatorDestinationBuilder(@g ActivityNavigator navigator, @g String route) {
