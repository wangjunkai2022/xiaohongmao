...
public class NavHostController extends NavController {
    ...
    public NavHostController(@g Context context) {
        super(context);
    ...
    @Override // androidx.navigation.NavController
    public final void setLifecycleOwner(@g LifecycleOwner owner) {
        Intrinsics.checkNotNullParameter(owner, "owner");
        super.setLifecycleOwner(owner);
    }

    @Override // androidx.navigation.NavController
    public final void setOnBackPressedDispatcher(@g OnBackPressedDispatcher dispatcher) {
        Intrinsics.checkNotNullParameter(dispatcher, "dispatcher");
        super.setOnBackPressedDispatcher(dispatcher);
    }

    @Override // androidx.navigation.NavController
    public final void setViewModelStore(@g ViewModelStore viewModelStore) {
