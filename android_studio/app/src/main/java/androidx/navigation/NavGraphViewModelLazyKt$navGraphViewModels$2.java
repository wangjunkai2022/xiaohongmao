...
public final class NavGraphViewModelLazyKt$navGraphViewModels$2 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public final ViewModelProvider.Factory invoke() {
        NavBackStackEntry m32navGraphViewModels$lambda0;
        m32navGraphViewModels$lambda0 = NavGraphViewModelLazyKt.m32navGraphViewModels$lambda0(this.$backStackEntry$delegate);
        return m32navGraphViewModels$lambda0.getDefaultViewModelProviderFactory();
    }
}
