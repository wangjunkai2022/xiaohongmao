...
public final class NavGraphViewModelLazyKt$navGraphViewModels$4 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public final ViewModelProvider.Factory invoke() {
        NavBackStackEntry m33navGraphViewModels$lambda1;
        m33navGraphViewModels$lambda1 = NavGraphViewModelLazyKt.m33navGraphViewModels$lambda1(this.$backStackEntry$delegate);
        return m33navGraphViewModels$lambda1.getDefaultViewModelProviderFactory();
    }
}
