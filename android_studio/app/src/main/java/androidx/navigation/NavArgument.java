...
public final class NavArgument {
    ...
    public static final class Builder {
        ...
        @g
        public final Builder setDefaultValue(@h Object obj) {
        ...
        @g
        public final Builder setIsNullable(boolean z9) {
            this.isNullable = z9;
            return this;
        }

        @g
        public final <T> Builder setType(@g NavType<T> type) {
    ...
    public NavArgument(@g NavType<Object> type, boolean z9, @h Object obj, boolean z10) {
        Intrinsics.checkNotNullParameter(type, "type");
        boolean z11 = false;
        if (!(type.isNullableAllowed() || !z9)) {
            throw new IllegalArgumentException((type.getName() + " does not allow nullable values").toString());
        }
        if ((!z9 && z10 && obj == null) ? true : true) {
            this.type = type;
            this.isNullable = z9;
            this.defaultValue = obj;
    ...
    public final void putDefaultValue(@g String name, @g Bundle bundle) {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public final boolean verify(@g String name, @g Bundle bundle) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(bundle, "bundle");
