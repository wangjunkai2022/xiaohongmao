...
public final class DialogFragmentNavigatorDestinationBuilder extends NavDestinationBuilder<DialogFragmentNavigator.Destination> {
    ...
    public DialogFragmentNavigatorDestinationBuilder(@g DialogFragmentNavigator navigator, @IdRes int i4, @g KClass<? extends DialogFragment> fragmentClass) {
        super(navigator, i4);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DialogFragmentNavigatorDestinationBuilder(@g DialogFragmentNavigator navigator, @g String route, @g KClass<? extends DialogFragment> fragmentClass) {
