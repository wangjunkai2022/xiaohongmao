...
public final class FragmentNavigatorDestinationBuilder extends NavDestinationBuilder<FragmentNavigator.Destination> {
    ...
    public FragmentNavigatorDestinationBuilder(@g FragmentNavigator navigator, @IdRes int i4, @g KClass<? extends Fragment> fragmentClass) {
        super(navigator, i4);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FragmentNavigatorDestinationBuilder(@g FragmentNavigator navigator, @g String route, @g KClass<? extends Fragment> fragmentClass) {
