...
public abstract class AbstractListDetailFragment extends Fragment {
    ...
    private static final class InnerOnBackPressedCallback extends OnBackPressedCallback implements SlidingPaneLayout.PanelSlideListener {
        ...
        public InnerOnBackPressedCallback(@g SlidingPaneLayout slidingPaneLayout) {
            super(true);
        ...
        public void onPanelClosed(@g View panel) {
            Intrinsics.checkNotNullParameter(panel, "panel");
            setEnabled(false);
        }

        @Override // androidx.slidingpanelayout.widget.SlidingPaneLayout.PanelSlideListener
        public void onPanelOpened(@g View panel) {
            Intrinsics.checkNotNullParameter(panel, "panel");
            setEnabled(true);
        }

        @Override // androidx.slidingpanelayout.widget.SlidingPaneLayout.PanelSlideListener
        public void onPanelSlide(@g View panel, float f10) {
            Intrinsics.checkNotNullParameter(panel, "panel");
        }
    }
    ...
    public NavHostFragment onCreateDetailPaneNavHostFragment() {
        int i4 = this.graphId;
        if (i4 != 0) {
            return NavHostFragment.Companion.create$default(NavHostFragment.Companion, i4, null, 2, null);
        }
        return new NavHostFragment();
    }

    @g
    public abstract View onCreateListPaneView(@g LayoutInflater layoutInflater, @h ViewGroup viewGroup, @h Bundle bundle);
    ...
    public final View onCreateView(@g LayoutInflater inflater, @h ViewGroup viewGroup, @h Bundle bundle) {
        ...
        int i4 = R.id.sliding_pane_detail_container;
        ...
        Fragment findFragmentById = getChildFragmentManager().findFragmentById(i4);
        boolean z9 = true;
        if (findFragmentById != null) {
            ...
            beginTransaction.add(i4, onCreateDetailPaneNavHostFragment);
        ...
        if (ViewCompat.isLaidOut(slidingPaneLayout) && !slidingPaneLayout.isLayoutRequested()) {
            ...
            slidingPaneLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.navigation.fragment.AbstractListDetailFragment$onCreateView$$inlined$doOnLayout$1
                ...
                public void onLayoutChange(@g View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
    ...
    public void onListPaneViewCreated(@g View view, @h Bundle bundle) {
    ...
    @Override // androidx.fragment.app.Fragment
    @CallSuper
    public final void onViewCreated(@g View view, @h Bundle bundle) {
        Intrinsics.checkNotNullParameter(view, "view");
