...
public final class NavHostKt {
    ...
    @g
    public static final NavGraph createGraph(@g NavHost navHost, @IdRes int i4, @IdRes int i10, @g Function1<? super NavGraphBuilder, Unit> builder) {
        Intrinsics.checkNotNullParameter(navHost, "<this>");
        Intrinsics.checkNotNullParameter(builder, "builder");
        NavGraphBuilder navGraphBuilder = new NavGraphBuilder(navHost.getNavController().getNavigatorProvider(), i4, i10);
    ...
    @g
    public static final NavGraph createGraph(@g NavHost navHost, @g String startDestination, @h String str, @g Function1<? super NavGraphBuilder, Unit> builder) {
        Intrinsics.checkNotNullParameter(navHost, "<this>");
