...
public final class NavControllerViewModel extends ViewModel implements NavViewModelStoreProvider {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @g
        public final NavControllerViewModel getInstance(@g ViewModelStore viewModelStore) {
    ...
    @JvmStatic
    @g
    public static final NavControllerViewModel getInstance(@g ViewModelStore viewModelStore) {
        return Companion.getInstance(viewModelStore);
    }

    public final void clear(@g String backStackEntryId) {
    ...
    @g
    public ViewModelStore getViewModelStore(@g String backStackEntryId) {
        Intrinsics.checkNotNullParameter(backStackEntryId, "backStackEntryId");
