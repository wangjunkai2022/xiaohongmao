...
public final class NavController$popBackStackInternal$2 extends Lambda implements Function1<NavBackStackEntry, Unit> {
    ...
    public NavController$popBackStackInternal$2(Ref.BooleanRef booleanRef, Ref.BooleanRef booleanRef2, NavController navController, boolean z9, ArrayDeque<NavBackStackEntryState> arrayDeque) {
        super(1);
