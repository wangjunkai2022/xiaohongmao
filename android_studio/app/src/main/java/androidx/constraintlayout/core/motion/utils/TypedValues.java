...
public interface TypedValues {
    ...
    public interface OnSwipe {
        ...
        public static final String[] AUTOCOMPLETE_MODE_ENUM = {"continuousVelocity", com.qennnsad.aknkaksd.e.f48516h};
    ...
    boolean setValue(int i4, float f10);

    boolean setValue(int i4, int i10);

    boolean setValue(int i4, String str);

    boolean setValue(int i4, boolean z9);
}
