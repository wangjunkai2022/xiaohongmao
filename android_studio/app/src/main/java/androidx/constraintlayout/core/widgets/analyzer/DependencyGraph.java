...
public class DependencyGraph {
    ...
    private void applyGroup(DependencyNode dependencyNode, int i4, int i10, DependencyNode dependencyNode2, ArrayList<RunGroup> arrayList, RunGroup runGroup) {
        ...
        while (it.hasNext()) {
            ...
            if (next.getVisibility() == 8) {
                ...
                if ((dimensionBehaviour9 == dimensionBehaviour11 || dimensionBehaviour9 == ConstraintWidget.DimensionBehaviour.FIXED || dimensionBehaviour9 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) && (dimensionBehaviour10 == dimensionBehaviour11 || dimensionBehaviour10 == ConstraintWidget.DimensionBehaviour.FIXED || dimensionBehaviour10 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT)) {
                    ...
                    measure(next, dimensionBehaviour, i4, dimensionBehaviour2, i10);
    ...
    private int computeWrap(ConstraintWidgetContainer constraintWidgetContainer, int i4) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            j4 = Math.max(j4, this.mGroups.get(i10).computeWrapSize(constraintWidgetContainer, i4));
        }
        return (int) j4;
    }
    ...
    private String generateDisplayGraph(WidgetRun widgetRun, String str) {
        ...
        if ((widgetRun instanceof HelperReferences) || !dependencyNode.dependencies.isEmpty() || (!dependencyNode2.dependencies.isEmpty() || !dependencyNode.targets.isEmpty()) || !dependencyNode2.targets.isEmpty()) {
            ...
            if (!(widgetRun instanceof HorizontalWidgetRun) && (!((z9 = widgetRun instanceof ChainRun)) || ((ChainRun) widgetRun).orientation != 0)) {
                if (z10 || (z9 && ((ChainRun) widgetRun).orientation == 1)) {
    ...
    private String generateDisplayNode(DependencyNode dependencyNode, boolean z9, String str) {
        ...
        while (it.hasNext()) {
            ...
            if (dependencyNode.margin > 0 || z9 || (dependencyNode.run instanceof HelperReferences)) {
                String str3 = str2 + "[";
    ...
    private void measure(ConstraintWidget constraintWidget, ConstraintWidget.DimensionBehaviour dimensionBehaviour, int i4, ConstraintWidget.DimensionBehaviour dimensionBehaviour2, int i10) {
    ...
    private String nodeDefinition(WidgetRun widgetRun) {
        ...
        boolean z10 = widgetRun.dimension.resolved;
        if (z10 && !widgetRun.widget.measured) {
            sb.append(" BGCOLOR=\"green\" ");
        } else if (z10) {
    ...
    public boolean directMeasure(boolean z9) {
        ...
        int y9 = this.container.getY();
        this.container.horizontalRun.start.resolve(x9);
        this.container.verticalRun.start.resolve(y9);
        measureWidgets();
        ConstraintWidget.DimensionBehaviour dimensionBehaviour3 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
        ...
        if (dimensionBehaviour4 == dimensionBehaviour5 || dimensionBehaviourArr[0] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            ...
            if (dimensionBehaviourArr2[1] == dimensionBehaviour5 || dimensionBehaviourArr2[1] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                ...
                this.container.verticalRun.dimension.resolve(height - y9);
            }
            measureWidgets();
            z10 = true;
        } else {
    ...
    public boolean directMeasureWithOrientation(boolean z9, int i4) {
        ...
        int x9 = this.container.getX();
        int y9 = this.container.getY();
        if (z12 && (dimensionBehaviour2 == (dimensionBehaviour = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) || dimensionBehaviour3 == dimensionBehaviour)) {
            Iterator<WidgetRun> it = this.mRuns.iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
            ...
            } else if (z12 && dimensionBehaviour3 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                this.container.setVerticalDimensionBehaviour(ConstraintWidget.DimensionBehaviour.FIXED);
                ConstraintWidgetContainer constraintWidgetContainer3 = this.container;
        ...
        if (i4 == 0) {
            ...
            if (dimensionBehaviourArr[0] == ConstraintWidget.DimensionBehaviour.FIXED || dimensionBehaviourArr[0] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                int width = constraintWidgetContainer5.getWidth() + x9;
                this.container.horizontalRun.end.resolve(width);
                this.container.horizontalRun.dimension.resolve(width - x9);
                z10 = true;
            }
            ...
            if (dimensionBehaviourArr2[1] == ConstraintWidget.DimensionBehaviour.FIXED || dimensionBehaviourArr2[1] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                int height = constraintWidgetContainer6.getHeight() + y9;
                this.container.verticalRun.end.resolve(height);
                this.container.verticalRun.dimension.resolve(height - y9);
                z10 = true;
            }
        ...
        while (it3.hasNext()) {
            ...
            if (next3.orientation == i4 && (z10 || next3.widget != this.container)) {
    ...
    public void measureWidgets() {
        ...
        while (it.hasNext()) {
            ...
            if (!next.measured) {
                ...
                ConstraintWidget.DimensionBehaviour dimensionBehaviour3 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                boolean z10 = dimensionBehaviour == dimensionBehaviour3 || (dimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && i4 == 1);
