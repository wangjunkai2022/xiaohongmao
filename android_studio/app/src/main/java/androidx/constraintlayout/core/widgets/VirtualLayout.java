...
public class VirtualLayout extends HelperWidget {
    ...
    public void measure(ConstraintWidget constraintWidget, ConstraintWidget.DimensionBehaviour dimensionBehaviour, int i4, ConstraintWidget.DimensionBehaviour dimensionBehaviour2, int i10) {
    ...
    public void setMeasure(int i4, int i10) {
