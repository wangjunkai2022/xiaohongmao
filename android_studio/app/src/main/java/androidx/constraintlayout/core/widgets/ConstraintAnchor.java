...
public class ConstraintAnchor {
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i4, int i10, boolean z9) {
        if (constraintAnchor == null) {
            reset();
            return true;
        } else if (z9 || isValidConnection(constraintAnchor)) {
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type2.ordinal()]) {
            ...
            case 3:
                ...
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    return (z10 || type == Type.CENTER_X) ? true : true;
                }
                return z10;
            case 4:
            case 5:
                ...
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    return (z11 || type == Type.CENTER_Y) ? true : true;
                }
                return z11;
            case 6:
