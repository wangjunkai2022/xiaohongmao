...
public class DesignTool implements ProxyInterface {
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public float getKeyFramePosition(Object view, int type, float x9, float y9) {
        MotionController motionController;
        if ((view instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get((View) view)) != null) {
            return motionController.getKeyFrameParameter(type, x9, y9);
        }
        return 0.0f;
    }
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Object getKeyframeAtLocation(Object viewObject, float x9, float y9) {
        MotionController motionController;
        View view = (View) viewObject;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), x9, y9);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Boolean getPositionKeyframe(Object keyFrame, Object view, float x9, float y9, String[] attribute, float[] value) {
        if (keyFrame instanceof KeyPositionBase) {
            View view2 = (View) view;
            this.mMotionLayout.mFrameArrayList.get(view2).positionKeyframe(view2, (KeyPositionBase) keyFrame, x9, y9, attribute, value);
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public boolean setKeyFramePosition(Object view, int position, int type, float x9, float y9) {
            ...
            if (motionLayout.mScene != null) {
                ...
                if (motionController != null) {
                    ...
                    if (motionLayout2.mScene.hasKeyFramePosition(view2, i4)) {
                        float keyFrameParameter = motionController.getKeyFrameParameter(2, x9, y9);
                        float keyFrameParameter2 = motionController.getKeyFrameParameter(5, x9, y9);
