...
public class ViewTransition {
    ...
    public static class Animate {
        ...
        public void reactTo(int action, float x9, float y9) {
            if (action == 1) {
                if (this.reverse) {
                    return;
                }
                ...
                if (this.mTempRec.contains((int) x9, (int) y9) || this.reverse) {
                    return;
                }
                reverse(true);
            }
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        if (i4 == 1) {
            for (int i10 : layout.getConstraintSetIds()) {
                if (i10 != fromId) {
                    ConstraintSet constraintSet = layout.getConstraintSet(i10);
                    for (View view : views) {
        ...
        layout.updateState(i11, current);
        layout.setState(i11, -1, -1);
        MotionScene.Transition transition = new MotionScene.Transition(-1, layout.mScene, i11, fromId);
    ...
    public boolean checkTags(View view) {
        ...
        boolean z9 = i4 == -1 || view.getTag(i4) != null;
