...
abstract class KeyPositionBase extends Key {
    ...
    public abstract boolean intersects(int layoutWidth, int layoutHeight, RectF start, RectF end, float x9, float y9);

    /* JADX INFO: Access modifiers changed from: package-private */
    public abstract void positionAttributes(View view, RectF start, RectF end, float x9, float y9, String[] attribute, float[] value);
}
