...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void adjustTexture(float l10, float t9, float r9, float b10) {
        if (this.mTextShaderMatrix == null) {
            return;
        }
        this.mFloatWidth = r9 - l10;
        this.mFloatHeight = b10 - t9;
        updateShaderMatrix();
    }
    ...
    private void setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex) {
        ...
        if (styleIndex > 0) {
            ...
            setTypeface(create);
            int i4 = (~(create != null ? create.getStyle() : 0)) & styleIndex;
    ...
    public void layout(float l10, float t9, float r9, float b10) {
        int i4 = (int) (l10 + 0.5f);
        this.mDeltaLeft = l10 - i4;
        int i10 = (int) (r9 + 0.5f);
        int i11 = i10 - i4;
        int i12 = (int) (b10 + 0.5f);
        int i13 = (int) (0.5f + t9);
        int i14 = i12 - i13;
        float f10 = r9 - l10;
