...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i4, int i10) {
            return i4 == this.mCachedBitmap.getWidth() && i10 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i4, int i10) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i4, i10)) {
                this.mCachedBitmap = Bitmap.createBitmap(i4, i10, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i4, int i10) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i4, i10, null);
        }
    ...
    static int applyAlpha(int i4, float f10) {
        return (i4 & 16777215) | (((int) (Color.alpha(i4) * f10)) << 24);
    }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i4 = 0; i4 < pathDataNodeArr.length; i4++) {
                ...
                for (int i10 = 0; i10 < pathDataNodeArr[i4].mParams.length; i10++) {
                    str = str + fArr[i10] + ",";
                }
            }
            return str;
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i4, int i10, ColorFilter colorFilter) {
            ...
            for (int i11 = 0; i11 < vGroup.mChildren.size(); i11++) {
                VObject vObject = vGroup.mChildren.get(i11);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup.mStackedMatrix, canvas, i4, i10, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup, (VPath) vObject, canvas, i4, i10, colorFilter);
                }
            }
            canvas.restore();
        }

        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i4, int i10, ColorFilter colorFilter) {
            float f10 = i4 / this.mViewportWidth;
        ...
        public void draw(Canvas canvas, int i4, int i10, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i4, i10, colorFilter);
        }
    ...
    public static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] iArr) {
            boolean z9 = false;
            for (int i4 = 0; i4 < this.mChildren.size(); i4++) {
                z9 |= this.mChildren.get(i4).onStateChanged(iArr);
            }
            return z9;
        }
