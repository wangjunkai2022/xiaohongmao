...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean blocksInteractionBelow(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9) {
            return getScrimOpacity(coordinatorLayout, v9) > 0.0f;
        }

        public boolean getInsetDodgeRect(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull Rect rect) {
            return false;
        }

        @ColorInt
        public int getScrimColor(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9) {
            return ViewCompat.MEASURED_STATE_MASK;
        }

        @FloatRange(from = 0.0d, to = 1.0d)
        public float getScrimOpacity(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9) {
            return 0.0f;
        }

        public boolean layoutDependsOn(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view) {
            return false;
        }

        @NonNull
        public WindowInsetsCompat onApplyWindowInsets(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull WindowInsetsCompat windowInsetsCompat) {
        ...
        public boolean onDependentViewChanged(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view) {
            return false;
        }

        public void onDependentViewRemoved(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view) {
        }
        ...
        public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, int i4, int i10, int i11, int i12) {
            return false;
        }

        public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, float f10, float f11, boolean z9) {
            return false;
        }
        ...
        @Deprecated
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, int i4, int i10, @NonNull int[] iArr) {
        }
        ...
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, int i4, int i10, @NonNull int[] iArr, int i11) {
            if (i11 == 0) {
                onNestedPreScroll(coordinatorLayout, v9, view, i4, i10, iArr);
            }
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, int i4, int i10, int i11, int i12) {
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, int i4, int i10, int i11, int i12, int i13) {
            if (i13 == 0) {
                onNestedScroll(coordinatorLayout, v9, view, i4, i10, i11, i12);
            }
        }

        @Deprecated
        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, @NonNull View view2, int i4) {
        }

        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, @NonNull View view2, int i4, int i10) {
            if (i10 == 0) {
                onNestedScrollAccepted(coordinatorLayout, v9, view, view2, i4);
            }
        }

        public boolean onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull Rect rect, boolean z9) {
            return false;
        }
        ...
        @Deprecated
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, @NonNull View view2, int i4) {
            return false;
        }
        ...
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, @NonNull View view2, int i4, int i10) {
            if (i10 == 0) {
                return onStartNestedScroll(coordinatorLayout, v9, view, view2, i4);
            }
            return false;
        }

        @Deprecated
        public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view) {
        }

        public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, int i4) {
            if (i4 == 0) {
                onStopNestedScroll(coordinatorLayout, v9, view);
            }
        }
        ...
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v9, @NonNull View view, int i4, int i10, int i11, int i12, int i13, @NonNull int[] iArr) {
            iArr[0] = iArr[0] + i11;
            iArr[1] = iArr[1] + i12;
            onNestedScroll(coordinatorLayout, v9, view, i4, i10, i11, i12, i13);
        }
    }
    ...
    private void constrainChildRect(LayoutParams layoutParams, Rect rect, int i4, int i10) {
        int width = getWidth();
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i4, Rect rect, Rect rect2, LayoutParams layoutParams, int i10, int i11) {
        int width;
        int height;
    ...
    private void layoutChildWithKeyline(View view, int i4, int i10) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    private void setInsetOffsetX(View view, int i4) {
        ...
        if (i10 != i4) {
            ViewCompat.offsetLeftAndRight(view, i4 - i10);
    ...
    private void setInsetOffsetY(View view, int i4) {
        ...
        if (i10 != i4) {
            ViewCompat.offsetTopAndBottom(view, i4 - i10);
    ...
    void getChildRect(View view, boolean z9, Rect rect) {
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        Log.e(TAG, "Default behavior class " + defaultBehavior.value().getName() + " could not be instantiated. Did you forget a default constructor?", e4);
                    }
                }
                layoutParams.mBehaviorResolved = true;
            }
    ...
    public boolean isPointInChildBounds(@NonNull View view, int i4, int i10) {
        Rect acquireTempRect = acquireTempRect();
        getDescendantRect(view, acquireTempRect);
        try {
            return acquireTempRect.contains(i4, i10);
        } finally {
            releaseTempRect(acquireTempRect);
        }
    }
    ...
    void offsetChildToAnchor(View view, int i4) {
        ...
        if (layoutParams.mAnchorView != null) {
            ...
            z9 = (acquireTempRect3.left == acquireTempRect2.left && acquireTempRect3.top == acquireTempRect2.top) ? true : true;
    ...
    public void onLayoutChild(@NonNull View view, int i4) {
        ...
        if (!layoutParams.checkAnchorChanged()) {
            ...
            if (i10 >= 0) {
                layoutChildWithKeyline(view, i10, i4);
                return;
            } else {
                layoutChild(view, i4);
                return;
    ...
    */
    ...
    public void onMeasureChild(View view, int i4, int i10, int i11, int i12) {
        measureChildWithMargins(view, i4, i10, i11, i12);
    }
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(0) && (behavior = layoutParams.getBehavior()) != null) {
                    z10 |= behavior.onNestedFling(this, childAt, view, f10, f11, z9);
                }
            }
        }
        if (z10) {
    ...
    public boolean onNestedPreFling(View view, float f10, float f11) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                LayoutParams layoutParams = (LayoutParams) childAt.getLayoutParams();
                if (layoutParams.isNestedScrollAccepted(0) && (behavior = layoutParams.getBehavior()) != null) {
                    z9 |= behavior.onNestedPreFling(this, childAt, view, f10, f11);
                }
            }
        }
        return z9;
    ...
    */
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i11) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedPreScroll(this, childAt, view, i4, i10, iArr2, i11);
                    int[] iArr3 = this.mBehaviorConsumed;
                    i12 = i4 > 0 ? Math.max(i12, iArr3[0]) : Math.min(i12, iArr3[0]);
    ...
    public void onNestedScroll(View view, int i4, int i10, int i11, int i12, int i13) {
        onNestedScroll(view, i4, i10, i11, i12, 0, this.mNestedScrollingV2ConsumedCompat);
    }

    @Override // androidx.core.view.NestedScrollingParent2
    public void onNestedScrollAccepted(View view, View view2, int i4, int i10) {
        Behavior behavior;
        this.mNestedScrollingParentHelper.onNestedScrollAccepted(view, view2, i4, i10);
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (layoutParams.isNestedScrollAccepted(i10) && (behavior = layoutParams.getBehavior()) != null) {
                behavior.onNestedScrollAccepted(this, childAt, view, view2, i4, i10);
            }
        }
    }
    ...
    public boolean onStartNestedScroll(View view, View view2, int i4, int i10) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                Behavior behavior = layoutParams.getBehavior();
                if (behavior != null) {
                    boolean onStartNestedScroll = behavior.onStartNestedScroll(this, childAt, view, view2, i4, i10);
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i13) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedScroll(this, childAt, view, i4, i10, i11, i12, i13, iArr2);
                    int[] iArr3 = this.mBehaviorConsumed;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        void setChangedAfterNestedScroll(boolean z9) {
        ...
        void setNestedScrollAccepted(int i4, boolean z9) {
            if (i4 == 0) {
