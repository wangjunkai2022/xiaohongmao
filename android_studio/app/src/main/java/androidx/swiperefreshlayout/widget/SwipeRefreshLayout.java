...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild3, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
    ...
    private Animation startAlphaAnimation(final int i4, final int i10) {
    ...
    private void startDragging(float f10) {
        ...
        if (f10 - f11 <= i4 || this.mIsBeingDragged) {
            return;
        }
        this.mInitialMotionY = f11 + i4;
    ...
    public boolean dispatchNestedFling(float f10, float f11, boolean z9) {
        return this.mNestedScrollingChildHelper.dispatchNestedFling(f10, f11, z9);
    }
    ...
    public boolean dispatchNestedPreScroll(int i4, int i10, int[] iArr, int[] iArr2, int i11) {
        return i11 == 0 && dispatchNestedPreScroll(i4, i10, iArr, iArr2);
    }

    @Override // androidx.core.view.NestedScrollingChild3
    public void dispatchNestedScroll(int i4, int i10, int i11, int i12, @Nullable int[] iArr, int i13, @NonNull int[] iArr2) {
        if (i13 == 0) {
            this.mNestedScrollingChildHelper.dispatchNestedScroll(i4, i10, i11, i12, iArr, i13, iArr2);
        }
    }
    ...
    void moveToStart(float f10) {
        int i4 = this.mFrom;
        setTargetOffsetTopAndBottom((i4 + ((int) ((this.mOriginalOffsetTop - i4) * f10))) - this.mCircleView.getTop());
    }
    ...
    public void onNestedScroll(@NonNull View view, int i4, int i10, int i11, int i12, int i13, @NonNull int[] iArr) {
        ...
        int i14 = iArr[1];
        dispatchNestedScroll(i4, i10, i11, i12, this.mParentOffsetInWindow, i13, iArr);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            startDragging(y9);
            if (this.mIsBeingDragged) {
                float f10 = (y9 - this.mInitialMotionY) * 0.5f;
                if (f10 <= 0.0f) {
                    return false;
                }
    ...
    public void setProgressViewEndTarget(boolean z9, int i4) {
        this.mSpinnerOffsetEnd = i4;
        this.mScale = z9;
        this.mCircleView.invalidate();
    }

    public void setProgressViewOffset(boolean z9, int i4, int i10) {
        this.mScale = z9;
    ...
    public boolean startNestedScroll(int i4, int i10) {
        return i10 == 0 && startNestedScroll(i4);
    }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        SavedState(Parcelable parcelable, boolean z9) {
            super(parcelable);
            this.mRefreshing = z9;
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.6
            ...
            public void applyTransformation(float f10, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i10 + ((int) ((i4 - i10) * f10))) - swipeRefreshLayout2.mCircleView.getTop());
    ...
    public boolean dispatchNestedPreScroll(int i4, int i10, int[] iArr, int[] iArr2) {
        return this.mNestedScrollingChildHelper.dispatchNestedPreScroll(i4, i10, iArr, iArr2);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int i4, int i10, int i11, int i12, int[] iArr, int i13) {
        return i13 == 0 && this.mNestedScrollingChildHelper.dispatchNestedScroll(i4, i10, i11, i12, iArr, i13);
    }
    ...
    public boolean dispatchNestedScroll(int i4, int i10, int i11, int i12, int[] iArr) {
        return this.mNestedScrollingChildHelper.dispatchNestedScroll(i4, i10, i11, i12, iArr);
    }

    @Override // androidx.core.view.NestedScrollingParent2
    public void onNestedScroll(View view, int i4, int i10, int i11, int i12, int i13) {
        onNestedScroll(view, i4, i10, i11, i12, i13, this.mNestedScrollingV2ConsumedCompat);
    }
