...
public final class LruCacheKt$lruCache$4 extends LruCache<K, V> {
    ...
    public LruCacheKt$lruCache$4(Function2 function2, Function1 function1, Function4 function4, int i4, int i10) {
        super(i10);
    ...
    @h
    protected V create(@g K k10) {
        return this.$create.invoke(k10);
    }

    @Override // androidx.collection.LruCache
    protected void entryRemoved(boolean z9, @g K k10, @g V v9, @h V v10) {
        this.$onEntryRemoved.invoke(Boolean.valueOf(z9), k10, v9, v10);
    }

    @Override // androidx.collection.LruCache
    protected int sizeOf(@g K k10, @g V v9) {
        return ((Number) this.$sizeOf.invoke(k10, v9)).intValue();
    }
}
