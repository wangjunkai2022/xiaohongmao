...
public abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements Iterator<T> {
        ...
        public T next() {
            if (hasNext()) {
                T t9 = (T) MapCollections.this.colGetEntry(this.mIndex, this.mOffset);
                this.mIndex++;
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public V setValue(V v9) {
            if (this.mEntryValid) {
                return (V) MapCollections.this.colSetValue(this.mIndex, v9);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
    ...
    protected abstract Object colGetEntry(int i4, int i10);
    ...
    protected abstract void colPut(K k10, V v9);

    protected abstract void colRemoveAt(int i4);

    protected abstract V colSetValue(int i4, V v9);
