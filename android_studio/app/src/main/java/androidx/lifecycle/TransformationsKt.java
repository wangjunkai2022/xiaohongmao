...
public final class TransformationsKt {
    @CheckResult
    @m8.g
    public static final <X> LiveData<X> distinctUntilChanged(@m8.g LiveData<X> liveData) {
    ...
    @CheckResult
    @m8.g
    public static final <X, Y> LiveData<Y> map(@m8.g LiveData<X> liveData, @m8.g final Function1<? super X, ? extends Y> transform) {
        Intrinsics.checkNotNullParameter(liveData, "<this>");
    ...
    @CheckResult
    @m8.g
    public static final <X, Y> LiveData<Y> switchMap(@m8.g LiveData<X> liveData, @m8.g final Function1<? super X, ? extends LiveData<Y>> transform) {
        Intrinsics.checkNotNullParameter(liveData, "<this>");
        Intrinsics.checkNotNullParameter(transform, "transform");
        LiveData<Y> switchMap = Transformations.switchMap(liveData, new Function() { // from class: androidx.lifecycle.TransformationsKt$switchMap$1
            ...
            public final LiveData<Y> apply(X x9) {
                return (LiveData) transform.invoke(x9);
            }
