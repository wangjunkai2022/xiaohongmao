...
public final class ViewModelLazy<VM extends ViewModel> implements Lazy<VM> {
    ...
    @JvmOverloads
    public ViewModelLazy(@m8.g KClass<VM> viewModelClass, @m8.g Function0<? extends ViewModelStore> storeProducer, @m8.g Function0<? extends ViewModelProvider.Factory> factoryProducer) {
    ...
    @JvmOverloads
    public ViewModelLazy(@m8.g KClass<VM> viewModelClass, @m8.g Function0<? extends ViewModelStore> storeProducer, @m8.g Function0<? extends ViewModelProvider.Factory> factoryProducer, @m8.g Function0<? extends CreationExtras> extrasProducer) {
        Intrinsics.checkNotNullParameter(viewModelClass, "viewModelClass");
        Intrinsics.checkNotNullParameter(storeProducer, "storeProducer");
        Intrinsics.checkNotNullParameter(factoryProducer, "factoryProducer");
    ...
    public /* synthetic */ ViewModelLazy(KClass kClass, Function0 function0, Function0 function02, Function0 function03, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(kClass, function0, function02, (i4 & 8) != 0 ? AnonymousClass1.INSTANCE : function03);
    }
}
