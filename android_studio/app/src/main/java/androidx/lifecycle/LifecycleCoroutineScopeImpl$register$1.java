...
public final class LifecycleCoroutineScopeImpl$register$1 extends SuspendLambda implements Function2<s0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(@m8.g s0 s0Var, @m8.h Continuation<? super Unit> continuation) {
        return ((LifecycleCoroutineScopeImpl$register$1) create(s0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@m8.g Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (this.this$0.getLifecycle$lifecycle_runtime_ktx_release().getCurrentState().compareTo(Lifecycle.State.INITIALIZED) >= 0) {
                ...
                o2.i(s0Var.getCoroutineContext(), null, 1, null);
            }
