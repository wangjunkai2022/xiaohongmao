...
public final class SavedStateHandleSupport {
    ...
    @MainThread
    public static final <T extends SavedStateRegistryOwner & ViewModelStoreOwner> void enableSavedStateHandles(@m8.g T t9) {
    ...
    @m8.g
    public static final SavedStateHandlesProvider getSavedStateHandlesProvider(@m8.g SavedStateRegistryOwner savedStateRegistryOwner) {
    ...
    @m8.g
    public static final SavedStateHandlesVM getSavedStateHandlesVM(@m8.g ViewModelStoreOwner viewModelStoreOwner) {
    ...
    @m8.g
    @MainThread
    public static final SavedStateHandle createSavedStateHandle(@m8.g CreationExtras creationExtras) {
