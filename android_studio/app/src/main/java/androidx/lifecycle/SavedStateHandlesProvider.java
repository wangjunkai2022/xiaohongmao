...
public final class SavedStateHandlesProvider implements SavedStateRegistry.SavedStateProvider {
    ...
    public SavedStateHandlesProvider(@m8.g SavedStateRegistry savedStateRegistry, @m8.g ViewModelStoreOwner viewModelStoreOwner) {
        Lazy lazy;
    ...
    @m8.h
    public final Bundle consumeRestoredStateForKey(@m8.g String key) {
