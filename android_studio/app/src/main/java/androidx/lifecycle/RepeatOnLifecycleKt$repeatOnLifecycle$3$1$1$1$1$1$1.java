...
final class RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1 extends SuspendLambda implements Function2<s0, Continuation<? super Unit>, Object> {
    ...
    public RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1(Function2<? super s0, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1> continuation) {
    ...
    public final Object invoke(@m8.g s0 s0Var, @m8.h Continuation<? super Unit> continuation) {
        return ((RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1) create(s0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@m8.g Object obj) {
        ...
        if (i4 == 0) {
            ...
            this.label = 1;
            if (function2.invoke((s0) this.L$0, this) == coroutine_suspended) {
