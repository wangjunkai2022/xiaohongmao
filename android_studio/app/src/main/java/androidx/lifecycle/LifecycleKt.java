...
public final class LifecycleKt {
    @m8.g
    public static final LifecycleCoroutineScope getCoroutineScope(@m8.g Lifecycle lifecycle) {
        ...
        do {
            ...
            lifecycleCoroutineScopeImpl = new LifecycleCoroutineScopeImpl(lifecycle, m3.c(null, 1, null).plus(i1.e().p0()));
