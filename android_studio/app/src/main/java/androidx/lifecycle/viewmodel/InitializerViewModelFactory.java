...
public final class InitializerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public InitializerViewModelFactory(@g ViewModelInitializer<?>... initializers) {
    ...
    @Override // androidx.lifecycle.ViewModelProvider.Factory
    @g
    public <T extends ViewModel> T create(@g Class<T> modelClass, @g CreationExtras extras) {
