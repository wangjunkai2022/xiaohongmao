...
public final class MutableCreationExtras extends CreationExtras {
    ...
    public MutableCreationExtras(@g CreationExtras initialExtras) {
    ...
    @h
    public <T> T get(@g CreationExtras.Key<T> key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (T) getMap$lifecycle_viewmodel_release().get(key);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final <T> void set(@g CreationExtras.Key<T> key, T t9) {
        Intrinsics.checkNotNullParameter(key, "key");
        getMap$lifecycle_viewmodel_release().put(key, t9);
    }
