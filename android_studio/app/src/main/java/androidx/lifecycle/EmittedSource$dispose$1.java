...
final class EmittedSource$dispose$1 extends SuspendLambda implements Function2<s0, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(@m8.g s0 s0Var, @m8.h Continuation<? super Unit> continuation) {
        return ((EmittedSource$dispose$1) create(s0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
