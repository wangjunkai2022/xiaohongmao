...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public static class Entry<K, V> implements Map.Entry<K, V> {
        ...
        Entry(@NonNull K k10, @NonNull V v9) {
            this.mKey = k10;
            this.mValue = v9;
        }
    ...
    public Entry<K, V> put(@NonNull K k10, @NonNull V v9) {
        Entry<K, V> entry = new Entry<>(k10, v9);
        this.mSize++;
    ...
    public V putIfAbsent(@NonNull K k10, @NonNull V v9) {
