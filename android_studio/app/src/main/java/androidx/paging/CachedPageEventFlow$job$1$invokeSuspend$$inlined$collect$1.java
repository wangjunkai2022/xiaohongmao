...
public final class CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1 implements j<IndexedValue<? extends PageEvent<T>>> {
    final /* synthetic */ CachedPageEventFlow this$0;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    @DebugMetadata(c = "androidx.paging.CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1", f = "CachedPageEventFlow.kt", i = {0, 0}, l = {h0.J, 136}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})
    ...
    */
    public java.lang.Object emit(kotlin.collections.IndexedValue<? extends androidx.paging.PageEvent<T>> r6, @m8.g kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
        ...
        L40:
            ...
            kotlinx.coroutines.flow.s r7 = androidx.paging.CachedPageEventFlow.access$getMutableSharedSrc$p(r7)
            r0.L$0 = r5
            r0.L$1 = r6
            r0.label = r4
