...
public final class RemoteMediatorAccessImpl$launchRefresh$1 extends SuspendLambda implements Function2<s0, Continuation<? super Unit>, Object> {
    Object L$0;
    int label;
    ...
    public final Object invoke(@g s0 s0Var, @h Continuation<? super Unit> continuation) {
        return ((RemoteMediatorAccessImpl$launchRefresh$1) create(s0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
