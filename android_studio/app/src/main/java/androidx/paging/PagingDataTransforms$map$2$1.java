...
final class PagingDataTransforms$map$2$1 extends SuspendLambda implements Function2<s0, Continuation<? super PageEvent<R>>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<T, Continuation<? super R>, Object> {
        ...
        @h
        public final Object invoke(@g T t9, @h Continuation<? super R> continuation) {
    ...
    public final Object invoke(@g s0 s0Var, @h Continuation<? super PageEvent<R>> continuation) {
        return ((PagingDataTransforms$map$2$1) create(s0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
