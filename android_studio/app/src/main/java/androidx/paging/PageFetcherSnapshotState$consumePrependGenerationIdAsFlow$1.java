...
public final class PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1 extends SuspendLambda implements Function2<j<? super Integer>, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(@g j<? super Integer> jVar, @h Continuation<? super Unit> continuation) {
        return ((PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1) create(jVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@g Object obj) {
        ...
        if (this.label == 0) {
            ...
            mVar = ((PageFetcherSnapshotState) this.this$0).prependGenerationIdCh;
            i4 = ((PageFetcherSnapshotState) this.this$0).prependGenerationId;
