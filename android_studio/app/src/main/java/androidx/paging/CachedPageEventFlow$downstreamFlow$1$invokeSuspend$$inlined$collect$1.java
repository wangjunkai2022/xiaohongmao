...
public final class CachedPageEventFlow$downstreamFlow$1$invokeSuspend$$inlined$collect$1 implements j<IndexedValue<? extends PageEvent<T>>> {
    ...
    public CachedPageEventFlow$downstreamFlow$1$invokeSuspend$$inlined$collect$1(Ref.IntRef intRef, j jVar) {
    ...
    */
    public java.lang.Object emit(kotlin.collections.IndexedValue<? extends androidx.paging.PageEvent<T>> r5, @m8.g kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r4 = this;
        ...
        L39:
            ...
            int r2 = r2.element
            if (r6 <= r2) goto L67
            kotlinx.coroutines.flow.j r6 = r4.$$this$flow$inlined
