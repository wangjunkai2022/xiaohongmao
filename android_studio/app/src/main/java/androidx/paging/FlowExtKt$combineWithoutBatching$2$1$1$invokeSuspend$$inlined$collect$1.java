...
public final class FlowExtKt$combineWithoutBatching$2$1$1$invokeSuspend$$inlined$collect$1 implements j<Object> {
    final /* synthetic */ int $index$inlined;
    final /* synthetic */ UnbatchedFlowCombiner $unbatchedFlowCombiner$inlined;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    @DebugMetadata(c = "androidx.paging.FlowExtKt$combineWithoutBatching$2$1$1$invokeSuspend$$inlined$collect$1", f = "FlowExt.kt", i = {}, l = {h0.J, h0.H}, m = "emit", n = {}, s = {})
    ...
    public FlowExtKt$combineWithoutBatching$2$1$1$invokeSuspend$$inlined$collect$1(UnbatchedFlowCombiner unbatchedFlowCombiner, int i4) {
    ...
    */
    public java.lang.Object emit(java.lang.Object r6, @m8.g kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
    ...
    public Object emit$$forInline(Object obj, @g Continuation continuation) {
        ...
        int i4 = this.$index$inlined;
        InlineMarker.mark(0);
        unbatchedFlowCombiner.onNext(i4, obj, continuation);
        InlineMarker.mark(1);
        InlineMarker.mark(0);
        z3.a(continuation);
        InlineMarker.mark(1);
