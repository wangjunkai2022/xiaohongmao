...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        static PendingIntent getActivities(Context context, int i4, Intent[] intentArr, int i10, Bundle bundle) {
            return PendingIntent.getActivities(context, i4, intentArr, i10, bundle);
        }
    }
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i4, int i10) {
        return getPendingIntent(i4, i10, null);
    }
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i4, int i10, @Nullable Bundle bundle) {
        if (!this.mIntents.isEmpty()) {
            Intent[] intentArr = (Intent[]) this.mIntents.toArray(new Intent[0]);
            intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
            return Api16Impl.getActivities(this.mSourceContext, i4, intentArr, i10, bundle);
        }
