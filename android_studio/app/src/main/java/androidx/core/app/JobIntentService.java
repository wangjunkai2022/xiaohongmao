...
public abstract class JobIntentService extends Service {
                ...
                synchronized (this) {
                    if (!this.mLaunchingService) {
                        ...
                        if (!this.mServiceProcessing) {
                            this.mLaunchWakeLock.acquire(w.f27407d);
                        }
                    }
                }
            }
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z9, int i4) {
    ...
    void ensureProcessorRunningLocked(boolean z9) {
