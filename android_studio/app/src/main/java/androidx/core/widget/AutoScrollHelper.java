...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long j4) {
            ...
            if (j11 >= 0 && j4 >= j11) {
                ...
                return (1.0f - f10) + (f10 * AutoScrollHelper.constrain(((float) (j4 - j11)) / this.mEffectiveRampDown, 0.0f, 1.0f));
            }
            return AutoScrollHelper.constrain(((float) (j4 - j10)) / this.mRampUpDuration, 0.0f, 1.0f) * 0.5f;
        }
    ...
    private float computeTargetVelocity(int i4, float f10, float f11, float f12) {
        float edgeValue = getEdgeValue(this.mRelativeEdges[i4], f11, this.mMaximumEdges[i4], f10);
        int i10 = (edgeValue > 0.0f ? 1 : (edgeValue == 0.0f ? 0 : -1));
        if (i10 == 0) {
            return 0.0f;
        }
        float f13 = this.mRelativeVelocity[i4];
        float f14 = this.mMinimumVelocity[i4];
        float f15 = this.mMaximumVelocity[i4];
        float f16 = f13 * f12;
        if (i10 > 0) {
    ...
    static int constrain(int i4, int i10, int i11) {
        return i4 > i11 ? i11 : i4 < i10 ? i10 : i4;
    }
    ...
    */
    ...
    public abstract void scrollTargetBy(int i4, int i10);
