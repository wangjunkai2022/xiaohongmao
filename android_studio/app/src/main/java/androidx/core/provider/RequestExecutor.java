...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i4, @IntRange(from = 0) int i10) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, 1, i10, TimeUnit.MILLISECONDS, new LinkedBlockingDeque(), new DefaultThreadFactory(str, i4));
