...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl {
        ...
        void setVisible(int i4, boolean z9) {
        }
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setVisible(int i4, boolean z9) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i4), z9);
        }
    ...
    public static class Impl {
        ...
        @NonNull
        WindowInsetsCompat inset(int i4, int i10, int i11, int i12) {
            return CONSUMED;
        }
    ...
    public static class Impl20 extends Impl {
        ...
        @NonNull
        protected Insets getInsetsForType(int i4, boolean z9) {
            Insets stableInsets;
            int i10;
        ...
        WindowInsetsCompat inset(int i4, int i10, int i11, int i12) {
            ...
            builder.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), i4, i10, i11, i12));
            builder.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), i4, i10, i11, i12));
        ...
        @NonNull
        @SuppressLint({"WrongConstant"})
        private Insets getInsets(int i4, boolean z9) {
            Insets insets = Insets.NONE;
            for (int i10 = 1; i10 <= 256; i10 <<= 1) {
                if ((i4 & i10) != 0) {
                    insets = Insets.max(insets, getInsetsForType(i10, z9));
                }
            }
            return insets;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Insets insetInsets(@NonNull Insets insets, int i4, int i10, int i11, int i12) {
        ...
        return (max == i4 && max2 == i10 && max3 == i11 && max4 == i12) ? insets : Insets.of(max, max2, max3, max4);
    }
    ...
    @NonNull
    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(int i4, int i10, int i11, int i12) {
        return new Builder(this).setSystemWindowInsets(Insets.of(i4, i10, i11, i12)).build();
    }
    ...
    @NonNull
    public WindowInsetsCompat inset(@IntRange(from = 0) int i4, @IntRange(from = 0) int i10, @IntRange(from = 0) int i11, @IntRange(from = 0) int i12) {
        return this.mImpl.inset(i4, i10, i11, i12);
    }
    ...
    private static class Impl29 extends Impl28 {
        ...
        @NonNull
        WindowInsetsCompat inset(int i4, int i10, int i11, int i12) {
            return WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets.inset(i4, i10, i11, i12));
        }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setVisible(int i4, boolean z9) {
            this.mImpl.setVisible(i4, z9);
            return this;
        }
