...
public final class MenuItemCompat {
    ...
    static class Api26Impl {
        ...
        @DoNotInline
        static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c10, int i4) {
            return menuItem.setAlphabeticShortcut(c10, i4);
        }
        ...
        @DoNotInline
        static MenuItem setNumericShortcut(MenuItem menuItem, char c10, int i4) {
            return menuItem.setNumericShortcut(c10, i4);
        }

        @DoNotInline
        static MenuItem setShortcut(MenuItem menuItem, char c10, char c11, int i4, int i10) {
            return menuItem.setShortcut(c10, c11, i4, i10);
        }
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c10, int i4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c10, i4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c10, i4);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c10, int i4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c10, i4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c10, i4);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c10, char c11, int i4, int i10) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c10, c11, i4, i10);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c10, c11, i4, i10);
        }
    }
