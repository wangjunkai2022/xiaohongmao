...
public final class LayoutInflaterCompat {
    ...
    static class Factory2Wrapper implements LayoutInflater.Factory2 {
        ...
        public String toString() {
            return getClass().getName() + "{" + this.mDelegateFactory + com.alipay.sdk.util.i.f6967d;
        }
    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        if (!sCheckedField) {
            try {
                ...
                Log.e(TAG, "forceSetFactory2 Could not find field 'mFactory2' on class " + LayoutInflater.class.getName() + "; inflation may have unexpected results.", e4);
            }
            sCheckedField = true;
        }
        ...
        if (field != null) {
            try {
                ...
                Log.e(TAG, "forceSetFactory2 could not set the Factory2 on LayoutInflater " + layoutInflater + "; inflation may have unexpected results.", e10);
            }
        }
    }
