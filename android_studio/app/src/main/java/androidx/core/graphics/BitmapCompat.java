...
public final class BitmapCompat {
    ...
    static class Api17Impl {
        ...
        @DoNotInline
        static void setHasMipMap(Bitmap bitmap, boolean z9) {
    ...
    static class Api27Impl {
        ...
        @DoNotInline
        static Bitmap createBitmapWithSourceColorspace(int i4, int i10, Bitmap bitmap, boolean z9) {
            ...
            return Bitmap.createBitmap(i4, i10, config, bitmap.hasAlpha(), colorSpace);
        }
    ...
    */
    ...
    public static void setHasMipMap(@NonNull Bitmap bitmap, boolean z9) {
        Api17Impl.setHasMipMap(bitmap, z9);
    }

    @VisibleForTesting
    public static int sizeAtStep(int i4, int i10, int i11, int i12) {
        return i11 == 0 ? i10 : i11 > 0 ? i4 * (1 << (i12 - i11)) : i10 << ((-i11) - 1);
    }
}
