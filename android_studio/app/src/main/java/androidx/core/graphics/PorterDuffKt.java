...
public final class PorterDuffKt {
    @g
    public static final PorterDuffColorFilter toColorFilter(@g PorterDuff.Mode mode, int i4) {
        Intrinsics.checkNotNullParameter(mode, "<this>");
        return new PorterDuffColorFilter(i4, mode);
    }

    @g
    public static final PorterDuffXfermode toXfermode(@g PorterDuff.Mode mode) {
        Intrinsics.checkNotNullParameter(mode, "<this>");
