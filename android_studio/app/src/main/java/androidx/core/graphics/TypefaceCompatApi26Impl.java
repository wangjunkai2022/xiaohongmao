...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public TypefaceCompatApi26Impl() {
        ...
        try {
            ...
            Log.e(TAG, "Unable to collect necessary methods for class " + e4.getClass().getName(), e4);
            method = null;
            constructor = null;
            method2 = null;
            method3 = null;
    ...
    private boolean addFontFromAssetManager(Context context, Object obj, String str, int i4, int i10, int i11, @Nullable FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.mAddFontFromAssetManager.invoke(obj, context.getAssets(), str, 0, Boolean.FALSE, Integer.valueOf(i4), Integer.valueOf(i10), Integer.valueOf(i11), fontVariationAxisArr)).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }

    private boolean addFontFromBuffer(Object obj, ByteBuffer byteBuffer, int i4, int i10, int i11) {
        try {
            return ((Boolean) this.mAddFontFromBuffer.invoke(obj, byteBuffer, Integer.valueOf(i4), null, Integer.valueOf(i10), Integer.valueOf(i11))).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public Typeface createFromResourcesFontFile(Context context, Resources resources, int i4, String str, int i10) {
        if (!isFontFamilyPrivateAPIAvailable()) {
            return super.createFromResourcesFontFile(context, resources, i4, str, i10);
        }
        Object newFamily = newFamily();
        if (newFamily == null) {
            return null;
