...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, String str, int i4, boolean z9) {
        init();
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, str, Integer.valueOf(i4), Boolean.valueOf(z9))).booleanValue();
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i4) {
        ...
        try {
            ...
            Typeface createFromInputStream = super.createFromInputStream(context, c10);
            c10.close();
            openFileDescriptor.close();
