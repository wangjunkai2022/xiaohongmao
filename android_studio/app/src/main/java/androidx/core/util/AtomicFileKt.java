...
public final class AtomicFileKt {
    @RequiresApi(17)
    @g
    public static final byte[] readBytes(@g android.util.AtomicFile atomicFile) {
    ...
    @RequiresApi(17)
    @g
    public static final String readText(@g android.util.AtomicFile atomicFile, @g Charset charset) {
        Intrinsics.checkNotNullParameter(atomicFile, "<this>");
    ...
    @RequiresApi(17)
    public static final void tryWrite(@g android.util.AtomicFile atomicFile, @g Function1<? super FileOutputStream, Unit> block) {
        Intrinsics.checkNotNullParameter(atomicFile, "<this>");
    ...
    @RequiresApi(17)
    public static final void writeBytes(@g android.util.AtomicFile atomicFile, @g byte[] array) {
        Intrinsics.checkNotNullParameter(atomicFile, "<this>");
    ...
    @RequiresApi(17)
    public static final void writeText(@g android.util.AtomicFile atomicFile, @g String text, @g Charset charset) {
        Intrinsics.checkNotNullParameter(atomicFile, "<this>");
