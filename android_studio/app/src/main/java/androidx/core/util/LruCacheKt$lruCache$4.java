...
public final class LruCacheKt$lruCache$4 extends LruCache<K, V> {
    ...
    public LruCacheKt$lruCache$4(Function2<? super K, ? super V, Integer> function2, Function1<? super K, ? extends V> function1, Function4<? super Boolean, ? super K, ? super V, ? super V, Unit> function4, int i4) {
        super(i4);
    ...
    @h
    protected V create(@g K key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return this.$create.invoke(key);
    }

    @Override // android.util.LruCache
    protected void entryRemoved(boolean z9, @g K key, @g V oldValue, @h V v9) {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(oldValue, "oldValue");
        this.$onEntryRemoved.invoke(Boolean.valueOf(z9), key, oldValue, v9);
    }

    @Override // android.util.LruCache
    protected int sizeOf(@g K key, @g V value) {
        Intrinsics.checkNotNullParameter(key, "key");
