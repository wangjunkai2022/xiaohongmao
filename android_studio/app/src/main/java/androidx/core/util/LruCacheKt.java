...
public final class LruCacheKt {
    @g
    public static final <K, V> LruCache<K, V> lruCache(int i4, @g Function2<? super K, ? super V, Integer> sizeOf, @g Function1<? super K, ? extends V> create, @g Function4<? super Boolean, ? super K, ? super V, ? super V, Unit> onEntryRemoved) {
        Intrinsics.checkNotNullParameter(sizeOf, "sizeOf");
        Intrinsics.checkNotNullParameter(create, "create");
        Intrinsics.checkNotNullParameter(onEntryRemoved, "onEntryRemoved");
        return new LruCacheKt$lruCache$4(sizeOf, create, onEntryRemoved, i4);
    }

    public static /* synthetic */ LruCache lruCache$default(int i4, Function2 sizeOf, Function1 create, Function4 onEntryRemoved, int i10, Object obj) {
        if ((i10 & 2) != 0) {
