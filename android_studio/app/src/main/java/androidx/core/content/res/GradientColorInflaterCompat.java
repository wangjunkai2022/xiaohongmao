...
public final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i4, @ColorInt int i10, boolean z9, @ColorInt int i11) {
        if (colorStops != null) {
            return colorStops;
        }
        if (z9) {
            return new ColorStops(i4, i11, i10);
        }
        return new ColorStops(i4, i10);
    }
    ...
    */
    ...
    public static final class ColorStops {
        ...
        ColorStops(@ColorInt int i4, @ColorInt int i10) {
            this.mColors = new int[]{i4, i10};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        ColorStops(@ColorInt int i4, @ColorInt int i10, @ColorInt int i11) {
            this.mColors = new int[]{i4, i10, i11};
