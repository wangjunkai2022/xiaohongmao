...
public final class ColorStateListInflaterCompat {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i4, @FloatRange(from = 0.0d, to = 1.0d) float f10, @FloatRange(from = 0.0d, to = 100.0d) float f11) {
        boolean z9 = f11 >= 0.0f && f11 <= 100.0f;
        if (f10 != 1.0f || z9) {
            int clamp = MathUtils.clamp((int) ((Color.alpha(i4) * f10) + 0.5f), 0, 255);
            if (z9) {
                CamColor fromColor = CamColor.fromColor(i4);
                i4 = CamColor.toColor(fromColor.getHue(), fromColor.getChroma(), f11);
            }
