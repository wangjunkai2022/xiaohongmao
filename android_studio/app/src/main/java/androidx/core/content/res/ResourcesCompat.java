...
public final class ResourcesCompat {
    ...
    static class Api15Impl {
        ...
        @DoNotInline
        static Drawable getDrawableForDensity(Resources resources, int i4, int i10) {
            return resources.getDrawableForDensity(i4, i10);
        }
    }
    ...
    static class Api21Impl {
        ...
        @DoNotInline
        static Drawable getDrawableForDensity(Resources resources, int i4, int i10, Resources.Theme theme) {
            return resources.getDrawableForDensity(i4, i10, theme);
        }
    }
                ...
                synchronized (sRebaseMethodLock) {
                    if (!sRebaseMethodFetched) {
                        try {
                            ...
                            Log.i(ResourcesCompat.TAG, "Failed to retrieve rebase() method", e4);
                        }
                    ...
                    if (method != null) {
                        try {
                            ...
                            Log.i(ResourcesCompat.TAG, "Failed to invoke rebase() method via reflection", e10);
                            sRebaseMethod = null;
                        }
                    }
                }
    ...
    @Nullable
    public static Drawable getDrawableForDensity(@NonNull Resources resources, @DrawableRes int i4, int i10, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        return Api21Impl.getDrawableForDensity(resources, i4, i10, theme);
    }
    ...
    private static ColorStateList inflateColorStateList(Resources resources, int i4, @Nullable Resources.Theme theme) {
        ...
        try {
            ...
            Log.w(TAG, "Failed to inflate ColorStateList, leaving it to the framework", e4);
            return null;
        }
    }
    ...
    private static Typeface loadFont(@NonNull Context context, int i4, @NonNull TypedValue typedValue, int i10, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z9, boolean z10) {
        Resources resources = context.getResources();
        resources.getValue(i4, typedValue, true);
        Typeface loadFont = loadFont(context, resources, typedValue, i4, i10, fontCallback, handler, z9, z10);
    ...
    */
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static Typeface getFont(@NonNull Context context, @FontRes int i4, @NonNull TypedValue typedValue, int i10, @Nullable FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, i4, typedValue, i10, fontCallback, null, true, false);
    }
}
