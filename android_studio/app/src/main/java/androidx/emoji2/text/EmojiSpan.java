...
public abstract class EmojiSpan extends ReplacementSpan {
    ...
    public int getSize(@NonNull Paint paint, @SuppressLint({"UnknownNullness"}) CharSequence charSequence, int i4, int i10, @Nullable Paint.FontMetricsInt fontMetricsInt) {
