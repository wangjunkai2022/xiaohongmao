...
public final class ViewTreeOnBackPressedDispatcherOwner {
    @h
    @JvmName(name = "get")
    public static final OnBackPressedDispatcherOwner get(@g View view) {
    ...
    @JvmName(name = "set")
    public static final void set(@g View view, @g OnBackPressedDispatcherOwner onBackPressedDispatcherOwner) {
        Intrinsics.checkNotNullParameter(view, "<this>");
