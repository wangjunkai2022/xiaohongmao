...
public abstract class ActivityResultContract<I, O> {
    ...
    @g
    public abstract Intent createIntent(@g Context context, I i4);

    @h
    public SynchronousResult<O> getSynchronousResult(@g Context context, I i4) {
        Intrinsics.checkNotNullParameter(context, "context");
        return null;
    }

    public abstract O parseResult(int i4, @h Intent intent);
}
