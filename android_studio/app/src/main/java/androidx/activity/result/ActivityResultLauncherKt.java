...
public final class ActivityResultLauncherKt {
    public static final void launch(@g ActivityResultLauncher<Void> activityResultLauncher, @h ActivityOptionsCompat activityOptionsCompat) {
    ...
    public static final void launchUnit(@g ActivityResultLauncher<Unit> activityResultLauncher, @h ActivityOptionsCompat activityOptionsCompat) {
        Intrinsics.checkNotNullParameter(activityResultLauncher, "<this>");
