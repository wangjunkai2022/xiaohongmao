...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner {
    ...
    @JvmOverloads
    public ComponentDialog(@g Context context) {
        this(context, 0, 2, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    public /* synthetic */ ComponentDialog(Context context, int i4, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i10 & 2) != 0 ? 0 : i4);
    }
    ...
    public void addContentView(@g View view, @h ViewGroup.LayoutParams layoutParams) {
    ...
    @JvmOverloads
    public ComponentDialog(@g Context context, @StyleRes int i4) {
        super(context, i4);
        Intrinsics.checkNotNullParameter(context, "context");
    ...
    @Override // android.app.Dialog
    public void setContentView(@g View view, @h ViewGroup.LayoutParams layoutParams) {
        Intrinsics.checkNotNullParameter(view, "view");
        initViewTreeOwners();
