...
public class DBUtil {
    ...
    @NonNull
    @Deprecated
    public static Cursor query(RoomDatabase roomDatabase, SupportSQLiteQuery supportSQLiteQuery, boolean z9) {
        return query(roomDatabase, supportSQLiteQuery, z9, null);
    }
    ...
    @NonNull
    public static Cursor query(@NonNull RoomDatabase roomDatabase, @NonNull SupportSQLiteQuery supportSQLiteQuery, boolean z9, @Nullable CancellationSignal cancellationSignal) {
