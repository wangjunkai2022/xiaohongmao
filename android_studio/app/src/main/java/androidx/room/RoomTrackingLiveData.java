...
public class RoomTrackingLiveData<T> extends LiveData<T> {
            ...
            do {
                if (RoomTrackingLiveData.this.mComputing.compareAndSet(false, true)) {
                    ...
                    while (RoomTrackingLiveData.this.mInvalid.compareAndSet(true, false)) {
                        try {
                            try {
                                t9 = RoomTrackingLiveData.this.mComputeFunction.call();
                                z9 = true;
                            } catch (Exception e4) {
    ...
    public RoomTrackingLiveData(RoomDatabase roomDatabase, InvalidationLiveDataContainer invalidationLiveDataContainer, boolean z9, Callable<T> callable, String[] strArr) {
