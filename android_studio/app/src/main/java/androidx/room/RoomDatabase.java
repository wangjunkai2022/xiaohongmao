...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            if (this.mContext != null) {
                if (this.mDatabaseClass != null) {
                    ...
                    T t9 = (T) Room.getGeneratedImplementation(this.mDatabaseClass, RoomDatabase.DB_IMPL_SUFFIX);
        ...
        @NonNull
        @ExperimentalRoomApi
        public Builder<T> setAutoCloseTimeout(@IntRange(from = 0) long j4, @NonNull TimeUnit timeUnit) {
            if (j4 >= 0) {
                this.mAutoCloseTimeout = j4;
    ...
    public void init(@NonNull DatabaseConfiguration databaseConfiguration) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                if (i4 >= 0) {
                    this.mAutoMigrationSpecs.put(next, databaseConfiguration.autoMigrationSpecs.get(i4));
                } else {
    ...
    public static class MigrationContainer {
        ...
        */
        ...
        @Nullable
        public List<Migration> findMigrationPath(int i4, int i10) {
            if (i4 == i10) {
                return Collections.emptyList();
            }
            return findUpMigrationPath(new ArrayList(), i10 > i4, i4, i10);
        }
