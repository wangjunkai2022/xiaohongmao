...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void onActivityResult(int i4, int i10, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i4 + " resultCode: " + i10 + " data: " + intent);
        }
    }
    ...
    @Nullable
    @MainThread
    public Animation onCreateAnimation(int i4, boolean z9, int i10) {
        return null;
    }

    @Nullable
    @MainThread
    public Animator onCreateAnimator(int i4, boolean z9, int i10) {
        return null;
    }
    ...
    public boolean performCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        ...
        return z9 | this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater);
    }
    ...
    public boolean performPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        return z9 | this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setAnimations(@AnimRes int i4, @AnimRes int i10, @AnimRes int i11, @AnimRes int i12) {
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i4, @Nullable Intent intent, int i10, int i11, int i12, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost != null) {
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in startIntentSenderForResult() requestCode: " + i4 + " IntentSender: " + intentSender + " fillInIntent: " + intent + " options: " + bundle);
            }
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i4, intent, i10, i11, i12, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
