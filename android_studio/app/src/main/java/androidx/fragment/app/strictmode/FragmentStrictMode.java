...
public final class FragmentStrictMode {
    ...
    public interface OnViolationListener {
        void onViolation(@g Violation violation);
    }

    /* compiled from: FragmentStrictMode.kt */
    @Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010#\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u000b\u0018\u0000 \u00162\u00020\u0001:\u0002\u0015\u0016BA\b\u0000\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006\u0012 \u0010\u0007\u001a\u001c\u0012\u0004\u0012\u00020\t\u0012\u0012\u0012\u0010\u0012\f\u0012\n\u0012\u0006\b\u0001\u0012\u00020\f0\u000b0\n0\b¢\u0006\u0002\u0010\rR\u001a\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0016\u0010\u0005\u001a\u0004\u0018\u00010\u0006X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R.\u0010\u0012\u001a\u001c\u0012\u0004\u0012\u00020\t\u0012\u0012\u0012\u0010\u0012\f\u0012\n\u0012\u0006\b\u0001\u0012\u00020\f0\u000b0\u00030\bX\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0017"}, d2 = {"Landroidx/fragment/app/strictmode/FragmentStrictMode$Policy;", "", "flags", "", "Landroidx/fragment/app/strictmode/FragmentStrictMode$Flag;", x.a.f29212a, "Landroidx/fragment/app/strictmode/FragmentStrictMode$OnViolationListener;", "allowedViolations", "", "", "", "Ljava/lang/Class;", "Landroidx/fragment/app/strictmode/Violation;", "(Ljava/util/Set;Landroidx/fragment/app/strictmode/FragmentStrictMode$OnViolationListener;Ljava/util/Map;)V", "getFlags$fragment_release", "()Ljava/util/Set;", "getListener$fragment_release", "()Landroidx/fragment/app/strictmode/FragmentStrictMode$OnViolationListener;", "mAllowedViolations", "getMAllowedViolations$fragment_release", "()Ljava/util/Map;", "Builder", "Companion", "fragment_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* loaded from: classes.dex */
    public static final class Policy {
        ...
        public Policy(@g Set<? extends Flag> flags, @h OnViolationListener onViolationListener, @g Map<String, ? extends Set<Class<? extends Violation>>> allowedViolations) {
        ...
        public static final class Builder {
            ...
            public final Builder allowViolation(@g Class<? extends Fragment> fragmentClass, @g Class<? extends Violation> violationClass) {
            ...
            @g
            @SuppressLint({"BuilderSetStyle"})
            public final Builder penaltyListener(@g OnViolationListener listener) {
            ...
            @g
            @SuppressLint({"BuilderSetStyle"})
            public final Builder allowViolation(@g String fragmentClass, @g Class<? extends Violation> violationClass) {
                Intrinsics.checkNotNullParameter(fragmentClass, "fragmentClass");
                Intrinsics.checkNotNullParameter(violationClass, "violationClass");
    ...
    private final void handlePolicyViolation(final Policy policy, final Violation violation) {
        ...
        if (policy.getListener$fragment_release() != null) {
            runOnHostThread(fragment, new Runnable() { // from class: c.a
                ...
                public final void run() {
                    FragmentStrictMode.m20handlePolicyViolation$lambda0(FragmentStrictMode.Policy.this, violation);
                }
            });
        }
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new Runnable() { // from class: c.b
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentStrictMode.m21handlePolicyViolation$lambda1(name, violation);
                }
            });
        }
    }
    ...
    public static final void onFragmentReuse(@g Fragment fragment, @g String previousFragmentId) {
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onFragmentTagUsage(@g Fragment fragment, @h ViewGroup viewGroup) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onGetRetainInstanceUsage(@g Fragment fragment) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onGetTargetFragmentRequestCodeUsage(@g Fragment fragment) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onGetTargetFragmentUsage(@g Fragment fragment) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onSetRetainInstanceUsage(@g Fragment fragment) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onSetTargetFragmentUsage(@g Fragment violatingFragment, @g Fragment targetFragment, int i4) {
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onSetUserVisibleHint(@g Fragment fragment, boolean z9) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onWrongFragmentContainer(@g Fragment fragment, @g ViewGroup container) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @VisibleForTesting
    public final void onPolicyViolation(@g Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "violation");
    ...
    public final void setDefaultPolicy(@g Policy policy) {
