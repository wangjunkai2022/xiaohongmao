...
public abstract class SpecialEffectsController {
    ...
    abstract void executeOperations(@NonNull List<Operation> list, boolean z9);
    ...
    public static class Operation {
        ...
        public String toString() {
            return "Operation {" + Integer.toHexString(System.identityHashCode(this)) + "} {mFinalState = " + this.mFinalState + "} {mLifecycleImpact = " + this.mLifecycleImpact + "} {mFragment = " + this.mFragment + com.alipay.sdk.util.i.f6967d;
        }
