...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public Op(int i4, Fragment fragment, boolean z9) {
            this.mCmd = i4;
            this.mFragment = fragment;
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i4, @AnimRes @AnimatorRes int i10) {
        return setCustomAnimations(i4, i10, 0, 0);
    }
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i4, @AnimRes @AnimatorRes int i10, @AnimRes @AnimatorRes int i11, @AnimRes @AnimatorRes int i12) {
        this.mEnterAnim = i4;
        this.mExitAnim = i10;
