...
public final class FragmentContainerView extends FrameLayout {
    ...
    public static final class Api20Impl {
        ...
        @m8.g
        public final WindowInsets onApplyWindowInsets(@m8.g View.OnApplyWindowInsetsListener onApplyWindowInsetsListener, @m8.g View v9, @m8.g WindowInsets insets) {
    ...
    public FragmentContainerView(@m8.g Context context) {
        super(context);
    ...
    @JvmOverloads
    public FragmentContainerView(@m8.g Context context, @m8.h AttributeSet attributeSet) {
    ...
    public void addView(@m8.g View child, int i4, @m8.h ViewGroup.LayoutParams layoutParams) {
    ...
    @RequiresApi(20)
    @m8.g
    public WindowInsets dispatchApplyWindowInsets(@m8.g WindowInsets insets) {
    ...
    @Override // android.view.ViewGroup, android.view.View
    protected void dispatchDraw(@m8.g Canvas canvas) {
    ...
    @Override // android.view.ViewGroup
    protected boolean drawChild(@m8.g Canvas canvas, @m8.g View child, long j4) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(child, "child");
    ...
    @Override // android.view.ViewGroup
    public void endViewTransition(@m8.g View view) {
    ...
    @RequiresApi(20)
    @m8.g
    public WindowInsets onApplyWindowInsets(@m8.g WindowInsets insets) {
        Intrinsics.checkNotNullParameter(insets, "insets");
        return insets;
    }
    ...
    public void removeView(@m8.g View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        addDisappearingFragmentView(view);
    ...
    @Override // android.view.ViewGroup
    public void removeViewInLayout(@m8.g View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        addDisappearingFragmentView(view);
    ...
    @Override // android.view.ViewGroup
    public void removeViews(int i4, int i10) {
        int i11 = i4 + i10;
    ...
    @Override // android.view.ViewGroup
    public void removeViewsInLayout(int i4, int i10) {
        int i11 = i4 + i10;
        for (int i12 = i4; i12 < i11; i12++) {
            View view = getChildAt(i12);
            Intrinsics.checkNotNullExpressionValue(view, "view");
    ...
    @Override // android.view.ViewGroup
    public void setLayoutTransition(@m8.h LayoutTransition layoutTransition) {
        throw new UnsupportedOperationException("FragmentContainerView does not support Layout Transitions or animateLayoutChanges=\"true\".");
    }

    @Override // android.view.View
    public void setOnApplyWindowInsetsListener(@m8.g View.OnApplyWindowInsetsListener listener) {
        Intrinsics.checkNotNullParameter(listener, "listener");
        this.applyWindowInsetsListener = listener;
    }

    @Override // android.view.ViewGroup
    public void startViewTransition(@m8.g View view) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public /* synthetic */ FragmentContainerView(Context context, AttributeSet attributeSet, int i4, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, attributeSet, (i10 & 4) != 0 ? 0 : i4);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public FragmentContainerView(@m8.g Context context, @m8.h AttributeSet attributeSet, int i4) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FragmentContainerView(@m8.g Context context, @m8.g AttributeSet attrs, @m8.g FragmentManager fm) {
        super(context, attrs);
        String str;
        Intrinsics.checkNotNullParameter(context, "context");
