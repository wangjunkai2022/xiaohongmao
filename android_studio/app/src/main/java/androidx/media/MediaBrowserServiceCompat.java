...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        ConnectionRecord(String str, int i4, int i10, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            this.pkg = str;
            this.pid = i4;
            this.uid = i10;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, i4, i10);
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public MediaBrowserService.BrowserRoot onGetRoot(String str, int i4, Bundle bundle) {
                ...
                BrowserRoot onGetRoot = MediaBrowserServiceImplApi21.this.onGetRoot(str, i4, bundle == null ? null : new Bundle(bundle));
                if (onGetRoot == null) {
                    return null;
                }
        ...
        public BrowserRoot onGetRoot(String str, int i4, Bundle bundle) {
            Bundle bundle2;
            int i10;
            ...
            ConnectionRecord connectionRecord = new ConnectionRecord(str, i10, i4, bundle, null);
    ...
    public static class Result<T> {
        ...
        private void checkExtraFields(Bundle bundle) {
            if (bundle != null && bundle.containsKey(MediaBrowserCompat.f70g)) {
                float f10 = bundle.getFloat(MediaBrowserCompat.f70g);
    ...
    public static class ResultWrapper<T> {
        ...
        public void sendResult(T t9) {
            if (t9 instanceof List) {
                this.mResultFwk.sendResult(parcelListToItemList((List) t9));
            } else if (t9 instanceof Parcel) {
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(final String str, final int i4, final int i10, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i10)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str, i4, i10, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int i4, final int i10, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.6
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        connectionRecord = new ConnectionRecord(str, i4, i10, bundle, serviceCallbacks);
                    }
