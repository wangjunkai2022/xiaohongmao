...
public final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void dispatchScrolled(int i4, float f10, int i10) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageScrolled(i4, f10, i10);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void notifyProgrammaticScroll(int i4, boolean z9) {
        this.mAdapterState = z9 ? 2 : 3;
        this.mFakeDragging = false;
        boolean z10 = this.mTarget != i4;
        this.mTarget = i4;
        dispatchStateChanged(2);
        if (z10) {
            dispatchSelected(i4);
