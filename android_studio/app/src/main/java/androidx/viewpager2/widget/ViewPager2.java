...
public final class ViewPager2 extends ViewGroup {
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i4, float f10, @Px int i10) {
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        private void addCollectionInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (ViewPager2.this.getAdapter() == null) {
                ...
                i4 = 0;
                AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(i4, i10, false, 0));
            }
            i10 = 0;
            AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(i4, i10, false, 0));
        }
    ...
    protected void onMeasure(int i4, int i10) {
        measureChild(this.mRecyclerView, i4, i10);
        int measuredWidth = this.mRecyclerView.getMeasuredWidth();
        int measuredHeight = this.mRecyclerView.getMeasuredHeight();
        int measuredState = this.mRecyclerView.getMeasuredState();
        int paddingLeft = measuredWidth + getPaddingLeft() + getPaddingRight();
        int paddingTop = measuredHeight + getPaddingTop() + getPaddingBottom();
        setMeasuredDimension(ViewGroup.resolveSizeAndState(Math.max(paddingLeft, getSuggestedMinimumWidth()), i4, measuredState), ViewGroup.resolveSizeAndState(Math.max(paddingTop, getSuggestedMinimumHeight()), i10, measuredState << 16));
    }
    ...
    public void requestTransform() {
        ...
        float f10 = (float) (relativeScrollPosition - i4);
        this.mPageTransformerAdapter.onPageScrolled(i4, f10, Math.round(getPageSize() * f10));
    }
    ...
    void setCurrentItemInternal(int i4, boolean z9) {
        ...
        if (adapter == null) {
            ...
            this.mScrollEventAdapter.notifyProgrammaticScroll(min, z9);
            if (!z9) {
            ...
            if (Math.abs(d10 - d4) > 3.0d) {
                this.mRecyclerView.scrollToPosition(d10 > d4 ? min - 3 : min + 3);
                RecyclerView recyclerView = this.mRecyclerView;
    ...
    @RequiresApi(21)
    public ViewPager2(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i10) {
