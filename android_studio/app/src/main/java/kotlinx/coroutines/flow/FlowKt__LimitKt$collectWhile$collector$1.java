...
public final class FlowKt__LimitKt$collectWhile$collector$1 implements j<T> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function2<T, Continuation<? super Boolean>, Object> f85467a;
    ...
    public FlowKt__LimitKt$collectWhile$collector$1(Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        this.f85467a = function2;
    }

    @m8.h
    public Object a(T t9, @m8.g Continuation<? super Unit> continuation) {
        InlineMarker.mark(4);
        new FlowKt__LimitKt$collectWhile$collector$1$emit$1(this, continuation);
        InlineMarker.mark(5);
        if (((Boolean) this.f85467a.invoke(t9, continuation)).booleanValue()) {
    ...
    */
    public java.lang.Object emit(T r5, @m8.g kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L18:
            ...
            if (r2 == 0) goto L35
            if (r2 != r3) goto L2d
            java.lang.Object r5 = r0.f85468a
        ...
        L35:
            kotlin.ResultKt.throwOnFailure(r6)
            kotlin.jvm.functions.Function2<T, kotlin.coroutines.Continuation<? super java.lang.Boolean>, java.lang.Object> r6 = r4.f85467a
            r0.f85468a = r4
            r0.f85471d = r3
