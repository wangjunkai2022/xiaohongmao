...
public enum CoroutineStart {
    ...
    @e2
    public final <T> void invoke(@m8.g Function1<? super Continuation<? super T>, ? extends Object> function1, @m8.g Continuation<? super T> continuation) {
        int i4 = a.$EnumSwitchMapping$0[ordinal()];
        if (i4 == 1) {
            z7.a.d(function1, continuation);
        } else if (i4 == 2) {
            ContinuationKt.startCoroutine(function1, continuation);
        } else if (i4 == 3) {
            z7.b.a(function1, continuation);
        } else if (i4 != 4) {
    ...
    @e2
    public final <R, T> void invoke(@m8.g Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r9, @m8.g Continuation<? super T> continuation) {
        int i4 = a.$EnumSwitchMapping$0[ordinal()];
        if (i4 == 1) {
            z7.a.f(function2, r9, continuation, null, 4, null);
        } else if (i4 == 2) {
            ContinuationKt.startCoroutine(function2, r9, continuation);
        } else if (i4 == 3) {
            z7.b.b(function2, r9, continuation);
        } else if (i4 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    }
