...
final class DebugProbesImpl$dumpDebuggerInfo$$inlined$dumpCoroutinesInfoImpl$1 extends Lambda implements Function1<DebugProbesImpl.a<?>, DebuggerInfo> {
    ...
    @m8.h
    public final DebuggerInfo invoke(@m8.g DebugProbesImpl.a<?> aVar) {
        CoroutineContext c10;
        if (DebugProbesImpl.f85154a.y(aVar) || (c10 = aVar.f85167b.c()) == null) {
            return null;
        }
        return new DebuggerInfo(aVar.f85167b, c10);
    }
}
