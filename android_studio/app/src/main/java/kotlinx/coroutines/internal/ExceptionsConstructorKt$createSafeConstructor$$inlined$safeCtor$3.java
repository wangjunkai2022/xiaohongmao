...
public final class ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3 extends Lambda implements Function1<Throwable, Throwable> {
    ...
    public final Throwable invoke(@m8.g Throwable th) {
        ...
        try {
            ...
            newInstance = this.f86207a.newInstance(th.getMessage());
        } catch (Throwable th2) {
        ...
        if (newInstance != null) {
            ...
            th3.initCause(th);
            m70constructorimpl = Result.m70constructorimpl(th3);
