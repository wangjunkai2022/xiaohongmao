...
public final class g0 {
    ...
    static final class a extends Lambda implements Function1<Throwable, Unit> {
        ...
        final /* synthetic */ Function1<E, Unit> f86262a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ E f86263b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ CoroutineContext f86264c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Function1<? super E, Unit> function1, E e4, CoroutineContext coroutineContext) {
            super(1);
            this.f86262a = function1;
            this.f86263b = e4;
            this.f86264c = coroutineContext;
        }
        ...
        public final void invoke2(@m8.g Throwable th) {
            g0.b(this.f86262a, this.f86263b, this.f86264c);
        }
    }

    @m8.g
    public static final <E> Function1<Throwable, Unit> a(@m8.g Function1<? super E, Unit> function1, E e4, @m8.g CoroutineContext coroutineContext) {
        return new a(function1, e4, coroutineContext);
    }

    public static final <E> void b(@m8.g Function1<? super E, Unit> function1, E e4, @m8.g CoroutineContext coroutineContext) {
        UndeliveredElementException c10 = c(function1, e4, null);
        if (c10 == null) {
            return;
        }
        kotlinx.coroutines.p0.b(coroutineContext, c10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @m8.h
    public static final <E> UndeliveredElementException c(@m8.g Function1<? super E, Unit> function1, E e4, @m8.h UndeliveredElementException undeliveredElementException) {
        try {
            function1.invoke(e4);
        } catch (Throwable th) {
