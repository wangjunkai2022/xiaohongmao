...
public final class a {
    ...
    public static final void c(@g Continuation<? super Unit> continuation, @g Continuation<?> continuation2) {
        Continuation intercepted;
        try {
            intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation);
            Result.Companion companion = Result.Companion;
            m.g(intercepted, Result.m70constructorimpl(Unit.INSTANCE), null, 2, null);
        } catch (Throwable th) {
            a(continuation2, th);
        }
    }
    ...
    @e2
    public static final <T> void d(@g Function1<? super Continuation<? super T>, ? extends Object> function1, @g Continuation<? super T> continuation) {
    ...
    public static final <R, T> void e(@g Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r9, @g Continuation<? super T> continuation, @h Function1<? super Throwable, Unit> function1) {
        Continuation createCoroutineUnintercepted;
        Continuation intercepted;
        try {
            createCoroutineUnintercepted = IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted(function2, r9, continuation);
            intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(createCoroutineUnintercepted);
            Result.Companion companion = Result.Companion;
            m.f(intercepted, Result.m70constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable th) {
            a(continuation, th);
        }
    }
