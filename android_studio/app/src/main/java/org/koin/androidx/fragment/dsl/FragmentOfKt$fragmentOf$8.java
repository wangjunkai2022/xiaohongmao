...
public final class FragmentOfKt$fragmentOf$8 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function3<T1, T2, T3, R> f92191a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FragmentOfKt$fragmentOf$8(Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        super(2);
        this.f92191a = function3;
    }
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function3<T1, T2, T3, R> function3 = this.f92191a;
