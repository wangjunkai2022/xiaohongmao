...
public final class FragmentOfKt$fragmentOf$2 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function0<R> f92182a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FragmentOfKt$fragmentOf$2(Function0<? extends R> function0) {
        super(2);
        this.f92182a = function0;
    }
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        return (Fragment) this.f92182a.invoke();
    }
}
