...
public final class FragmentOfKt$fragmentOf$18 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f92180a;
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8 = this.f92180a;
