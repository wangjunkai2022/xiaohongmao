...
public final class ViewModelOfKt$viewModelOf$11 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function5<T1, T2, T3, T4, T5, R> f92267a;
    ...
    public final ViewModel invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function5<T1, T2, T3, T4, T5, R> function5 = this.f92267a;
