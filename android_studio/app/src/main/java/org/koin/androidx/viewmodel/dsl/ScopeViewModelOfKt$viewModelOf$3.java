...
public final class ScopeViewModelOfKt$viewModelOf$3 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function1<T1, R> f92258a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ScopeViewModelOfKt$viewModelOf$3(Function1<? super T1, ? extends R> function1) {
        super(2);
        this.f92258a = function1;
    }
    ...
    public final ViewModel invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function1<T1, R> function1 = this.f92258a;
