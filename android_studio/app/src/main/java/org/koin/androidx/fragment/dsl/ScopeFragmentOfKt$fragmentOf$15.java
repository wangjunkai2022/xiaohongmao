...
public final class ScopeFragmentOfKt$fragmentOf$15 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function7<T1, T2, T3, T4, T5, T6, T7, R> f92199a;
    ...
    public final Fragment invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function7<T1, T2, T3, T4, T5, T6, T7, R> function7 = this.f92199a;
        ...
        return (Fragment) function7.invoke(p9, p10, p11, p12, p13, p14, _factoryInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
