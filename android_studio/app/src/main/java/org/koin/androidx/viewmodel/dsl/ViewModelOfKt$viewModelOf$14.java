...
public final class ViewModelOfKt$viewModelOf$14 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function6<T1, T2, T3, T4, T5, T6, R> f92270a;
    ...
    public final ViewModel invoke(@g Scope viewModel, @g a it) {
        ...
        Function6<T1, T2, T3, T4, T5, T6, R> function6 = this.f92270a;
