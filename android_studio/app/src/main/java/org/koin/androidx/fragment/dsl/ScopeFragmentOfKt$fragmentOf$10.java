...
public final class ScopeFragmentOfKt$fragmentOf$10 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function4<T1, T2, T3, T4, R> f92194a;
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function4<T1, T2, T3, T4, R> function4 = this.f92194a;
        ...
        return (Fragment) function4.invoke(p9, p10, p11, fragment.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
