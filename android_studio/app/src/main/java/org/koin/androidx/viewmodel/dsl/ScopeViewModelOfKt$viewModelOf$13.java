...
public final class ScopeViewModelOfKt$viewModelOf$13 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function6<T1, T2, T3, T4, T5, T6, R> f92247a;
    ...
    public final ViewModel invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function6<T1, T2, T3, T4, T5, T6, R> function6 = this.f92247a;
        ...
        return (ViewModel) function6.invoke(p9, p10, p11, p12, p13, _factoryInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
