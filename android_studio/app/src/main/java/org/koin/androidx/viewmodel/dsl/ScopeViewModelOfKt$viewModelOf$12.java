...
public final class ScopeViewModelOfKt$viewModelOf$12 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function5<T1, T2, T3, T4, T5, R> f92246a;
    ...
    public final ViewModel invoke(@g Scope viewModel, @g a it) {
        ...
        Function5<T1, T2, T3, T4, T5, R> function5 = this.f92246a;
