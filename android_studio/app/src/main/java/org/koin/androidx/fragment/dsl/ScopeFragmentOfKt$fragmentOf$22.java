...
public final class ScopeFragmentOfKt$fragmentOf$22 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> f92207a;
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> function10 = this.f92207a;
        ...
        Object p17 = fragment.p(Reflection.getOrCreateKotlinClass(Object.class), null, null);
        Intrinsics.reifiedOperationMarker(4, "T10");
        return (Fragment) function10.invoke(p9, p10, p11, p12, p13, p14, p15, p16, p17, fragment.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
