...
public final class ViewModelOfKt$viewModelOf$22 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> f92279a;
    ...
    public final ViewModel invoke(@g Scope viewModel, @g a it) {
        ...
        Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> function10 = this.f92279a;
