...
public final class FragmentVMKt {
    public static final /* synthetic */ <T extends ViewModel> T a(Fragment fragment, z8.a aVar, Function0<? extends ViewModelStoreOwner> owner, Function0<? extends y8.a> function0) {
        ...
        FragmentVMKt$getViewModel$$inlined$viewModel$1 fragmentVMKt$getViewModel$$inlined$viewModel$1 = new FragmentVMKt$getViewModel$$inlined$viewModel$1(owner, aVar, function0, a10);
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
        return (T) FragmentViewModelLazyKt.createViewModelLazy(fragment, Reflection.getOrCreateKotlinClass(ViewModel.class), new FragmentVMKt$viewModel$$inlined$viewModels$1(owner), fragmentVMKt$getViewModel$$inlined$viewModel$1).getValue();
    }
    ...
    public static /* synthetic */ ViewModel b(Fragment fragment, z8.a aVar, Function0 owner, Function0 function0, int i4, Object obj) {
        ...
        if ((i4 & 2) != 0) {
            owner = new FragmentVMKt$getViewModel$1(fragment);
        }
        if ((i4 & 4) != 0) {
            function0 = null;
        }
        ...
        FragmentVMKt$getViewModel$$inlined$viewModel$1 fragmentVMKt$getViewModel$$inlined$viewModel$1 = new FragmentVMKt$getViewModel$$inlined$viewModel$1(owner, aVar, function0, a10);
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
        return (ViewModel) FragmentViewModelLazyKt.createViewModelLazy(fragment, Reflection.getOrCreateKotlinClass(ViewModel.class), new FragmentVMKt$viewModel$$inlined$viewModels$1(owner), fragmentVMKt$getViewModel$$inlined$viewModel$1).getValue();
    }
    ...
    public static final /* synthetic */ <T extends ViewModel> Lazy<T> c(Fragment fragment, z8.a aVar, Function0<? extends ViewModelStoreOwner> owner, Function0<? extends y8.a> function0) {
        ...
        Scope a10 = org.koin.android.ext.android.a.a(fragment);
        Intrinsics.needClassReification();
        FragmentVMKt$viewModel$2 fragmentVMKt$viewModel$2 = new FragmentVMKt$viewModel$2(owner, aVar, function0, a10);
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
        return FragmentViewModelLazyKt.createViewModelLazy(fragment, Reflection.getOrCreateKotlinClass(ViewModel.class), new FragmentVMKt$viewModel$$inlined$viewModels$1(owner), fragmentVMKt$viewModel$2);
    }
    ...
    public static /* synthetic */ Lazy d(Fragment fragment, z8.a aVar, Function0 owner, Function0 function0, int i4, Object obj) {
        ...
        if ((i4 & 2) != 0) {
            owner = new FragmentVMKt$viewModel$1(fragment);
        }
        if ((i4 & 4) != 0) {
            function0 = null;
        }
