...
public final class ViewModelOfKt$viewModelOf$15 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function7<T1, T2, T3, T4, T5, T6, T7, R> f92271a;
    ...
    public final ViewModel invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function7<T1, T2, T3, T4, T5, T6, T7, R> function7 = this.f92271a;
