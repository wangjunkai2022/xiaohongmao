...
public final class ViewModelOfKt$viewModelOf$10 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function4<T1, T2, T3, T4, R> f92266a;
    ...
    public final ViewModel invoke(@g Scope viewModel, @g a it) {
        ...
        Function4<T1, T2, T3, T4, R> function4 = this.f92266a;
