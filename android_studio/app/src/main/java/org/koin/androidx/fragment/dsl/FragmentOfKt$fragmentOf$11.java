...
public final class FragmentOfKt$fragmentOf$11 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function5<T1, T2, T3, T4, T5, R> f92173a;
    ...
    public final Fragment invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function5<T1, T2, T3, T4, T5, R> function5 = this.f92173a;
