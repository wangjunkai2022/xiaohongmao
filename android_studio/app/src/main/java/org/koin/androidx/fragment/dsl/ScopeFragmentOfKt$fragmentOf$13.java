...
public final class ScopeFragmentOfKt$fragmentOf$13 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function6<T1, T2, T3, T4, T5, T6, R> f92197a;
    ...
    public final Fragment invoke(@g Scope _factoryInstanceFactory, @g a it) {
        ...
        Function6<T1, T2, T3, T4, T5, T6, R> function6 = this.f92197a;
