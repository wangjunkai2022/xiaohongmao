...
public final class ScopeViewModelOfKt$viewModelOf$20 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f92255a;
    ...
    public final ViewModel invoke(@g Scope viewModel, @g a it) {
        ...
        Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9 = this.f92255a;
        ...
        return (ViewModel) function9.invoke(p9, p10, p11, p12, p13, p14, p15, p16, viewModel.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
