...
public final class ScopeFragmentOfKt$fragmentOf$6 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function2<T1, T2, R> f92211a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ScopeFragmentOfKt$fragmentOf$6(Function2<? super T1, ? super T2, ? extends R> function2) {
        super(2);
        this.f92211a = function2;
    }
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function2<T1, T2, R> function2 = this.f92211a;
