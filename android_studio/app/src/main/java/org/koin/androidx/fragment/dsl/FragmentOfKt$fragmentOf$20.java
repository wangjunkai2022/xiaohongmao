...
public final class FragmentOfKt$fragmentOf$20 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f92183a;
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9 = this.f92183a;
