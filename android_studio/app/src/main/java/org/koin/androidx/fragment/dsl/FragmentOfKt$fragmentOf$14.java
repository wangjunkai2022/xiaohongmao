...
public final class FragmentOfKt$fragmentOf$14 extends Lambda implements Function2<Scope, a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function6<T1, T2, T3, T4, T5, T6, R> f92176a;
    ...
    public final Fragment invoke(@g Scope fragment, @g a it) {
        ...
        Function6<T1, T2, T3, T4, T5, T6, R> function6 = this.f92176a;
