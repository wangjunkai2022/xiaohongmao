...
public final class FactoryOfKt$factoryOf$7 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function3<T1, T2, T3, R> f92467a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FactoryOfKt$factoryOf$7(Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        super(2);
        this.f92467a = function3;
    }
    ...
    public final R invoke(@g Scope _factoryInstanceFactory, @g y8.a it) {
        ...
        Function3<T1, T2, T3, R> function3 = this.f92467a;
        ...
        return function3.invoke(p9, p10, _factoryInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
