...
public final class InstanceRegistry$declareScopedInstance$def$1 extends Lambda implements Function2<Scope, y8.a, T> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ T f92518a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InstanceRegistry$declareScopedInstance$def$1(T t9) {
        super(2);
        this.f92518a = t9;
    }
