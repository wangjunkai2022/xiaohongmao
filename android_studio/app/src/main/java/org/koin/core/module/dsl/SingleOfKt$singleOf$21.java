...
public final class SingleOfKt$singleOf$21 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> f92505a;
    ...
    public final R invoke(@g Scope _singleInstanceFactory, @g y8.a it) {
        ...
        Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> function10 = this.f92505a;
        ...
        Object p15 = _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null);
        Intrinsics.reifiedOperationMarker(4, "T8");
        Object p16 = _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null);
        Intrinsics.reifiedOperationMarker(4, "T9");
        Object p17 = _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null);
        Intrinsics.reifiedOperationMarker(4, "T10");
        return function10.invoke(p9, p10, p11, p12, p13, p14, p15, p16, p17, _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
