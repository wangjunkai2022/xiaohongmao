...
public final class ScopedOfKt$scopedOf$11 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function5<T1, T2, T3, T4, T5, R> f92472a;
    ...
    public final R invoke(@g Scope _scopedInstanceFactory, @g y8.a it) {
        ...
        Function5<T1, T2, T3, T4, T5, R> function5 = this.f92472a;
        ...
        return function5.invoke(p9, p10, p11, p12, _scopedInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
