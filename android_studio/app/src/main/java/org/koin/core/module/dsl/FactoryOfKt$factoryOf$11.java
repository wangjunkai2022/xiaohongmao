...
public final class FactoryOfKt$factoryOf$11 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function5<T1, T2, T3, T4, T5, R> f92450a;
    ...
    public final R invoke(@g Scope _factoryInstanceFactory, @g y8.a it) {
        ...
        Function5<T1, T2, T3, T4, T5, R> function5 = this.f92450a;
        ...
        return function5.invoke(p9, p10, p11, p12, _factoryInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
