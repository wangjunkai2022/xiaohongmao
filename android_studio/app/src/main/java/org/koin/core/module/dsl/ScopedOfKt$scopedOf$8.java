...
public final class ScopedOfKt$scopedOf$8 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function3<T1, T2, T3, R> f92490a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ScopedOfKt$scopedOf$8(Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        super(2);
        this.f92490a = function3;
    }
    ...
    public final R invoke(@g Scope scoped, @g y8.a it) {
        ...
        Function3<T1, T2, T3, R> function3 = this.f92490a;
        ...
        return function3.invoke(p9, p10, scoped.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
