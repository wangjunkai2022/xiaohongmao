...
public final class SingleOfKt$singleOf$18 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f92501a;
    ...
    public final R invoke(@g Scope single, @g y8.a it) {
        ...
        Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8 = this.f92501a;
        ...
        return function8.invoke(p9, p10, p11, p12, p13, p14, p15, single.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
