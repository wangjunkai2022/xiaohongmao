...
public final class ScopedOfKt$scopedOf$10 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function4<T1, T2, T3, T4, R> f92471a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ScopedOfKt$scopedOf$10(Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> function4) {
        super(2);
        this.f92471a = function4;
    }
    ...
    public final R invoke(@g Scope scoped, @g y8.a it) {
        ...
        Function4<T1, T2, T3, T4, R> function4 = this.f92471a;
        ...
        return function4.invoke(p9, p10, p11, scoped.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
