...
public final class ScopedOfKt$scopedOf$16 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function7<T1, T2, T3, T4, T5, T6, T7, R> f92477a;
    ...
    public final R invoke(@g Scope scoped, @g y8.a it) {
        ...
        Function7<T1, T2, T3, T4, T5, T6, T7, R> function7 = this.f92477a;
        ...
        return function7.invoke(p9, p10, p11, p12, p13, p14, scoped.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
