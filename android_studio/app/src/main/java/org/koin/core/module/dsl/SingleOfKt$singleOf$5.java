...
public final class SingleOfKt$singleOf$5 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function2<T1, T2, R> f92509a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SingleOfKt$singleOf$5(Function2<? super T1, ? super T2, ? extends R> function2) {
        super(2);
        this.f92509a = function2;
    }
    ...
    public final R invoke(@g Scope _singleInstanceFactory, @g y8.a it) {
        ...
        Function2<T1, T2, R> function2 = this.f92509a;
        Intrinsics.reifiedOperationMarker(4, "T1");
        Object p9 = _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null);
        Intrinsics.reifiedOperationMarker(4, "T2");
        return function2.invoke(p9, _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
