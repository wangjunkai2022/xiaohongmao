...
public final class SingleOfKt$singleOf$11 extends Lambda implements Function2<Scope, y8.a, R> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function5<T1, T2, T3, T4, T5, R> f92494a;
    ...
    public final R invoke(@g Scope _singleInstanceFactory, @g y8.a it) {
        ...
        Function5<T1, T2, T3, T4, T5, R> function5 = this.f92494a;
        ...
        return function5.invoke(p9, p10, p11, p12, _singleInstanceFactory.p(Reflection.getOrCreateKotlinClass(Object.class), null, null));
    }
}
