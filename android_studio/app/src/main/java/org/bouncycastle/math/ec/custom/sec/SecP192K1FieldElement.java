...
public class SecP192K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f91439x;

    public SecP192K1FieldElement() {
        this.f91439x = Nat192.create();
    }
    ...
    public SecP192K1FieldElement(BigInteger bigInteger) {
        ...
        this.f91439x = SecP192K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP192K1Field.add(this.f91439x, ((SecP192K1FieldElement) eCFieldElement).f91439x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat192.create();
        SecP192K1Field.addOne(this.f91439x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.inv(((SecP192K1FieldElement) eCFieldElement).f91439x, create);
        SecP192K1Field.multiply(create, this.f91439x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP192K1FieldElement) {
            return Nat192.eq(this.f91439x, ((SecP192K1FieldElement) obj).f91439x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f91439x, 0, 6);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat192.create();
        SecP192K1Field.inv(this.f91439x, create);
        return new SecP192K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat192.isOne(this.f91439x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat192.isZero(this.f91439x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.multiply(this.f91439x, ((SecP192K1FieldElement) eCFieldElement).f91439x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat192.create();
        SecP192K1Field.negate(this.f91439x, create);
        return new SecP192K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f91439x;
    ...
    public ECFieldElement square() {
        int[] create = Nat192.create();
        SecP192K1Field.square(this.f91439x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.subtract(this.f91439x, ((SecP192K1FieldElement) eCFieldElement).f91439x, create);
        return new SecP192K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat192.getBit(this.f91439x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f91439x);
    }
}
