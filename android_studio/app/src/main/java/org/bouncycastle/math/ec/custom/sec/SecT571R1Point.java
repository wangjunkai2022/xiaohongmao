...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f91423x;
        ...
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) this.f91424y;
        ...
        long[] precompMultiplicand = secT571FieldElement7.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement7.f91462x);
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement5.f91462x;
            jArr2 = secT571FieldElement8.f91462x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement5.f91462x, precompMultiplicand, create642);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f91462x, precompMultiplicand, create644);
            jArr = create642;
            jArr2 = create644;
        }
        long[] precompMultiplicand2 = secT571FieldElement9.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement9.f91462x);
        long[] jArr4 = secT571FieldElement4.f91462x;
        if (precompMultiplicand2 == null) {
            jArr3 = secT571FieldElement6.f91462x;
        } else {
            SecT571Field.multiplyPrecomp(jArr4, precompMultiplicand2, create64);
            SecT571Field.multiplyPrecomp(secT571FieldElement6.f91462x, precompMultiplicand2, create643);
            jArr4 = create64;
            jArr3 = create643;
        }
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(create64, create642, secT571FieldElement11.f91462x);
            ...
            SecT571Field.multiplyPrecomp(create644, precompMultiplicand3, secT571FieldElement12.f91462x);
            if (precompMultiplicand2 != null) {
                long[] jArr5 = secT571FieldElement12.f91462x;
            ...
            SecT571Field.add(secT571FieldElement6.f91462x, secT571FieldElement7.f91462x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement12.f91462x, createExt64);
            SecT571FieldElement secT571FieldElement13 = new SecT571FieldElement(create644);
            SecT571Field.reduce(createExt64, secT571FieldElement13.f91462x);
            if (precompMultiplicand != null) {
                long[] jArr6 = secT571FieldElement12.f91462x;
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecT571FieldElement secT571FieldElement = (SecT571FieldElement) this.f91423x;
        if (secT571FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement) this.f91424y;
        SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement) this.zs[0];
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] precompMultiplicand = secT571FieldElement3.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement3.f91462x);
        long[] jArr2 = secT571FieldElement2.f91462x;
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement3.f91462x;
        } else {
            SecT571Field.multiplyPrecomp(jArr2, precompMultiplicand, create64);
            SecT571Field.square(secT571FieldElement3.f91462x, create642);
            jArr2 = create64;
            jArr = create642;
        }
        long[] create643 = Nat576.create64();
        SecT571Field.square(secT571FieldElement2.f91462x, create643);
        ...
        SecT571Field.square(create643, secT571FieldElement4.f91462x);
        SecT571FieldElement secT571FieldElement5 = new SecT571FieldElement(create643);
        if (precompMultiplicand != null) {
            long[] jArr3 = secT571FieldElement5.f91462x;
            SecT571Field.multiply(jArr3, jArr, jArr3);
        }
        long[] jArr4 = secT571FieldElement.f91462x;
        if (precompMultiplicand != null) {
        ...
        SecT571Field.addBothTo(secT571FieldElement4.f91462x, secT571FieldElement5.f91462x, create642);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f91424y;
        ...
        long[] create643 = Nat576.create64();
        long[] create644 = Nat576.create64();
        SecT571Field.square(secT571FieldElement.f91462x, create64);
        SecT571Field.square(secT571FieldElement4.f91462x, create642);
        SecT571Field.square(secT571FieldElement5.f91462x, create643);
        SecT571Field.multiply(secT571FieldElement4.f91462x, secT571FieldElement5.f91462x, create644);
        SecT571Field.addBothTo(create643, create642, create644);
        long[] precompMultiplicand = SecT571Field.precompMultiplicand(create643);
        SecT571Field.multiplyPrecomp(secT571FieldElement6.f91462x, precompMultiplicand, create643);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement2.f91462x, precompMultiplicand, create64);
        ...
        if (Nat576.isZero64(create642)) {
            ...
            SecT571Field.square(create643, secT571FieldElement7.f91462x);
            long[] jArr = secT571FieldElement7.f91462x;
            SecT571Field.multiply(jArr, create64, jArr);
            SecT571FieldElement secT571FieldElement8 = new SecT571FieldElement(create64);
            SecT571Field.multiply(create643, create642, secT571FieldElement8.f91462x);
            long[] jArr2 = secT571FieldElement8.f91462x;
            ...
            SecT571Field.add(create643, create642, secT571FieldElement9.f91462x);
            long[] jArr3 = secT571FieldElement9.f91462x;
            SecT571Field.square(jArr3, jArr3);
            Nat.zero64(18, createExt64);
            SecT571Field.multiplyAddToExt(secT571FieldElement9.f91462x, create644, createExt64);
            SecT571Field.addOne(secT571FieldElement6.f91462x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement8.f91462x, createExt64);
            SecT571Field.reduce(createExt64, secT571FieldElement9.f91462x);
