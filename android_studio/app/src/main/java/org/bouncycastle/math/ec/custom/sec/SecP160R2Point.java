...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f91423x, this.f91424y.negate(), this.zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] create2 = Nat160.create();
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f91437x, create3);
        int[] create4 = Nat160.create();
        SecP160R2Field.square(create3, create4);
        boolean isOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f91437x;
        if (!isOne) {
            SecP160R2Field.square(iArr, create2);
            iArr = create2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f91437x, iArr, create);
        SecP160R2Field.add(secP160R2FieldElement2.f91437x, iArr, create2);
        ...
        SecP160R2Field.square(create2, secP160R2FieldElement4.f91437x);
        int[] iArr2 = secP160R2FieldElement4.f91437x;
        SecP160R2Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP160R2FieldElement4.f91437x;
        ...
        SecP160R2Field.subtract(create3, secP160R2FieldElement4.f91437x, secP160R2FieldElement5.f91437x);
        int[] iArr4 = secP160R2FieldElement5.f91437x;
        SecP160R2Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP160R2FieldElement5.f91437x;
        ...
        if (!isOne) {
            int[] iArr6 = secP160R2FieldElement6.f91437x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement3.f91437x, iArr6);
        }
