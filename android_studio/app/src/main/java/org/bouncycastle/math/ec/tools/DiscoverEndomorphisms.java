...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger[] extEuclidBezout(BigInteger[] bigIntegerArr) {
        boolean z9 = bigIntegerArr[0].compareTo(bigIntegerArr[1]) < 0;
        if (z9) {
            swap(bigIntegerArr);
        }
    ...
    private static boolean isShorter(BigInteger[] bigIntegerArr, BigInteger[] bigIntegerArr2) {
        ...
        boolean z9 = abs.compareTo(abs3) < 0;
        return z9 == (abs2.compareTo(abs4) < 0) ? z9 : abs.multiply(abs).add(abs2.multiply(abs2)).compareTo(abs3.multiply(abs3).add(abs4.multiply(abs4))) < 0;
    }
    ...
    private static void printGLVTypeAParameters(X9ECParameters x9ECParameters) {
        BigInteger n9 = x9ECParameters.getN();
        BigInteger bigInteger = ECConstants.ONE;
        BigInteger[] solveQuadraticEquation = solveQuadraticEquation(n9, bigInteger, ECConstants.ZERO, bigInteger);
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters) {
        BigInteger n9 = x9ECParameters.getN();
        BigInteger bigInteger = ECConstants.ONE;
        BigInteger[] solveQuadraticEquation = solveQuadraticEquation(n9, bigInteger, bigInteger, bigInteger);
    ...
    private static BigInteger roundQuotient(BigInteger bigInteger, BigInteger bigInteger2) {
        boolean z9 = bigInteger.signum() != bigInteger2.signum();
        BigInteger abs = bigInteger.abs();
        BigInteger abs2 = bigInteger2.abs();
        BigInteger divide = abs.add(abs2.shiftRight(1)).divide(abs2);
        return z9 ? divide.negate() : divide;
    }
