...
public class LongArray implements Cloneable {
    ...
    public LongArray(long[] jArr, int i4, int i10) {
        if (i4 == 0 && i10 == jArr.length) {
            this.m_ints = jArr;
            return;
        }
    ...
    private static void add(long[] jArr, int i4, long[] jArr2, int i10, int i11) {
    ...
    private static void add(long[] jArr, int i4, long[] jArr2, int i10, long[] jArr3, int i11, int i12) {
        for (int i13 = 0; i13 < i12; i13++) {
            jArr3[i11 + i13] = jArr[i4 + i13] ^ jArr2[i10 + i13];
        }
    }

    private static void addBoth(long[] jArr, int i4, long[] jArr2, int i10, long[] jArr3, int i11, int i12) {
        for (int i13 = 0; i13 < i12; i13++) {
            int i14 = i4 + i13;
    ...
    private void addShiftedByBitsSafe(LongArray longArray, int i4, int i10) {
        int i11 = (i4 + 63) >>> 6;
        int i12 = i10 >>> 6;
        int i13 = i10 & 63;
        if (i13 == 0) {
    ...
    private static long addShiftedDown(long[] jArr, int i4, long[] jArr2, int i10, int i11, int i12) {
        int i13 = 64 - i12;
        long j4 = 0;
        while (true) {
            i11--;
            ...
            long j10 = jArr2[i10 + i11];
            int i14 = i4 + i11;
            jArr[i14] = (j4 | (j10 >>> i12)) ^ jArr[i14];
            j4 = j10 << i13;
        }
    }

    private static long addShiftedUp(long[] jArr, int i4, long[] jArr2, int i10, int i11, int i12) {
        int i13 = 64 - i12;
        long j4 = 0;
        for (int i14 = 0; i14 < i11; i14++) {
            long j10 = jArr2[i10 + i14];
            int i15 = i4 + i14;
            jArr[i15] = (j4 | (j10 << i12)) ^ jArr[i15];
            j4 = j10 >>> i13;
        }
        return j4;
    }

    private static int bitLength(long j4) {
        int i4;
        int i10 = 32;
        int i11 = (int) (j4 >>> 32);
        if (i11 == 0) {
        ...
        if (i12 == 0) {
            int i13 = i11 >>> 8;
            i4 = i13 == 0 ? bitLengths[i11] : bitLengths[i13] + 8;
        } else {
            int i14 = i12 >>> 8;
            i4 = i14 == 0 ? bitLengths[i12] + 16 : bitLengths[i14] + c.B;
        }
        return i10 + i4;
    }

    private int degreeFrom(int i4) {
        int i10 = (i4 + 62) >>> 6;
        while (i10 != 0) {
            i10--;
            long j4 = this.m_ints[i10];
            if (j4 != 0) {
                return (i10 << 6) + bitLength(j4);
            }
        }
        return 0;
    }

    private static void distribute(long[] jArr, int i4, int i10, int i11, int i12) {
        for (int i13 = 0; i13 < i12; i13++) {
            long j4 = jArr[i4 + i13];
            int i14 = i10 + i13;
            jArr[i14] = jArr[i14] ^ j4;
            int i15 = i11 + i13;
            jArr[i15] = j4 ^ jArr[i15];
        }
    }

    private static void flipBit(long[] jArr, int i4, int i10) {
        int i11 = i4 + (i10 >>> 6);
        jArr[i11] = jArr[i11] ^ (1 << (i10 & 63));
    }

    private static void flipVector(long[] jArr, int i4, long[] jArr2, int i10, int i11, int i12) {
        int i13 = i4 + (i12 >>> 6);
        int i14 = i12 & 63;
        if (i14 == 0) {
    ...
    private static void flipWord(long[] jArr, int i4, int i10, long j4) {
        int i11 = i4 + (i10 >>> 6);
        int i12 = i10 & 63;
        if (i12 == 0) {
        ...
        jArr[i11] = jArr[i11] ^ (j4 << i12);
        long j10 = j4 >>> (64 - i12);
        if (j10 != 0) {
            int i13 = i11 + 1;
            jArr[i13] = j10 ^ jArr[i13];
        }
    }

    private static void interleave(long[] jArr, int i4, long[] jArr2, int i10, int i11, int i12) {
        if (i12 == 3) {
            interleave3(jArr, i4, jArr2, i10, i11);
        } else if (i12 == 5) {
            interleave5(jArr, i4, jArr2, i10, i11);
        } else if (i12 != 7) {
            interleave2_n(jArr, i4, jArr2, i10, i11, bitLengths[i12] - 1);
        } else {
            interleave7(jArr, i4, jArr2, i10, i11);
        }
    }

    private static long interleave2_32to64(int i4) {
        short[] sArr = INTERLEAVE2_TABLE;
        int i10 = sArr[i4 & 255] | (sArr[(i4 >>> 8) & 255] << 16);
        short s9 = sArr[(i4 >>> 16) & 255];
        return (i10 & 4294967295L) | ((((sArr[i4 >>> 24] << 16) | s9) & 4294967295L) << 32);
    }

    private static long interleave2_n(long j4, int i4) {
        while (i4 > 1) {
            i4 -= 2;
            j4 = (interleave4_16to64(((int) (j4 >>> 48)) & 65535) << 3) | (interleave4_16to64(((int) (j4 >>> 16)) & 65535) << 1) | interleave4_16to64(((int) j4) & 65535) | (interleave4_16to64(((int) (j4 >>> 32)) & 65535) << 2);
        }
        if (i4 > 0) {
            return (interleave2_32to64((int) (j4 >>> 32)) << 1) | interleave2_32to64((int) j4);
        }
        return j4;
    }

    private static void interleave2_n(long[] jArr, int i4, long[] jArr2, int i10, int i11, int i12) {
        for (int i13 = 0; i13 < i11; i13++) {
            jArr2[i10 + i13] = interleave2_n(jArr[i4 + i13], i12);
        }
    }

    private static long interleave3(long j4) {
        return (interleave3_21to63(((int) (j4 >>> 42)) & 2097151) << 2) | (Long.MIN_VALUE & j4) | interleave3_21to63(((int) j4) & 2097151) | (interleave3_21to63(((int) (j4 >>> 21)) & 2097151) << 1);
    }

    private static void interleave3(long[] jArr, int i4, long[] jArr2, int i10, int i11) {
        for (int i12 = 0; i12 < i11; i12++) {
            jArr2[i10 + i12] = interleave3(jArr[i4 + i12]);
        }
    }

    private static long interleave3_13to65(int i4) {
        int[] iArr = INTERLEAVE5_TABLE;
        return (iArr[i4 & 127] & 4294967295L) | ((iArr[i4 >>> 7] & 4294967295L) << 35);
    }

    private static long interleave3_21to63(int i4) {
        int[] iArr = INTERLEAVE3_TABLE;
        int i10 = iArr[i4 & 127];
        int i11 = iArr[(i4 >>> 7) & 127];
        return (i10 & 4294967295L) | ((iArr[i4 >>> 14] & 4294967295L) << 42) | ((i11 & 4294967295L) << 21);
    }

    private static long interleave4_16to64(int i4) {
        int[] iArr = INTERLEAVE4_TABLE;
        return (iArr[i4 & 255] & 4294967295L) | ((iArr[i4 >>> 8] & 4294967295L) << 32);
    }

    private static long interleave5(long j4) {
        return (interleave3_13to65(((int) (j4 >>> 52)) & 8191) << 4) | interleave3_13to65(((int) j4) & 8191) | (interleave3_13to65(((int) (j4 >>> 13)) & 8191) << 1) | (interleave3_13to65(((int) (j4 >>> 26)) & 8191) << 2) | (interleave3_13to65(((int) (j4 >>> 39)) & 8191) << 3);
    }

    private static void interleave5(long[] jArr, int i4, long[] jArr2, int i10, int i11) {
        for (int i12 = 0; i12 < i11; i12++) {
            jArr2[i10 + i12] = interleave5(jArr[i4 + i12]);
        }
    }

    private static long interleave7(long j4) {
        long[] jArr = INTERLEAVE7_TABLE;
        return (jArr[((int) (j4 >>> 54)) & FrameMetricsAggregator.EVERY_DURATION] << 6) | (Long.MIN_VALUE & j4) | jArr[((int) j4) & FrameMetricsAggregator.EVERY_DURATION] | (jArr[((int) (j4 >>> 9)) & FrameMetricsAggregator.EVERY_DURATION] << 1) | (jArr[((int) (j4 >>> 18)) & FrameMetricsAggregator.EVERY_DURATION] << 2) | (jArr[((int) (j4 >>> 27)) & FrameMetricsAggregator.EVERY_DURATION] << 3) | (jArr[((int) (j4 >>> 36)) & FrameMetricsAggregator.EVERY_DURATION] << 4) | (jArr[((int) (j4 >>> 45)) & FrameMetricsAggregator.EVERY_DURATION] << 5);
    }

    private static void interleave7(long[] jArr, int i4, long[] jArr2, int i10, int i11) {
        for (int i12 = 0; i12 < i11; i12++) {
            jArr2[i10 + i12] = interleave7(jArr[i4 + i12]);
        }
    }

    private static void multiplyWord(long j4, long[] jArr, int i4, long[] jArr2, int i10) {
        if ((j4 & 1) != 0) {
            add(jArr2, i10, jArr, 0, i4);
        }
        int i11 = 1;
        long j10 = j4;
        while (true) {
            ...
            if ((j11 & 1) != 0) {
                long addShiftedUp = addShiftedUp(jArr2, i10, jArr, 0, i4, i11);
                if (addShiftedUp != 0) {
                    int i12 = i10 + i4;
                    jArr2[i12] = addShiftedUp ^ jArr2[i12];
                }
            }
            i11++;
            j10 = j11;
    ...
    private static void reduceBit(long[] jArr, int i4, int i10, int i11, int[] iArr) {
        flipBit(jArr, i4, i10);
        int i12 = i10 - i11;
        ...
        while (true) {
            ...
            flipBit(jArr, i4, iArr[length] + i12);
        }
    }

    private static void reduceBitWise(long[] jArr, int i4, int i10, int i11, int[] iArr) {
        while (true) {
            i10--;
            if (i10 < i11) {
                return;
            }
            if (testBit(jArr, i4, i10)) {
                reduceBit(jArr, i4, i10, i11, iArr);
            }
        }
    }

    private static int reduceInPlace(long[] jArr, int i4, int i10, int i11, int[] iArr) {
        int i12 = (i11 + 63) >>> 6;
        if (i10 < i12) {
            return i10;
        }
        ...
        if (min2 > 1) {
            int i18 = i15 - min2;
            reduceVectorWise(jArr, i4, i15, i18, i11, iArr);
            while (i15 > i18) {
                i15--;
                jArr[i4 + i15] = 0;
            }
        ...
        if (min > max) {
            reduceWordWise(jArr, i4, i15, max, i11, iArr);
        } else {
            max = min;
        }
        if (max > i11) {
            reduceBitWise(jArr, i4, max, i11, iArr);
        }
        return i12;
    }

    private static LongArray reduceResult(long[] jArr, int i4, int i10, int i11, int[] iArr) {
        return new LongArray(jArr, i4, reduceInPlace(jArr, i4, i10, i11, iArr));
    }

    private static void reduceVectorWise(long[] jArr, int i4, int i10, int i11, int i12, int[] iArr) {
        int i13 = (i11 << 6) - i12;
        int length = iArr.length;
        while (true) {
            length--;
            if (length < 0) {
                flipVector(jArr, i4, jArr, i4 + i11, i10 - i11, i13);
                return;
            }
            flipVector(jArr, i4, jArr, i4 + i11, i10 - i11, i13 + iArr[length]);
        }
    }

    private static void reduceWord(long[] jArr, int i4, int i10, long j4, int i11, int[] iArr) {
        int i12 = i10 - i11;
        int length = iArr.length;
        while (true) {
            length--;
            if (length < 0) {
                flipWord(jArr, i4, i12, j4);
                return;
            }
            flipWord(jArr, i4, iArr[length] + i12, j4);
        }
    }

    private static void reduceWordWise(long[] jArr, int i4, int i10, int i11, int i12, int[] iArr) {
        int i13 = i11 >>> 6;
        int i14 = i10;
        while (true) {
            int i15 = i14 - 1;
            ...
            if (j4 != 0) {
                jArr[i16] = 0;
                reduceWord(jArr, i4, i15 << 6, j4, i12, iArr);
            }
            i14 = i15;
        }
        int i17 = i11 & 63;
        int i18 = i4 + i13;
        long j10 = jArr[i18] >>> i17;
        if (j10 != 0) {
            jArr[i18] = jArr[i18] ^ (j10 << i17);
            reduceWord(jArr, i4, i11, j10, i12, iArr);
        }
    }

    private long[] resizedInts(int i4) {
    ...
    private static long shiftUp(long[] jArr, int i4, int i10, int i11) {
        int i12 = 64 - i11;
        long j4 = 0;
    ...
    private static long shiftUp(long[] jArr, int i4, long[] jArr2, int i10, int i11, int i12) {
        int i13 = 64 - i12;
        long j4 = 0;
        for (int i14 = 0; i14 < i11; i14++) {
            long j10 = jArr[i4 + i14];
            jArr2[i10 + i14] = j4 | (j10 << i12);
            j4 = j10 >>> i13;
        }
        return j4;
    }

    private static void squareInPlace(long[] jArr, int i4, int i10, int[] iArr) {
        int i11 = i4 << 1;
        while (true) {
            i4--;
            if (i4 < 0) {
            ...
            long j4 = jArr[i4];
            int i12 = i11 - 1;
            jArr[i12] = interleave2_32to64((int) (j4 >>> 32));
            i11 = i12 - 1;
            jArr[i11] = interleave2_32to64((int) j4);
        }
    }

    private static boolean testBit(long[] jArr, int i4, int i10) {
        return (jArr[i4 + (i10 >>> 6)] & (1 << (i10 & 63))) != 0;
    }
    ...
    public void addShiftedByWords(LongArray longArray, int i4) {
        int usedLength = longArray.getUsedLength();
        if (usedLength == 0) {
            return;
        }
        int i10 = usedLength + i4;
        if (i10 > this.m_ints.length) {
            this.m_ints = resizedInts(i10);
        }
        add(this.m_ints, i4, longArray.m_ints, 0, usedLength);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void copyTo(long[] jArr, int i4) {
        long[] jArr2 = this.m_ints;
    ...
    public int degree() {
        ...
        while (length != 0) {
            length--;
            long j4 = this.m_ints[length];
            if (j4 != 0) {
                return (length << 6) + bitLength(j4);
            }
        }
        return 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof LongArray) {
            ...
            for (int i4 = 0; i4 < usedLength; i4++) {
                if (this.m_ints[i4] != longArray.m_ints[i4]) {
                    return false;
                }
            }
            return true;
    ...
    public int getUsedLengthFrom(int i4) {
        long[] jArr = this.m_ints;
    ...
    public LongArray modInverse(int i4, int[] iArr) {
        int degree = degree();
        if (degree == 0) {
        ...
        reduceBit(longArray.m_ints, 0, i4, i4, iArr);
        ...
        while (true) {
            ...
            int i17 = 1 - i10;
            longArrayArr[i10].addShiftedByBitsSafe(longArrayArr[i17], iArr2[i17], i14);
            int degreeFrom = longArrayArr[i10].degreeFrom(i12);
            if (degreeFrom == 0) {
                return longArrayArr2[i17];
            }
            int i18 = iArr3[i17];
            longArrayArr2[i10].addShiftedByBitsSafe(longArrayArr2[i17], i18, i14);
            int i19 = i18 + i14;
            if (i19 > i13) {
                i13 = i19;
            } else if (i19 == i13) {
                i13 = longArrayArr2[i10].degreeFrom(i13);
            }
            i14 += degreeFrom - i12;
            i12 = degreeFrom;
        }
    ...
    public LongArray modMultiply(LongArray longArray, int i4, int[] iArr) {
        int i10;
        int i11;
        ...
        if (i14 == 1) {
            long j4 = longArray2.m_ints[0];
            if (j4 == 1) {
                return longArray3;
            }
            long[] jArr2 = new long[i16];
            multiplyWord(j4, longArray3.m_ints, i15, jArr2, 0);
            return reduceResult(jArr2, 0, i16, i4, iArr);
        }
        int i17 = ((i11 + 7) + 63) >>> 6;
        ...
        while (i24 < i14) {
            ...
            while (true) {
                long j11 = j10 >>> 4;
                i12 = i24;
                addBoth(jArr7, i25, jArr4, iArr2[((int) j10) & 15], jArr5, iArr2[((int) j11) & 15], i17);
                j10 = j11 >>> 4;
                if (j10 == 0) {
                    break;
                }
        ...
        while (true) {
            i23 -= i16;
            if (i23 == 0) {
                return reduceResult(jArr7, 0, i16, i4, iArr);
            }
            addShiftedUp(jArr7, i23 - i16, jArr7, i23, i16, 8);
        }
    }

    public LongArray modMultiplyAlt(LongArray longArray, int i4, int[] iArr) {
        int i10;
        int i11;
        LongArray longArray2;
        LongArray longArray3;
        ...
        if (i14 == 1) {
            ...
            multiplyWord(j4, longArray3.m_ints, i15, jArr, 0);
            return reduceResult(jArr, 0, i16, i4, iArr);
        }
        int i17 = 15;
        int i18 = ((i11 + 15) + 63) >>> 6;
        int i19 = i18 * 8;
        ...
        long[] jArr2 = new long[i20 + 1];
        int i22 = i19;
        interleave(longArray2.m_ints, 0, jArr2, 0, i14, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr2, i14, i15);
        int i23 = i14;
        int i24 = 1;
        while (i24 < 8) {
            int i25 = i23 + i18;
            shiftUp(jArr2, i14, jArr2, i25, i18, i24);
            i24++;
            i23 = i25;
        }
        int i26 = 0;
        while (true) {
            ...
            do {
                int i28 = i14;
                long j10 = jArr2[i27] >>> i26;
                int i29 = 0;
                while (true) {
                    int i30 = ((int) j10) & i17;
                    if (i30 != 0) {
                        add(jArr2, iArr2[i30] + i27, jArr2, i28, i18);
                    }
                    i12 = 1;
                    i29++;
                    if (i29 == 8) {
        ...
        while (true) {
            int i32 = i31 - 1;
            if (i32 <= i12) {
                return reduceResult(jArr2, iArr2[1], i16, i4, iArr);
            }
            if ((i32 & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i32 >>> 1], jArr2, iArr2[i32], i16, 16);
            } else {
                distribute(jArr2, iArr2[i32], iArr2[i32 - 1], iArr2[1], i16);
            }
            i31 = i32;
            i12 = 1;
        }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i4, int[] iArr) {
        int i10;
        int i11;
        LongArray longArray2;
        LongArray longArray3;
        ...
        if (i13 == 1) {
            ...
            multiplyWord(j4, longArray3.m_ints, i14, jArr2, 0);
            return reduceResult(jArr2, 0, i15, i4, iArr);
        }
        int i16 = ((i11 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        int i17 = i16 << 4;
        ...
        iArr2[1] = i16;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i16, i14);
        int i18 = 2;
        int i19 = i16;
        while (i18 < 16) {
            i19 += i16;
            ...
            if ((i18 & 1) == 0) {
                jArr = jArr3;
                i12 = i17;
                shiftUp(jArr3, i19 >>> 1, jArr3, i19, i16, 1);
            } else {
                jArr = jArr3;
                i12 = i17;
                add(jArr, i16, jArr3, i19 - i16, jArr, i19, i16);
            }
            i18++;
            i17 = i12;
            jArr3 = jArr;
        ...
        for (int i21 = 56; i21 >= 0; i21 -= 8) {
            for (int i22 = 1; i22 < i13; i22 += 2) {
                int i23 = (int) (jArr6[i22] >>> i21);
                addBoth(jArr7, i22 - 1, jArr4, iArr2[i23 & 15], jArr5, iArr2[(i23 >>> 4) & 15], i16);
            }
            shiftUp(jArr7, 0, i15, 8);
        }
        for (int i24 = 56; i24 >= 0; i24 -= 8) {
            for (int i25 = 0; i25 < i13; i25 += 2) {
                int i26 = (int) (jArr6[i25] >>> i24);
                addBoth(jArr7, i25, jArr4, iArr2[i26 & 15], jArr5, iArr2[(i26 >>> 4) & 15], i16);
            }
            if (i24 > 0) {
                shiftUp(jArr7, 0, i15, 8);
            }
        }
        return reduceResult(jArr7, 0, i15, i4, iArr);
    }

    public LongArray modReduce(int i4, int[] iArr) {
        long[] clone = Arrays.clone(this.m_ints);
        return new LongArray(clone, 0, reduceInPlace(clone, 0, clone.length, i4, iArr));
    }

    public LongArray modSquare(int i4, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        int i11 = 0;
        while (i11 < i10) {
            long j4 = this.m_ints[i11 >>> 1];
            int i12 = i11 + 1;
            jArr[i11] = interleave2_32to64((int) j4);
            i11 = i12 + 1;
            jArr[i12] = interleave2_32to64((int) (j4 >>> 32));
        }
        return new LongArray(jArr, 0, reduceInPlace(jArr, 0, i10, i4, iArr));
    }

    public LongArray modSquareN(int i4, int i10, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
    ...
    public LongArray multiply(LongArray longArray, int i4, int[] iArr) {
        int i10;
        int i11;
        LongArray longArray2;
        LongArray longArray3;
        ...
        if (i13 == 1) {
            ...
            long[] jArr2 = new long[i15];
            multiplyWord(j4, longArray3.m_ints, i14, jArr2, 0);
            return new LongArray(jArr2, 0, i15);
        }
        int i16 = ((i11 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        int i17 = i16 << 4;
        ...
        for (int i20 = 16; i18 < i20; i20 = 16) {
            ...
            if ((i18 & 1) == 0) {
                ...
                jArr = jArr3;
                i12 = i17;
                add(jArr, i16, jArr, i19 - i16, jArr3, i19, i16);
            }
            i18++;
            i17 = i12;
            jArr3 = jArr;
        ...
        for (int i23 = 0; i23 < i13; i23++) {
            ...
            while (true) {
                long j11 = j10 >>> 4;
                addBoth(jArr7, i24, jArr4, iArr2[((int) j10) & 15], jArr5, iArr2[((int) j11) & 15], i16);
                j10 = j11 >>> 4;
                if (j10 == 0) {
                    break;
                }
        ...
        while (true) {
            i22 -= i15;
            if (i22 == 0) {
                return new LongArray(jArr7, 0, i15);
            }
            addShiftedUp(jArr7, i22 - i15, jArr7, i22, i15, 8);
        }
    }

    public void reduce(int i4, int[] iArr) {
        long[] jArr = this.m_ints;
        int reduceInPlace = reduceInPlace(jArr, 0, jArr.length, i4, iArr);
    ...
    public LongArray square(int i4, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
    ...
    public BigInteger toBigInteger() {
        ...
        int i4 = usedLength - 1;
        long j4 = this.m_ints[i4];
        byte[] bArr = new byte[8];
        int i10 = 0;
        boolean z9 = false;
        for (int i11 = 7; i11 >= 0; i11--) {
            byte b10 = (byte) (j4 >>> (i11 * 8));
            if (z9 || b10 != 0) {
                bArr[i10] = b10;
                i10++;
                z9 = true;
    ...
    public String toString() {
        ...
        int i4 = usedLength - 1;
        StringBuffer stringBuffer = new StringBuffer(Long.toBinaryString(this.m_ints[i4]));
        while (true) {
            i4--;
            if (i4 < 0) {
                return stringBuffer.toString();
            }
            String binaryString = Long.toBinaryString(this.m_ints[i4]);
