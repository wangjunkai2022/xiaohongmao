...
class SimpleBigDecimal {
    ...
    public static SimpleBigDecimal getInstance(BigInteger bigInteger, int i4) {
    ...
    public SimpleBigDecimal adjustScale(int i4) {
        if (i4 >= 0) {
            int i10 = this.scale;
            return i4 == i10 ? this : new SimpleBigDecimal(this.bigInt.shiftLeft(i4 - i10), i4);
        }
        throw new IllegalArgumentException("scale may not be negative");
    }
    ...
    public SimpleBigDecimal shiftLeft(int i4) {
        return new SimpleBigDecimal(this.bigInt.shiftLeft(i4), this.scale);
    }
    ...
    public String toString() {
        ...
        int i4 = this.scale - length;
        for (int i10 = 0; i10 < i4; i10++) {
            cArr[i10] = '0';
        }
        for (int i11 = 0; i11 < length; i11++) {
            cArr[i4 + i11] = bigInteger2.charAt(i11);
        }
