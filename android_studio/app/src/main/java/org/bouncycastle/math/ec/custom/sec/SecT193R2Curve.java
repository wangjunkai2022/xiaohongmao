...
public class SecT193R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R2Curve() {
        ...
        this.f91410a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
        this.f91411b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT193R2Curve.1
            ...
            public ECPoint lookupVar(int i14) {
                ...
                for (int i16 = 0; i16 < 4; i16++) {
                    long j4 = create64[i16];
                    long[] jArr2 = jArr;
                    create64[i16] = j4 ^ jArr2[i15 + i16];
                    create642[i16] = create642[i16] ^ jArr2[(i15 + 4) + i16];
                }
                return createPoint(create64, create642);
            }
        };
