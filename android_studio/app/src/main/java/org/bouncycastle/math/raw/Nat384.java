...
public abstract class Nat384 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        boolean z9 = Nat192.diff(iArr, 6, iArr, 0, create, 0) != Nat192.diff(iArr2, 6, iArr2, 0, create2, 0);
        int[] createExt = Nat192.createExt();
        Nat192.mul(create, create2, createExt);
        Nat.addWordAt(24, addTo + (z9 ? Nat.addTo(12, createExt, 0, iArr3, 6) : Nat.subFrom(12, createExt, 0, iArr3, 6)), iArr3, 18);
    }
