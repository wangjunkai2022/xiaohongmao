...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R1Curve() {
        ...
        this.f91410a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.f91411b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i4, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawXCoord()).f91456x, 0, jArr, i11);
            int i13 = i11 + 3;
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawYCoord()).f91456x, 0, jArr, i13);
            i11 = i13 + 3;
        }
