...
public class SecP224R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f91444q = SecP224R1FieldElement.Q;
    ...
    public SecP224R1Curve() {
        ...
        this.f91410a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE")));
        this.f91411b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i4, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawXCoord()).f91445x, 0, iArr, i11);
            int i13 = i11 + 7;
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawYCoord()).f91445x, 0, iArr, i13);
            i11 = i13 + 7;
        }
