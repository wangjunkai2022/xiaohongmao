...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp {
    ...
    public Curve25519FieldElement(BigInteger bigInteger) {
        ...
        this.f91428x = Curve25519Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        Curve25519Field.add(this.f91428x, ((Curve25519FieldElement) eCFieldElement).f91428x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        Curve25519Field.addOne(this.f91428x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.inv(((Curve25519FieldElement) eCFieldElement).f91428x, create);
        Curve25519Field.multiply(create, this.f91428x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Curve25519FieldElement) {
            return Nat256.eq(this.f91428x, ((Curve25519FieldElement) obj).f91428x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f91428x, 0, 8);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Curve25519Field.inv(this.f91428x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat256.isOne(this.f91428x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat256.isZero(this.f91428x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.multiply(this.f91428x, ((Curve25519FieldElement) eCFieldElement).f91428x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        Curve25519Field.negate(this.f91428x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f91428x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        Curve25519Field.square(this.f91428x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.subtract(this.f91428x, ((Curve25519FieldElement) eCFieldElement).f91428x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat256.getBit(this.f91428x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f91428x);
    }
}
