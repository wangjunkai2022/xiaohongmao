...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f91423x;
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f91424y;
        ...
        if (isOne) {
            iArr = secP192K1FieldElement3.f91439x;
            iArr2 = secP192K1FieldElement4.f91439x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement5.f91439x, create2);
            SecP192K1Field.multiply(create2, secP192K1FieldElement3.f91439x, create);
            SecP192K1Field.multiply(create2, secP192K1FieldElement5.f91439x, create2);
            SecP192K1Field.multiply(create2, secP192K1FieldElement4.f91439x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP192K1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP192K1FieldElement.f91439x;
            iArr4 = secP192K1FieldElement2.f91439x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement6.f91439x, create3);
            SecP192K1Field.multiply(create3, secP192K1FieldElement.f91439x, createExt);
            SecP192K1Field.multiply(create3, secP192K1FieldElement6.f91439x, create3);
            SecP192K1Field.multiply(create3, secP192K1FieldElement2.f91439x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP192K1Field.square(create, secP192K1FieldElement7.f91439x);
        int[] iArr5 = secP192K1FieldElement7.f91439x;
        ...
        SecP192K1Field.subtract(create2, secP192K1FieldElement7.f91439x, secP192K1FieldElement8.f91439x);
        SecP192K1Field.multiplyAddToExt(secP192K1FieldElement8.f91439x, create, createExt);
        SecP192K1Field.reduce(createExt, secP192K1FieldElement8.f91439x);
        SecP192K1FieldElement secP192K1FieldElement9 = new SecP192K1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP192K1FieldElement9.f91439x;
            SecP192K1Field.multiply(iArr6, secP192K1FieldElement5.f91439x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP192K1FieldElement9.f91439x;
            SecP192K1Field.multiply(iArr7, secP192K1FieldElement6.f91439x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192K1Point(this.curve, this.f91423x, this.f91424y.negate(), this.zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f91424y;
        if (secP192K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f91423x;
        SecP192K1FieldElement secP192K1FieldElement3 = (SecP192K1FieldElement) this.zs[0];
        int[] create = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement.f91439x, create);
        int[] create2 = Nat192.create();
        SecP192K1Field.square(create, create2);
        int[] create3 = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement2.f91439x, create3);
        SecP192K1Field.reduce32(Nat192.addBothTo(create3, create3, create3), create3);
        SecP192K1Field.multiply(create, secP192K1FieldElement2.f91439x, create);
        ...
        SecP192K1Field.square(create3, secP192K1FieldElement4.f91439x);
        int[] iArr = secP192K1FieldElement4.f91439x;
        SecP192K1Field.subtract(iArr, create, iArr);
        int[] iArr2 = secP192K1FieldElement4.f91439x;
        SecP192K1Field.subtract(iArr2, create, iArr2);
        SecP192K1FieldElement secP192K1FieldElement5 = new SecP192K1FieldElement(create);
        SecP192K1Field.subtract(create, secP192K1FieldElement4.f91439x, secP192K1FieldElement5.f91439x);
        int[] iArr3 = secP192K1FieldElement5.f91439x;
        SecP192K1Field.multiply(iArr3, create3, iArr3);
        int[] iArr4 = secP192K1FieldElement5.f91439x;
        ...
        SecP192K1Field.twice(secP192K1FieldElement.f91439x, secP192K1FieldElement6.f91439x);
        if (!secP192K1FieldElement3.isOne()) {
            int[] iArr5 = secP192K1FieldElement6.f91439x;
            SecP192K1Field.multiply(iArr5, secP192K1FieldElement3.f91439x, iArr5);
        }
