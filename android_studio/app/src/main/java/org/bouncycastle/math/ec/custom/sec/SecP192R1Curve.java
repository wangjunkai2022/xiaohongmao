...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f91440q = SecP192R1FieldElement.Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f91410a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f91411b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i4, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f91441x, 0, iArr, i11);
            int i13 = i11 + 6;
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f91441x, 0, iArr, i13);
            i11 = i13 + 6;
        }
