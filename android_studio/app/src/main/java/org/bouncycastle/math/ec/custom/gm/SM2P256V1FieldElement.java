...
public class SM2P256V1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f91430x;

    public SM2P256V1FieldElement() {
        this.f91430x = Nat256.create();
    }
    ...
    public SM2P256V1FieldElement(BigInteger bigInteger) {
        ...
        this.f91430x = SM2P256V1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SM2P256V1Field.add(this.f91430x, ((SM2P256V1FieldElement) eCFieldElement).f91430x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SM2P256V1Field.addOne(this.f91430x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SM2P256V1Field.inv(((SM2P256V1FieldElement) eCFieldElement).f91430x, create);
        SM2P256V1Field.multiply(create, this.f91430x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SM2P256V1FieldElement) {
            return Nat256.eq(this.f91430x, ((SM2P256V1FieldElement) obj).f91430x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f91430x, 0, 8);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        SM2P256V1Field.inv(this.f91430x, create);
        return new SM2P256V1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat256.isOne(this.f91430x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat256.isZero(this.f91430x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SM2P256V1Field.multiply(this.f91430x, ((SM2P256V1FieldElement) eCFieldElement).f91430x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SM2P256V1Field.negate(this.f91430x, create);
        return new SM2P256V1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f91430x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SM2P256V1Field.square(this.f91430x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SM2P256V1Field.subtract(this.f91430x, ((SM2P256V1FieldElement) eCFieldElement).f91430x, create);
        return new SM2P256V1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat256.getBit(this.f91430x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f91430x);
    }
}
