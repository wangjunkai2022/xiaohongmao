...
public class BCGMSSPublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        ...
        for (int i4 = 0; i4 < this.gmssParameterSet.getHeightOfTrees().length; i4++) {
            str = str + "Layer " + i4 + " : " + this.gmssParameterSet.getHeightOfTrees()[i4] + " WinternitzParameter: " + this.gmssParameterSet.getWinternitzParameter()[i4] + " K: " + this.gmssParameterSet.getK()[i4] + "\n";
        }
        return str;
    }
}
