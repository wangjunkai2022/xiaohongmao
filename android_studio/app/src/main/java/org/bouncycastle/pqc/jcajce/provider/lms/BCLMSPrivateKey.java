...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
    ...
    public LMSPrivateKey extractKeyShard(int i4) {
        ...
        return lMSKeyParameters instanceof LMSPrivateKeyParameters ? new BCLMSPrivateKey(((LMSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i4)) : new BCLMSPrivateKey(((HSSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i4));
    }
