...
public abstract class AsymmetricBlockCipher extends CipherSpiExt {
    ...
    protected void checkLength(int i4) throws IllegalBlockSizeException {
        int size = i4 + this.buf.size();
        int i10 = this.opMode;
        if (i10 == 1) {
        ...
        } else if (i10 != 2 || size == this.cipherTextSize) {
        } else {
    ...
    public final int doFinal(byte[] bArr, int i4, int i10, byte[] bArr2, int i11) throws ShortBufferException, IllegalBlockSizeException, BadPaddingException {
    ...
    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public final byte[] doFinal(byte[] bArr, int i4, int i10) throws IllegalBlockSizeException, BadPaddingException {
        checkLength(i10);
        update(bArr, i4, i10);
    ...
    public final int getOutputSize(int i4) {
        if (i4 + this.buf.size() > getBlockSize()) {
            return 0;
        }
    ...
    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public final int update(byte[] bArr, int i4, int i10, byte[] bArr2, int i11) {
        update(bArr, i4, i10);
        return 0;
    }

    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public final byte[] update(byte[] bArr, int i4, int i10) {
        if (i10 != 0) {
