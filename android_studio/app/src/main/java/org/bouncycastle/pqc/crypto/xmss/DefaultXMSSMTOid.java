...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    private static String createKey(String str, int i4, int i10, int i11, int i12, int i13) {
        Objects.requireNonNull(str, "algorithmName == null");
        return str + "-" + i4 + "-" + i10 + "-" + i11 + "-" + i12 + "-" + i13;
    }

    public static DefaultXMSSMTOid lookup(String str, int i4, int i10, int i11, int i12, int i13) {
        Objects.requireNonNull(str, "algorithmName == null");
        return oidLookupTable.get(createKey(str, i4, i10, i11, i12, i13));
    }
