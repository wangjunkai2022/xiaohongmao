    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof LMSKeyGenParameterSpec) {
            ...
            if (algorithmParameterSpec instanceof LMSHSSKeyGenParameterSpec) {
                ...
                while (i4 != lMSSpecs.length) {
                    lMSParametersArr[i4] = new LMSParameters(lMSSpecs[i4].getSigParams(), lMSSpecs[i4].getOtsParams());
                    i4++;
                }
                ...
                while (i4 != lMSSpecs2.length) {
                    lMSParametersArr2[i4] = new LMSParameters(lMSSpecs2[i4].getSigParams(), lMSSpecs2[i4].getOtsParams());
                    i4++;
                }
