...
public class XMSSMTPrivateKey extends ASN1Object {
    ...
    public XMSSMTPrivateKey(long j4, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        this.version = 0;
        this.index = j4;
    ...
    public XMSSMTPrivateKey(long j4, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, long j10) {
        this.version = 1;
        this.index = j4;
        this.secretKeySeed = Arrays.clone(bArr);
        this.secretKeyPRF = Arrays.clone(bArr2);
    ...
    private XMSSMTPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence2.size() == 6) {
            ...
            j4 = ASN1Integer.getInstance(aSN1TaggedObject, false).longValueExact();
