...
public interface StateAwareSignature {
    ...
    int sign(byte[] bArr, int i4, int i10) throws SignatureException;
    ...
    void update(byte[] bArr, int i4, int i10) throws SignatureException;

    boolean verify(byte[] bArr) throws SignatureException;

    boolean verify(byte[] bArr, int i4, int i10) throws SignatureException;
}
