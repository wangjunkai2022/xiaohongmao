...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    private int f5(int i4, int i10, int i11) {
        return i4 ^ (i10 | (~i11));
    }
    ...
    public int doFinal(byte[] bArr, int i4) {
        ...
        unpackWord(this.H8, bArr, i4 + 32);
        unpackWord(this.H9, bArr, i4 + 36);
        reset();
        return 40;
    }
    ...
    protected void processBlock() {
        ...
        int i17 = this.H8;
        int i18 = this.H9;
        int RL = RL(i4 + f1(i10, i11, i12) + this.X[0], 11) + i13;
        int RL2 = RL(i11, 10);
        int RL3 = RL(i13 + f1(RL, i10, RL2) + this.X[1], 14) + i12;
        int RL4 = RL(i10, 10);
        int RL5 = RL(i12 + f1(RL3, RL, RL4) + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i14 + f5(i15, i16, i17) + this.X[5] + 1352829926, 8) + i18;
        int RL34 = RL(i16, 10);
        int RL35 = RL(i18 + f5(RL33, i15, RL34) + this.X[14] + 1352829926, 9) + i17;
        int RL36 = RL(i15, 10);
        int RL37 = RL(i17 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
