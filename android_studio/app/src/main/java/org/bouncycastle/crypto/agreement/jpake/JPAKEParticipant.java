...
public class JPAKEParticipant {
    ...
    private BigInteger f91164b;
    private final Digest digest;

    /* renamed from: g  reason: collision with root package name */
    private final BigInteger f91165g;
    ...
    private final BigInteger f91166p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q  reason: collision with root package name */
    private final BigInteger f91167q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1  reason: collision with root package name */
    private BigInteger f91168x1;

    /* renamed from: x2  reason: collision with root package name */
    private BigInteger f91169x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f91166p = jPAKEPrimeOrderGroup.getP();
        this.f91167q = jPAKEPrimeOrderGroup.getQ();
        this.f91165g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i4 >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f91166p, this.f91167q, this.gx4, this.f91169x2, calculateS, this.f91164b);
            this.f91168x1 = null;
            this.f91169x2 = null;
            this.f91164b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f91168x1 = JPAKEUtil.generateX1(this.f91167q, this.random);
        this.f91169x2 = JPAKEUtil.generateX2(this.f91167q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f91166p, this.f91165g, this.f91168x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f91166p, this.f91165g, this.f91169x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f91166p, this.f91167q, this.f91165g, this.gx1, this.f91168x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f91166p, this.f91167q, this.f91165g, this.gx2, this.f91169x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i4 >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f91166p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f91167q, this.f91169x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f91166p, this.f91167q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f91166p, this.f91167q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f91166p, this.f91167q, this.f91165g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f91166p, this.f91167q, this.f91165g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i4 >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f91166p, this.gx3, this.gx1, this.gx2);
            this.f91164b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f91166p, this.f91167q, calculateGA, this.f91164b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        }
    }
