...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        BigInteger p9 = jPAKEPrimeOrderGroup.getP();
        BigInteger q9 = jPAKEPrimeOrderGroup.getQ();
        BigInteger g4 = jPAKEPrimeOrderGroup.getG();
        System.out.println("********* Initialization **********");
        System.out.println("Public parameters for the cyclic group:");
        PrintStream printStream = System.out;
        printStream.println("p (" + p9.bitLength() + " bits): " + p9.toString(16));
        PrintStream printStream2 = System.out;
        printStream2.println("q (" + q9.bitLength() + " bits): " + q9.toString(16));
        PrintStream printStream3 = System.out;
        printStream3.println("g (" + p9.bitLength() + " bits): " + g4.toString(16));
        PrintStream printStream4 = System.out;
        StringBuilder sb = new StringBuilder();
        sb.append("p mod q = ");
        sb.append(p9.mod(q9).toString(16));
        printStream4.println(sb.toString());
        PrintStream printStream5 = System.out;
        printStream5.println("g^{q} mod p = " + g4.modPow(q9, p9).toString(16));
        System.out.println("");
        ...
        printStream9.println("KP{x1}={" + createRound1PayloadToSend.getKnowledgeProofForX1()[0].toString(16) + "};{" + createRound1PayloadToSend.getKnowledgeProofForX1()[1].toString(16) + i.f6967d);
        PrintStream printStream10 = System.out;
        printStream10.println("KP{x2}={" + createRound1PayloadToSend.getKnowledgeProofForX2()[0].toString(16) + "};{" + createRound1PayloadToSend.getKnowledgeProofForX2()[1].toString(16) + i.f6967d);
        System.out.println("");
        ...
        printStream13.println("KP{x3}={" + createRound1PayloadToSend2.getKnowledgeProofForX1()[0].toString(16) + "};{" + createRound1PayloadToSend2.getKnowledgeProofForX1()[1].toString(16) + i.f6967d);
        PrintStream printStream14 = System.out;
        printStream14.println("KP{x4}={" + createRound1PayloadToSend2.getKnowledgeProofForX2()[0].toString(16) + "};{" + createRound1PayloadToSend2.getKnowledgeProofForX2()[1].toString(16) + i.f6967d);
        System.out.println("");
        ...
        printStream16.println("KP{x2*s}={" + createRound2PayloadToSend.getKnowledgeProofForX2s()[0].toString(16) + "},{" + createRound2PayloadToSend.getKnowledgeProofForX2s()[1].toString(16) + i.f6967d);
        System.out.println("");
        System.out.println("Bob sends to Alice");
        PrintStream printStream17 = System.out;
        printStream17.println("B=" + createRound2PayloadToSend2.getA().toString(16));
        PrintStream printStream18 = System.out;
        printStream18.println("KP{x4*s}={" + createRound2PayloadToSend2.getKnowledgeProofForX2s()[0].toString(16) + "},{" + createRound2PayloadToSend2.getKnowledgeProofForX2s()[1].toString(16) + i.f6967d);
        System.out.println("");
