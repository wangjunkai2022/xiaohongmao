...
public class GCFBBlockCipher extends StreamBlockCipher {
    private static final byte[] C = {105, 0, 114, 34, 100, -55, 4, 35, -115, 58, -37, -106, 70, -23, 42, -60, c.B, -2, -84, -108, 0, -19, 7, c.f32114u, -64, -122, -36, -62, a.f13998i, 76, -87, 43};
    ...
    public void init(boolean z9, CipherParameters cipherParameters) throws IllegalArgumentException {
        this.counter = 0L;
        this.cfbEngine.init(z9, cipherParameters);
    ...
    public int processBlock(byte[] bArr, int i4, byte[] bArr2, int i10) throws DataLengthException, IllegalStateException {
        processBytes(bArr, i4, this.cfbEngine.getBlockSize(), bArr2, i10);
        return this.cfbEngine.getBlockSize();
    }
