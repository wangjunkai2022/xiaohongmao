...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i4, byte[] bArr2, int i10) {
        this.X3 = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i4);
        this.X2 = this.wKey[130] ^ Pack.bigEndianToInt(bArr, i4 + 4);
        this.X1 = this.wKey[129] ^ Pack.bigEndianToInt(bArr, i4 + 8);
        int bigEndianToInt = Pack.bigEndianToInt(bArr, i4 + 12) ^ this.wKey[128];
        ...
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToBigEndian(this.X3 ^ this.wKey[3], bArr2, i10);
        Pack.intToBigEndian(this.X2 ^ this.wKey[2], bArr2, i10 + 4);
        Pack.intToBigEndian(this.X1 ^ this.wKey[1], bArr2, i10 + 8);
        Pack.intToBigEndian(this.X0 ^ this.wKey[0], bArr2, i10 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    protected void encryptBlock(byte[] bArr, int i4, byte[] bArr2, int i10) {
        this.X3 = Pack.bigEndianToInt(bArr, i4);
        this.X2 = Pack.bigEndianToInt(bArr, i4 + 4);
        this.X1 = Pack.bigEndianToInt(bArr, i4 + 8);
        int bigEndianToInt = Pack.bigEndianToInt(bArr, i4 + 12);
        this.X0 = bigEndianToInt;
        int[] iArr = this.wKey;
        ...
        Pack.intToBigEndian(this.wKey[131] ^ this.X3, bArr2, i10);
        Pack.intToBigEndian(this.wKey[130] ^ this.X2, bArr2, i10 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ this.X1, bArr2, i10 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ this.X0, bArr2, i10 + 12);
    }
    ...
    protected int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        int i4 = 0;
        while (length > 0) {
            iArr[i4] = Pack.bigEndianToInt(bArr, length);
            length -= 4;
            i4++;
        }
        if (length == 0) {
            int i10 = i4 + 1;
            iArr[i4] = Pack.bigEndianToInt(bArr, 0);
            if (i10 < 8) {
                iArr[i10] = 1;
            }
