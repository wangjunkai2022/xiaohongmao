...
public class MD5Digest extends GeneralDigest implements EncodableDigest {
    ...
    public MD5Digest(byte[] bArr) {
        ...
        for (int i4 = 0; i4 != this.xOff; i4++) {
            this.X[i4] = Pack.bigEndianToInt(bArr, (i4 * 4) + 36);
        }
    }
    ...
    private int K(int i4, int i10, int i11) {
        return (i4 | (~i11)) ^ i10;
    }
    ...
    public int doFinal(byte[] bArr, int i4) {
        finish();
        unpackWord(this.H1, bArr, i4);
        unpackWord(this.H2, bArr, i4 + 4);
        unpackWord(this.H3, bArr, i4 + 8);
        unpackWord(this.H4, bArr, i4 + 12);
        reset();
        return 16;
    }
    ...
    public byte[] getEncodedState() {
        ...
        for (int i4 = 0; i4 != this.xOff; i4++) {
            Pack.intToBigEndian(this.X[i4], bArr, (i4 * 4) + 36);
        }
        return bArr;
    }
    ...
    protected void processBlock() {
        ...
        int i11 = this.H3;
        int i12 = this.H4;
        int rotateLeft = rotateLeft(((i4 + F(i10, i11, i12)) + this.X[0]) - 680876936, 7) + i10;
        int rotateLeft2 = rotateLeft(((i12 + F(rotateLeft, i10, i11)) + this.X[1]) - 389564586, 12) + rotateLeft;
        int rotateLeft3 = rotateLeft(i11 + F(rotateLeft2, rotateLeft, i10) + this.X[2] + 606105819, 17) + rotateLeft2;
        int rotateLeft4 = rotateLeft(((i10 + F(rotateLeft3, rotateLeft2, rotateLeft)) + this.X[3]) - 1044525330, 22) + rotateLeft3;
