...
public class RIPEMD256Digest extends GeneralDigest {
    ...
    private int F1(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f1(i10, i11, i12) + i13, i14);
    }

    private int F2(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f2(i10, i11, i12) + i13 + 1518500249, i14);
    }

    private int F3(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f3(i10, i11, i12) + i13 + 1859775393, i14);
    }

    private int F4(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(((i4 + f4(i10, i11, i12)) + i13) - 1894007588, i14);
    }

    private int FF1(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f1(i10, i11, i12) + i13, i14);
    }

    private int FF2(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f2(i10, i11, i12) + i13 + 1836072691, i14);
    }

    private int FF3(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f3(i10, i11, i12) + i13 + 1548603684, i14);
    }

    private int FF4(int i4, int i10, int i11, int i12, int i13, int i14) {
        return RL(i4 + f4(i10, i11, i12) + i13 + 1352829926, i14);
    }

    private int RL(int i4, int i10) {
    ...
    private int f1(int i4, int i10, int i11) {
        return (i4 ^ i10) ^ i11;
    }

    private int f2(int i4, int i10, int i11) {
        return ((~i4) & i11) | (i10 & i4);
    }

    private int f3(int i4, int i10, int i11) {
        return (i4 | (~i10)) ^ i11;
    }

    private int f4(int i4, int i10, int i11) {
        return (i4 & i11) | (i10 & (~i11));
    }

    private void unpackWord(int i4, byte[] bArr, int i10) {
        bArr[i10] = (byte) i4;
    ...
    public int doFinal(byte[] bArr, int i4) {
        finish();
        unpackWord(this.H0, bArr, i4);
        unpackWord(this.H1, bArr, i4 + 4);
        unpackWord(this.H2, bArr, i4 + 8);
        unpackWord(this.H3, bArr, i4 + 12);
        unpackWord(this.H4, bArr, i4 + 16);
        unpackWord(this.H5, bArr, i4 + 20);
        unpackWord(this.H6, bArr, i4 + 24);
        unpackWord(this.H7, bArr, i4 + 28);
        reset();
        return 32;
    }
    ...
    protected void processBlock() {
        ...
        int i15 = this.H6;
        int i16 = this.H7;
        int F1 = F1(i4, i10, i11, i12, this.X[0], 11);
        int F12 = F1(i12, F1, i10, i11, this.X[1], 14);
        int F13 = F1(i11, F12, F1, i10, this.X[2], 15);
        int F14 = F1(i10, F13, F12, F1, this.X[3], 12);
        ...
        int FF4 = FF4(i13, i14, i15, i16, this.X[5], 8);
        int FF42 = FF4(i16, FF4, i14, i15, this.X[14], 9);
        int FF43 = FF4(i15, FF42, FF4, i14, this.X[7], 9);
        int FF44 = FF4(i14, FF43, FF42, FF4, this.X[0], 11);
    ...
    protected void processWord(byte[] bArr, int i4) {
        ...
        int i11 = i10 + 1;
        this.xOff = i11;
        iArr[i10] = ((bArr[i4 + 3] & 255) << 24) | (bArr[i4] & 255) | ((bArr[i4 + 1] & 255) << 8) | ((bArr[i4 + 2] & 255) << 16);
        if (i11 == 16) {
            processBlock();
        }
    }
