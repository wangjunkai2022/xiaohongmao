...
public final class X448PrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public X448PrivateKeyParameters(byte[] bArr, int i4) {
        super(true);
    ...
    public void encode(byte[] bArr, int i4) {
        System.arraycopy(this.data, 0, bArr, i4, 56);
    }
    ...
    public void generateSecret(X448PublicKeyParameters x448PublicKeyParameters, byte[] bArr, int i4) {
        byte[] bArr2 = new byte[56];
        x448PublicKeyParameters.encode(bArr2, 0);
        if (!X448.calculateAgreement(this.data, 0, bArr2, 0, bArr, i4)) {
