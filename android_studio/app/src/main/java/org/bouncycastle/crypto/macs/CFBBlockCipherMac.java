...
public class CFBBlockCipherMac implements Mac {
    ...
    public CFBBlockCipherMac(BlockCipher blockCipher, int i4, int i10) {
        this(blockCipher, i4, i10, null);
    }

    public CFBBlockCipherMac(BlockCipher blockCipher, int i4, int i10, BlockCipherPadding blockCipherPadding) {
        this.padding = null;
        if (i10 % 8 != 0) {
