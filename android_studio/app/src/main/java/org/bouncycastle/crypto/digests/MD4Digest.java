...
public class MD4Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int i11 = this.H3;
        int i12 = this.H4;
        int rotateLeft = rotateLeft(i4 + F(i10, i11, i12) + this.X[0], 3);
        int rotateLeft2 = rotateLeft(i12 + F(rotateLeft, i10, i11) + this.X[1], 7);
        int rotateLeft3 = rotateLeft(i11 + F(rotateLeft2, rotateLeft, i10) + this.X[2], 11);
        int rotateLeft4 = rotateLeft(i10 + F(rotateLeft3, rotateLeft2, rotateLeft) + this.X[3], 19);
