...
public class CramerShoupParametersGenerator {
    ...
    private static class ParametersHelper {
        ...
        static BigInteger[] generateSafePrimes(int i4, int i10, SecureRandom secureRandom) {
    ...
    public CramerShoupParameters generateParameters(DHParameters dHParameters) {
        ...
        do {
            selectGenerator = ParametersHelper.selectGenerator(p9, this.random);
        } while (g4.equals(selectGenerator));
        return new CramerShoupParameters(p9, g4, selectGenerator, new SHA256Digest());
    }
