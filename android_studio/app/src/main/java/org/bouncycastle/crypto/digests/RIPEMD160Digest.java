...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int i12 = this.H3;
        int i13 = this.H4;
        int RL = RL(f1(i10, i11, i12) + i4 + this.X[0], 11) + i13;
        int RL2 = RL(i11, 10);
        int RL3 = RL(f1(RL, i10, RL2) + i13 + this.X[1], 14) + i12;
        int RL4 = RL(i10, 10);
        int RL5 = RL(f1(RL3, RL, RL4) + i12 + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i4 + f5(i10, i11, i12) + this.X[5] + 1352829926, 8) + i13;
        int RL34 = RL(i11, 10);
        int RL35 = RL(i13 + f5(RL33, i10, RL34) + this.X[14] + 1352829926, 9) + i12;
        int RL36 = RL(i10, 10);
        int RL37 = RL(i12 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
