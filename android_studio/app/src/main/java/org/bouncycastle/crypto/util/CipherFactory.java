...
public class CipherFactory {
    ...
    public static Object createContentCipher(boolean z9, CipherParameters cipherParameters, AlgorithmIdentifier algorithmIdentifier) throws IllegalArgumentException {
        ...
        if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.rc4)) {
            ...
            rC4Engine.init(z9, cipherParameters);
            return rC4Engine;
        }
        if (algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_aes128_GCM) || algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_aes192_GCM) || algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_aes256_GCM)) {
            ...
            if (aSN1Primitive != null && !(aSN1Primitive instanceof ASN1Null)) {
                ...
                createCipher.init(z9, parametersWithIV);
                ...
                createCipher.init(z9, new ParametersWithIV(cipherParameters, new byte[8]));
            } else {
                createCipher.init(z9, cipherParameters);
            }
            return createCipher;
        } else {
            createAEADCipher = createAEADCipher(algorithmIdentifier.getAlgorithm());
        ...
        createAEADCipher.init(z9, aEADParameters);
