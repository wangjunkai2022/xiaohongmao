...
public final class X25519PrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public X25519PrivateKeyParameters(byte[] bArr, int i4) {
        super(true);
    ...
    public void generateSecret(X25519PublicKeyParameters x25519PublicKeyParameters, byte[] bArr, int i4) {
        byte[] bArr2 = new byte[32];
        x25519PublicKeyParameters.encode(bArr2, 0);
        if (!X25519.calculateAgreement(this.data, 0, bArr2, 0, bArr, i4)) {
