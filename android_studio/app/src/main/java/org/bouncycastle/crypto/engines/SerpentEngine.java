...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i4, byte[] bArr2, int i10) {
        this.X0 = this.wKey[128] ^ Pack.littleEndianToInt(bArr, i4);
        this.X1 = this.wKey[129] ^ Pack.littleEndianToInt(bArr, i4 + 4);
        this.X2 = this.wKey[130] ^ Pack.littleEndianToInt(bArr, i4 + 8);
        int littleEndianToInt = Pack.littleEndianToInt(bArr, i4 + 12) ^ this.wKey[131];
        this.X3 = littleEndianToInt;
        ib7(this.X0, this.X1, this.X2, littleEndianToInt);
        int i11 = this.X0;
        int[] iArr = this.wKey;
        this.X0 = i11 ^ iArr[124];
        this.X1 ^= iArr[125];
        this.X2 ^= iArr[126];
        this.X3 ^= iArr[127];
        inverseLT();
        ...
        this.X0 = i41 ^ iArr31[4];
        this.X1 ^= iArr31[5];
        this.X2 ^= iArr31[6];
        this.X3 ^= iArr31[7];
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToLittleEndian(this.X0 ^ this.wKey[0], bArr2, i10);
        Pack.intToLittleEndian(this.X1 ^ this.wKey[1], bArr2, i10 + 4);
        Pack.intToLittleEndian(this.X2 ^ this.wKey[2], bArr2, i10 + 8);
        Pack.intToLittleEndian(this.X3 ^ this.wKey[3], bArr2, i10 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    protected void encryptBlock(byte[] bArr, int i4, byte[] bArr2, int i10) {
        this.X0 = Pack.littleEndianToInt(bArr, i4);
        this.X1 = Pack.littleEndianToInt(bArr, i4 + 4);
        this.X2 = Pack.littleEndianToInt(bArr, i4 + 8);
        int littleEndianToInt = Pack.littleEndianToInt(bArr, i4 + 12);
        this.X3 = littleEndianToInt;
        int[] iArr = this.wKey;
        ...
        Pack.intToLittleEndian(this.wKey[128] ^ this.X0, bArr2, i10);
        Pack.intToLittleEndian(this.wKey[129] ^ this.X1, bArr2, i10 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ this.X2, bArr2, i10 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ this.X3, bArr2, i10 + 12);
    }
    ...
    protected int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        while (true) {
            ...
            iArr[i10] = Pack.littleEndianToInt(bArr, i4);
            i4 = i11;
            i10++;
        }
        if (i4 % 4 == 0) {
