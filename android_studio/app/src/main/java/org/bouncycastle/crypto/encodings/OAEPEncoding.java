...
public class OAEPEncoding implements AsymmetricBlockCipher {
    ...
    private byte[] maskGeneratorFunction1(byte[] bArr, int i4, int i10, int i11) {
        ...
        while (i12 < i11 / digestSize) {
            ...
            this.mgf1Hash.update(bArr, i4, i10);
    ...
    public byte[] decodeBlock(byte[] bArr, int i4, int i10) throws InvalidCipherTextException {
        byte[] bArr2;
        byte[] bArr3;
        byte[] processBlock = this.engine.processBlock(bArr, i4, i10);
        int outputBlockSize = this.engine.getOutputBlockSize();
        byte[] bArr4 = new byte[outputBlockSize];
        boolean z9 = outputBlockSize < (this.defHash.length * 2) + 1;
        ...
        for (int length2 = bArr3.length * 2; length2 != outputBlockSize; length2++) {
            if ((bArr4[length2] != 0) & (i13 == outputBlockSize)) {
                i13 = length2;
            }
        }
        boolean z11 = i13 > outputBlockSize + (-1);
        boolean z12 = bArr4[i13] != 1;
        int i14 = i13 + 1;
        if ((z11 | z12) || (z9 | z10)) {
    ...
    public byte[] encodeBlock(byte[] bArr, int i4, int i10) throws InvalidCipherTextException {
