...
public class SHA256Digest extends GeneralDigest implements EncodableDigest {
    ...
    private static int Ch(int i4, int i10, int i11) {
        return ((~i4) & i11) ^ (i10 & i4);
    }

    private static int Maj(int i4, int i10, int i11) {
        return ((i4 ^ i10) & i11) | (i4 & i10);
    }

    private static int Sum0(int i4) {
        return ((i4 << 10) | (i4 >>> 22)) ^ (((i4 >>> 2) | (i4 << 30)) ^ ((i4 >>> 13) | (i4 << 19)));
    }

    private static int Sum1(int i4) {
        return ((i4 << 7) | (i4 >>> 25)) ^ (((i4 >>> 6) | (i4 << 26)) ^ ((i4 >>> 11) | (i4 << 21)));
    }

    private static int Theta0(int i4) {
        return (i4 >>> 3) ^ (((i4 >>> 7) | (i4 << 25)) ^ ((i4 >>> 18) | (i4 << 14)));
    }

    private static int Theta1(int i4) {
    ...
    public int doFinal(byte[] bArr, int i4) {
        ...
        Pack.intToBigEndian(this.H8, bArr, i4 + 28);
        reset();
        return 32;
    }
