...
public class BufferedEncoder {
    ...
    public BufferedEncoder(Translator translator, int i4) {
    ...
    public int processByte(byte b10, byte[] bArr, int i4) {
        ...
        bArr2[i10] = b10;
        if (i11 == bArr2.length) {
            int encode = this.translator.encode(bArr2, 0, bArr2.length, bArr, i4);
            this.bufOff = 0;
            return encode;
        }
        return 0;
    ...
    public int processBytes(byte[] bArr, int i4, int i10, byte[] bArr2, int i11) {
        if (i10 >= 0) {
            ...
            if (i10 > i13) {
                ...
                byte[] bArr4 = this.buf;
                int encode = translator.encode(bArr4, 0, bArr4.length, bArr2, i11) + 0;
                this.bufOff = 0;
                int i15 = i10 - i13;
                int i16 = i4 + i13;
                int i17 = i11 + encode;
                int length2 = i15 - (i15 % this.buf.length);
                i14 = encode + this.translator.encode(bArr, i16, length2, bArr2, i17);
                i10 = i15 - length2;
                i4 = i16 + length2;
            }
            if (i10 != 0) {
