...
public abstract class Pack {
    ...
    public static void bigEndianToInt(byte[] bArr, int i4, int[] iArr, int i10, int i11) {
        for (int i12 = 0; i12 < i11; i12++) {
            iArr[i10 + i12] = bigEndianToInt(bArr, i4);
            i4 += 4;
        }
    }
    ...
    public static void bigEndianToLong(byte[] bArr, int i4, long[] jArr, int i10, int i11) {
        for (int i12 = 0; i12 < i11; i12++) {
            jArr[i10 + i12] = bigEndianToLong(bArr, i4);
            i4 += 8;
        }
    }

    public static short bigEndianToShort(byte[] bArr, int i4) {
    ...
    public static void intToBigEndian(int[] iArr, int i4, int i10, byte[] bArr, int i11) {
        for (int i12 = 0; i12 < i10; i12++) {
            intToBigEndian(iArr[i4 + i12], bArr, i11);
            i11 += 4;
        }
    }
    ...
    public static void intToLittleEndian(int[] iArr, int i4, int i10, byte[] bArr, int i11) {
        for (int i12 = 0; i12 < i10; i12++) {
            intToLittleEndian(iArr[i4 + i12], bArr, i11);
            i11 += 4;
        }
    }
    ...
    public static int[] littleEndianToInt(byte[] bArr, int i4, int i10) {
        int[] iArr = new int[i10];
        for (int i11 = 0; i11 < i10; i11++) {
            iArr[i11] = littleEndianToInt(bArr, i4);
            i4 += 4;
        }
        return iArr;
    }
    ...
    public static void littleEndianToLong(byte[] bArr, int i4, long[] jArr, int i10, int i11) {
        for (int i12 = 0; i12 < i11; i12++) {
            jArr[i10 + i12] = littleEndianToLong(bArr, i4);
            i4 += 8;
        }
    }

    public static short littleEndianToShort(byte[] bArr, int i4) {
    ...
    public static void longToBigEndian(long j4, byte[] bArr, int i4, int i10) {
        for (int i11 = i10 - 1; i11 >= 0; i11--) {
            bArr[i11 + i4] = (byte) (255 & j4);
            j4 >>>= 8;
        }
    }

    public static void longToBigEndian(long[] jArr, int i4, int i10, byte[] bArr, int i11) {
        for (int i12 = 0; i12 < i10; i12++) {
            longToBigEndian(jArr[i4 + i12], bArr, i11);
            i11 += 8;
        }
    }
    ...
    public static void longToLittleEndian(long[] jArr, int i4, int i10, byte[] bArr, int i11) {
        for (int i12 = 0; i12 < i10; i12++) {
            longToLittleEndian(jArr[i4 + i12], bArr, i11);
            i11 += 8;
        }
    }
    ...
    public static void shortToBigEndian(short s9, byte[] bArr, int i4) {
        bArr[i4] = (byte) (s9 >>> 8);
        bArr[i4 + 1] = (byte) s9;
    }

    public static byte[] shortToBigEndian(short s9) {
        byte[] bArr = new byte[2];
        shortToBigEndian(s9, bArr, 0);
        return bArr;
    }

    public static void shortToLittleEndian(short s9, byte[] bArr, int i4) {
        bArr[i4] = (byte) s9;
        bArr[i4 + 1] = (byte) (s9 >>> 8);
    }

    public static byte[] shortToLittleEndian(short s9) {
        byte[] bArr = new byte[2];
        shortToLittleEndian(s9, bArr, 0);
        return bArr;
    }
}
