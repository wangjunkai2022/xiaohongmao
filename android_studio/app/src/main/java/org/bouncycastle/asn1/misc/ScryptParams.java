...
public class ScryptParams extends ASN1Object {
    ...
    public ScryptParams(byte[] bArr, int i4, int i10, int i11) {
        this(bArr, BigInteger.valueOf(i4), BigInteger.valueOf(i10), BigInteger.valueOf(i11), (BigInteger) null);
    }

    public ScryptParams(byte[] bArr, int i4, int i10, int i11, int i12) {
        this(bArr, BigInteger.valueOf(i4), BigInteger.valueOf(i10), BigInteger.valueOf(i11), BigInteger.valueOf(i12));
    }
