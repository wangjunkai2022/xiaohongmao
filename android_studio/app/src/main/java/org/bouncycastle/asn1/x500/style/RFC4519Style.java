...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f91142c;
    ...
    public static final ASN1ObjectIdentifier f91143l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f91144o;
    ...
    static {
        ...
        hashtable.put(intern3, a.f51009a);
        ...
        hashtable2.put(a.f51009a, intern3);
    ...
    public RDN[] fromString(String str) {
        ...
        for (int i4 = 0; i4 != rDNsFromString.length; i4++) {
            rdnArr[(length - i4) - 1] = rDNsFromString[i4];
        }
        return rdnArr;
    }
