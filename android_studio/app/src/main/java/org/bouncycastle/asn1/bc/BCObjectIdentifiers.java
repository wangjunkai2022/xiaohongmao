...
public interface BCObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch12 = branch8.branch(h.f67840d);
        xmss_SHAKE256ph = branch12;
        xmss_SHA256 = branch8.branch(h.f67841e);
        xmss_SHA512 = branch8.branch("6");
        xmss_SHAKE128 = branch8.branch(h.f67842f);
        xmss_SHAKE256 = branch8.branch(h.f67843g);
        ...
        xmss_mt_SHAKE256ph = branch13.branch(h.f67840d);
        xmss_mt_SHA256 = branch13.branch(h.f67841e);
        xmss_mt_SHA512 = branch13.branch("6");
        ASN1ObjectIdentifier branch16 = branch13.branch(h.f67842f);
        xmss_mt_SHAKE128 = branch16;
        ASN1ObjectIdentifier branch17 = branch13.branch(h.f67843g);
        ...
        ASN1ObjectIdentifier branch18 = branch6.branch(h.f67840d);
        qTESLA = branch18;
        qTESLA_Rnd1_I = branch18.branch("1");
        qTESLA_Rnd1_III_size = branch18.branch("2");
        qTESLA_Rnd1_III_speed = branch18.branch("3");
        qTESLA_Rnd1_p_I = branch18.branch(h.f67840d);
        qTESLA_Rnd1_p_III = branch18.branch(h.f67841e);
        ...
        ASN1ObjectIdentifier branch20 = aSN1ObjectIdentifier.branch(h.f67840d);
        bc_ext = branch20;
