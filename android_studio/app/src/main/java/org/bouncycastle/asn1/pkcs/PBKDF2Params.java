...
public class PBKDF2Params extends ASN1Object {
    ...
    public PBKDF2Params(byte[] bArr, int i4, int i10) {
        this(bArr, i4, i10, null);
    }

    public PBKDF2Params(byte[] bArr, int i4, int i10, AlgorithmIdentifier algorithmIdentifier) {
        this.octStr = new DEROctetString(Arrays.clone(bArr));
        this.iterationCount = new ASN1Integer(i4);
