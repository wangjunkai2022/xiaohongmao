...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        md5WithRSAEncryption = aSN1ObjectIdentifier.branch(h.f67840d);
        sha1WithRSAEncryption = aSN1ObjectIdentifier.branch(h.f67841e);
        srsaOAEPEncryptionSET = aSN1ObjectIdentifier.branch("6");
        id_RSAES_OAEP = aSN1ObjectIdentifier.branch(h.f67842f);
        id_mgf1 = aSN1ObjectIdentifier.branch(h.f67843g);
        id_pSpecified = aSN1ObjectIdentifier.branch(h.f67844h);
        ...
        pbeWithMD2AndRC2_CBC = aSN1ObjectIdentifier3.branch(h.f67840d);
        ...
        des_EDE3_CBC = aSN1ObjectIdentifier4.branch(h.f67842f);
        RC2_CBC = aSN1ObjectIdentifier4.branch("2");
        rc4 = aSN1ObjectIdentifier4.branch(h.f67840d);
        ...
        md4 = aSN1ObjectIdentifier5.branch(h.f67840d);
        md5 = aSN1ObjectIdentifier5.branch(h.f67841e);
        id_hmacWithSHA1 = aSN1ObjectIdentifier5.branch(h.f67842f).intern();
        id_hmacWithSHA224 = aSN1ObjectIdentifier5.branch(h.f67843g).intern();
        id_hmacWithSHA256 = aSN1ObjectIdentifier5.branch(h.f67844h).intern();
        ...
        pkcs_9_at_messageDigest = aSN1ObjectIdentifier6.branch(h.f67840d).intern();
        pkcs_9_at_signingTime = aSN1ObjectIdentifier6.branch(h.f67841e).intern();
        pkcs_9_at_counterSignature = aSN1ObjectIdentifier6.branch("6").intern();
        pkcs_9_at_challengePassword = aSN1ObjectIdentifier6.branch(h.f67842f).intern();
        pkcs_9_at_unstructuredAddress = aSN1ObjectIdentifier6.branch(h.f67843g).intern();
        pkcs_9_at_extendedCertificateAttributes = aSN1ObjectIdentifier6.branch(h.f67844h).intern();
        ...
        id_ct_TSTInfo = aSN1ObjectIdentifier7.branch(h.f67840d);
        id_ct_compressedData = aSN1ObjectIdentifier7.branch(h.f67844h);
        ...
        id_alg = branch3;
        id_alg_PWRI_KEK = branch3.branch(h.f67844h);
        ...
        id_cti_ets_proofOfSender = aSN1ObjectIdentifier8.branch(h.f67840d);
        id_cti_ets_proofOfApproval = aSN1ObjectIdentifier8.branch(h.f67841e);
        ...
        id_aa_contentHint = aSN1ObjectIdentifier9.branch(h.f67840d);
        id_aa_msgSigDigest = aSN1ObjectIdentifier9.branch(h.f67841e);
        ...
        id_aa_contentIdentifier = aSN1ObjectIdentifier9.branch(h.f67842f);
        ...
        crlBag = branch8.branch(h.f67840d);
        secretBag = branch8.branch(h.f67841e);
        ...
        pbeWithSHAAnd2_KeyTripleDES_CBC = branch9.branch(h.f67840d);
        pbeWithSHAAnd128BitRC2_CBC = branch9.branch(h.f67841e);
