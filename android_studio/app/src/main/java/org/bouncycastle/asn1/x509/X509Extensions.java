...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(Vector vector, Vector vector2) {
        ...
        while (elements2.hasMoreElements()) {
            this.extensions.put((ASN1ObjectIdentifier) elements2.nextElement(), (X509Extension) vector2.elementAt(i4));
            i4++;
        }
    }
    ...
    private ASN1ObjectIdentifier[] getExtensionOIDs(boolean z9) {
        ...
        for (int i4 = 0; i4 != this.ordering.size(); i4++) {
            ...
            if (((X509Extension) this.extensions.get(elementAt)).isCritical() == z9) {
    ...
    public static X509Extensions getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z9) {
