...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_aria128_ofb = branch2.branch(h.f67840d);
        id_aria128_ctr = branch2.branch(h.f67841e);
        id_aria192_ecb = branch2.branch("6");
        id_aria192_cbc = branch2.branch(h.f67842f);
        id_aria192_cfb = branch2.branch(h.f67843g);
        id_aria192_ofb = branch2.branch(h.f67844h);
