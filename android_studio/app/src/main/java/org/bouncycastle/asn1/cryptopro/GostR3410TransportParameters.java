...
public class GostR3410TransportParameters extends ASN1Object {
    ...
    public static GostR3410TransportParameters getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z9) {
        return new GostR3410TransportParameters(ASN1Sequence.getInstance(aSN1TaggedObject, z9));
    }
