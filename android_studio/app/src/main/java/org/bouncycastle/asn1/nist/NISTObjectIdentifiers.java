...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        id_sha224 = branch.branch(h.f67840d);
        id_sha512_224 = branch.branch(h.f67841e);
        id_sha512_256 = branch.branch("6");
        id_sha3_224 = branch.branch(h.f67842f);
        id_sha3_256 = branch.branch(h.f67843g);
        id_sha3_384 = branch.branch(h.f67844h);
        ...
        id_aes128_CFB = branch2.branch(h.f67840d);
        id_aes128_wrap = branch2.branch(h.f67841e);
        id_aes128_GCM = branch2.branch("6");
        id_aes128_CCM = branch2.branch(h.f67842f);
        id_aes128_wrap_pad = branch2.branch(h.f67843g);
        ...
        dsa_with_sha512 = branch3.branch(h.f67840d);
        id_dsa_with_sha3_224 = branch3.branch(h.f67841e);
        id_dsa_with_sha3_256 = branch3.branch("6");
        id_dsa_with_sha3_384 = branch3.branch(h.f67842f);
        id_dsa_with_sha3_512 = branch3.branch(h.f67843g);
        id_ecdsa_with_sha3_224 = branch3.branch(h.f67844h);
