...
public class ObjectDigestInfo extends ASN1Object {
    ...
    public ObjectDigestInfo(int i4, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(i4);
        if (i4 == 2) {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i4 + 1));
        this.objectDigest = DERBitString.getInstance((Object) aSN1Sequence.getObjectAt(i4 + 2));
    }
    ...
    public static ObjectDigestInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z9) {
