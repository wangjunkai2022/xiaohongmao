...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        netscapeCARevocationURL = aSN1ObjectIdentifier.branch(h.f67840d);
        netscapeRenewalURL = aSN1ObjectIdentifier.branch(h.f67842f);
        netscapeCApolicyURL = aSN1ObjectIdentifier.branch(h.f67843g);
