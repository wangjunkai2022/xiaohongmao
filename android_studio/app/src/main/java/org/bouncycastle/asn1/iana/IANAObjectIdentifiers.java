...
public interface IANAObjectIdentifiers {
    ...
    static {
        ...
        _private = aSN1ObjectIdentifier.branch(h.f67840d);
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(h.f67841e);
        security = branch;
        SNMPv2 = aSN1ObjectIdentifier.branch("6");
        mail = aSN1ObjectIdentifier.branch(h.f67842f);
        ASN1ObjectIdentifier branch2 = branch.branch(h.f67841e);
        security_mechanisms = branch2;
        security_nametypes = branch.branch("6");
        pkix = branch2.branch("6");
        ASN1ObjectIdentifier branch3 = branch2.branch(h.f67843g);
        ipsec = branch3;
        ...
        hmacRIPEMD160 = branch4.branch(h.f67840d);
    }
}
