...
public class ResponseData extends ASN1Object {
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        int i10 = i4 + 1;
        this.responderID = ResponderID.getInstance(aSN1Sequence.getObjectAt(i4));
        int i11 = i10 + 1;
        this.producedAt = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(i10));
        int i12 = i11 + 1;
    ...
    public static ResponseData getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z9) {
