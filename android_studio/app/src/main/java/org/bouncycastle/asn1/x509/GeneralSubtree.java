...
public class GeneralSubtree extends ASN1Object {
    ...
    public static GeneralSubtree getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z9) {
        return new GeneralSubtree(ASN1Sequence.getInstance(aSN1TaggedObject, z9));
    }
