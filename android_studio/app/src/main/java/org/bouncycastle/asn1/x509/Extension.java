...
public class Extension extends ASN1Object {
    ...
    public Extension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z9, byte[] bArr) {
        this(aSN1ObjectIdentifier, z9, new DEROctetString(bArr));
    }
    ...
    public static Extension create(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z9, ASN1Encodable aSN1Encodable) throws IOException {
        return new Extension(aSN1ObjectIdentifier, z9, aSN1Encodable.toASN1Primitive().getEncoded());
    }
