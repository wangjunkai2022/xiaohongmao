...
public class X509V3CertificateGenerator {
    ...
    private DERBitString booleanToBitString(boolean[] zArr) {
        ...
        for (int i4 = 0; i4 != zArr.length; i4++) {
            int i10 = i4 / 8;
            bArr[i10] = (byte) (bArr[i10] | (zArr[i4] ? 1 << (7 - (i4 % 8)) : 0));
        }
    ...
    public void addExtension(String str, boolean z9, ASN1Encodable aSN1Encodable) {
        addExtension(new ASN1ObjectIdentifier(str), z9, aSN1Encodable);
    }

    public void addExtension(String str, boolean z9, byte[] bArr) {
        addExtension(new ASN1ObjectIdentifier(str), z9, bArr);
    }

    public void addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z9, ASN1Encodable aSN1Encodable) {
        this.extGenerator.addExtension(new ASN1ObjectIdentifier(aSN1ObjectIdentifier.getId()), z9, aSN1Encodable);
    }

    public void addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z9, byte[] bArr) {
        this.extGenerator.addExtension(new ASN1ObjectIdentifier(aSN1ObjectIdentifier.getId()), z9, bArr);
    }

    public void copyAndAddExtension(String str, boolean z9, X509Certificate x509Certificate) throws CertificateParsingException {
        byte[] extensionValue = x509Certificate.getExtensionValue(str);
        if (extensionValue != null) {
            try {
                addExtension(str, z9, X509ExtensionUtil.fromExtensionValue(extensionValue));
                return;
    ...
    public void copyAndAddExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z9, X509Certificate x509Certificate) throws CertificateParsingException {
        copyAndAddExtension(aSN1ObjectIdentifier.getId(), z9, x509Certificate);
    }
