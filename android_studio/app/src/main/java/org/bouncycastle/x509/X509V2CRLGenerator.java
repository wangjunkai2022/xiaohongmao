...
public class X509V2CRLGenerator {
    ...
    public void addCRLEntry(BigInteger bigInteger, Date date, int i4) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), i4);
    }

    public void addCRLEntry(BigInteger bigInteger, Date date, int i4, Date date2) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), i4, new ASN1GeneralizedTime(date2));
    }
