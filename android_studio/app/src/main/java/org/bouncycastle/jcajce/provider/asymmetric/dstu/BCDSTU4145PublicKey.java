...
public class BCDSTU4145PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
        ...
        try {
            ...
            if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
                ...
                if (dSTU4145Params.isNamedCurve()) {
                    ...
                    eCParameterSpec = new org.bouncycastle.jce.spec.ECParameterSpec(f2m, DSTU4145PointEncoder.decodePoint(f2m, g4), eCBinary.getN());
                }
                x9ECParameters = null;
            }
    ...
    public org.bouncycastle.math.ec.ECPoint getQ() {
        org.bouncycastle.math.ec.ECPoint q9 = this.ecPublicKey.getQ();
