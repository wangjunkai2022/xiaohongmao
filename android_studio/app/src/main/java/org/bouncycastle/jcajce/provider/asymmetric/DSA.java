...
public class DSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addSignatureAlgorithm(configurableProvider, f.f93516h, "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_224", NISTObjectIdentifiers.id_dsa_with_sha3_224);
            ...
            addSignatureAlgorithm(configurableProvider, f.f93518j, "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_384", NISTObjectIdentifiers.id_dsa_with_sha3_384);
            addSignatureAlgorithm(configurableProvider, f.f93519k, "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_512", NISTObjectIdentifiers.id_dsa_with_sha3_512);
            ...
            while (true) {
                ...
                configurableProvider.addAlgorithm("Alg.Alias.Signature." + aSN1ObjectIdentifierArr[i4], "DSA");
                registerOid(configurableProvider, aSN1ObjectIdentifierArr[i4], "DSA", keyFactorySpi);
                registerOidAlgorithmParameterGenerator(configurableProvider, aSN1ObjectIdentifierArr[i4], "DSA");
                i4++;
            }
        }
    }
