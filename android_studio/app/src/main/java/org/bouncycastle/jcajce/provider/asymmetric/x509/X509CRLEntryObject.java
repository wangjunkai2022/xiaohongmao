...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f91372c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            ...
            return this.f91372c.equals(x509CRLEntryObject.f91372c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f91372c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f91372c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f91372c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f91372c.getExtensions() != null;
    }
