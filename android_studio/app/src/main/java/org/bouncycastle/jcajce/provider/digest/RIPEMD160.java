...
public class RIPEMD160 {
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        public KeyGenerator() {
            super("HMACRIPEMD160", a1.f54532a, new CipherKeyGenerator());
        }
    }
    ...
    public static class PBEWithHmac extends BaseMac {
        public PBEWithHmac() {
            super(new HMac(new RIPEMD160Digest()), 2, 2, a1.f54532a);
        }
    }
    ...
    public static class PBEWithHmacKeyFactory extends PBESecretKeyFactory {
        public PBEWithHmacKeyFactory() {
            super("PBEwithHmacRIPEMD160", null, false, 2, 2, a1.f54532a, 0);
        }
    }
