...
public class MD2 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.MessageDigest." + PKCSObjectIdentifiers.md2, f.f93509a);
            addHMACAlgorithm(configurableProvider, f.f93509a, str + "$HashMac", str + "$KeyGenerator");
        }
    }
