...
public interface PBE {
    ...
    public static class Util {
        private static byte[] convertPassword(int i4, PBEKeySpec pBEKeySpec) {
            return i4 == 2 ? PBEParametersGenerator.PKCS12PasswordToBytes(pBEKeySpec.getPassword()) : (i4 == 5 || i4 == 4) ? PBEParametersGenerator.PKCS5PasswordToUTF8Bytes(pBEKeySpec.getPassword()) : PBEParametersGenerator.PKCS5PasswordToBytes(pBEKeySpec.getPassword());
        }
        ...
        public static CipherParameters makePBEMacParameters(SecretKey secretKey, int i4, int i10, int i11, PBEParameterSpec pBEParameterSpec) {
        ...
        public static CipherParameters makePBEMacParameters(PBEKeySpec pBEKeySpec, int i4, int i10, int i11) {
            PBEParametersGenerator makePBEGenerator = makePBEGenerator(i4, i10);
        ...
        public static CipherParameters makePBEParameters(PBEKeySpec pBEKeySpec, int i4, int i10, int i11, int i12) {
            PBEParametersGenerator makePBEGenerator = makePBEGenerator(i4, i10);
            byte[] convertPassword = convertPassword(i4, pBEKeySpec);
            makePBEGenerator.init(convertPassword, pBEKeySpec.getSalt(), pBEKeySpec.getIterationCount());
        ...
        public static CipherParameters makePBEParameters(byte[] bArr, int i4, int i10, int i11, int i12, AlgorithmParameterSpec algorithmParameterSpec, String str) throws InvalidAlgorithmParameterException {
            if (algorithmParameterSpec == null || !(algorithmParameterSpec instanceof PBEParameterSpec)) {
