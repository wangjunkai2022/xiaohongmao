...
public class MessageDigestUtils {
    ...
    static {
        ...
        hashMap.put(PKCSObjectIdentifiers.md2, f.f93509a);
        digestOidMap.put(PKCSObjectIdentifiers.md4, "MD4");
        digestOidMap.put(PKCSObjectIdentifiers.md5, f.f93510b);
        ...
        digestOidMap.put(NISTObjectIdentifiers.id_sha3_224, f.f93516h);
        digestOidMap.put(NISTObjectIdentifiers.id_sha3_256, "SHA3-256");
        digestOidMap.put(NISTObjectIdentifiers.id_sha3_384, f.f93518j);
        digestOidMap.put(NISTObjectIdentifiers.id_sha3_512, f.f93519k);
