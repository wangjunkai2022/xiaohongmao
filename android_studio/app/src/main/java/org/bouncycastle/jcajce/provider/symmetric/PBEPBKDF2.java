...
public class PBEPBKDF2 {
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        public BasePBKDF2(String str, int i4) {
            this(str, i4, 1);
        }

        public BasePBKDF2(String str, int i4, int i10) {
        ...
        public SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            if (keySpec instanceof PBEKeySpec) {
                ...
                if (pBEKeySpec.getSalt() == null) {
                    ...
                    int i4 = this.defaultDigest;
                    int keyLength2 = pBEKeySpec.getKeyLength();
                    return new BCPBEKey(this.algName, this.algOid, this.scheme, i4, keyLength2, -1, pBEKeySpec, PBE.Util.makePBEMacParameters(pBEKeySpec, this.scheme, i4, keyLength2));
                } else {
