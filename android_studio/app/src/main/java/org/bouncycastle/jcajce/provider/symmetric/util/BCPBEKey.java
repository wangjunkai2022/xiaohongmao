...
public class BCPBEKey implements PBEKey, Destroyable {
    ...
    public BCPBEKey(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, int i4, int i10, int i11, int i12, PBEKeySpec pBEKeySpec, CipherParameters cipherParameters) {
    ...
    public byte[] getEncoded() {
        ...
        if (cipherParameters == null) {
            int i4 = this.type;
            return i4 == 2 ? PBEParametersGenerator.PKCS12PasswordToBytes(this.password) : i4 == 5 ? PBEParametersGenerator.PKCS5PasswordToUTF8Bytes(this.password) : PBEParametersGenerator.PKCS5PasswordToBytes(this.password);
        }
