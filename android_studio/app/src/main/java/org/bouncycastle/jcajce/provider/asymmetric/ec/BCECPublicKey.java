...
public class BCECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public byte[] getEncoded() {
        boolean z9 = this.withCompression || Properties.isOverrideSet("org.bouncycastle.ec.enable_pc");
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ECUtils.getDomainParametersFromName(this.ecSpec, z9)), this.ecPublicKey.getQ().getEncoded(z9));
    }
    ...
    public ECPoint getQ() {
        ECPoint q9 = this.ecPublicKey.getQ();
        return this.ecSpec == null ? q9.getDetachedPoint() : q9;
    }
