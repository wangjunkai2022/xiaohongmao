...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final String[] DIGESTS = {"GOST3411", "Keccak", f.f93509a, "MD4", f.f93510b, "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "SHA3", "Skein", "SM3", "Tiger", "Whirlpool", "Blake2b", "Blake2s", "DSTU7564", "Haraka"};
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int i4 = 0; i4 != strArr.length; i4++) {
            Class loadClass = ClassUtil.loadClass(BouncyCastleProvider.class, str + strArr[i4] + "$Mappings");
            if (loadClass != null) {
                try {
