...
public class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private Certificate extractCert() throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException("cannot process signing cert: " + e4.getMessage(), e4, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    static URI getOcspResponderURI(X509Certificate x509Certificate) {
        ...
        for (int i4 = 0; i4 != accessDescriptions.length; i4++) {
            AccessDescription accessDescription = accessDescriptions[i4];
