...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f91389c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (!this.f91389c.getSignatureAlgorithm().equals(this.f91389c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z9) {
        ...
        if (getVersion() != 2 || (extensions = this.f91389c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f91389c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRL) {
            if (obj instanceof X509CRLObject) {
                ...
                return this.f91389c.equals(x509CRLObject.f91389c);
            }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f91389c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f91389c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f91389c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f91389c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f91389c.getNextUpdate() != null) {
            return this.f91389c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f91389c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f91389c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f91389c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e4) {
            throw new CRLException(e4.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f91389c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f91389c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f91389c.getRevokedCertificateEnumeration();
            X500Name issuer2 = this.f91389c.getIssuer();
