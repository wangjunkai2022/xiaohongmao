...
public class PKIXPolicyNode implements PolicyNode {
    ...
    public PKIXPolicyNode(List list, int i4, Set set, PolicyNode policyNode, Set set2, String str, boolean z9) {
        this.children = list;
        this.depth = i4;
    ...
    public void setCritical(boolean z9) {
        this.critical = z9;
    }
    ...
    public String toString(String str) {
        ...
        for (int i4 = 0; i4 < this.children.size(); i4++) {
            stringBuffer.append(((PKIXPolicyNode) this.children.get(i4)).toString(str + "    "));
        }
        stringBuffer.append(str);
        stringBuffer.append("}\n");
