...
public class JCEECPrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    public JCEECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f91380d = eCPrivateKeySpec.getS();
    ...
    public JCEECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f91380d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public JCEECPrivateKey(String str, JCEECPrivateKey jCEECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f91380d = jCEECPrivateKey.f91380d;
    ...
    public JCEECPrivateKey(String str, org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f91380d = eCPrivateKeySpec.getD();
    ...
    public JCEECPrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "EC";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f91380d = eCPrivateKey.getS();
    ...
    */
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f91380d.toString(16));
        stringBuffer.append(lineSeparator);
