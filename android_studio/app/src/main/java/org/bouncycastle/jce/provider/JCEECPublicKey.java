...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f91381q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f91381q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f91381q = jCEECPublicKey.f91381q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = str;
        this.f91381q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f91381q.getCurve() == null) {
                this.f91381q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f91381q.getAffineXCoord().toBigInteger(), this.f91381q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f91381q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f91381q = curve2.decodePoint(bArr);
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            this.f91381q = new X9ECPoint(curve, dEROctetString).getPoint();
        } else {
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f91381q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f91381q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f91381q.getDetachedPoint() : this.f91381q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f91381q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f91381q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f91381q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
