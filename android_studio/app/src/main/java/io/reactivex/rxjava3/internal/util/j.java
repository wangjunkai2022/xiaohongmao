...
public final class j<T> implements q7.c<List<T>, List<T>, List<T>> {

    /* renamed from: a  reason: collision with root package name */
    final Comparator<? super T> f81338a;

    public j(Comparator<? super T> comparator) {
        this.f81338a = comparator;
    }
    ...
    */
    public java.util.List<T> apply(java.util.List<T> r6, java.util.List<T> r7) {
        ...
        L37:
            if (r0 == 0) goto L61
            if (r3 == 0) goto L61
            java.util.Comparator<? super T> r4 = r5.f81338a
        ...
        L85:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.rxjava3.internal.util.j.apply(java.util.List, java.util.List):java.util.List");
    }
}
