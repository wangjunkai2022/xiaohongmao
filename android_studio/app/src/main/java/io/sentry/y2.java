...
public final class y2 implements u2.c {
    @m8.g

    /* renamed from: a  reason: collision with root package name */
    private final u2.b f84203a;

    public y2(@m8.g u2.b bVar) {
        this.f84203a = (u2.b) io.sentry.util.l.c(bVar, "SendFireAndForgetDirPath is required");
    }
    ...
    public u2.a b(@m8.g n0 n0Var, @m8.g SentryOptions sentryOptions) {
        ...
        String a10 = this.f84203a.a();
        if (a10 != null && c(a10, sentryOptions.getLogger())) {
            return a(new j2(n0Var, sentryOptions.getEnvelopeReader(), sentryOptions.getSerializer(), sentryOptions.getLogger(), sentryOptions.getFlushTimeoutMillis()), a10, sentryOptions.getLogger());
        }
