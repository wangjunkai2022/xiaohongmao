...
public class CropImageOptions implements Parcelable {
                                ...
                                if (this.borderCornerThickness >= 0.0f) {
                                    if (this.guidelinesThickness >= 0.0f) {
                                        if (this.minCropWindowHeight >= 0) {
                                            ...
                                            if (i4 >= 0) {
                                                int i10 = this.minCropResultHeight;
                                                if (i10 >= 0) {
                                                    if (this.maxCropResultWidth >= i4) {
                                                        if (this.maxCropResultHeight >= i10) {
    ...
    public void writeToParcel(Parcel parcel, int i4) {
        ...
        TextUtils.writeToParcel(this.activityTitle, parcel, i4);
        parcel.writeInt(this.activityMenuIconColor);
        parcel.writeParcelable(this.outputUri, i4);
        ...
        parcel.writeParcelable(this.initialCropWindowRectangle, i4);
        ...
        TextUtils.writeToParcel(this.cropMenuCropButtonTitle, parcel, i4);
