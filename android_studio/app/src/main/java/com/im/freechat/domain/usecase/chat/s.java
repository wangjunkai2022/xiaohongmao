...
/* compiled from: SubscribeChatSyncStateInteractor.kt */
...
public final class s extends FlowUseCase<Unit, Boolean> {
    @m8.g

    /* renamed from: a  reason: collision with root package name */
    private final com.im.freechat.domain.t f41531a;

    public s(@m8.g com.im.freechat.domain.t syncRepository) {
        Intrinsics.checkNotNullParameter(syncRepository, "syncRepository");
        this.f41531a = syncRepository;
    }
