...
/* compiled from: ListenReceivedFriendRequestsInteractor.kt */
...
public final class c extends FlowUseCase<Unit, List<? extends FriendStatus>> {
    @g

    /* renamed from: a  reason: collision with root package name */
    private final com.im.freechat.domain.c f41559a;

    public c(@g com.im.freechat.domain.c databaseRepository) {
        Intrinsics.checkNotNullParameter(databaseRepository, "databaseRepository");
        this.f41559a = databaseRepository;
    }
