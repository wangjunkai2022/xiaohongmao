...
public final class ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$36 extends Lambda implements Function2<Scope, y8.a, f> {
    public ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$36() {
        super(2);
    }
    ...
    public final f invoke(@g Scope factory, @g y8.a it) {
        ...
        return new f((t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null));
    }
}
