...
public final class ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$28 extends Lambda implements Function2<Scope, y8.a, b> {
    public ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$28() {
        super(2);
    }
    ...
    public final b invoke(@g Scope factory, @g y8.a it) {
        ...
        return new b((k) p9, (p) factory.p(Reflection.getOrCreateKotlinClass(p.class), null, null), (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
