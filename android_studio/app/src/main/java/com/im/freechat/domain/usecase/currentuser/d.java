...
/* compiled from: GetSoundSettingInteractor.kt */
...
public final class d extends com.im.freechat.domain.usecase.base.a<Unit, Boolean> {
    @m8.g

    /* renamed from: a  reason: collision with root package name */
    private final com.im.freechat.domain.k f41671a;

    public d(@m8.g com.im.freechat.domain.k loginRepository) {
        Intrinsics.checkNotNullParameter(loginRepository, "loginRepository");
        this.f41671a = loginRepository;
    }
    ...
    public Object b(@m8.g Unit unit, @m8.g Continuation<? super Boolean> continuation) {
        return Boxing.boxBoolean(this.f41671a.k());
    }
}
