...
public final class ChatListModuleKt$chatListModule$1$invoke$$inlined$factoryOf$3 extends Lambda implements Function2<Scope, y8.a, f> {
    public ChatListModuleKt$chatListModule$1$invoke$$inlined$factoryOf$3() {
        super(2);
    }
    ...
    public final f invoke(@g Scope factory, @g y8.a it) {
        ...
        return new f((k) factory.p(Reflection.getOrCreateKotlinClass(k.class), null, null));
    }
}
