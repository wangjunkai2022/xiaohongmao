...
public final class ContactModuleKt$contactModule$1$invoke$$inlined$factoryOf$9 extends Lambda implements Function2<Scope, y8.a, i> {
    public ContactModuleKt$contactModule$1$invoke$$inlined$factoryOf$9() {
        super(2);
    }
    ...
    public final i invoke(@g Scope factory, @g y8.a it) {
        ...
        return new i((t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null));
    }
}
