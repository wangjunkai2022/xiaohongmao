...
public final class a extends com.im.freechat.domain.usecase.base.a<Unit, UserInfo> {
    @m8.g

    /* renamed from: a  reason: collision with root package name */
    private final com.im.freechat.domain.k f41668a;

    public a(@m8.g com.im.freechat.domain.k loginRepository) {
        Intrinsics.checkNotNullParameter(loginRepository, "loginRepository");
        this.f41668a = loginRepository;
    }
    ...
    @m8.h
    /* renamed from: c */
    public Object b(@m8.g Unit unit, @m8.g Continuation<? super UserInfo> continuation) {
        return this.f41668a.v(continuation);
    }
}
