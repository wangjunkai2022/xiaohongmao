...
import com.im.freechat.service.music.b;
...
public final class CommonModuleKt$commonModule$1$invoke$$inlined$singleOf$4 extends Lambda implements Function2<Scope, y8.a, e> {
    ...
    public final e invoke(@g Scope single, @g y8.a it) {
        ...
        return new e((b) single.p(Reflection.getOrCreateKotlinClass(b.class), null, null));
    }
}
