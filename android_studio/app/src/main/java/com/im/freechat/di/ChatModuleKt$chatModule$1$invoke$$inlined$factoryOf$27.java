...
public final class ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$27 extends Lambda implements Function2<Scope, y8.a, f> {
    public ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$27() {
        super(2);
    }
    ...
    public final f invoke(@g Scope factory, @g y8.a it) {
        ...
        return new f((p) factory.p(Reflection.getOrCreateKotlinClass(p.class), null, null), (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
