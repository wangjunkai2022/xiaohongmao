...
public final class ApiModuleKt$apiModule$1$invoke$$inlined$singleOf$1 extends Lambda implements Function2<Scope, y8.a, c> {
    public ApiModuleKt$apiModule$1$invoke$$inlined$singleOf$1() {
        super(2);
    }
    ...
    public final c invoke(@g Scope single, @g y8.a it) {
        ...
        return new c((RemoteApi) single.p(Reflection.getOrCreateKotlinClass(RemoteApi.class), null, null));
    }
}
