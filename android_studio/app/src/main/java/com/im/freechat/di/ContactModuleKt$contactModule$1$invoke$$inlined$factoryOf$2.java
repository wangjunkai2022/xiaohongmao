...
public final class ContactModuleKt$contactModule$1$invoke$$inlined$factoryOf$2 extends Lambda implements Function2<Scope, y8.a, h> {
    public ContactModuleKt$contactModule$1$invoke$$inlined$factoryOf$2() {
        super(2);
    }

    @Override // kotlin.jvm.functions.Function2
    public final h invoke(@g Scope factory, @g y8.a it) {
        Intrinsics.checkNotNullParameter(factory, "$this$factory");
        Intrinsics.checkNotNullParameter(it, "it");
        Object p9 = factory.p(Reflection.getOrCreateKotlinClass(k.class), null, null);
        return new h((k) p9, (p) factory.p(Reflection.getOrCreateKotlinClass(p.class), null, null), (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
