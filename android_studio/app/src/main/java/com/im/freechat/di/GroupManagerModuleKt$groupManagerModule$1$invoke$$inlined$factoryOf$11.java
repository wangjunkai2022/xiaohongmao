...
public final class GroupManagerModuleKt$groupManagerModule$1$invoke$$inlined$factoryOf$11 extends Lambda implements Function2<Scope, y8.a, m> {
    public GroupManagerModuleKt$groupManagerModule$1$invoke$$inlined$factoryOf$11() {
        super(2);
    }
    ...
    public final m invoke(@g Scope factory, @g y8.a it) {
        ...
        return new m((k) p9, (com.im.freechat.domain.g) factory.p(Reflection.getOrCreateKotlinClass(com.im.freechat.domain.g.class), null, null), (t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null));
    }
}
