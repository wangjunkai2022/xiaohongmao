...
public final class ChatListModuleKt$chatListModule$1$invoke$$inlined$factoryOf$18 extends Lambda implements Function2<Scope, y8.a, m> {
    public ChatListModuleKt$chatListModule$1$invoke$$inlined$factoryOf$18() {
        super(2);
    }
    ...
    public final m invoke(@g Scope factory, @g y8.a it) {
        ...
        return new m((k) p9, (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null), (p) factory.p(Reflection.getOrCreateKotlinClass(p.class), null, null));
    }
}
