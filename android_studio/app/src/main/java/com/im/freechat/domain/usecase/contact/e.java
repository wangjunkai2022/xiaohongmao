...
public final class e extends FlowUseCase<Unit, List<? extends UserModel>> {
    ...
    @m8.h
    /* renamed from: e */
    public Object b(@m8.g Unit unit, @m8.g Continuation<? super kotlinx.coroutines.flow.i<? extends List<UserModel>>> continuation) {
