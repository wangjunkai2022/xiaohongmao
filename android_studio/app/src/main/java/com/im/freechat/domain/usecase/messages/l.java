...
public final class l extends FlowUseCase<Unit, SocketEvent> {
    ...
    @m8.h
    /* renamed from: e */
    public Object b(@m8.g Unit unit, @m8.g Continuation<? super kotlinx.coroutines.flow.i<? extends SocketEvent>> continuation) {
