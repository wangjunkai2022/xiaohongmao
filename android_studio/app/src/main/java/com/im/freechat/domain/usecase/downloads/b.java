...
public final class b extends FlowUseCase<Unit, List<? extends DownloadInfo>> {
    ...
    @h
    /* renamed from: e */
    public Object b(@g Unit unit, @g Continuation<? super i<? extends List<DownloadInfo>>> continuation) {
        return this.f41783a.r();
    }
}
