...
import com.im.freechat.domain.usecase.currentuser.g;
...
public final class AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$8 extends Lambda implements Function2<Scope, y8.a, g> {
    public AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$8() {
        super(2);
    }
    ...
    public final g invoke(@m8.g Scope factory, @m8.g y8.a it) {
        ...
        return new g((k) p9, (t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null), (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
