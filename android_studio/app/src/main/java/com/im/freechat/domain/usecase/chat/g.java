...
/* compiled from: ListenAllChatsInteractor.kt */
...
public final class g extends FlowUseCase<Unit, List<? extends Chat>> {
    @m8.g

    /* renamed from: a  reason: collision with root package name */
    private final com.im.freechat.domain.c f41483a;

    public g(@m8.g com.im.freechat.domain.c databaseRepository) {
        Intrinsics.checkNotNullParameter(databaseRepository, "databaseRepository");
        this.f41483a = databaseRepository;
    }
