...
public final class GroupManagerModuleKt$groupManagerModule$1$invoke$$inlined$factoryOf$9 extends Lambda implements Function2<Scope, y8.a, o> {
    public GroupManagerModuleKt$groupManagerModule$1$invoke$$inlined$factoryOf$9() {
        super(2);
    }
    ...
    public final o invoke(@g Scope factory, @g y8.a it) {
        ...
        return new o((k) factory.p(Reflection.getOrCreateKotlinClass(k.class), null, null), (t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null));
    }
}
