...
public final class ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$35 extends Lambda implements Function2<Scope, y8.a, i> {
    public ChatModuleKt$chatModule$1$invoke$$inlined$factoryOf$35() {
        super(2);
    }
    ...
    public final i invoke(@g Scope factory, @g y8.a it) {
        ...
        return new i((c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
