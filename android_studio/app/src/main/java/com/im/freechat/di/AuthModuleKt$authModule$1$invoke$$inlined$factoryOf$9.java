...
public final class AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$9 extends Lambda implements Function2<Scope, y8.a, b> {
    public AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$9() {
        super(2);
    }
    ...
    public final b invoke(@g Scope factory, @g y8.a it) {
        ...
        return new b((k) p9, (t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null), (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
