...
public final class AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$2 extends Lambda implements Function2<Scope, y8.a, i> {
    public AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$2() {
        super(2);
    }
    ...
    public final i invoke(@g Scope factory, @g y8.a it) {
        ...
        return new i((k) factory.p(Reflection.getOrCreateKotlinClass(k.class), null, null));
    }
}
