...
public final class AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$6 extends Lambda implements Function2<Scope, y8.a, i> {
    public AuthModuleKt$authModule$1$invoke$$inlined$factoryOf$6() {
        super(2);
    }
    ...
    public final i invoke(@g Scope factory, @g y8.a it) {
        ...
        Object p10 = factory.p(Reflection.getOrCreateKotlinClass(p.class), null, null);
        return new i((k) p9, (p) p10, (t) factory.p(Reflection.getOrCreateKotlinClass(t.class), null, null), (c) factory.p(Reflection.getOrCreateKotlinClass(c.class), null, null));
    }
}
