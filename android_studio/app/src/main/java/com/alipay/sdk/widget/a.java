...
public final class a {
    ...
    /* loaded from: classes.dex */
    public class AlertDialogC0039a extends AlertDialog {
        /* JADX INFO: Access modifiers changed from: protected */
        public AlertDialogC0039a(Context context) {
            super(context);
        }
        ...
        private static Drawable b(Context context, String str) {
            ...
            try {
                byteArrayInputStream = new ByteArrayInputStream(n.a.d(str));
        ...
        private View c(Context context) {
            ...
            layoutParams2.setMargins(a(a.this.f6984b, 17.0f), a(a.this.f6984b, 10.0f), a(a.this.f6984b, 8.0f), a(a.this.f6984b, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(b(context, a.f6982g));
            ...
            textView.setText(TextUtils.isEmpty(a.this.f6985c) ? a.f6979d : a.this.f6985c);
