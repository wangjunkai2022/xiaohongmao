...
final class b {
    ...
    static final String f55561a = "GMT";

    /* renamed from: b  reason: collision with root package name */
    static final TimeZone f55562b = TimeZone.getTimeZone(f55561a);
    ...
    public static String b(Date date) {
        GregorianCalendar gregorianCalendar = new GregorianCalendar(f55562b, Locale.US);
    ...
    */
    public static java.util.Date e(java.lang.String r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.squareup.moshi.adapters.b.e(java.lang.String):java.util.Date");
    }
