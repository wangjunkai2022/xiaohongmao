...
public final class m0 extends k0 {
    ...
    public m0(@m8.g ViewGroup viewGroup, @m8.g View view) {
        super(null);
        this.f43879a = viewGroup;
        this.f43880b = view;
    }

    public static /* synthetic */ m0 f(m0 m0Var, ViewGroup viewGroup, View view, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            viewGroup = m0Var.b();
        }
        if ((i4 & 2) != 0) {
    ...
    @m8.g
    public final m0 e(@m8.g ViewGroup viewGroup, @m8.g View view) {
