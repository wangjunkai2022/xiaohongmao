...
public class c {
    ...
    public static Map<Integer, List<String>> a() {
        ...
        arrayList50.add("TN");
        hashMap.put(Integer.valueOf((int) com.facebook.imageutils.c.f13388c), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        hashMap.put(Integer.valueOf((int) com.facebook.imageutils.c.f13391f), arrayList51);
        ...
        arrayList57.add("CI");
        hashMap.put(Integer.valueOf((int) com.facebook.imageutils.c.f13392g), arrayList57);
        ...
        arrayList72.add("GQ");
        hashMap.put(Integer.valueOf((int) a0.A), arrayList72);
        ...
        arrayList133.add("CZ");
        hashMap.put(Integer.valueOf((int) TypedValues.Cycle.TYPE_EASING), arrayList133);
        ArrayList arrayList134 = new ArrayList(1);
        arrayList134.add("SK");
        hashMap.put(421, arrayList134);
        ArrayList arrayList135 = new ArrayList(1);
        arrayList135.add("LI");
        hashMap.put(Integer.valueOf((int) TypedValues.Cycle.TYPE_WAVE_PERIOD), arrayList135);
        ...
        arrayList138.add("GT");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_DRAWPATH), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_PERCENT_WIDTH), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_PERCENT_HEIGHT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_SIZE_PERCENT), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("CR");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_PERCENT_X), arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PA");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_PERCENT_Y), arrayList143);
        ArrayList arrayList144 = new ArrayList(1);
        arrayList144.add("PM");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_CURVE_FIT), arrayList144);
        ...
        arrayList155.add("CW");
        arrayList155.add("BQ");
        hashMap.put(Integer.valueOf((int) f0.f83193d), arrayList155);
