...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(@NonNull TextInputLayout textInputLayout) {
        ...
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.2
            ...
            public void onFocusChange(View view, boolean z9) {
                DropdownMenuEndIconDelegate.this.textInputLayout.setEndIconActivated(z9);
                if (z9) {
                    return;
                }
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float f10, float f11, float f12, int i4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setEndIconChecked(boolean z9) {
