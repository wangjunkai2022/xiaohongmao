...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public class CheckedStateTracker implements MaterialButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(@NonNull MaterialButton materialButton, boolean z9) {
            if (MaterialButtonToggleGroup.this.skipCheckedStateTracker) {
                return;
            }
            if (MaterialButtonToggleGroup.this.singleSelection) {
                MaterialButtonToggleGroup.this.checkedId = z9 ? materialButton.getId() : -1;
            }
            if (MaterialButtonToggleGroup.this.updateCheckedStates(materialButton.getId(), z9)) {
    ...
    public interface OnButtonCheckedListener {
        void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, @IdRes int i4, boolean z9);
    }
    ...
    private void checkForced(int i4, boolean z9) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void dispatchOnButtonChecked(@IdRes int i4, boolean z9) {
        Iterator<OnButtonCheckedListener> it = this.onButtonCheckedListeners.iterator();
        while (it.hasNext()) {
            it.next().onButtonChecked(this, i4, z9);
        }
    }
    ...
    @Nullable
    private CornerData getNewCornerData(int i4, int i10, int i11) {
    ...
    private void setCheckedStateForView(@IdRes int i4, boolean z9) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean updateCheckedStates(int i4, boolean z9) {
