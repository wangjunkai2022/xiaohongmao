...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i10) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, i4, i10, new int[0]);
    ...
    protected void applyNewVisibility(boolean z9) {
    ...
    public void setTrackCornerRadius(@Px int i4) {
        S s9 = this.spec;
        if (s9.trackCornerRadius != i4) {
            s9.trackCornerRadius = Math.min(i4, s9.trackThickness / 2);
        }
    }

    public void setTrackThickness(@Px int i4) {
        S s9 = this.spec;
        if (s9.trackThickness != i4) {
            s9.trackThickness = i4;
            requestLayout();
        }
    }
