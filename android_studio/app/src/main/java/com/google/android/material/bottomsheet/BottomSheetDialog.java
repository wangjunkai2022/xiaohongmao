...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    protected BottomSheetDialog(@NonNull Context context, boolean z9, DialogInterface.OnCancelListener onCancelListener) {
