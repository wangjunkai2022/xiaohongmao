...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public void updateTime(int i4, int i10, int i11) {
    ...
    public void setHandRotation(float f10, boolean z9) {
        this.clockHandView.setHandRotation(f10, z9);
    }
    ...
    public TimePickerView(Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView.2
            ...
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i10, boolean z9) {
                int i11 = i10 == R.id.material_clock_period_pm_button ? 1 : 0;
                if (TimePickerView.this.onPeriodChangeListener == null || !z9) {
                    return;
                }
