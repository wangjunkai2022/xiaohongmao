...
public class MaterialResources {
    ...
    public static int getDimensionPixelSize(@NonNull Context context, @NonNull TypedArray typedArray, @StyleableRes int i4, int i10) {
    ...
    @StyleableRes
    public static int getIndexWithValue(@NonNull TypedArray typedArray, @StyleableRes int i4, @StyleableRes int i10) {
        return typedArray.hasValue(i4) ? i4 : i10;
    }
