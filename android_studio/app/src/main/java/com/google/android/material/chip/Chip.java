...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private void insetChipBackgroundDrawable(int i4, int i10, int i11, int i12) {
        this.insetBackgroundDrawable = new InsetDrawable((Drawable) this.chipDrawable, i4, i10, i11, i12);
    }
    ...
    protected void onFocusChanged(boolean z9, int i4, Rect rect) {
        ...
        this.touchHelper.onFocusChanged(z9, i4, rect);
    }
    ...
    */
    ...
    public void setChecked(boolean z9) {
        ...
        if (chipDrawable == null) {
            ...
            super.setChecked(z9);
            if (isChecked == z9 || (onCheckedChangeListener = this.onCheckedChangeListenerInternal) == null) {
                return;
            }
