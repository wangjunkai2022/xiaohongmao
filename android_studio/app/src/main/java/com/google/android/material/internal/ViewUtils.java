...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i4, int i10) {
        doOnApplyWindowInsets(view, attributeSet, i4, i10, null);
    }
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i4, int i10, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, R.styleable.Insets, i4, i10);
        final boolean z9 = obtainStyledAttributes.getBoolean(R.styleable.Insets_paddingBottomSystemWindowInsets, false);
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(int i4, int i10, int i11, int i12) {
            this.start = i4;
            this.top = i10;
            this.end = i11;
            this.bottom = i12;
