...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    @NonNull
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f10, float f11, boolean z9, @NonNull FabTransformationSpec fabTransformationSpec) {
        MotionTiming timing;
    ...
    private void createDependencyTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z9, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list) {
        ...
        Pair<MotionTiming, MotionTiming> calculateMotionTiming = calculateMotionTiming(calculateTranslationX, calculateTranslationY, z9, fabTransformationSpec);
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, float f10, float f11, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        Animator animator;
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z9) {
                ...
                createPreFillRadialExpansion(view2, timing.getDelay(), i4, i10, f12, list);
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i4, i10, width, list);
    ...
    private void createPostFillRadialExpansion(View view, long j4, long j10, long j11, int i4, int i10, float f10, @NonNull List<Animator> list) {
        long j12 = j4 + j10;
        if (j12 < j11) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i4, i10, f10, f10);
    ...
    private void createPreFillRadialExpansion(View view, long j4, int i4, int i10, float f10, @NonNull List<Animator> list) {
        if (j4 > 0) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i4, i10, f10, f10);
    ...
    @NonNull
    protected AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull final View view, @NonNull final View view2, final boolean z9, boolean z10) {
        FabTransformationSpec onCreateMotionSpec = onCreateMotionSpec(view2.getContext(), z9);
        if (z9) {
        ...
        createElevationAnimation(view, view2, z9, z10, onCreateMotionSpec, arrayList, arrayList2);
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view, view2, z9, z10, onCreateMotionSpec, arrayList, arrayList2, rectF);
        float width = rectF.width();
        float height = rectF.height();
        createDependencyTranslationAnimation(view, view2, z9, onCreateMotionSpec, arrayList);
        createIconFadeAnimation(view, view2, z9, z10, onCreateMotionSpec, arrayList, arrayList2);
        createExpansionAnimation(view, view2, z9, z10, onCreateMotionSpec, width, height, arrayList, arrayList2);
        createColorAnimation(view, view2, z9, z10, onCreateMotionSpec, arrayList, arrayList2);
        createChildrenFadeAnimation(view, view2, z9, z10, onCreateMotionSpec, arrayList, arrayList2);
    ...
    protected abstract FabTransformationSpec onCreateMotionSpec(Context context, boolean z9);
