...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, @NonNull View view, @NonNull View view2, int i4, int i10) {
            return bottomAppBar.getHideOnScroll() && super.onStartNestedScroll(coordinatorLayout, (CoordinatorLayout) bottomAppBar, view, view2, i4, i10);
        }
    ...
    private void createMenuViewTranslationAnimation(final int i4, final boolean z9, @NonNull List<Animator> list) {
        final ActionMenuView actionMenuView = getActionMenuView();
        if (actionMenuView == null) {
            return;
        }
        Animator ofFloat = ObjectAnimator.ofFloat(actionMenuView, "alpha", 1.0f);
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i4, z9)) > 1.0f) {
            ...
            ofFloat2.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, i4, z9, z10);
                }
            });
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int i4, boolean z9) {
        ...
        createMenuViewTranslationAnimation(i4, z9, arrayList);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i4, boolean z9) {
        translateActionMenuView(actionMenuView, i4, z9, false);
    }
    ...
    protected int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i4, boolean z9) {
        if (i4 == 1 && z9) {
            boolean isLayoutRtl = ViewUtils.isLayoutRtl(this);
    ...
    public void setFabAlignmentModeAndReplaceMenu(int i4, @MenuRes int i10) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i4, final boolean z9, boolean z10) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                ActionMenuView actionMenuView2 = actionMenuView;
                actionMenuView2.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(actionMenuView2, i4, z9));
            }
        };
        if (z10) {
