...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i4) {
            ...
            CollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction(Math.abs(i4) / f10);
        }
    }
    ...
    private void updateCollapsedBounds(boolean z9) {
        ...
        collapsingTextHelper.setCollapsedBounds(i13, i14, i15 - i12, (rect.bottom + maxOffsetForPinChild) - i4);
    }
    ...
    private void updateContentScrimBounds(@NonNull Drawable drawable, int i4, int i10) {
        updateContentScrimBounds(drawable, this.toolbar, i4, i10);
    }
    ...
    private void updateTextBounds(int i4, int i10, int i11, int i12, boolean z9) {
        View view;
        if (!this.collapsingTitleEnabled || (view = this.dummyView) == null) {
            return;
        }
        boolean z10 = ViewCompat.isAttachedToWindow(view) && this.dummyView.getVisibility() == 0;
        this.drawCollapsingTitle = z10;
        if (z10 || z9) {
            boolean z11 = ViewCompat.getLayoutDirection(this) == 1;
            updateCollapsedBounds(z11);
            this.collapsingTextHelper.setExpandedBounds(z11 ? this.expandedMarginEnd : this.expandedMarginStart, this.tmpRect.top + this.expandedMarginTop, (i11 - i4) - (z11 ? this.expandedMarginStart : this.expandedMarginEnd), (i12 - i10) - this.expandedMarginBottom);
    ...
    protected boolean drawChild(Canvas canvas, View view, long j4) {
        ...
        return super.drawChild(canvas, view, j4) || z9;
    }
    ...
    protected void onLayout(boolean z9, int i4, int i10, int i11, int i12) {
        ...
        updateTextBounds(i4, i10, i11, i12, false);
    ...
    protected void onSizeChanged(int i4, int i10, int i11, int i12) {
        ...
        if (drawable != null) {
            updateContentScrimBounds(drawable, i4, i10);
        }
    }
    ...
    private void updateContentScrimBounds(@NonNull Drawable drawable, @Nullable View view, int i4, int i10) {
