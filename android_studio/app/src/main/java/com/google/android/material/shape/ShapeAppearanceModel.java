...
public class ShapeAppearanceModel {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setAllCorners(int i4, @Dimension float f10) {
            return setAllCorners(MaterialShapeUtils.createCornerTreatment(i4)).setAllCornerSizes(f10);
        }
        ...
        @NonNull
        public Builder setBottomLeftCorner(int i4, @Dimension float f10) {
            return setBottomLeftCorner(MaterialShapeUtils.createCornerTreatment(i4)).setBottomLeftCornerSize(f10);
        }
        ...
        @NonNull
        public Builder setBottomRightCorner(int i4, @Dimension float f10) {
            return setBottomRightCorner(MaterialShapeUtils.createCornerTreatment(i4)).setBottomRightCornerSize(f10);
        }
        ...
        @NonNull
        public Builder setTopLeftCorner(int i4, @Dimension float f10) {
            return setTopLeftCorner(MaterialShapeUtils.createCornerTreatment(i4)).setTopLeftCornerSize(f10);
        }
        ...
        @NonNull
        public Builder setTopRightCorner(int i4, @Dimension float f10) {
            return setTopRightCorner(MaterialShapeUtils.createCornerTreatment(i4)).setTopRightCornerSize(f10);
        }
    ...
    @NonNull
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i10) {
    ...
    @NonNull
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i10, int i11) {
        return builder(context, attributeSet, i4, i10, new AbsoluteCornerSize(i11));
    }

    @NonNull
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i10, @NonNull CornerSize cornerSize) {
    ...
    @NonNull
    public static Builder builder(Context context, @StyleRes int i4, @StyleRes int i10) {
        return builder(context, i4, i10, 0);
    }

    @NonNull
    private static Builder builder(Context context, @StyleRes int i4, @StyleRes int i10, int i11) {
        return builder(context, i4, i10, new AbsoluteCornerSize(i11));
    }

    @NonNull
    private static Builder builder(Context context, @StyleRes int i4, @StyleRes int i10, @NonNull CornerSize cornerSize) {
        if (i10 != 0) {
