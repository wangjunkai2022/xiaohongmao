...
public class ElevationOverlayProvider {
    ...
    @ColorInt
    public int compositeOverlay(@ColorInt int i4, float f10, @NonNull View view) {
        return compositeOverlay(i4, f10 + getParentAbsoluteElevation(view));
    }

    @ColorInt
    public int compositeOverlayIfNeeded(@ColorInt int i4, float f10, @NonNull View view) {
        return compositeOverlayIfNeeded(i4, f10 + getParentAbsoluteElevation(view));
    }
    ...
    @ColorInt
    public int compositeOverlay(@ColorInt int i4, float f10) {
    ...
    @ColorInt
    public int compositeOverlayIfNeeded(@ColorInt int i4, float f10) {
        return (this.elevationOverlayEnabled && isThemeSurfaceColor(i4)) ? compositeOverlay(i4, f10) : i4;
    }
