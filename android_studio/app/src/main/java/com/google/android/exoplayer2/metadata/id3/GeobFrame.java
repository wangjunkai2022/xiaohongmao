...
public final class GeobFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return z0.c(this.mimeType, geobFrame.mimeType) && z0.c(this.filename, geobFrame.filename) && z0.c(this.description, geobFrame.description) && Arrays.equals(this.data, geobFrame.data);
    }
    ...
    GeobFrame(Parcel parcel) {
        ...
        this.filename = (String) z0.k(parcel.readString());
