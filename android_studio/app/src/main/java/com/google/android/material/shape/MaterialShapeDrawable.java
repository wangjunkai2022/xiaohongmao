...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private PorterDuffColorFilter calculateTintFilter(@Nullable ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, @NonNull Paint paint, boolean z9) {
        if (colorStateList != null && mode != null) {
            return calculateTintColorTintFilter(colorStateList, mode, z9);
        }
        return calculatePaintColorTintFilter(paint, z9);
    }
    ...
    private static int modulateAlpha(int i4, int i10) {
        return (i4 * (i10 + (i10 >>> 7))) >>> 8;
    }
    ...
    public int compositeElevationOverlayIfNeeded(@ColorInt int i4) {
        ...
        return elevationOverlayProvider != null ? elevationOverlayProvider.compositeOverlayIfNeeded(i4, z9) : i4;
    }
    ...
    @Deprecated
    public void getPathForSize(int i4, int i10, @NonNull Path path) {
        calculatePathForSize(new RectF(0.0f, 0.0f, i4, i10), path);
    }
    ...
    public boolean isPointInTransparentRegion(int i4, int i10) {
        return getTransparentRegion().contains(i4, i10);
    }
    ...
    public void setPadding(int i4, int i10, int i11, int i12) {
        ...
        this.drawableState.padding.set(i4, i10, i11, i12);
        invalidateSelf();
    }
    ...
    public void setStroke(float f10, @ColorInt int i4) {
        setStrokeWidth(f10);
    ...
    public MaterialShapeDrawable(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i10) {
        this(ShapeAppearanceModel.builder(context, attributeSet, i4, i10).build());
    }
