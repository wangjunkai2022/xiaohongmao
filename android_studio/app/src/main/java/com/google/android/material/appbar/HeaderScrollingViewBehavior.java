...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i4, int i10, int i11, int i12) {
        ...
        if ((i13 == -1 || i13 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            ...
            coordinatorLayout.onMeasureChild(view, i4, i10, View.MeasureSpec.makeMeasureSpec(scrollRange, i13 == -1 ? 1073741824 : Integer.MIN_VALUE), i12);
            return true;
        }
        return false;
    }
