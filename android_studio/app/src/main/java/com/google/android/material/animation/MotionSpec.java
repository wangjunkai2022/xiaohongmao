...
public class MotionSpec {
    ...
    public static MotionSpec createFromResource(@NonNull Context context, @AnimatorRes int i4) {
        try {
            ...
            Log.w(TAG, "Can't load animation resource ID #0x" + Integer.toHexString(i4), e4);
            return null;
        }
    }
    ...
    public <T> ObjectAnimator getAnimator(@NonNull String str, @NonNull T t9, @NonNull Property<T, ?> property) {
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(t9, getPropertyValues(str));
