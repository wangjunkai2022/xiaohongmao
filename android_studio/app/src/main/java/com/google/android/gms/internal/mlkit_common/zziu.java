...
public enum zziu implements f0 {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_TRANSLATOR_CREATE(com.google.android.exoplayer2.extractor.ts.h0.K),
    ...
    AGGREGATED_ON_DEVICE_SEGMENTATION(com.facebook.imageutils.c.f13394i),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(TypedValues.Cycle.TYPE_VISIBILITY),
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(TypedValues.Cycle.TYPE_ALPHA),
    ...
    NLCLASSIFIER_CLIENT_LIBRARY_CREATE(TypedValues.Cycle.TYPE_CUSTOM_WAVE_SHAPE),
    NLCLASSIFIER_CLIENT_LIBRARY_CLASSIFY(TypedValues.Cycle.TYPE_WAVE_PERIOD),
    NLCLASSIFIER_CLIENT_LIBRARY_CLOSE(TypedValues.Cycle.TYPE_WAVE_OFFSET),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(TypedValues.Position.TYPE_DRAWPATH),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(TypedValues.Position.TYPE_PERCENT_WIDTH),
    ON_DEVICE_EXPLICIT_CONTENT_CLOSE(TypedValues.Position.TYPE_PERCENT_HEIGHT),
