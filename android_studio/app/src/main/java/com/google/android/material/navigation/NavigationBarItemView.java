...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    private static void setViewLayoutParams(@NonNull View view, int i4, int i10) {
    ...
    private static void setViewScaleValues(@NonNull View view, float f10, float f11, int i4) {
        view.setScaleX(f10);
        view.setScaleY(f11);
