...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private void updateIconPosition(int i4, int i10) {
        ...
        if (i12 != 1 && i12 != 3) {
            ...
            int textWidth = (((((i4 - getTextWidth()) - ViewCompat.getPaddingEnd(this)) - i13) - this.iconPadding) - ViewCompat.getPaddingStart(this)) / 2;
    ...
    public void onLayout(boolean z9, int i4, int i10, int i11, int i12) {
        ...
        materialButtonHelper.updateMaskBounds(i12 - i10, i11 - i4);
    }
