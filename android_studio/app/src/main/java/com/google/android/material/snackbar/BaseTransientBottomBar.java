...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static abstract class BaseCallback<B> {
        ...
        public void onDismissed(B b10, int i4) {
        }
    ...
    public interface OnLayoutChangeListener {
        void onLayoutChange(View view, int i4, int i10, int i11, int i12);
    }
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected void onLayout(boolean z9, int i4, int i10, int i11, int i12) {
            ...
            if (onLayoutChangeListener != null) {
                onLayoutChangeListener.onLayoutChange(this, i4, i10, i11, i12);
            }
        }
    ...
    final void showView() {
        ...
        if (ViewCompat.isLaidOut(this.view)) {
            ...
            this.view.setOnLayoutChangeListener(new OnLayoutChangeListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.8
                ...
                public void onLayoutChange(View view, int i4, int i10, int i11, int i12) {
