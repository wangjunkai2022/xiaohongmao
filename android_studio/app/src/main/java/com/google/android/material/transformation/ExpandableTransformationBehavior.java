...
public abstract class ExpandableTransformationBehavior extends ExpandableBehavior {
    ...
    @NonNull
    protected abstract AnimatorSet onCreateExpandedStateChangeAnimation(View view, View view2, boolean z9, boolean z10);
    ...
    public boolean onExpandedStateChange(View view, View view2, boolean z9, boolean z10) {
        ...
        AnimatorSet onCreateExpandedStateChangeAnimation = onCreateExpandedStateChangeAnimation(view, view2, z9, z11);
