...
public final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void maybeUpdateSegmentColors(int i4) {
        for (int i10 = 0; i10 < 4; i10++) {
            float fractionInRange = getFractionInRange(i4, DELAY_TO_FADE_IN_MS[i10], 333);
    ...
    private void updateSegmentPositions(int i4) {
        ...
        fArr[1] = f10 * 1520.0f;
        for (int i10 = 0; i10 < 4; i10++) {
            float fractionInRange = getFractionInRange(i4, DELAY_TO_EXPAND_IN_MS[i10], 667);
            float[] fArr2 = this.segmentPositions;
            fArr2[1] = fArr2[1] + (this.interpolator.getInterpolation(fractionInRange) * 250.0f);
            float fractionInRange2 = getFractionInRange(i4, DELAY_TO_COLLAPSE_IN_MS[i10], 667);
