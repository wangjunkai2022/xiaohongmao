...
public final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void updateSegmentPositions(int i4) {
        for (int i10 = 0; i10 < 4; i10++) {
            this.segmentPositions[i10] = Math.max(0.0f, Math.min(1.0f, this.interpolatorArray[i10].getInterpolation(getFractionInRange(i4, DELAY_TO_MOVE_SEGMENT_ENDS[i10], DURATION_TO_MOVE_SEGMENT_ENDS[i10]))));
        }
    }
