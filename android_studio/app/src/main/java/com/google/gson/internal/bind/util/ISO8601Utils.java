...
public class ISO8601Utils {
    ...
    private static boolean checkOffset(String str, int i4, char c10) {
    ...
    private static void padInt(StringBuilder sb, int i4, int i10) {
    ...
    */
    ...
    private static int parseInt(String str, int i4, int i10) throws NumberFormatException {
        int i11;
        int i12;
