...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
            ...
            while (i4 < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (i10 < size) {
                        ...
                        Field field2 = field;
                        boundField2 = boundField3 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, TypeToken.get(resolve), z10, excludeField2)) : boundField3;
                        i10 = i11 + 1;
                        excludeField = z10;
                        fieldNames = list;
                        size = i12;
    ...
    static boolean excludeField(Field field, boolean z9, Excluder excluder) {
