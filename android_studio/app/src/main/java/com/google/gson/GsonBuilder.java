...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i4, int i10, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            ...
            TypeAdapterFactory createAdapterFactory = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(i4, i10);
            if (z9) {
                typeAdapterFactory3 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i4, i10);
                TypeAdapterFactory createAdapterFactory2 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i4, i10);
