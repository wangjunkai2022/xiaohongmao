...
public abstract class a<VB extends ViewBinding, Event> extends BaseMvvmFragment<VB, Event> implements q6.d {
    ...
    private ContextWrapper f51171f;

    /* renamed from: g  reason: collision with root package name */
    private boolean f51172g;

    /* renamed from: h  reason: collision with root package name */
    private volatile dagger.hilt.android.internal.managers.g f51173h;

    /* renamed from: i  reason: collision with root package name */
    private final Object f51174i = new Object();
    ...
    private void v0() {
        if (this.f51171f == null) {
            this.f51171f = dagger.hilt.android.internal.managers.g.b(super.getContext(), this);
            this.f51172g = dagger.hilt.android.flags.a.a(super.getContext());
        }
    }
    ...
    public Context getContext() {
        if (super.getContext() != null || this.f51172g) {
            v0();
            return this.f51171f;
        }
        return null;
    ...
    protected void w0() {
        ...
        this.f51175j = true;
        ((o) generatedComponent()).v((LoginFragment) q6.i.a(this));
    }
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f51171f;
