    ...
    */
    public static final void f(com.qennnsad.aknkaksd.domain.usecase.user.q0 r67, int r68, java.lang.String r69) {
        /*
            ...
            r9 = 0
            r10 = 0
            java.lang.String r11 = java.lang.String.valueOf(r68)
            r12 = 0
            r13 = 0
            r14 = 0
            r15 = 0
            ...
            r62 = 0
            r63 = 0
            r64 = -257(0xfffffffffffffeff, float:NaN)
        ...
        L92:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qennnsad.aknkaksd.domain.usecase.user.q0.f(com.qennnsad.aknkaksd.domain.usecase.user.q0, int, java.lang.String):void");
    }
    ...
    protected io.reactivex.z<String> e(final int i4) {
        io.reactivex.z<Response<String>> emotion = com.qennnsad.aknkaksd.data.repository.m.g(this.f48463b, false, 1, null).getEmotion(i4);
        final com.qennnsad.aknkaksd.domain.base.d<String> dVar = this.f48464c;
        io.reactivex.z<String> doOnNext = emotion.map(new n7.o() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.p0
            @Override // n7.o
            public final Object apply(Object obj) {
                String g4;
                g4 = q0.g(com.qennnsad.aknkaksd.domain.base.d.this, (Response) obj);
                return g4;
            }
        }).doOnNext(new n7.g() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.o0
            @Override // n7.g
            public final void accept(Object obj) {
                q0.f(q0.this, i4, (String) obj);
            }
        });
        Intrinsics.checkNotNullExpressionValue(doOnNext, "sourceFactory.create().g…eUserInfo(user)\n        }");
        return doOnNext;
    }
}
