    ...
    */
    public static final void f(com.qennnsad.aknkaksd.domain.usecase.user.i0 r67, java.lang.String r68, java.lang.String r69) {
        ...
        L97:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qennnsad.aknkaksd.domain.usecase.user.i0.f(com.qennnsad.aknkaksd.domain.usecase.user.i0, java.lang.String, java.lang.String):void");
    }
    ...
    public io.reactivex.z<String> a(@m8.g final String params) {
        ...
        io.reactivex.z<Response<String>> updateBirthday = com.qennnsad.aknkaksd.data.repository.m.g(this.f48413b, false, 1, null).updateBirthday(params);
        final com.qennnsad.aknkaksd.domain.base.d<String> dVar = this.f48414c;
        io.reactivex.z<String> doOnNext = updateBirthday.map(new n7.o() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.h0
            @Override // n7.o
        ...
        }).doOnNext(new n7.g() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.g0
            @Override // n7.g
            public final void accept(Object obj) {
                i0.f(i0.this, params, (String) obj);
            }
        });
