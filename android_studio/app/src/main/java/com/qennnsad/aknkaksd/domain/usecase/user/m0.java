    ...
    */
    public static final void f(com.qennnsad.aknkaksd.domain.usecase.user.m0 r67, java.lang.String r68, java.lang.String r69) {
        ...
        L97:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qennnsad.aknkaksd.domain.usecase.user.m0.f(com.qennnsad.aknkaksd.domain.usecase.user.m0, java.lang.String, java.lang.String):void");
    }
    ...
    public io.reactivex.z<String> a(@m8.g final String params) {
        ...
        io.reactivex.z<Response<String>> city = com.qennnsad.aknkaksd.data.repository.m.g(this.f48439b, false, 1, null).setCity(params);
        final com.qennnsad.aknkaksd.domain.base.d<String> dVar = this.f48440c;
        io.reactivex.z<String> doOnNext = city.map(new n7.o() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.l0
            @Override // n7.o
            public final Object apply(Object obj) {
                String g4;
                g4 = m0.g(com.qennnsad.aknkaksd.domain.base.d.this, (Response) obj);
                return g4;
            }
        }).doOnNext(new n7.g() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.k0
            @Override // n7.g
            public final void accept(Object obj) {
                m0.f(m0.this, params, (String) obj);
            }
        });
        Intrinsics.checkNotNullExpressionValue(doOnNext, "sourceFactory.create().s…eUserInfo(user)\n        }");
        return doOnNext;
    }
}
