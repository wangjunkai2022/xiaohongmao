    ...
    */
    public static final void f(com.qennnsad.aknkaksd.domain.usecase.user.u0 r67, int r68, java.lang.String r69) {
        ...
        L90:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qennnsad.aknkaksd.domain.usecase.user.u0.f(com.qennnsad.aknkaksd.domain.usecase.user.u0, int, java.lang.String):void");
    }
    ...
    protected io.reactivex.z<String> e(final int i4) {
        io.reactivex.z<Response<String>> updateSex = com.qennnsad.aknkaksd.data.repository.m.g(this.f48484b, false, 1, null).updateSex(String.valueOf(i4));
        final com.qennnsad.aknkaksd.domain.base.d<String> dVar = this.f48485c;
        io.reactivex.z<String> doOnNext = updateSex.map(new n7.o() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.t0
            @Override // n7.o
            public final Object apply(Object obj) {
                String g4;
                g4 = u0.g(com.qennnsad.aknkaksd.domain.base.d.this, (Response) obj);
                return g4;
            }
        }).doOnNext(new n7.g() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.s0
            @Override // n7.g
            public final void accept(Object obj) {
                u0.f(u0.this, i4, (String) obj);
            }
        });
