    ...
    */
    public static final void f(com.qennnsad.aknkaksd.domain.usecase.user.g1 r67, java.lang.String r68, java.lang.String r69) {
        ...
        L97:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qennnsad.aknkaksd.domain.usecase.user.g1.f(com.qennnsad.aknkaksd.domain.usecase.user.g1, java.lang.String, java.lang.String):void");
    }
    ...
    public io.reactivex.z<String> a(@m8.g final String params) {
        ...
        io.reactivex.z<Response<String>> updateNickName = com.qennnsad.aknkaksd.data.repository.m.g(this.f48402b, false, 1, null).updateNickName(params);
        final com.qennnsad.aknkaksd.domain.base.d<String> dVar = this.f48403c;
        io.reactivex.z<String> doOnNext = updateNickName.map(new n7.o() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.f1
            @Override // n7.o
            public final Object apply(Object obj) {
                String g4;
                g4 = g1.g(com.qennnsad.aknkaksd.domain.base.d.this, (Response) obj);
                return g4;
            }
        }).doOnNext(new n7.g() { // from class: com.qennnsad.aknkaksd.domain.usecase.user.e1
            @Override // n7.g
            public final void accept(Object obj) {
                g1.f(g1.this, params, (String) obj);
            }
        });
