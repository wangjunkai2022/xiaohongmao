...
/* compiled from: Hilt_SimpleWebViewFragment.java */
/* loaded from: classes3.dex */
public abstract class a<VB extends ViewBinding, Event> extends BaseMvvmFragment<VB, Event> implements q6.d {

    /* renamed from: f  reason: collision with root package name */
    private ContextWrapper f52114f;

    /* renamed from: g  reason: collision with root package name */
    private boolean f52115g;

    /* renamed from: h  reason: collision with root package name */
    private volatile dagger.hilt.android.internal.managers.g f52116h;

    /* renamed from: i  reason: collision with root package name */
    private final Object f52117i = new Object();

    /* renamed from: j  reason: collision with root package name */
    private boolean f52118j = false;

    private void v0() {
        if (this.f52114f == null) {
            this.f52114f = dagger.hilt.android.internal.managers.g.b(super.getContext(), this);
            this.f52115g = dagger.hilt.android.flags.a.a(super.getContext());
        }
    }
    ...
    public Context getContext() {
        if (super.getContext() != null || this.f52115g) {
            v0();
            return this.f52114f;
        }
        return null;
    ...
    protected void w0() {
        ...
        this.f52118j = true;
        ((o) generatedComponent()).D((SimpleWebViewFragment) q6.i.a(this));
    }
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f52114f;
