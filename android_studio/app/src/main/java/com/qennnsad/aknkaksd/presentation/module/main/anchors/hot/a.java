...
/* compiled from: Hilt_HotAnchorFragment.java */
/* loaded from: classes3.dex */
public abstract class a<Event> extends AbstractAnchorFragment<Event> implements q6.d {

    /* renamed from: i  reason: collision with root package name */
    private ContextWrapper f51535i;

    /* renamed from: j  reason: collision with root package name */
    private boolean f51536j;

    /* renamed from: k  reason: collision with root package name */
    private volatile g f51537k;

    /* renamed from: l  reason: collision with root package name */
    private final Object f51538l = new Object();

    /* renamed from: m  reason: collision with root package name */
    private boolean f51539m = false;

    private void P0() {
        if (this.f51535i == null) {
            this.f51535i = g.b(super.getContext(), this);
            this.f51536j = dagger.hilt.android.flags.a.a(super.getContext());
        }
    }
    ...
    protected void Q0() {
        ...
        this.f51539m = true;
        ((b) generatedComponent()).t((HotAnchorFragment) i.a(this));
    }
    ...
    public Context getContext() {
        if (super.getContext() != null || this.f51536j) {
            P0();
            return this.f51535i;
        }
        return null;
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f51535i;
