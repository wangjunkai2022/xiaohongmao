...
public final class PlatformRandomKt {
    ...
    @g
    public static final java.util.Random asJavaRandom(@g Random random) {
    ...
    @SinceKotlin(version = "1.3")
    @g
    public static final Random asKotlinRandom(@g java.util.Random random) {
        Random impl;
        Intrinsics.checkNotNullParameter(random, "<this>");
    ...
    public static final double doubleFromParts(int i4, int i10) {
        return ((i4 << 27) + i10) / 9.007199254740992E15d;
    }
}
