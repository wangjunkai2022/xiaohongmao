...
public abstract class DeepRecursiveScope<T, R> {
    ...
    @h
    public abstract Object callRecursive(T t9, @g Continuation<? super R> continuation);

    @h
    public abstract <U, S> Object callRecursive(@g DeepRecursiveFunction<U, S> deepRecursiveFunction, U u9, @g Continuation<? super S> continuation);
    ...
    @g
    public final Void invoke(@g DeepRecursiveFunction<?, ?> deepRecursiveFunction, @h Object obj) {
