...
public final class ULongKt {
    ...
    private static final long toULong(byte b10) {
        return ULong.m242constructorimpl(b10);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final long toULong(short s9) {
        return ULong.m242constructorimpl(s9);
    }
    ...
    private static final long toULong(int i4) {
        return ULong.m242constructorimpl(i4);
    }
    ...
    private static final long toULong(long j4) {
        return ULong.m242constructorimpl(j4);
    }
