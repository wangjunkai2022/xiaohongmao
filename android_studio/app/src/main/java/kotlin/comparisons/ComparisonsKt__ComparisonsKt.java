...
public class ComparisonsKt__ComparisonsKt {
    @g
    public static final <T> Comparator<T> compareBy(@g final Function1<? super T, ? extends Comparable<?>>... selectors) {
        ...
        if (selectors.length > 0) {
            return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$compareBy$1
                ...
                public final int compare(T t9, T t10) {
                    ...
                    compareValuesByImpl$ComparisonsKt__ComparisonsKt = ComparisonsKt__ComparisonsKt.compareValuesByImpl$ComparisonsKt__ComparisonsKt(t9, t10, selectors);
    ...
    public static <T extends Comparable<?>> int compareValues(@h T t9, @h T t10) {
        if (t9 == t10) {
            return 0;
        }
        if (t9 == null) {
    ...
    public static final <T> int compareValuesBy(T t9, T t10, @g Function1<? super T, ? extends Comparable<?>>... selectors) {
        Intrinsics.checkNotNullParameter(selectors, "selectors");
        if (selectors.length > 0) {
    ...
    public static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(T t9, T t10, Function1<? super T, ? extends Comparable<?>>[] function1Arr) {
        int compareValues;
        for (Function1<? super T, ? extends Comparable<?>> function1 : function1Arr) {
            compareValues = compareValues(function1.invoke(t9), function1.invoke(t10));
            if (compareValues != 0) {
    ...
    @g
    public static final <T> Comparator<T> nullsFirst(@g final Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$nullsFirst$1
            @Override // java.util.Comparator
            public final int compare(@h T t9, @h T t10) {
                if (t9 == t10) {
                    return 0;
                }
                if (t9 == null) {
                ...
                return comparator.compare(t9, t10);
            }
        };
    }

    @g
    public static final <T> Comparator<T> nullsLast(@g final Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
    ...
    @g
    public static final <T> Comparator<T> reversed(@g Comparator<T> comparator) {
    ...
    @g
    public static final <T> Comparator<T> then(@g final Comparator<T> comparator, @g final Comparator<? super T> comparator2) {
        Intrinsics.checkNotNullParameter(comparator, "<this>");
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$then$1
            ...
            public final int compare(T t9, T t10) {
                ...
                return compare != 0 ? compare : comparator2.compare(t9, t10);
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenBy(final Comparator<T> comparator, final Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenBy$1
            ...
            public final int compare(T t9, T t10) {
                ...
                compareValues = ComparisonsKt__ComparisonsKt.compareValues(function1.invoke(t9), function1.invoke(t10));
                return compareValues;
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenByDescending(final Comparator<T> comparator, final Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenByDescending$1
            ...
            public final int compare(T t9, T t10) {
                ...
                Function1<T, Comparable<?>> function1 = selector;
                compareValues = ComparisonsKt__ComparisonsKt.compareValues(function1.invoke(t10), function1.invoke(t9));
                return compareValues;
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenComparator(final Comparator<T> comparator, final Function2<? super T, ? super T, Integer> comparison) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenComparator$1
            ...
            public final int compare(T t9, T t10) {
                int compare = comparator.compare(t9, t10);
                return compare != 0 ? compare : comparison.invoke(t9, t10).intValue();
            }
        };
    }

    @g
    public static final <T> Comparator<T> thenDescending(@g final Comparator<T> comparator, @g final Comparator<? super T> comparator2) {
        Intrinsics.checkNotNullParameter(comparator, "<this>");
        Intrinsics.checkNotNullParameter(comparator2, "comparator");
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenDescending$1
            ...
            public final int compare(T t9, T t10) {
                int compare = comparator.compare(t9, t10);
                return compare != 0 ? compare : comparator2.compare(t10, t9);
            }
        };
    }
    ...
    private static final <T, K> Comparator<T> compareByDescending(final Comparator<? super K> comparator, final Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$compareByDescending$2
            ...
            public final int compare(T t9, T t10) {
                ...
                return comparator2.compare(function1.invoke(t10), function1.invoke(t9));
            }
        };
    }
    ...
    private static final <T, K> Comparator<T> thenBy(final Comparator<T> comparator, final Comparator<? super K> comparator2, final Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenBy$2
            ...
            public final int compare(T t9, T t10) {
                ...
                Function1<T, K> function1 = selector;
                return comparator3.compare(function1.invoke(t9), function1.invoke(t10));
            }
        };
    }
    ...
    private static final <T, K> Comparator<T> thenByDescending(final Comparator<T> comparator, final Comparator<? super K> comparator2, final Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenByDescending$2
            ...
            public final int compare(T t9, T t10) {
                ...
                Comparator<? super K> comparator3 = comparator2;
                Function1<T, K> function1 = selector;
                return comparator3.compare(function1.invoke(t10), function1.invoke(t9));
            }
        };
    }
    ...
    @InlineOnly
    private static final <T> int compareValuesBy(T t9, T t10, Function1<? super T, ? extends Comparable<?>> selector) {
        int compareValues;
        Intrinsics.checkNotNullParameter(selector, "selector");
    ...
    private static final <T, K> Comparator<T> compareBy(final Comparator<? super K> comparator, final Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$compareBy$3
            ...
            public final int compare(T t9, T t10) {
                Comparator<? super K> comparator2 = comparator;
                Function1<T, K> function1 = selector;
                return comparator2.compare(function1.invoke(t9), function1.invoke(t10));
            }
        };
    }

    @InlineOnly
    private static final <T, K> int compareValuesBy(T t9, T t10, Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return comparator.compare((K) selector.invoke(t9), (K) selector.invoke(t10));
    }
}
