...
public final class MonotonicTimeSource implements TimeSource {
    ...
    public final long m1541adjustReading6QKq23U(long j4, long j10) {
        return TimeSource.Monotonic.ValueTimeMark.m1550constructorimpl(LongSaturatedMathKt.m1539saturatingAddpTJri5U(j4, j10));
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1542elapsedFrom6eNON_k(long j4) {
        return LongSaturatedMathKt.saturatingDiff(read(), j4);
    }

    @Override // kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ TimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1549boximpl(m1543markNowz9LOYto());
    }

    /* renamed from: markNow-z9LOYto  reason: not valid java name */
    public long m1543markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1550constructorimpl(read());
    }
