...
class DurationUnitKt__DurationUnitKt extends DurationUnitKt__DurationUnitJvmKt {
    ...
    @g
    public static final DurationUnit durationUnitByIsoChar(char c10, boolean z9) {
        if (!z9) {
            if (c10 == 'D') {
    ...
    @SinceKotlin(version = "1.5")
    @g
    public static final DurationUnit durationUnitByShortName(@g String shortName) {
    ...
    @g
    public static final String shortName(@g DurationUnit durationUnit) {
