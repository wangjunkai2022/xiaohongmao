...
class DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final double convertDurationUnit(double d4, @g DurationUnit sourceUnit, @g DurationUnit targetUnit) {
    ...
    public static final long convertDurationUnitOverflow(long j4, @g DurationUnit sourceUnit, @g DurationUnit targetUnit) {
        Intrinsics.checkNotNullParameter(sourceUnit, "sourceUnit");
        Intrinsics.checkNotNullParameter(targetUnit, "targetUnit");
    ...
    @g
    @ExperimentalTime
    public static final DurationUnit toDurationUnit(@g TimeUnit timeUnit) {
    ...
    @g
    @ExperimentalTime
    public static final TimeUnit toTimeUnit(@g DurationUnit durationUnit) {
        Intrinsics.checkNotNullParameter(durationUnit, "<this>");
        return durationUnit.getTimeUnit$kotlin_stdlib();
    }

    @SinceKotlin(version = "1.5")
    public static final long convertDurationUnit(long j4, @g DurationUnit sourceUnit, @g DurationUnit targetUnit) {
        Intrinsics.checkNotNullParameter(sourceUnit, "sourceUnit");
        Intrinsics.checkNotNullParameter(targetUnit, "targetUnit");
        return targetUnit.getTimeUnit$kotlin_stdlib().convert(j4, sourceUnit.getTimeUnit$kotlin_stdlib());
    }
