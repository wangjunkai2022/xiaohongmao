...
public final class KTypeProjection {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @g
        public final KTypeProjection contravariant(@g KType type) {
        ...
        @JvmStatic
        @g
        public final KTypeProjection covariant(@g KType type) {
            Intrinsics.checkNotNullParameter(type, "type");
        ...
        @JvmStatic
        @g
        public final KTypeProjection invariant(@g KType type) {
            Intrinsics.checkNotNullParameter(type, "type");
    ...
    public KTypeProjection(@h KVariance kVariance, @h KType kType) {
        String str;
    ...
    @JvmStatic
    @g
    public static final KTypeProjection contravariant(@g KType kType) {
    ...
    @JvmStatic
    @g
    public static final KTypeProjection covariant(@g KType kType) {
        return Companion.covariant(kType);
    }

    @JvmStatic
    @g
    public static final KTypeProjection invariant(@g KType kType) {
    ...
    @g
    public final KTypeProjection copy(@h KVariance kVariance, @h KType kType) {
