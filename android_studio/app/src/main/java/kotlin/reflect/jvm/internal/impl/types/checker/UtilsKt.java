...
public final class UtilsKt {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        m1369debugInfo$lambda1$unaryPlus("type: " + typeConstructor, sb);
        m1369debugInfo$lambda1$unaryPlus("hashCode: " + typeConstructor.hashCode(), sb);
        m1369debugInfo$lambda1$unaryPlus("javaClass: " + typeConstructor.getClass().getCanonicalName(), sb);
        for (DeclarationDescriptor declarationDescriptor = typeConstructor.getDeclarationDescriptor(); declarationDescriptor != null; declarationDescriptor = declarationDescriptor.getContainingDeclaration()) {
            m1369debugInfo$lambda1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptor), sb);
            m1369debugInfo$lambda1$unaryPlus("javaClass: " + declarationDescriptor.getClass().getCanonicalName(), sb);
        }
    ...
    private static final StringBuilder m1369debugInfo$lambda1$unaryPlus(String str, StringBuilder sb) {
    ...
    @h
    public static final KotlinType findCorrespondingSupertype(@g KotlinType subtype, @g KotlinType supertype, @g TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        boolean z9;
        boolean z10;
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo1364getSupertypes()) {
