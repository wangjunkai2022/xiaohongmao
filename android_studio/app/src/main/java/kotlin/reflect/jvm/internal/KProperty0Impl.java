...
public class KProperty0Impl<V> extends KPropertyImpl<V> implements KProperty0<V> {
    ...
    public static final class Getter<R> extends KPropertyImpl.Getter<R> implements KProperty0.Getter<R> {
        ...
        public Getter(@g KProperty0Impl<? extends R> property) {
    ...
    public KProperty0Impl(@g KDeclarationContainerImpl container, @g PropertyDescriptor descriptor) {
        super(container, descriptor);
        Lazy<Object> lazy;
        Intrinsics.checkNotNullParameter(container, "container");
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        ReflectProperties.LazyVal<Getter<V>> lazy2 = ReflectProperties.lazy(new KProperty0Impl$_getter$1(this));
        Intrinsics.checkNotNullExpressionValue(lazy2, "lazy { Getter(this) }");
        this._getter = lazy2;
        lazy = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new KProperty0Impl$delegateValue$1(this));
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KProperty0Impl(@g KDeclarationContainerImpl container, @g String name, @g String signature, @h Object obj) {
