...
public enum ErrorTypeKind {
    ...
    ErrorTypeKind(String str, boolean z9) {
        this.debugMessage = str;
        this.isUnresolved = z9;
    }
    ...
    /* synthetic */ ErrorTypeKind(String str, boolean z9, int i4, DefaultConstructorMarker defaultConstructorMarker) {
