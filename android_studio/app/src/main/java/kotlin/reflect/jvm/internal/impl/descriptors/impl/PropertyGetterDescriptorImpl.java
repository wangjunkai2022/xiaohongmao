...
public class PropertyGetterDescriptorImpl extends PropertyAccessorDescriptorImpl implements PropertyGetterDescriptor {
    ...
    public PropertyGetterDescriptorImpl(@g PropertyDescriptor propertyDescriptor, @g Annotations annotations, @g Modality modality, @g DescriptorVisibility descriptorVisibility, boolean z9, boolean z10, boolean z11, @g CallableMemberDescriptor.Kind kind, @h PropertyGetterDescriptor propertyGetterDescriptor, @g SourceElement sourceElement) {
        super(modality, descriptorVisibility, propertyDescriptor, annotations, Name.special("<get-" + propertyDescriptor.getName() + ">"), z9, z10, z11, kind, sourceElement);
