...
public class Flags {
    ...
    public static class BooleanFlagField extends FlagField<Boolean> {
        ...
        public BooleanFlagField(int i4) {
            super(i4, 1);
        }
        ...
        public Boolean get(int i4) {
            Boolean valueOf = Boolean.valueOf((i4 & (1 << this.offset)) != 0);
            if (valueOf == null) {
                $$$reportNull$$$0(0);
            }
            return valueOf;
    ...
    public static class EnumLiteFlagField<E extends Internal.EnumLite> extends FlagField<E> {
        ...
        public EnumLiteFlagField(int i4, E[] eArr) {
            super(i4, bitWidth(eArr));
            this.values = eArr;
        }

        private static <E> int bitWidth(@g E[] eArr) {
            if (eArr == null) {
                $$$reportNull$$$0(0);
            }
        ...
        public E get(int i4) {
            E[] eArr;
            int i10 = this.offset;
            int i11 = (i4 & (((1 << this.bitWidth) - 1) << i10)) >> i10;
    ...
    public static abstract class FlagField<E> {
        ...
        private FlagField(int i4, int i10) {
            this.offset = i4;
            this.bitWidth = i10;
        }
    }
    ...
    */
    ...
    public static int getAccessorFlags(boolean z9, @g ProtoBuf.Visibility visibility, @g ProtoBuf.Modality modality, boolean z10, boolean z11, boolean z12) {
        if (visibility == null) {
            $$$reportNull$$$0(10);
        }
        if (modality == null) {
        ...
        return HAS_ANNOTATIONS.toFlags(Boolean.valueOf(z9)) | MODALITY.toFlags(modality) | VISIBILITY.toFlags(visibility) | IS_NOT_DEFAULT.toFlags(Boolean.valueOf(z10)) | IS_EXTERNAL_ACCESSOR.toFlags(Boolean.valueOf(z11)) | IS_INLINE_ACCESSOR.toFlags(Boolean.valueOf(z12));
    }
}
