...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    private static int computeElementSize(WireFormat.FieldType fieldType, int i4, Object obj) {
    ...
    */
    ...
    private static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i4, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
