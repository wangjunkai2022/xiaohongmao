...
public abstract class KotlinBuiltIns {
    ...
    public static class Primitives {
        ...
        private Primitives(@g Map<PrimitiveType, SimpleType> map, @g Map<KotlinType, SimpleType> map2, @g Map<SimpleType, SimpleType> map3) {
            if (map == null) {
                $$$reportNull$$$0(0);
            }
            if (map2 == null) {
    ...
    public KotlinBuiltIns(@g StorageManager storageManager) {
    ...
    private static boolean classFqNameEquals(@g ClassifierDescriptor classifierDescriptor, @g FqNameUnsafe fqNameUnsafe) {
    ...
    @g
    private ClassDescriptor getBuiltInClassByName(@g String str) {
        if (str == null) {
            $$$reportNull$$$0(14);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @g
    public SimpleType getBuiltInTypeByClassName(@g String str) {
        if (str == null) {
            $$$reportNull$$$0(46);
        }
    ...
    @h
    private static KotlinType getElementTypeForUnsignedArray(@g KotlinType kotlinType, @g ModuleDescriptor moduleDescriptor) {
        ClassId classId;
    ...
    @h
    public static PrimitiveType getPrimitiveArrayElementType(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(92);
        }
        ClassifierDescriptor declarationDescriptor = kotlinType.getConstructor().getDeclarationDescriptor();
    ...
    @h
    public static PrimitiveType getPrimitiveArrayType(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(77);
        }
    ...
    @g
    private ClassDescriptor getPrimitiveClassDescriptor(@g PrimitiveType primitiveType) {
    ...
    @h
    public static PrimitiveType getPrimitiveType(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(76);
        }
    ...
    public static boolean isAny(@g ClassDescriptor classDescriptor) {
    ...
    public static boolean isAnyOrNullableAny(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(139);
        }
    ...
    public static boolean isArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(88);
        }
    ...
    public static boolean isArrayOrPrimitiveArray(@g ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(89);
        }
    ...
    public static boolean isBuiltIn(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(9);
        }
    ...
    private static boolean isConstructedFromGivenClass(@g KotlinType kotlinType, @g FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(97);
        }
        if (fqNameUnsafe == null) {
    ...
    private static boolean isConstructedFromGivenClassAndNotNullable(@g KotlinType kotlinType, @g FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(h0.Q);
        }
        if (fqNameUnsafe == null) {
    ...
    public static boolean isDefaultBound(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(141);
        }
    ...
    public static boolean isDeprecated(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(a1.f54532a);
        }
    ...
    public static boolean isKClass(@g ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(157);
        }
    ...
    private static boolean isNotNullConstructedFromGivenClass(@g KotlinType kotlinType, @g FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(105);
        }
        if (fqNameUnsafe == null) {
    ...
    public static boolean isNothing(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(136);
        }
    ...
    public static boolean isNothingOrNullableNothing(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(h0.H);
        }
    ...
    public static boolean isNullableAny(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(140);
        }
    ...
    public static boolean isPrimitiveArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(91);
        }
        ClassifierDescriptor declarationDescriptor = kotlinType.getConstructor().getDeclarationDescriptor();
    ...
    public static boolean isPrimitiveClass(@g ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(96);
        }
    ...
    public static boolean isPrimitiveType(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(94);
        }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(95);
        }
        ClassifierDescriptor declarationDescriptor = kotlinType.getConstructor().getDeclarationDescriptor();
    ...
    public static boolean isSpecialClassWithNoSupertypes(@g ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(107);
        }
    ...
    public static boolean isString(@h KotlinType kotlinType) {
        return kotlinType != null && isNotNullConstructedFromGivenClass(kotlinType, StandardNames.FqNames.string);
    }

    public static boolean isTypeConstructorForGivenClass(@g TypeConstructor typeConstructor, @g FqNameUnsafe fqNameUnsafe) {
    ...
    public static boolean isUByteArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(128);
        }
    ...
    public static boolean isUIntArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(h0.I);
        }
    ...
    public static boolean isULongArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(131);
        }
    ...
    public static boolean isUShortArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(h0.G);
        }
    ...
    public static boolean isUnderKotlinPackage(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(10);
        }
    ...
    public static boolean isUnit(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(142);
        }
    ...
    public static boolean isUnsignedArrayType(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(132);
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void createBuiltInsModule(boolean z9) {
        ...
        moduleDescriptorImpl.initialize(BuiltInsLoader.Companion.getInstance().createPackageFragmentProvider(this.storageManager, this.builtInsModule, getClassDescriptorFactories(), getPlatformDependentDeclarationFilter(), getAdditionalClassPartsProvider(), z9));
    ...
    @g
    public KotlinType getArrayElementType(@g KotlinType kotlinType) {
    ...
    @g
    public SimpleType getArrayType(@g Variance variance, @g KotlinType kotlinType, @g Annotations annotations) {
        if (variance == null) {
            $$$reportNull$$$0(78);
        }
        if (kotlinType == null) {
    ...
    @g
    public ClassDescriptor getBuiltInClassByFqName(@g FqName fqName) {
        if (fqName == null) {
            $$$reportNull$$$0(12);
        }
    ...
    @g
    public ClassDescriptor getFunction(int i4) {
        return getBuiltInClassByName(StandardNames.getFunctionName(i4));
    }
    ...
    @g
    public SimpleType getPrimitiveArrayKotlinType(@g PrimitiveType primitiveType) {
        if (primitiveType == null) {
            $$$reportNull$$$0(73);
        }
    ...
    @g
    public SimpleType getPrimitiveKotlinType(@g PrimitiveType primitiveType) {
        if (primitiveType == null) {
            $$$reportNull$$$0(53);
        }
    ...
    @g
    public ClassDescriptor getSuspendFunction(int i4) {
        ClassDescriptor builtInClassByFqName = getBuiltInClassByFqName(StandardNames.COROUTINES_PACKAGE_FQ_NAME.child(Name.identifier(StandardNames.getSuspendFunctionName(i4))));
        if (builtInClassByFqName == null) {
            $$$reportNull$$$0(18);
        }
        return builtInClassByFqName;
    ...
    public void setBuiltInsModule(@g final ModuleDescriptorImpl moduleDescriptorImpl) {
        if (moduleDescriptorImpl == null) {
            $$$reportNull$$$0(1);
        }
    ...
    public static boolean isArrayOrPrimitiveArray(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(90);
        }
    ...
    @g
    public SimpleType getArrayType(@g Variance variance, @g KotlinType kotlinType) {
        if (variance == null) {
            $$$reportNull$$$0(82);
        }
        if (kotlinType == null) {
