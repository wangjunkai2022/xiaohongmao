...
public class TypeCheckingProcedure {
    ...
    @h
    public static KotlinType findCorrespondingSupertype(@g KotlinType kotlinType, @g KotlinType kotlinType2) {
        if (kotlinType == null) {
            $$$reportNull$$$0(0);
        }
        if (kotlinType2 == null) {
    ...
    @h
    public static KotlinType findCorrespondingSupertype(@g KotlinType kotlinType, @g KotlinType kotlinType2, @g TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        if (kotlinType == null) {
            $$$reportNull$$$0(2);
        }
        if (kotlinType2 == null) {
