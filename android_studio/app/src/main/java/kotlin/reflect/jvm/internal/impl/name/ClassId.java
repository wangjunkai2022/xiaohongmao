...
public final class ClassId {
    ...
    */
    ...
    public ClassId(@g FqName fqName, @g FqName fqName2, boolean z9) {
        if (fqName == null) {
            $$$reportNull$$$0(1);
        }
        if (fqName2 == null) {
    ...
    @g
    public static ClassId fromString(@g String str) {
        if (str == null) {
            $$$reportNull$$$0(11);
        }
    ...
    @g
    public static ClassId topLevel(@g FqName fqName) {
        if (fqName == null) {
            $$$reportNull$$$0(0);
        }
    ...
    public String asString() {
        ...
        String str = this.packageFqName.asString().replace('.', e.f13819f) + "/" + this.relativeClassName.asString();
        if (str == null) {
            $$$reportNull$$$0(14);
        }
        return str;
    ...
    @g
    public ClassId createNestedClassId(@g Name name) {
        if (name == null) {
            $$$reportNull$$$0(8);
        }
    ...
    @g
    public static ClassId fromString(@g String str, boolean z9) {
        String str2;
        if (str == null) {
            $$$reportNull$$$0(12);
        }
        ...
        if (lastIndexOf == -1) {
            ...
            String replace = str.substring(0, lastIndexOf).replace(e.f13819f, '.');
            str = str.substring(lastIndexOf + 1);
            str2 = replace;
        }
        return new ClassId(new FqName(str2), new FqName(str), z9);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ClassId(@g FqName fqName, @g Name name) {
