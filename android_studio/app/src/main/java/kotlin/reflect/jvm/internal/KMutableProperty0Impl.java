...
public final class KMutableProperty0Impl<V> extends KProperty0Impl<V> implements KMutableProperty0<V> {
    ...
    public static final class Setter<R> extends KPropertyImpl.Setter<R> implements KMutableProperty0.Setter<R> {
        ...
        public Setter(@g KMutableProperty0Impl<R> property) {
        ...
        public void invoke2(R r9) {
            getProperty().set(r9);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KMutableProperty0Impl(@g KDeclarationContainerImpl container, @g PropertyDescriptor descriptor) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KMutableProperty0Impl(@g KDeclarationContainerImpl container, @g String name, @g String signature, @h Object obj) {
