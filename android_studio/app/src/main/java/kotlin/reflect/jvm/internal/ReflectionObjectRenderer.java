...
public final class ReflectionObjectRenderer {
    ...
    @g
    public final String renderFunction(@g FunctionDescriptor descriptor) {
    ...
    @g
    public final String renderLambda(@g FunctionDescriptor invoke) {
    ...
    @g
    public final String renderParameter(@g KParameterImpl parameter) {
        Intrinsics.checkNotNullParameter(parameter, "parameter");
        StringBuilder sb = new StringBuilder();
        int i4 = WhenMappings.$EnumSwitchMapping$0[parameter.getKind().ordinal()];
        if (i4 == 1) {
    ...
    @g
    public final String renderProperty(@g PropertyDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        StringBuilder sb = new StringBuilder();
    ...
    @g
    public final String renderType(@g KotlinType type) {
