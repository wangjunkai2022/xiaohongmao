...
public final class StaticScopeForKotlinEnum extends MemberScopeImpl {
    ...
    public StaticScopeForKotlinEnum(@g StorageManager storageManager, @g ClassDescriptor containingClass) {
    ...
    @h
    public Void getContributedClassifier(@g Name name, @g LookupLocation location) {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScopeImpl, kotlin.reflect.jvm.internal.impl.resolve.scopes.ResolutionScope
    @g
    public List<SimpleFunctionDescriptor> getContributedDescriptors(@g DescriptorKindFilter kindFilter, @g Function1<? super Name, Boolean> nameFilter) {
    ...
    @g
    public SmartList<SimpleFunctionDescriptor> getContributedFunctions(@g Name name, @g LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
