...
public class KProperty2Impl<D, E, V> extends KPropertyImpl<V> implements KProperty2<D, E, V> {
    ...
    public static final class Getter<D, E, V> extends KPropertyImpl.Getter<V> implements KProperty2.Getter<D, E, V> {
        ...
        public Getter(@g KProperty2Impl<D, E, ? extends V> property) {
    ...
    public KProperty2Impl(@g KDeclarationContainerImpl container, @g String name, @g String signature) {
        super(container, name, signature, CallableReference.NO_RECEIVER);
        Lazy<Member> lazy;
        Intrinsics.checkNotNullParameter(container, "container");
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(signature, "signature");
        ReflectProperties.LazyVal<Getter<D, E, V>> lazy2 = ReflectProperties.lazy(new KProperty2Impl$_getter$1(this));
        Intrinsics.checkNotNullExpressionValue(lazy2, "lazy { Getter(this) }");
        this._getter = lazy2;
        lazy = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new KProperty2Impl$delegateSource$1(this));
    ...
    public Object getDelegate(D d4, E e4) {
        return getDelegateImpl(this.delegateSource.getValue(), d4, e4);
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KProperty2Impl(@g KDeclarationContainerImpl container, @g PropertyDescriptor descriptor) {
