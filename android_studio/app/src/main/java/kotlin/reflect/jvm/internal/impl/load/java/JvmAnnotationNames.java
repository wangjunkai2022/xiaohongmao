...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        METADATA_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName).getInternalName() + i.f6965b;
        ...
        SERIALIZED_IR_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName2).getInternalName() + i.f6965b;
