...
public final class ProtoEnumFlags {
    ...
    @g
    public final ClassKind classKind(@h ProtoBuf.Class.Kind kind) {
    ...
    @g
    public final Modality modality(@h ProtoBuf.Modality modality) {
        int i4 = modality == null ? -1 : WhenMappings.$EnumSwitchMapping$0[modality.ordinal()];
        if (i4 != 1) {
            if (i4 != 2) {
                if (i4 != 3) {
                    if (i4 != 4) {
    ...
    @g
    public final Variance variance(@g ProtoBuf.TypeParameter.Variance variance) {
        Intrinsics.checkNotNullParameter(variance, "variance");
        int i4 = WhenMappings.$EnumSwitchMapping$5[variance.ordinal()];
        if (i4 != 1) {
            if (i4 != 2) {
                if (i4 == 3) {
    ...
    @g
    public final Variance variance(@g ProtoBuf.Type.Argument.Projection projection) {
        Intrinsics.checkNotNullParameter(projection, "projection");
        int i4 = WhenMappings.$EnumSwitchMapping$6[projection.ordinal()];
        if (i4 != 1) {
            if (i4 != 2) {
                if (i4 != 3) {
                    if (i4 != 4) {
