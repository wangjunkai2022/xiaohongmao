...
public class DescriptorUtils {
    ...
    public static boolean areInSameModule(@g DeclarationDescriptor declarationDescriptor, @g DeclarationDescriptor declarationDescriptor2) {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(@g D d4, @g Set<D> set) {
        if (d4 == null) {
            $$$reportNull$$$0(70);
        }
        if (set == 0) {
        ...
        for (CallableDescriptor callableDescriptor : d4.getOriginal().getOverriddenDescriptors()) {
    ...
    @g
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(@g D d4) {
        if (d4 == null) {
            $$$reportNull$$$0(68);
        }
    ...
    @g
    public static ClassDescriptor getClassDescriptorForType(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(45);
        }
    ...
    @g
    public static ClassDescriptor getClassDescriptorForTypeConstructor(@g TypeConstructor typeConstructor) {
    ...
    @g
    public static ModuleDescriptor getContainingModule(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(21);
        }
    ...
    @h
    public static ModuleDescriptor getContainingModuleOrNull(@g KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(20);
        }
    ...
    @g
    public static SourceFile getContainingSourceFile(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(79);
        }
    ...
    @g
    public static DescriptorVisibility getDefaultConstructorVisibility(@g ClassDescriptor classDescriptor, boolean z9) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    @h
    public static ReceiverParameterDescriptor getDispatchReceiverParameterIfNeeded(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(0);
        }
    ...
    @g
    public static FqNameUnsafe getFqName(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(2);
        }
    ...
    @g
    public static FqName getFqNameSafe(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(3);
        }
        FqName fqNameSafeIfPossible = getFqNameSafeIfPossible(declarationDescriptor);
    ...
    @h
    private static FqName getFqNameSafeIfPossible(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(5);
        }
    ...
    @g
    private static FqNameUnsafe getFqNameUnsafe(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(6);
        }
    ...
    @h
    public static <D extends DeclarationDescriptor> D getParentOfType(@h DeclarationDescriptor declarationDescriptor, @g Class<D> cls) {
        if (cls == null) {
            $$$reportNull$$$0(18);
        }
    ...
    @h
    public static ClassDescriptor getSuperClassDescriptor(@g ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(44);
        }
        for (KotlinType kotlinType : classDescriptor.getTypeConstructor().mo1364getSupertypes()) {
    ...
    public static boolean isAnnotationClass(@h DeclarationDescriptor declarationDescriptor) {
        return isKindOf(declarationDescriptor, ClassKind.ANNOTATION_CLASS);
    }

    public static boolean isAnonymousObject(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(34);
        }
    ...
    public static boolean isClass(@h DeclarationDescriptor declarationDescriptor) {
        return isKindOf(declarationDescriptor, ClassKind.CLASS);
    }

    public static boolean isClassOrEnumClass(@h DeclarationDescriptor declarationDescriptor) {
        return isClass(declarationDescriptor) || isEnumClass(declarationDescriptor);
    }

    public static boolean isCompanionObject(@h DeclarationDescriptor declarationDescriptor) {
    ...
    public static boolean isDirectSubclass(@g ClassDescriptor classDescriptor, @g ClassDescriptor classDescriptor2) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(26);
        }
    ...
    public static boolean isEnumClass(@h DeclarationDescriptor declarationDescriptor) {
        return isKindOf(declarationDescriptor, ClassKind.ENUM_CLASS);
    }

    public static boolean isEnumEntry(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(36);
        }
    ...
    public static boolean isInterface(@h DeclarationDescriptor declarationDescriptor) {
        return isKindOf(declarationDescriptor, ClassKind.INTERFACE);
    }

    private static boolean isKindOf(@h DeclarationDescriptor declarationDescriptor, @g ClassKind classKind) {
        if (classKind == null) {
            $$$reportNull$$$0(37);
        }
    ...
    public static boolean isLocal(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(1);
        }
    ...
    private static boolean isSameClass(@g KotlinType kotlinType, @g DeclarationDescriptor declarationDescriptor) {
        if (kotlinType == null) {
            $$$reportNull$$$0(30);
        }
        if (declarationDescriptor == null) {
    ...
    public static boolean isSealedClass(@h DeclarationDescriptor declarationDescriptor) {
    ...
    public static boolean isSubclass(@g ClassDescriptor classDescriptor, @g ClassDescriptor classDescriptor2) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(28);
        }
        if (classDescriptor2 == null) {
    ...
    public static boolean isSubtypeOfClass(@g KotlinType kotlinType, @g DeclarationDescriptor declarationDescriptor) {
        if (kotlinType == null) {
            $$$reportNull$$$0(32);
        }
        if (declarationDescriptor == null) {
        ...
        for (KotlinType kotlinType2 : kotlinType.getConstructor().mo1364getSupertypes()) {
    ...
    public static boolean isTopLevelDeclaration(@h DeclarationDescriptor declarationDescriptor) {
        return declarationDescriptor != null && (declarationDescriptor.getContainingDeclaration() instanceof PackageFragmentDescriptor);
    }

    public static boolean shouldRecordInitializerForProperty(@g VariableDescriptor variableDescriptor, @g KotlinType kotlinType) {
    ...
    @g
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(@g D d4) {
        if (d4 == null) {
            $$$reportNull$$$0(59);
        }
    ...
    @g
    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(@g D d4) {
        if (d4 == null) {
            $$$reportNull$$$0(61);
        }
    ...
    @h
    public static <D extends DeclarationDescriptor> D getParentOfType(@h DeclarationDescriptor declarationDescriptor, @g Class<D> cls, boolean z9) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
    ...
    @h
    public static ModuleDescriptor getContainingModuleOrNull(@g DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(23);
        }
        while (declarationDescriptor != null) {
