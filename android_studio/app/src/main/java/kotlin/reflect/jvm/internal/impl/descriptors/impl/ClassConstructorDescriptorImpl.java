...
public class ClassConstructorDescriptorImpl extends FunctionDescriptorImpl implements ClassConstructorDescriptor {
    ...
    */
    ...
    public ClassConstructorDescriptorImpl(@g ClassDescriptor classDescriptor, @h ConstructorDescriptor constructorDescriptor, @g Annotations annotations, boolean z9, @g CallableMemberDescriptor.Kind kind, @g SourceElement sourceElement) {
    ...
    @g
    public static ClassConstructorDescriptorImpl create(@g ClassDescriptor classDescriptor, @g Annotations annotations, boolean z9, @g SourceElement sourceElement) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(4);
        }
        if (annotations == null) {
        ...
        return new ClassConstructorDescriptorImpl(classDescriptor, null, annotations, z9, CallableMemberDescriptor.Kind.DECLARATION, sourceElement);
    }
    ...
    public ClassConstructorDescriptorImpl initialize(@g List<ValueParameterDescriptor> list, @g DescriptorVisibility descriptorVisibility, @g List<TypeParameterDescriptor> list2) {
        if (list == null) {
            $$$reportNull$$$0(10);
        }
    ...
    @g
    public ClassConstructorDescriptorImpl createSubstitutedCopy(@g DeclarationDescriptor declarationDescriptor, @h FunctionDescriptor functionDescriptor, @g CallableMemberDescriptor.Kind kind, @h Name name, @g Annotations annotations, @g SourceElement sourceElement) {
    ...
    public ClassConstructorDescriptorImpl initialize(@g List<ValueParameterDescriptor> list, @g DescriptorVisibility descriptorVisibility) {
        if (list == null) {
            $$$reportNull$$$0(13);
        }
        if (descriptorVisibility == null) {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl, kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor
    @g
    public ClassConstructorDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z9) {
        ClassConstructorDescriptor classConstructorDescriptor = (ClassConstructorDescriptor) super.copy(declarationDescriptor, modality, descriptorVisibility, kind, z9);
    ...
    @h
    public ClassConstructorDescriptor substitute(@g TypeSubstitutor typeSubstitutor) {
