...
public final class KProperties {
    ...
    @h
    public static final Object getExtensionDelegate(@g KProperty1<?, ?> kProperty1) {
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static final <D> Object getExtensionDelegate(@g KProperty2<D, ?, ?> kProperty2, D d4) {
        Intrinsics.checkNotNullParameter(kProperty2, "<this>");
        return kProperty2.getDelegate(d4, KPropertyImpl.Companion.getEXTENSION_PROPERTY_DELEGATE());
    }
}
