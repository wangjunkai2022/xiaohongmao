...
public final class TypeReference implements KType {
    ...
    public TypeReference(@g KClassifier classifier, @g List<KTypeProjection> arguments, @h KType kType, int i4) {
    ...
    public TypeReference(@g KClassifier classifier, @g List<KTypeProjection> arguments, boolean z9) {
