...
public class ReflectionFactory {
    ...
    @SinceKotlin(version = "1.4")
    public KType typeOf(KClassifier kClassifier, List<KTypeProjection> list, boolean z9) {
        return new TypeReference(kClassifier, list, z9);
    }

    @SinceKotlin(version = "1.4")
    public KTypeParameter typeParameter(Object obj, String str, KVariance kVariance, boolean z9) {
        return new TypeParameterReference(obj, str, kVariance, z9);
    }
