...
public final class JvmClassMappingKt {
    ...
    private static final <E extends Enum<E>> Class<E> getDeclaringJavaClass(E e4) {
        Intrinsics.checkNotNullParameter(e4, "<this>");
        Class<E> declaringClass = e4.getDeclaringClass();
    ...
    public static final <T> Class<T> getJavaClass(@g KClass<T> kClass) {
    ...
    @g
    public static final <T> Class<T> getJavaObjectType(@g KClass<T> kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).getJClass();
        if (!cls.isPrimitive()) {
    ...
    @h
    public static final <T> Class<T> getJavaPrimitiveType(@g KClass<T> kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).getJClass();
        if (cls.isPrimitive()) {
    ...
    public static final <T> KClass<T> getKotlinClass(@g Class<T> cls) {
    ...
    public static final <T> Class<KClass<T>> getRuntimeClassOfKClassInstance(@g KClass<T> kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
    ...
    @g
    public static final <T> Class<T> getJavaClass(@g T t9) {
        Intrinsics.checkNotNullParameter(t9, "<this>");
        Class<T> cls = (Class<T>) t9.getClass();
