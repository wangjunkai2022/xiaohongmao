...
public class CollectionsKt__MutableCollectionsJVMKt extends CollectionsKt__IteratorsKt {
    ...
    @InlineOnly
    private static final <T> void fill(List<T> list, T t9) {
    ...
    public static <T> void sortWith(@g List<T> list, @g Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        if (list.size() > 1) {
    ...
    public static <T extends Comparable<? super T>> void sort(@g List<T> list) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        if (list.size() > 1) {
