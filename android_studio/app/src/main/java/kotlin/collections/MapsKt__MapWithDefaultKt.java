...
public class MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> V getOrImplicitDefaultNullable(@g Map<K, ? extends V> map, K k10) {
    ...
    @g
    public static final <K, V> Map<K, V> withDefault(@g Map<K, ? extends V> map, @g Function1<? super K, ? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    public static final <K, V> Map<K, V> withDefaultMutable(@g Map<K, V> map, @g Function1<? super K, ? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
