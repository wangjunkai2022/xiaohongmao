...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    @g
    public static final <T> Collection<T> asCollection(@g T[] tArr) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        return new ArrayAsCollection(tArr, false);
    }

    public static final <T extends Comparable<? super T>> int binarySearch(@g List<? extends T> list, @h T t9, int i4, int i10) {
        int compareValues;
        Intrinsics.checkNotNullParameter(list, "<this>");
        rangeCheck$CollectionsKt__CollectionsKt(list.size(), i4, i10);
        int i11 = i10 - 1;
        while (i4 <= i11) {
            int i12 = (i4 + i11) >>> 1;
            compareValues = ComparisonsKt__ComparisonsKt.compareValues(list.get(i12), t9);
            if (compareValues < 0) {
                i4 = i12 + 1;
    ...
    public static /* synthetic */ int binarySearch$default(List list, Comparable comparable, int i4, int i10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            i4 = 0;
        }
        if ((i11 & 4) != 0) {
        ...
        return binarySearch(list, comparable, i4, i10);
    }

    public static final <T, K extends Comparable<? super K>> int binarySearchBy(@g List<? extends T> list, @h K k10, int i4, int i10, @g Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return binarySearch(list, i4, i10, new CollectionsKt__CollectionsKt$binarySearchBy$1(selector, k10));
    }

    public static /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i4, int i10, Function1 function1, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            i4 = 0;
        }
        if ((i11 & 4) != 0) {
        ...
        return binarySearch(list, i4, i10, new CollectionsKt__CollectionsKt$binarySearchBy$1(function1, comparable));
    }
    ...
    @g
    public static IntRange getIndices(@g Collection<?> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        return new IntRange(0, collection.size() - 1);
    }

    public static <T> int getLastIndex(@g List<? extends T> list) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        return list.size() - 1;
    }
    ...
    @g
    public static <T> List<T> listOf(@g T... elements) {
        List<T> emptyList;
        List<T> asList;
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    @g
    public static <T> List<T> listOfNotNull(@h T t9) {
        List<T> emptyList;
        List<T> listOf;
        if (t9 != null) {
            listOf = CollectionsKt__CollectionsJVMKt.listOf(t9);
            return listOf;
        }
        emptyList = emptyList();
        return emptyList;
    ...
    @g
    public static <T> List<T> optimizeReadOnlyList(@g List<? extends T> list) {
        List<T> emptyList;
        List<T> listOf;
        Intrinsics.checkNotNullParameter(list, "<this>");
        int size = list.size();
    ...
    private static final void rangeCheck$CollectionsKt__CollectionsKt(int i4, int i10, int i11) {
        if (i10 > i11) {
            ...
            throw new IndexOutOfBoundsException("toIndex (" + i11 + ") is greater than size (" + i4 + ").");
        }
    }
    ...
    @g
    public static <T> ArrayList<T> arrayListOf(@g T... elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        return elements.length == 0 ? new ArrayList<>() : new ArrayList<>(new ArrayAsCollection(elements, true));
    }

    public static /* synthetic */ int binarySearch$default(List list, Object obj, Comparator comparator, int i4, int i10, int i11, Object obj2) {
        if ((i11 & 4) != 0) {
            i4 = 0;
        }
        if ((i11 & 8) != 0) {
        ...
        return binarySearch(list, obj, comparator, i4, i10);
    }
    ...
    @g
    public static <T> List<T> listOfNotNull(@g T... elements) {
    ...
    @g
    public static <T> List<T> mutableListOf(@g T... elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        return elements.length == 0 ? new ArrayList() : new ArrayList(new ArrayAsCollection(elements, true));
    }
    ...
    public static /* synthetic */ int binarySearch$default(List list, int i4, int i10, Function1 function1, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i4 = 0;
        }
        if ((i11 & 2) != 0) {
        ...
        return binarySearch(list, i4, i10, function1);
    }

    public static final <T> int binarySearch(@g List<? extends T> list, T t9, @g Comparator<? super T> comparator, int i4, int i10) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        ...
        while (i4 <= i11) {
            int i12 = (i4 + i11) >>> 1;
            int compare = comparator.compare((T) list.get(i12), t9);
            if (compare < 0) {
                i4 = i12 + 1;
            } else if (compare <= 0) {
                return i12;
    ...
    public static final <T> int binarySearch(@g List<? extends T> list, int i4, int i10, @g Function1<? super T, Integer> comparison) {
        Intrinsics.checkNotNullParameter(list, "<this>");
