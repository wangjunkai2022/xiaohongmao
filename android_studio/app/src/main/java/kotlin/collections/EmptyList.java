...
public final class EmptyList implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public boolean contains(@g Void element) {
        Intrinsics.checkNotNullParameter(element, "element");
        return false;
    }

    @Override // java.util.List, java.util.Collection
    public boolean containsAll(@g Collection elements) {
    ...
    public int indexOf(@g Void element) {
        Intrinsics.checkNotNullParameter(element, "element");
        return -1;
    }
    ...
    public int lastIndexOf(@g Void element) {
        Intrinsics.checkNotNullParameter(element, "element");
        return -1;
    }
    ...
    public List subList(int i4, int i10) {
        ...
        throw new IndexOutOfBoundsException("fromIndex: " + i4 + ", toIndex: " + i10);
    }
