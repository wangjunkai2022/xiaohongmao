...
public class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    @g
    public static <R> List<R> filterIsInstance(@g Iterable<?> iterable, @g Class<R> klass) {
    ...
    @g
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(@g Iterable<?> iterable, @g C destination, @g Class<R> klass) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
    ...
    public static <T> void reverse(@g List<T> list) {
    ...
    @g
    public static final <T extends Comparable<? super T>> SortedSet<T> toSortedSet(@g Iterable<? extends T> iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return (SortedSet) CollectionsKt___CollectionsKt.toCollection(iterable, new TreeSet());
    }

    @g
    public static final <T> SortedSet<T> toSortedSet(@g Iterable<? extends T> iterable, @g Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
