...
public class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
    ...
    @PublishedApi
    @g
    public static <K, V> Map<K, V> build(@g Map<K, V> builder) {
    ...
    public static final <K, V> V getOrPut(@g ConcurrentMap<K, V> concurrentMap, K k10, @g Function0<? extends V> defaultValue) {
    ...
    @g
    public static <K, V> Map<K, V> mapOf(@g Pair<? extends K, ? extends V> pair) {
    ...
    @g
    public static final <K extends Comparable<? super K>, V> SortedMap<K, V> sortedMapOf(@g Pair<? extends K, ? extends V>... pairs) {
    ...
    @g
    public static final <K, V> Map<K, V> toSingletonMap(@g Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @g
    public static final <K extends Comparable<? super K>, V> SortedMap<K, V> toSortedMap(@g Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @g
    public static final <K, V> SortedMap<K, V> sortedMapOf(@g Comparator<? super K> comparator, @g Pair<? extends K, ? extends V>... pairs) {
    ...
    @g
    public static <K, V> SortedMap<K, V> toSortedMap(@g Map<? extends K, ? extends V> map, @g Comparator<? super K> comparator) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        TreeMap treeMap = new TreeMap(comparator);
        treeMap.putAll(map);
