...
public class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    @g
    public static final <R> Sequence<R> filterIsInstance(@g Sequence<?> sequence, @g Class<R> klass) {
        Sequence<R> filter;
    ...
    @g
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(@g Sequence<?> sequence, @g C destination, @g Class<R> klass) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @g
    public static final <T extends Comparable<? super T>> SortedSet<T> toSortedSet(@g Sequence<? extends T> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return (SortedSet) SequencesKt___SequencesKt.toCollection(sequence, new TreeSet());
    }

    @g
    public static final <T> SortedSet<T> toSortedSet(@g Sequence<? extends T> sequence, @g Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
