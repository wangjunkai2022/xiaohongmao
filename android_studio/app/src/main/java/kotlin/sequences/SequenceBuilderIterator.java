...
public final class SequenceBuilderIterator<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    public final void setNextStep(@h Continuation<? super Unit> continuation) {
        this.nextStep = continuation;
    }

    @Override // kotlin.sequences.SequenceScope
    @h
    public Object yield(T t9, @g Continuation<? super Unit> continuation) {
    ...
    @Override // kotlin.sequences.SequenceScope
    @h
    public Object yieldAll(@g Iterator<? extends T> it, @g Continuation<? super Unit> continuation) {
        Object coroutine_suspended;
        Object coroutine_suspended2;
        Object coroutine_suspended3;
        if (it.hasNext()) {
