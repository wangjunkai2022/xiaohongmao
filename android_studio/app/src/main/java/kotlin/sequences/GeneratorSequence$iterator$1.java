...
public final class GeneratorSequence$iterator$1 implements Iterator<T>, KMappedMarker {
    ...
    private final void calcNext() {
        ...
        if (this.nextState == -2) {
            ...
            t9 = function1.invoke(t10);
        }
        this.nextItem = t9;
        this.nextState = t9 == 0 ? 0 : 1;
    }
    ...
    public T next() {
        ...
        if (this.nextState != 0) {
            T t9 = this.nextItem;
            Intrinsics.checkNotNull(t9, "null cannot be cast to non-null type T of kotlin.sequences.GeneratorSequence");
            this.nextState = -1;
            return t9;
        }
    ...
    public final void setNextItem(@h T t9) {
        this.nextItem = t9;
    }
