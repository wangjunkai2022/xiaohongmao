...
public class SequencesKt__SequenceBuilderKt {
    ...
    @g
    public static <T> Iterator<T> iterator(@BuilderInference @g Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
    ...
    @SinceKotlin(version = "1.3")
    @g
    public static <T> Sequence<T> sequence(@BuilderInference @g final Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
