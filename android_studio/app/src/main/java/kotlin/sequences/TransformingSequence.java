...
public final class TransformingSequence<T, R> implements Sequence<R> {
    ...
    public TransformingSequence(@g Sequence<? extends T> sequence, @g Function1<? super T, ? extends R> transformer) {
    ...
    @g
    public final <E> Sequence<E> flatten$kotlin_stdlib(@g Function1<? super R, ? extends Iterator<? extends E>> iterator) {
