...
public abstract class ContinuationImpl extends BaseContinuationImpl {
    ...
    public ContinuationImpl(@h Continuation<Object> continuation, @h CoroutineContext coroutineContext) {
        super(continuation);
    ...
    public ContinuationImpl(@h Continuation<Object> continuation) {
