...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public BaseContinuationImpl(@h Continuation<Object> continuation) {
        this.completion = continuation;
    }

    @g
    public Continuation<Unit> create(@g Continuation<?> completion) {
    ...
    @h
    protected abstract Object invokeSuspend(@g Object obj);
    ...
    public final void resumeWith(@g Object obj) {
        ...
        while (true) {
            ...
            try {
                ...
                obj = Result.m70constructorimpl(ResultKt.createFailure(th));
            }
    ...
    @g
    public Continuation<Unit> create(@h Object obj, @g Continuation<?> completion) {
        Intrinsics.checkNotNullParameter(completion, "completion");
