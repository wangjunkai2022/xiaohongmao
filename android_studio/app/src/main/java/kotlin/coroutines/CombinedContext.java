...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    private static final class Serialized implements Serializable {
        ...
        public Serialized(@g CoroutineContext[] elements) {
    ...
    public CombinedContext(@g CoroutineContext left, @g CoroutineContext.Element element) {
    ...
    public <R> R fold(R r9, @g Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
