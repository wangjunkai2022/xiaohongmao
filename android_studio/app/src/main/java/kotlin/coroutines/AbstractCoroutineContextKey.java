...
public abstract class AbstractCoroutineContextKey<B extends CoroutineContext.Element, E extends B> implements CoroutineContext.Key<E> {
    ...
    public AbstractCoroutineContextKey(@g CoroutineContext.Key<B> baseKey, @g Function1<? super CoroutineContext.Element, ? extends E> safeCast) {
    ...
    public final boolean isSubKey$kotlin_stdlib(@g CoroutineContext.Key<?> key) {
    ...
    @h
    public final CoroutineContext.Element tryCast$kotlin_stdlib(@g CoroutineContext.Element element) {
