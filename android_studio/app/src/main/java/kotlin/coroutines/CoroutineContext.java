...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        @g
        public static CoroutineContext plus(@g CoroutineContext coroutineContext, @g CoroutineContext context) {
    ...
    public interface Element extends CoroutineContext {
        ...
        /* loaded from: classes4.dex */
        public static final class DefaultImpls {
            public static <R> R fold(@g Element element, R r9, @g Function2<? super R, ? super Element, ? extends R> operation) {
                Intrinsics.checkNotNullParameter(operation, "operation");
                return operation.invoke(r9, element);
            }

            /* JADX WARN: Multi-variable type inference failed */
            @h
            public static <E extends Element> E get(@g Element element, @g Key<E> key) {
            ...
            @g
            public static CoroutineContext minusKey(@g Element element, @g Key<?> key) {
                Intrinsics.checkNotNullParameter(key, "key");
                return Intrinsics.areEqual(element.getKey(), key) ? EmptyCoroutineContext.INSTANCE : element;
            }

            @g
            public static CoroutineContext plus(@g Element element, @g CoroutineContext context) {
                Intrinsics.checkNotNullParameter(context, "context");
        ...
        <R> R fold(R r9, @g Function2<? super R, ? super Element, ? extends R> function2);

        @Override // kotlin.coroutines.CoroutineContext
        @h
        <E extends Element> E get(@g Key<E> key);
        ...
        @Override // kotlin.coroutines.CoroutineContext
        @g
        CoroutineContext minusKey(@g Key<?> key);
    }
    ...
    @g
    CoroutineContext plus(@g CoroutineContext coroutineContext);
}
