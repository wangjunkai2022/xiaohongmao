...
public final class ContinuationKt {
    ...
    private static final <T> Continuation<T> Continuation(final CoroutineContext context, final Function1<? super Result<? extends T>, Unit> resumeWith) {
        ...
        return new Continuation<T>() { // from class: kotlin.coroutines.ContinuationKt$Continuation$1
            ...
            @Override // kotlin.coroutines.Continuation
            public void resumeWith(@g Object obj) {
                resumeWith.invoke(Result.m69boximpl(obj));
            }
        };
    }
    ...
    @SinceKotlin(version = "1.3")
    @g
    public static final <T> Continuation<Unit> createCoroutine(@g Function1<? super Continuation<? super T>, ? extends Object> function1, @g Continuation<? super T> completion) {
    ...
    @SinceKotlin(version = "1.3")
    public static final <T> void startCoroutine(@g Function1<? super Continuation<? super T>, ? extends Object> function1, @g Continuation<? super T> completion) {
        Continuation createCoroutineUnintercepted;
        Continuation intercepted;
        Intrinsics.checkNotNullParameter(function1, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
        ...
        intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(createCoroutineUnintercepted);
        Result.Companion companion = Result.Companion;
        intercepted.resumeWith(Result.m70constructorimpl(Unit.INSTANCE));
    }
    ...
    @SinceKotlin(version = "1.3")
    @g
    public static final <R, T> Continuation<Unit> createCoroutine(@g Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r9, @g Continuation<? super T> completion) {
        Continuation createCoroutineUnintercepted;
        Continuation intercepted;
        Object coroutine_suspended;
        Intrinsics.checkNotNullParameter(function2, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
        createCoroutineUnintercepted = IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted(function2, r9, completion);
        intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(createCoroutineUnintercepted);
        coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        return new SafeContinuation(intercepted, coroutine_suspended);
    }
    ...
    @SinceKotlin(version = "1.3")
    public static final <R, T> void startCoroutine(@g Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r9, @g Continuation<? super T> completion) {
        Continuation createCoroutineUnintercepted;
        Continuation intercepted;
        Intrinsics.checkNotNullParameter(function2, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
