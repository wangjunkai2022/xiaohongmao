...
final class StringsKt___StringsKt$windowedSequence$2 extends Lambda implements Function1<Integer, R> {
    ...
    public StringsKt___StringsKt$windowedSequence$2(int i4, CharSequence charSequence, Function1<? super CharSequence, ? extends R> function1) {
        super(1);
        this.$size = i4;
    ...
    public final R invoke(int i4) {
        ...
        return this.$transform.invoke(this.$this_windowedSequence.subSequence(i4, i10));
    }
}
