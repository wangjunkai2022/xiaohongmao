...
public class StringsKt__StringNumberConversionsKt extends StringsKt__StringNumberConversionsJVMKt {
    @g
    public static final Void numberFormatError(@g String input) {
    ...
    @h
    public static final Byte toByteOrNull(@g String str) {
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static Integer toIntOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static Long toLongOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static final Short toShortOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static final Byte toByteOrNull(@g String str, int i4) {
        int intValue;
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static final Integer toIntOrNull(@g String str, int i4) {
        boolean z9;
        int i10;
        Intrinsics.checkNotNullParameter(str, "<this>");
        ...
        int i14 = -59652323;
        while (i13 < length) {
            int digitOf = CharsKt__CharJVMKt.digitOf(str.charAt(i13), i4);
            if (digitOf < 0) {
                return null;
            }
            if ((i11 < i14 && (i14 != -59652323 || i11 < (i14 = i12 / i4))) || (i10 = i11 * i4) < i12 + digitOf) {
                return null;
            }
            i11 = i10 - digitOf;
            i13++;
    ...
    */
    public static final java.lang.Long toLongOrNull(@m8.g java.lang.String r18, int r19) {
        /*
            r0 = r18
            r1 = r19
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static final Short toShortOrNull(@g String str, int i4) {
        int intValue;
        Intrinsics.checkNotNullParameter(str, "<this>");
        Integer intOrNull = toIntOrNull(str, i4);
