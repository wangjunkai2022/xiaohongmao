...
public final class StringsKt__StringsKt$rangesDelimitedBy$2 extends Lambda implements Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public StringsKt__StringsKt$rangesDelimitedBy$2(List<String> list, boolean z9) {
        super(2);
    ...
    @h
    public final Pair<Integer, Integer> invoke(@g CharSequence $receiver, int i4) {
        Pair findAnyOf$StringsKt__StringsKt;
        Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
        findAnyOf$StringsKt__StringsKt = StringsKt__StringsKt.findAnyOf$StringsKt__StringsKt($receiver, this.$delimitersList, i4, this.$ignoreCase, false);
