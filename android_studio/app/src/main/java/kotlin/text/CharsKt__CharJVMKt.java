...
public class CharsKt__CharJVMKt {
    ...
    public static final int digitOf(char c10, int i4) {
        return Character.digit((int) c10, i4);
    }
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final String titlecase(char c10, @g Locale locale) {
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final String lowercase(char c10, @g Locale locale) {
        Intrinsics.checkNotNullParameter(locale, "locale");
        String valueOf = String.valueOf(c10);
        Intrinsics.checkNotNull(valueOf, "null cannot be cast to non-null type java.lang.String");
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final String uppercase(char c10, @g Locale locale) {
        Intrinsics.checkNotNullParameter(locale, "locale");
        String valueOf = String.valueOf(c10);
        Intrinsics.checkNotNull(valueOf, "null cannot be cast to non-null type java.lang.String");
