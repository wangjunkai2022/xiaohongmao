...
public final class StringsKt__StringsKt$rangesDelimitedBy$1 extends Lambda implements Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public StringsKt__StringsKt$rangesDelimitedBy$1(char[] cArr, boolean z9) {
        super(2);
    ...
    public final Pair<Integer, Integer> invoke(@g CharSequence $receiver, int i4) {
        ...
        int indexOfAny = StringsKt__StringsKt.indexOfAny($receiver, this.$delimiters, i4, this.$ignoreCase);
        if (indexOfAny < 0) {
            return null;
        }
