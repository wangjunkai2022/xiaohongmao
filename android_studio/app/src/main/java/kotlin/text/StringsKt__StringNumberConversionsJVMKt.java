...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    @SinceKotlin(version = "1.2")
    @h
    public static final BigDecimal toBigDecimalOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        try {
            if (ScreenFloatValueRegEx.value.matches(str)) {
                return new BigDecimal(str);
    ...
    @SinceKotlin(version = "1.2")
    @h
    public static final BigInteger toBigIntegerOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @h
    public static final Double toDoubleOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        try {
            if (ScreenFloatValueRegEx.value.matches(str)) {
    ...
    @SinceKotlin(version = "1.1")
    @h
    public static final Float toFloatOrNull(@g String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        try {
            if (ScreenFloatValueRegEx.value.matches(str)) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(byte b10, int i4) {
        int checkRadix;
        int checkRadix2;
    ...
    @SinceKotlin(version = "1.2")
    @h
    public static final BigInteger toBigIntegerOrNull(@g String str, int i4) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(short s9, int i4) {
        int checkRadix;
        int checkRadix2;
        checkRadix = CharsKt__CharJVMKt.checkRadix(i4);
        checkRadix2 = CharsKt__CharJVMKt.checkRadix(checkRadix);
        String num = Integer.toString(s9, checkRadix2);
        Intrinsics.checkNotNullExpressionValue(num, "toString(this, checkRadix(radix))");
        return num;
    }
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(int i4, int i10) {
        int checkRadix;
    ...
    @SinceKotlin(version = "1.2")
    @h
    public static final BigDecimal toBigDecimalOrNull(@g String str, @g MathContext mathContext) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(mathContext, "mathContext");
        try {
            if (ScreenFloatValueRegEx.value.matches(str)) {
    ...
    private static final String toString(long j4, int i4) {
        int checkRadix;
        checkRadix = CharsKt__CharJVMKt.checkRadix(i4);
        String l10 = Long.toString(j4, checkRadix);
