...
public class StringsKt__AppendableKt {
    @g
    public static final <T extends Appendable> T append(@g T t9, @g CharSequence... value) {
    ...
    public static <T> void appendElement(@g Appendable appendable, T t9, @h Function1<? super T, ? extends CharSequence> function1) {
        Intrinsics.checkNotNullParameter(appendable, "<this>");
        if (function1 != null) {
            appendable.append(function1.invoke(t9));
            return;
        }
        if (t9 == null ? true : t9 instanceof CharSequence) {
    ...
    public static final <T extends Appendable> T appendRange(@g T t9, @g CharSequence value, int i4, int i10) {
        Intrinsics.checkNotNullParameter(t9, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        T t10 = (T) t9.append(value, i4, i10);
