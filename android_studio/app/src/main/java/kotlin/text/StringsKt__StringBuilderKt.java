...
public class StringsKt__StringBuilderKt extends StringsKt__StringBuilderJVMKt {
    ...
    @g
    public static StringBuilder append(@g StringBuilder sb, @g String... value) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
    ...
    @g
    public static final StringBuilder append(@g StringBuilder sb, @g Object... value) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb, boolean z9) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append(z9);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        sb.append('\n');
