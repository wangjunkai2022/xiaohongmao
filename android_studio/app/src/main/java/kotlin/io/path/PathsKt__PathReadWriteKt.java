...
class PathsKt__PathReadWriteKt {
    ...
    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final void appendText(@g Path path, @g CharSequence text, @g Charset charset) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ BufferedReader bufferedReader$default(Path path, Charset charset, int i4, OpenOption[] options, int i10, Object obj) throws IOException {
        if ((i10 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i10 & 2) != 0) {
    ...
    static /* synthetic */ BufferedWriter bufferedWriter$default(Path path, Charset charset, int i4, OpenOption[] options, int i10, Object obj) throws IOException {
        if ((i10 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i10 & 2) != 0) {
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final String readText(@g Path path, @g Charset charset) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
    ...
    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final void writeText(@g Path path, @g CharSequence text, @g Charset charset, @g OpenOption... options) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(options, "options");
