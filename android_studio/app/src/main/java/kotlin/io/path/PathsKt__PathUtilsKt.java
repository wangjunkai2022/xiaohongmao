...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    @InlineOnly
    private static final Path copyTo(Path path, Path target, boolean z9) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z9, int i4, Object obj) throws IOException {
        if ((i4 & 2) != 0) {
            z9 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    @PublishedApi
    @g
    public static final Void fileAttributeViewNotAvailable(@g Path path, @g Class<?> attributeViewClass) {
        Intrinsics.checkNotNullParameter(path, "path");
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        V v9 = (V) Files.getFileAttributeView(path, FileAttributeView.class, (LinkOption[]) Arrays.copyOf(options, options.length));
        if (v9 != null) {
            return v9;
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
    ...
    */
    public static final java.lang.String getExtension(@m8.g java.nio.file.Path r2) {
        /*
    ...
    @g
    public static final String getInvariantSeparatorsPathString(@g Path path) {
    ...
    @g
    public static final String getName(@g Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.String getNameWithoutExtension(@m8.g java.nio.file.Path r3) {
        /*
            java.lang.String r0 = "<this>"
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final List<Path> listDirectoryEntries(@g Path path, @g String glob) throws IOException {
        List<Path> list;
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(glob, "glob");
        DirectoryStream<Path> it = Files.newDirectoryStream(path, glob);
    ...
    static /* synthetic */ Path moveTo$default(Path path, Path target, boolean z9, int i4, Object obj) throws IOException {
        if ((i4 & 2) != 0) {
            z9 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final Path relativeTo(@g Path path, @g Path base) {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    @h
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final Path relativeToOrNull(@g Path path, @g Path base) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(base, "base");
        try {
            return PathRelativizer.INSTANCE.tryRelativeTo(path, base);
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final Path relativeToOrSelf(@g Path path, @g Path base) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(base, "base");
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final Path createTempDirectory(@h Path path, @h String str, @g FileAttribute<?>... attributes) throws IOException {
        Intrinsics.checkNotNullParameter(attributes, "attributes");
        if (path != null) {
    ...
    @g
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final Path createTempFile(@h Path path, @h String str, @h String str2, @g FileAttribute<?>... attributes) throws IOException {
        Intrinsics.checkNotNullParameter(attributes, "attributes");
        if (path != null) {
    ...
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    @InlineOnly
    private static final Path moveTo(Path path, Path target, boolean z9) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        CopyOption[] copyOptionArr = z9 ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path move = Files.move(path, target, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
