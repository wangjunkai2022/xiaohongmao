...
public final class FilePathComponents {
    ...
    public FilePathComponents(@g File root, @g List<? extends File> segments) {
    ...
    @g
    public final FilePathComponents copy(@g File root, @g List<? extends File> segments) {
        Intrinsics.checkNotNullParameter(root, "root");
        Intrinsics.checkNotNullParameter(segments, "segments");
    ...
    @g
    public final File subPath(int i4, int i10) {
        String joinToString$default;
        if (i4 >= 0 && i4 <= i10 && i10 <= getSize()) {
            List<File> subList = this.segments.subList(i4, i10);
