...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final void appendText(@g File file, @g String text, @g Charset charset) {
        Intrinsics.checkNotNullParameter(file, "<this>");
    ...
    static /* synthetic */ BufferedReader bufferedReader$default(File file, Charset charset, int i4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i10 & 2) != 0) {
    ...
    private static final BufferedWriter bufferedWriter(File file, Charset charset, int i4) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(l.b.a(new FileOutputStream(file), file), charset);
    ...
    static /* synthetic */ BufferedWriter bufferedWriter$default(File file, Charset charset, int i4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final void forEachBlock(@g File file, @g Function2<? super byte[], ? super Integer, Unit> action) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        forEachBlock(file, 4096, action);
    }

    public static final void forEachLine(@g File file, @g Charset charset, @g Function1<? super String, Unit> action) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(action, "action");
        TextStreamsKt.forEachLine(new BufferedReader(new InputStreamReader(h.b.a(new FileInputStream(file), file), charset)), action);
    }
    ...
    @g
    public static final byte[] readBytes(@g File file) {
        Intrinsics.checkNotNullParameter(file, "<this>");
            ...
            if (length <= 2147483647L) {
                ...
                if (i10 > 0) {
                    ...
                    if (read2 != -1) {
                        ...
                        ByteStreamsKt.copyTo$default(a10, exposingBufferByteArrayOutputStream, 0, 2, null);
    ...
    @g
    public static final List<String> readLines(@g File file, @g Charset charset) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
    ...
    @g
    public static final String readText(@g File file, @g Charset charset) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        InputStreamReader inputStreamReader = new InputStreamReader(h.b.a(new FileInputStream(file), file), charset);
        try {
    ...
    private static final InputStreamReader reader(File file, Charset charset) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        return new InputStreamReader(h.b.a(new FileInputStream(file), file), charset);
    }
    ...
    public static final <T> T useLines(@g File file, @g Charset charset, @g Function1<? super Sequence<String>, ? extends T> block) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
    ...
    public static final void writeBytes(@g File file, @g byte[] array) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(array, "array");
    ...
    public static final void writeText(@g File file, @g String text, @g Charset charset) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(charset, "charset");
        byte[] bytes = text.getBytes(charset);
    ...
    private static final OutputStreamWriter writer(File file, Charset charset) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        return new OutputStreamWriter(l.b.a(new FileOutputStream(file), file), charset);
    }
    ...
    public static final void forEachBlock(@g File file, int i4, @g Function2<? super byte[], ? super Integer, Unit> action) {
        int coerceAtLeast;
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
