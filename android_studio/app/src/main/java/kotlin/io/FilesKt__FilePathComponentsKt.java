...
public class FilesKt__FilePathComponentsKt {
    @g
    public static final File getRoot(@g File file) {
    ...
    */
    ...
    @g
    public static final String getRootName(@g File file) {
        Intrinsics.checkNotNullParameter(file, "<this>");
    ...
    public static final boolean isRooted(@g File file) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        String path = file.getPath();
        Intrinsics.checkNotNullExpressionValue(path, "path");
    ...
    @g
    public static final File subPath(@g File file, int i4, int i10) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        return toComponents(file).subPath(i4, i10);
    }

    @g
    public static final FilePathComponents toComponents(@g File file) {
