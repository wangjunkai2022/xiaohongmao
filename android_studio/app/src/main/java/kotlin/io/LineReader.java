...
public final class LineReader {
    ...
    private final int decode(boolean z9) {
        while (true) {
    ...
    private final int decodeEndOfInput(int i4, int i10) {
        ByteBuffer byteBuffer = byteBuf;
        byteBuffer.limit(i4);
    ...
    */
    public final synchronized java.lang.String readLine(@m8.g java.io.InputStream r11, @m8.g java.nio.charset.Charset r12) {
        /*
            r10 = this;
            monitor-enter(r10)
