...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return onFailure.invoke(m73exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r9) {
        return Result.m76isFailureimpl(obj) ? r9 : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable m73exceptionOrNullimpl = Result.m73exceptionOrNullimpl(obj);
        return m73exceptionOrNullimpl == null ? obj : onFailure.invoke(m73exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        if (Result.m77isSuccessimpl(obj)) {
            ...
            return Result.m70constructorimpl(transform.invoke(obj));
        }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable m73exceptionOrNullimpl = Result.m73exceptionOrNullimpl(obj);
        if (m73exceptionOrNullimpl != null) {
            action.invoke(m73exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m70constructorimpl(transform.invoke(m73exceptionOrNullimpl));
    }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            return Result.m70constructorimpl(block.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m70constructorimpl(createFailure(th));
        }
    ...
    @SinceKotlin(version = "1.3")
    @PublishedApi
    public static final void throwOnFailure(@g Object obj) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T, R> Object runCatching(T t9, Function1<? super T, ? extends R> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        try {
            Result.Companion companion = Result.Companion;
            return Result.m70constructorimpl(block.invoke(t9));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m70constructorimpl(createFailure(th));
        }
