...
public final class KotlinVersion implements Comparable<KotlinVersion> {
    ...
    public KotlinVersion(int i4, int i10, int i11) {
        this.major = i4;
        this.minor = i10;
        this.patch = i11;
        this.version = versionOf(i4, i10, i11);
    }

    private final int versionOf(int i4, int i10, int i11) {
        boolean z9 = false;
        if (new IntRange(0, 255).contains(i4) && new IntRange(0, 255).contains(i10) && new IntRange(0, 255).contains(i11)) {
            z9 = true;
        }
        if (z9) {
    ...
    public final boolean isAtLeast(int i4, int i10) {
        int i11 = this.major;
        return i11 > i4 || (i11 == i4 && this.minor >= i10);
    }
    ...
    public int compareTo(@g KotlinVersion other) {
    ...
    public final boolean isAtLeast(int i4, int i10, int i11) {
        int i12;
        int i13 = this.major;
        return i13 > i4 || (i13 == i4 && ((i12 = this.minor) > i10 || (i12 == i10 && this.patch >= i11)));
    }

    public KotlinVersion(int i4, int i10) {
        this(i4, i10, 0);
    }
}
