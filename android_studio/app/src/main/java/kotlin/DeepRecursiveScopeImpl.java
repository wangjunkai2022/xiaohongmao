...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public DeepRecursiveScopeImpl(@g Function3<? super DeepRecursiveScope<T, R>, ? super T, ? super Continuation<? super R>, ? extends Object> block, T t9) {
        super(null);
        Object obj;
    ...
    @h
    public Object callRecursive(T t9, @g Continuation<? super R> continuation) {
    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            obj = DeepRecursiveKt.UNDEFINED_RESULT;
            if (Result.m72equalsimpl0(obj, r9)) {
                try {
                    ...
                    if (invoke != coroutine_suspended) {
                        ...
                        continuation.resumeWith(Result.m70constructorimpl(invoke));
                    }
                } catch (Throwable th) {
    ...
    @Override // kotlin.DeepRecursiveScope
    @h
    public <U, S> Object callRecursive(@g DeepRecursiveFunction<U, S> deepRecursiveFunction, U u9, @g Continuation<? super S> continuation) {
        Object coroutine_suspended;
        Object coroutine_suspended2;
